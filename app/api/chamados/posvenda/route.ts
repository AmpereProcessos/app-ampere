...
import { z } from "zod";
import { type Db, ObjectId, type Filter } from "mongodb";
...
export type TGetAllPosVendaCallsOutput = Exclude<
	UnwrapAppRouterNextResponse<Awaited<ReturnType<typeof getPosVendaCalls>>>["data"]["default"],
	undefined
>;
export type TGetPosVendaCallByIdOutput = Exclude<
	UnwrapAppRouterNextResponse<Awaited<ReturnType<typeof getPosVendaCalls>>>["data"]["byId"],
	undefined
>;
