					...
					<div className="flex h-full flex-col">
						...
						<div className="my-2 flex flex-wrap items-center justify-center gap-2">
							{infoHolder.created ? (
								infoHolder.status == "RESOLVIDO" ? (
									<h1 className={`rounded border border-green-400 p-2 text-xs font-bold text-green-400`}>RESOLVIDO</h1>
								) : (
									<>
										<h1
						...
						<div className="overscroll-y scrollbar-thin scrollbar-thumb-primary/20 scrollbar-track-primary/20 flex flex-col overflow-y-auto">
							<div className="border-primary/20 mt-4 flex flex-col gap-x-2 border p-2 lg:flex-row lg:items-center">
								...
								<div className={"grow"}>
									{!info.created ? (
										...
										<p className="text-primary/70 text-center uppercase">{info.nomeCliente}</p>
									)}
								</div>
							</div>
							<div className="border-primary/20 mt-4 flex flex-col gap-x-2 border p-2 lg:flex-row">
								...
								<p className="grow text-center text-sm">{infoHolder.codProjeto ? infoHolder.codProjeto : "-"}</p>
							</div>
							<div className="border-primary/20 mt-4 flex flex-col gap-x-2 border p-2 lg:flex-row">
