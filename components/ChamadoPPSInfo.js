...
function ChamadosExternoPPSInfo({ dados, setDados, setStage }) {
  ...
  function addEquipment() {
    if (
      equipHolder.pot == 0 ||
      equipHolder.hoursOfUse == 0 ||
      equipHolder.name.trim().length < 3
    ) {
      setMsg({
      ...
      {dados.tipoDeSolicitacao != "DÚVIDAS E AUXILIOS TÉCNICOS" ? (
        <>
          ...
          <SelectInput
            ...
            handleChange={(value) =>
              setDados({ ...dados, tipoDoCliente: value })
            }
          />
              ...
              <div className="flex flex-col w-full mt-2">
                ...
                <div className="flex items-center justify-center gap-2 flex-wrap">
                  ...
                  <NumberInput
                    ...
                    handleChange={(value) =>
                      setEquipHolder({ ...equipHolder, qtde: Number(value) })
                    }
                  />
                  <NumberInput
                    ...
                    handleChange={(value) =>
                      setEquipHolder({ ...equipHolder, pot: Number(value) })
                    }
                  />
                  <NumberInput
                  ...
                  <button
                    ...
                    className="p-1 rounded border border-green-500 text-green-500 hover:text-white hover:bg-green-500"
                  >
                    <IoMdAddCircle />
                  </button>
                </div>
                <div className="flex flex-col">
                  <h1 className="text-center text-[#fead61] font-bold">
                    LISTA
                  </h1>
