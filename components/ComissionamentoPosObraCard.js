...
function ComissionamentoPosObraCard({ project, index, handleUpdates }) {
  ...
  return (
    <motion.div
      ...
      className={`flex flex-col ${getBorderColor(
        dayjs().diff(info.medidor.data, "days")
      )} p-2`}
    >
      <div className="grid grid-rows-10 grid-cols-1 lg:grid-cols-10 lg:grid-rows-1 w-full">
        ...
        <div className="col-span-9 flex flex-col row-span-5">
          <div className="flex items-center justify-center gap-4">
            ...
            <div className="flex flex-col items-center">
              <p className="text-xs text-[#15599a] font-bold">EQUIPE RESP.</p>
