	...
	return (
		<div className="flex w-full flex-col items-center">
			...
			<div className="mt-3 flex w-full flex-col gap-2">
				<div className="flex w-full items-center justify-center rounded border border-gray-300 p-2 pl-4 dark:border-gray-700">
					<input checked={infoHolder.testesCCeCA} onChange={(e) => setInfo({ ...infoHolder, testesCCeCA: e.target.checked })} type="checkbox" value="" className="outline-none" />
				...
				<div className="flex w-full items-center justify-center rounded border border-gray-300 p-2 pl-4 dark:border-gray-700">
					<input
						...
						className="outline-none"
					/>
					<label className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">CONFERÊNCIA DOS GRAMPOS (FINAL E/OU INTERMEDIÁRIOS) FEITA ?</label>
				</div>
				<div className="flex w-full items-center justify-center rounded border border-gray-300 p-2 pl-4 dark:border-gray-700">
					<input
							...
							<div className="absolute">
								{images.irregularidadesCorrigidas ? (
									<div className="flex flex-col items-center">
										<i className="fa fa-folder-open fa-4x text-blue-700"></i>
										<span className="block text-center font-normal text-gray-400">
											{images.irregularidadesCorrigidas.length == 1 ? images.irregularidadesCorrigidas[0].name : `${images.irregularidadesCorrigidas[0].name}...`}
										</span>
									</div>
								) : (
									<div className="flex flex-col items-center">
						...
						<div className="relative mt-2 flex h-fit items-center justify-center rounded-lg border-2 border-dotted border-blue-700 bg-gray-100 p-2">
							<div className="absolute">
								{images.kitInversor ? (
									<div className="flex flex-col items-center">
										<i className="fa fa-folder-open fa-4x text-blue-700"></i>
										<span className="block text-center font-normal text-gray-400">{images.kitInversor.length == 1 ? images.kitInversor[0].name : `${images.kitInversor[0].name}...`}</span>
									</div>
								) : (
									<div className="flex flex-col items-center">
										<i className="fa fa-folder-open fa-4x text-blue-700"></i>
              ...
              />
				...
				<div className="flex flex-col items-center">
					...
					<textarea
						...
						className={"min-h-[200px] w-full resize-none border border-gray-300 p-2 text-center text-xs outline-none lg:w-[600px]"}
					/>
				</div>
			</div>
