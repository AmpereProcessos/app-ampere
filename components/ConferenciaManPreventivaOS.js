	...
	return (
		<div className="flex w-full flex-col items-center">
			...
			<div className="mt-3 flex w-full flex-col gap-2">
				<div className="border-primary/20 dark:border-primary/70 flex w-full items-center justify-center rounded border p-2 pl-4">
					<input
					...
					/>
					<label className="dark:text-primary/20 ml-2 text-sm font-medium text-gray-900">TESTES E CONFERÊNCIAS CA E CC FEITOS ?</label>
				</div>
				<div className="border-primary/20 dark:border-primary/70 flex w-full items-center justify-center rounded border p-2 pl-4">
					<input
						...
						className="outline-hidden"
					/>
					<label className="dark:text-primary/20 ml-2 text-sm font-medium text-gray-900">CONFERÊNCIA DOS CONECTORES FEITA ?</label>
				</div>
				<div className="border-primary/20 dark:border-primary/70 flex w-full items-center justify-center rounded border p-2 pl-4">
					<input
				...
				<div className="border-primary/20 dark:border-primary/70 flex w-full items-center justify-center rounded border p-2 pl-4">
					<input
						...
						className="outline-hidden"
					/>
					<label className="dark:text-primary/20 ml-2 text-sm font-medium text-gray-900">REVISAO DO MADEIRAMENTO FEITA ?</label>
				</div>
              ...
              />
				...
				<div className="flex flex-col items-center">
					...
					<textarea
						...
						className={"border-primary/20 min-h-[200px] w-full resize-none border p-2 text-center text-xs outline-hidden lg:w-[600px]"}
					/>
				</div>
			</div>
