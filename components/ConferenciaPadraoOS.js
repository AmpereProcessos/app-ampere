    ...
    <div className="flex w-full flex-col items-center">
      ...
      <div className="mt-3 flex w-full flex-col gap-2">
        <div className="border-primary/20 dark:border-primary/70 flex w-full items-center justify-center rounded border p-2 pl-4">
          ...
          />
          <label className="dark:text-primary/20 ml-2 text-sm font-medium text-gray-900">REALIMENTAÇÃO FEITA ?</label>
        </div>
        <div className="border-primary/20 dark:border-primary/70 flex w-full items-center justify-center rounded border p-2 pl-4">
          <input
            ...
            className="outline-hidden"
          />
          <label className="dark:text-primary/20 ml-2 text-sm font-medium text-gray-900">RAMAL PASSADO ?</label>
        </div>
