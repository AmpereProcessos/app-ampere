      ...
      <div className="flex flex-wrap items-center justify-center gap-2 lg:justify-between">
        ...
        <div className="flex flex-wrap justify-end gap-x-4 gap-y-2">
          <div className="flex flex-col items-center">
            <h1 className="text-foreground text-center font-bold">DIAS DESDE TROCA DO MEDIDOR</h1>
            <h1 className="text-foreground text-center">
              {info.medidor?.data ? dayjs().diff(new Date(info.medidor.data), "days") : "-"}
            </h1>
          </div>
          <div className="flex flex-col items-center">
            <h1 className="text-foreground text-center font-bold">VENDEDOR</h1>
            <h1 className="text-foreground text-center">{info.vendedor.nome}</h1>
          </div>
          <div className="flex flex-col items-center">
            <h1 className="text-foreground text-center font-bold">CIDADE</h1>
            <h1 className="text-foreground text-center">{info.cidade}</h1>
          </div>
          <div className="flex flex-col items-center">
            <h1 className="text-foreground text-center font-bold">TOPOLOGIA</h1>
            <h1 className="text-foreground text-center">{info.sistema.topologia}</h1>
          </div>
          <div className="flex flex-col items-center">
            <h1 className="text-foreground text-center font-bold">ENTREGA TÉCNICA FEITA?</h1>
            <div className="flex">
              <input
