...
function EntregasCard({ project, index }) {
  ...
  return (
    ...
    >
      <div className="border-primary/20 grid grid-cols-1 grid-rows-4 items-center gap-2 border p-1 lg:grid-cols-10 lg:grid-rows-1">
        ...
        <div className="col-span-1 hidden flex-col items-center lg:flex">
          <p className="text-primary/80 text-xs">NºMÓDULOS</p>
          <p className="text-primary/80 text-xs">{project.sistema?.qtdeModulos}</p>
        </div>
        <div className="col-span-2 hidden flex-col items-center lg:flex">
          <p className="text-primary/80 text-xs">FATURAMENTO</p>
          <p
            className={`text-primary/80 ${project.faturamento?.previsaoFaturamento?.length > 70 ? 'text-xxs font-bold' : 'text-xs'} text-center uppercase`}
          >
            {project.faturamento?.previsaoFaturamento ? project.faturamento?.previsaoFaturamento : '-'}
          </p>
        </div>
        <div className="col-span-2 hidden flex-col items-center lg:flex">
          <p className="text-primary/80 text-xs">RASTREIO</p>
          <div className="w-full text-center">
            <p
              className={`text-primary/80 max-w-full break-words ${project.compra?.rastreio?.length > 70 ? 'text-xxs font-bold' : 'text-xxs'} text-center uppercase`}
            >
        ...
        <div className="flex flex-col items-center lg:col-span-1">
          <p className="text-primary/80 text-xs">PREV.ENTREGA</p>
          <input
        ...
        <div className="flex flex-col items-center lg:col-span-1">
          <p className="text-primary/80 text-xs">DATA ENTREGA</p>
          <input
