...
function FormSolicitacaoDadosConcessionariaAumento({ avancar, setDados, dados, voltar }) {
  ...
  return (
    <div className="bg-background flex w-full flex-col border border-[#15599a] pb-2 shadow-lg">
      ...
      <div className="mt-2 flex items-center justify-center">
        <SelectFoatingInput
          label={'JÁ É UM CLIENTE AMPERE ?'}
          value={dados.clienteAmpere}
          editable={true}
          handleChange={(value) => {
            setDados((prev) => ({ ...prev, clienteAmpere: value }))
          }}
          options={[
            { label: 'SIM', value: 'SIM' },
            { label: 'NÃO', value: 'NÃO' },
...
export default FormSolicitacaoDadosConcessionariaAumento
