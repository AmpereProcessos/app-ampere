...
function FormSolicitacaoDadosEstrutura({ avancar, setDados, dados, voltar }) {
  ...
  function validarCamposObrigatorios() {
    ...
    if (dados.tipoDeServico == 'OPERAÇÃO E MANUTENÇÃO' && (!dados.materialEstrutura || dados.materialEstrutura == 'NÃO DEFINIDO')) {
    ...
    if (dados.tipoDeServico != 'OPERAÇÃO E MANUTENÇÃO') {
      ...
      if (dados.responsavelEstrutura != 'AMPERE' && dados.estruturaAmpere == 'SIM' && (dados.valorEstrutura == null || dados.valorEstrutura == 0)) {
