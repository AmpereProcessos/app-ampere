...
function FormSolicitacaoDadosEstruturaMontagemDesmontagem({
  avancar,
  setDados,
  dados,
  voltar,
  ...
  function validarCamposObrigatorios() {
    ...
    if (
      dados.tipoEstruturaRemontagem == null ||
      dados.tipoEstruturaRemontagem == "NÃO DEFINIDO"
    ) {
    ...
    if (
      ...
      dados.materialEstruturaRemontagem == "NÃO DEFINIDO"
    ) {
      setMessage(
        "Por favor, preencha sobre o material da estrutura do novo local."
      );
      return false;
    }
      ...
      <div className="flex flex-col lg:grid lg:grid-cols-3 gap-2 p-2">
        ...
        <div className="flex items-center justify-center col-span-3 gap-2 flex-wrap">
          ...
          <SelectFloatingInput
            ...
            handleChange={(value) =>
              setDados({ ...dados, materialEstruturaRemontagem: value })
            }
          />
        </div>
