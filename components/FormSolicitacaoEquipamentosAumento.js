...
function FormSolicitacaoEquipamentosAumento({
  avancar,
  setDados,
  dados,
  voltar,
          ...
          <div className="flex flex-col border-t border-gray-200 p-2">
            ...
            <div className="flex flex-col mb-1 px-2">
              <p className="text-center italic text-xs">
                Você agora pode adicionar micro/inversores de potência e/ou
                marca diferentes.
              </p>
          ...
          <>
            ...
            <div className="flex flex-col border-t border-gray-200 p-2">
              ...
              <div className="flex flex-col mb-1 px-2">
                ...
                <p className="text-center italic text-xs text-[#fead61] font-bold">
                  Preencha as informações do micro/inversor e clique em
                  adicionar.
                </p>
              </div>
