...
function FormSolicitacaoEquipamentosAumento({ avancar, setDados, dados, voltar }) {
	...
	return (
		<div className="flex w-full flex-col border border-[#15599a] bg-[#fff] pb-2 shadow-lg">
			...
			{dados.clienteAmpere != "SIM" ? (
				<>
					<span className="py-2 text-center text-sm font-bold uppercase text-[#fead61]">DADOS DO SISTEMA (AUMENTO)</span>
					...
					<>
						<span className="py-2 text-center text-sm font-bold uppercase text-[#fead61]">DADOS DO SISTEMA ATUAL</span>
						<div className="my-2 flex justify-center p-2">
							<SelectFoatingInput
								label={"TOPOLOGIA (ANTERIOR)"}
								editable={true}
								value={dados.topologiaAnterior ? dados.topologiaAnterior : "NÃO DEFINIDO"}
						...
						<div className="flex flex-col border-t border-gray-300 p-2">
							...
							<div className="mt-3 flex flex-col gap-x-2 gap-y-1 lg:grid lg:grid-cols-4">
								...
								<div className="flex items-center justify-center">
									<div onClick={addInversorAnterior} className="flex h-fit cursor-pointer items-center justify-center rounded bg-green-300 p-2 text-white hover:bg-green-500">
										<MdOutlineAddCircle style={{ fontSize: "15px" }} />
									</div>
								</div>
							</div>
						...
						{dados.topologiaAnterior == "OTIMIZADOR" && (
							<div className="mt-2 flex flex-wrap justify-around gap-2 p-2">
								<TextFloatingInput
									...
									editable={true}
									value={dados.marcaOtimizadorAumento ? dados.marcaOtimizadorAumento : ""}
									handleChange={(value) =>
										setDados({
											...dados,
								...
								<NumberFloatingInput
									...
									handleChange={(value) => setDados({ ...dados, potOtimizadorAnterior: Number(value) })}
								/>
							</div>
						)}
						<div className="flex flex-col border-t border-gray-300 p-2">
							...
							<div className="mt-3 flex flex-col gap-x-2 gap-y-1 lg:grid lg:grid-cols-4">
								...
								<div className="flex items-center justify-center">
									<div onClick={addModulosAumento} className="flex h-fit cursor-pointer items-center justify-center rounded bg-green-300 p-2 text-white hover:bg-green-500">
										<MdOutlineAddCircle style={{ fontSize: "15px" }} />
									</div>
								</div>
							</div>
				...
				<>
					<span className="py-2 text-center text-sm font-bold uppercase text-[#fead61]">DADOS DO SISTEMA PARA AUMENTO</span>
					<div className="my-2 flex justify-center p-2">
						<SelectFoatingInput
							label={"TOPOLOGIA"}
							editable={true}
...
export default FormSolicitacaoEquipamentosAumento;
