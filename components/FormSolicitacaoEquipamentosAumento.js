  ...
  return (
    <div className="bg-background flex w-full flex-col border border-[#15599a] pb-2 shadow-lg">
      ...
      {dados.clienteAmpere != 'SIM' ? (
        <>
          <span className="py-2 text-center text-sm font-bold text-[#fead61] uppercase">DADOS DO SISTEMA (AUMENTO)</span>
          ...
          <>
            <span className="py-2 text-center text-sm font-bold text-[#fead61] uppercase">DADOS DO SISTEMA ATUAL</span>
            <div className="my-2 flex justify-center p-2">
              <SelectFoatingInput
            ...
            <div className="border-primary/20 flex flex-col border-t p-2">
              ...
              <div className="mb-1 flex flex-col px-2">
                <p className="text-center text-xs italic">Você agora pode adicionar micro/inversores de potência e/ou marca diferentes.</p>
                <p className="text-center text-xs font-bold text-[#fead61] italic">
        ...
        <>
          <span className="py-2 text-center text-sm font-bold text-[#fead61] uppercase">DADOS DO SISTEMA PARA AUMENTO</span>
          <div className="my-2 flex justify-center p-2">
            <SelectFoatingInput
              label={'TOPOLOGIA'}
              editable={true}
