...
function FormSolicitacaoEquipamentosMontagemDesmontagem({ avancar, setDados, dados, voltar }) {
	...
	return (
		<div className="flex w-full flex-col border border-[#15599a] bg-[#fff] pb-2 shadow-lg">
			<span className="py-2 text-center text-sm font-bold uppercase text-[#15599a]">DADOS DO SISTEMA (SOMENTE QUANTIDADES QUE SERÃO DESMONTADAS/MONTADAS)</span>
...
export default FormSolicitacaoEquipamentosMontagemDesmontagem;
