...
function FormSolicitacaoEquipamentosOFFGRID({
  dados,
  setDados,
  avancar,
  voltar,
  ...
  function addInversor() {
    if (
      !dadosInversores.marca ||
      !dadosInversores.qtde ||
      !dadosInversores.pot
    ) {
  ...
  function validarCamposObrigatorios() {
    if (
      dados.marcaInversor.trim().length == 0 ||
    ...
    if (
      dados.marcaModulos.trim().length == 0 ||
      dados.qtdeModulos.trim().length == 0 ||
      dados.potModulos.trim().length == 0
    ) {
  ...
  return (
    <div className="w-full flex flex-col border border-[#15599a] pb-2 shadow-lg bg-[#fff]">
      ...
      <div className="flex flex-col border-t border-gray-200 p-2">
        ...
        {inversoresMsg && (
          <p className="text-center italic text-sm text-red-500">
            {inversoresMsg}
          </p>
        )}
      </div>
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-4 items-center mt-2">
          <div className="flex justify-center items-center w-full">
            <TextFloatingInput
              ...
              handleChange={(value) =>
                setDados({ ...dados, marcaBateria: value.toUpperCase() })
              }
            />
          </div>
          <div className="flex justify-center items-center w-full">
