...
function FormSolicitacaoEquipamentosOFFGRID({ dados, setDados, avancar, voltar }) {
  ...
  return (
    <div className="bg-background flex w-full flex-col border border-[#15599a] pb-2 shadow-lg">
      <span className="py-2 text-center text-sm font-bold text-[#15599a] uppercase">DADOS DO SISTEMA OFF GRID</span>
      <div className="border-primary/20 flex flex-col border-t p-2">
        <h1 className="mt-2 text-center text-sm font-bold text-[#15599a]">ADICIONE INVERSORES</h1>
        <div className="mb-1 flex flex-col px-2">
          <p className="text-center text-xs italic">Você agora pode adicionar inversores de potência e/ou marca diferentes.</p>
          <p className="text-center text-xs font-bold text-[#fead61] italic">Preencha as informações dos inversores e clique em adicionar.</p>
        </div>
      ...
      <div className="border-primary/20 flex flex-col border-t p-2">
        <h1 className="mt-2 text-center text-sm font-bold text-[#15599a]">CONTROLADORES</h1>
