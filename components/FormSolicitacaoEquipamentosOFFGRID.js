...
function FormSolicitacaoEquipamentosOFFGRID({ dados, setDados, avancar, voltar }) {
	...
	return (
		<div className="w-full flex flex-col border border-[#15599a] pb-2 shadow-lg bg-[#fff]">
			...
			<div className="flex flex-col border-t border-gray-300 p-2">
				<h1 className="text-center text-[#15599a] text-sm font-bold mt-2">ADICIONE INVERSORES</h1>
				<div className="flex flex-col mb-1 px-2">
					<p className="text-center italic text-xs">Você agora pode adicionar inversores de potência e/ou marca diferentes.</p>
					<p className="text-center italic text-xs text-[#fead61] font-bold">Preencha as informações dos inversores e clique em adicionar.</p>
				</div>
				<div className="flex flex-col lg:grid lg:grid-cols-4 gap-x-2 gap-y-1 mt-3">
					...
					<div className="flex items-center justify-center">
						<NumberFloatingInput label={"QTDE INVERSOR"} editable={true} value={dadosInversores.qtde} handleChange={(value) => setDadosInvesores({ ...dadosInversores, qtde: value })} />
					</div>
					<div className="flex items-center justify-center">
						<NumberFloatingInput
			...
			{arrInv.length > 0 && (
				<div className="flex flex-col mt-2 font-bold">
					<h1 className="text-center text-[#15599a] text-xs">INVERSORES ADICIONADOS</h1>
			...
			<div className="flex flex-col border-t border-gray-300 p-2">
				<h1 className="text-center text-[#15599a] text-sm font-bold mt-2">CONTROLADORES</h1>
...
export default FormSolicitacaoEquipamentosOFFGRID;
