...
function FormSolicitacaoPagamentoManutencao({ dados, setDados, avancar, voltar }) {
  ...
  return (
    <div className="bg-background flex w-full flex-col border border-[#15599a] pb-2 shadow-lg">
      <span className="py-2 text-center text-sm font-bold text-[#15599a] uppercase">DADOS DE PAGAMENTO</span>
...
export default FormSolicitacaoPagamentoManutencao
