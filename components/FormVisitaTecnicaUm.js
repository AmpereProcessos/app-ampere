  ...
  return (
    <div className="bg-background flex w-full flex-col border border-[#15599a] p-4 shadow-lg">
      ...
      <div className="mt-2 flex flex-col">
        ...
        <div className="border-border flex flex-col border-t p-2">
          <h1 className="mt-2 text-center text-sm font-bold text-[#15599a]">
            ADICIONE MICRO/INVERSORES
          </h1>
          <div className="mb-1 flex flex-col px-2">
            <p className="text-center text-xs italic">
              Você agora pode adicionar micro/inversores de potência e/ou marca diferentes.
            </p>
        ...
        {arrModulos.length > 0 && (
          <div className="mt-2 flex flex-col font-bold">
            ...
            {arrModulos.map((inv, index) => (
              <div
                key={index}
                className="mt-3 flex flex-col gap-x-2 gap-y-1 lg:grid lg:grid-cols-4"
              >
      ...
      {[
        ...
        <div className="mt-3 flex items-center justify-center">
          <button
            onClick={goToNext}
            className="w-fit rounded bg-[#fead61] p-2 text-center font-bold hover:bg-[#15599a] hover:text-white"
          >
            PRÓXIMA ETAPA
          </button>
        </div>
