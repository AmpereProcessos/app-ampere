...
function DocumentationInformation({ infoHolder, setInfoHolder, changes, setChanges }: DocumentationInformationProps) {
  return (
    <div className="flex w-full flex-col gap-2">
      <h1 className="bg-primary/80 w-full rounded p-1 text-center font-bold text-white">INFORMAÇÕES SOBRE A DOCUMENTAÇÃO</h1>
        ...
        <div className="w-full lg:w-1/2">
          <DateInput
            ...
            handleChange={(value) => {
              setInfoHolder((prev) => ({
                ...prev,
                homologacao: { ...prev.homologacao, documentacao: { ...prev.homologacao.documentacao, dataLiberacao: formatDateInputChange(value) } },
              }))
              setChanges((prev) => ({ ...prev, 'homologacao.documentacao.dataLiberacao': formatDateInputChange(value) }))
            }}
            width="100%"
          />
        </div>
          ...
          <DateInput
            ...
            handleChange={(value) => {
              setInfoHolder((prev) => ({
                ...
                homologacao: {
                  ...prev.homologacao,
                  documentacao: { ...prev.homologacao.documentacao, dataAssinatura: formatDateInputChange(value) },
                },
              }))
              setChanges((prev) => ({ ...prev, 'homologacao.documentacao.dataAssinatura': formatDateInputChange(value) }))
            }}
            width="100%"
          />
        </div>
          ...
          <DateInput
            ...
            handleChange={(value) => {
              setInfoHolder((prev) => ({
                ...
                homologacao: {
                  ...prev.homologacao,
                  documentacao: { ...prev.homologacao.documentacao, dataInicioElaboracao: formatDateInputChange(value) },
                },
              }))
              setChanges((prev) => ({ ...prev, 'homologacao.documentacao.dataInicioElaboracao': formatDateInputChange(value) }))
            }}
            width="100%"
          />
        </div>
          ...
          <DateInput
            ...
            handleChange={(value) => {
              setInfoHolder((prev) => ({
                ...
                homologacao: {
                  ...prev.homologacao,
                  documentacao: { ...prev.homologacao.documentacao, dataConclusaoElaboracao: formatDateInputChange(value) },
                },
              }))
              setChanges((prev) => ({ ...prev, 'homologacao.documentacao.dataConclusaoElaboracao': formatDateInputChange(value) }))
            }}
            width="100%"
          />
        </div>
