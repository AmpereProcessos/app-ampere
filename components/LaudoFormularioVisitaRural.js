			...
			<div className="flex h-full w-full flex-col">
				...
				<div className="mt-4 flex flex-col">
					...
					<div className="flex w-full border border-t-0 border-black">
						...
						<div className="grid w-[80%] grid-cols-9">
							<div className="col-span-3 border-r border-black p-1 text-end text-xs" />
				...
				<div className="mt-6 flex flex-col">
					...
					<div className="h-[200px] border border-t-0 border-black" />
				</div>
				<div className="mt-6 flex flex-col">
					...
					<div className="grid grid-cols-3 grid-rows-2 border border-b-0 border-black">
						<div className="flex border-b border-black">
							...
							<div className="flex w-[60%] items-center justify-center border-r border-black bg-gray-200 text-center text-xs">FOTO DO PADRÃO DE ENTRADA</div>
							<div className="w-[20%] border-r border-black text-center text-xs" />
						</div>
						<div className="flex border-b border-black">
						...
						<div className="flex border-b border-black">
							...
							<div className="flex w-[60%] items-center justify-center border-r border-black bg-gray-200 text-center text-xs">FOTO DO RAMAL DE ENTRADA</div>
						...
						<div className="flex border-b border-black">
							...
							<div className="flex w-[60%] items-center justify-center border-r border-black bg-gray-200 text-center text-xs">LOCALIZAÇÃO DO PADRÃO</div>
							<div className="w-[20%] border-r border-black text-center text-xs" />
						</div>
						<div className="flex border-b border-black">
							<div className="flex w-[20%] items-center justify-center border-r border-black bg-gray-200 text-center text-xs">5</div>
							<div className="flex w-[60%] items-center justify-center border-r border-black bg-gray-200 text-center text-xs">FOTO GERAL DO PADRÃO ATÉ A RESIDÊNCIA</div>
							<div className="w-[20%] border-r border-black text-center text-xs" />
						</div>
						<div className="flex border-b border-black">
					...
					<div className="grid grid-cols-3">
						...
						<div className="flex border-b border-black">
							<div className="flex w-[20%] items-center justify-center border-r border-black bg-gray-200 text-center text-xs">2</div>
							<div className="flex w-[60%] items-center justify-center border-r border-black bg-gray-200 text-center text-xs">Nº DO TRANSFORMADOR</div>
							<div className="w-[20%] border-r border-black text-center text-xs" />
						</div>
						<div className="flex border-b border-black">
							<div className="flex w-[20%] items-center justify-center border-r border-black bg-gray-200 text-center text-xs">3</div>
							<div className="flex w-[60%] items-center justify-center border-r border-black bg-gray-200 text-center text-xs">FOTO DO TRANSFORMADOR</div>
							<div className="w-[20%] border-r border-black text-center text-xs" />
						</div>
					</div>
					...
					<div className="grid grid-cols-3 grid-rows-3 border border-black">
						...
						<div className="flex border-b border-black">
							<div className="flex w-[20%] items-center justify-center border-r border-black bg-gray-200 text-center text-xs">2</div>
							<div className="flex w-[60%] items-center justify-center border-r border-black bg-gray-200 text-center text-xs">FOTO DO LOCAL DE MONTAGEM(SOLO)</div>
							<div className="w-[20%] border-r border-black text-center text-xs" />
						</div>
						<div className="flex border-b border-black">
							<div className="flex w-[20%] items-center justify-center border-r border-black bg-gray-200 text-center text-xs">3</div>
						...
						<div className="flex border-b border-black">
							<div className="flex w-[20%] items-center justify-center border-r border-black bg-gray-200 text-center text-xs">6</div>
							<div className="flex w-[60%] items-center justify-center border-r border-black bg-gray-200 text-center text-xs">LOCALIZAÇÃO DAS PLACAS(SOLO)</div>
							<div className="w-[20%] text-center text-xs" />
						</div>
						<div className="flex border-b border-black">
							<div className="flex w-[20%] items-center justify-center border-r border-black bg-gray-200 text-center text-xs">7</div>
							<div className="flex w-[60%] items-center justify-center border-r border-black bg-gray-200 text-center text-xs">FOTO LOCAL DO INVERSOR</div>
							<div className="w-[20%] border-r border-black text-center text-xs" />
						</div>
						<div className="flex border-b border-black">
						...
						<div className="flex border-b border-r-0 border-black">
							...
							<div className="flex w-[60%] items-center justify-center border-r border-black bg-gray-200 text-center text-xs">FOTOS DA ESTRUTURA TELHADO</div>
							<div className="w-[20%] text-center text-xs" />
						</div>
					</div>
					...
					<div className="grid grid-cols-3 grid-rows-2">
						<div className="flex border-b border-black">
							<div className="flex w-[80%] items-center justify-center border-r border-black bg-gray-200 text-center text-xs">Nº POSTE DE DERIVAÇÃO</div>
							<div className="w-[20%] border-r border-black text-center text-xs" />
						</div>
						<div className="flex border-b border-black">
							<div className="flex w-[80%] items-center justify-center border-r border-black bg-gray-200 text-center text-xs">LOCAL DE ATERRAMENTO</div>
							<div className="w-[20%] border-r border-black text-center text-xs" />
						</div>
						<div className="flex border-b border-black">
							<div className="flex w-[80%] items-center justify-center border-r border-black bg-gray-200 text-center text-xs">POTÊNCIA DO TRANSFORMADOR</div>
							<div className="w-[20%] border-r border-black text-center text-xs" />
						</div>
						<div className="flex border-b border-black">
							<div className="flex w-[80%] items-center justify-center border-r border-black bg-gray-200 text-center text-xs">LOCALIZAÇÃO POSTE DERIVAÇÃO</div>
							<div className="w-[20%] border-r border-black text-center text-xs" />
						</div>
						<div className="flex border-b border-black">
						...
						<div className="flex border-b border-black">
							<div className="flex w-[80%] items-center justify-center border-r border-black bg-gray-200 text-center text-xs">NºPOSTE DO TRANSFORMADOR</div>
							<div className="w-[20%] border-r border-black text-center text-xs" />
						</div>
					</div>
				</div>
				<div className="mt-6 flex flex-col">
					...
					<div className="mb-2 h-[500px] border border-t-0 border-black" />
				</div>
			</div>
		</div>
	);
