		...
		<div className="w-[21cm] h-[29.7cm]">
			<div className="flex flex-col w-full h-full">
				...
				<div className="flex flex-col">
					...
					<div className="flex">
						<div className="w-[20%] h-full flex justify-center items-center bg-[#15599a] text-center text-white font-bold">DESCRIÇÃO DO SISTEMA FOTOVOLTAICO</div>
						<div className="w-[80%] flex flex-col">
							...
							<h1 className="bg-[#fead61] text-white text-sm  text-center font-raleway font-bold  border border-black border-b-0">MÓDULOS FOTOVOLTÁICOS</h1>
							<div className="flex  border border-black border-b-0">
								<div className="flex flex-col w-[50%]">
									<div className="grid grid-cols-2">
										<p className="bg-gray-200 text-center text-xs font-bold p-1">QUANTIDADE</p>
				...
				<div className="flex flex-col mt-6">
					...
					<div className="flex w-full border border-black border-t-0">
						...
						<div className="grid grid-cols-9 w-[80%]">
							<div className="text-end text-xs col-span-3 border-r border-black p-1" />
					...
					<div className="flex flex-col w-full">
						<div className="grid grid-cols-10 border border-black">
							<div className="bg-gray-200 text-center col-span-1 text-xs font-bold flex items-center justify-center border-r border-black">NºCAIXA</div>
							<div className="bg-gray-200 text-center col-span-2 text-xs font-bold flex items-center justify-center border-r border-black">AMPERAGEM</div>
							<div className="bg-gray-200 text-center col-span-2 text-xs font-bold flex items-center justify-center border-r border-black">MONO/BI/TRI</div>
							<div className="bg-gray-200 text-center col-span-2 text-xs font-bold flex items-center justify-center border-r border-black">NºMEDIDOR</div>
							<div className="bg-gray-200 text-center col-span-2 text-xs font-bold flex items-center justify-center border-r border-black">MODELO CAIXA</div>
						...
						<div className="grid grid-cols-10 border border-black border-t-0">
							...
							<div className="text-center col-span-2 text-xs font-bold flex items-center justify-center border-r border-black" />
							<div className="text-center col-span-2 text-xs font-bold flex items-center justify-center border-r border-black" />
							<div className="text-center col-span-2 text-xs font-bold flex items-center justify-center border-r border-black" />
						...
						<div className="grid grid-cols-10 border border-black border-t-0">
							...
							<div className="bg-gray-200 text-center col-span-2 text-xs font-bold flex items-center justify-center border-r border-black" />
							<div className="bg-gray-200 text-center col-span-2 text-xs font-bold flex items-center justify-center border-r border-black" />
							<div className="bg-gray-200 text-end col-span-1 text-xs font-bold flex items-center justify-center" />
						</div>
					</div>
				</div>
				<div className="flex flex-col mt-6">
					...
					<div className="flex border border-black border-t-0">
						<div className="w-[30%] flex items-center justify-center text-center text-xs border-r border-black bg-gray-200 font-bold">TIPO DA TELHA</div>
					...
					<div className="flex border border-black border-t-0">
						<h1 className="w-[30%] flex items-center justify-center text-center text-xs border-r border-black bg-gray-200 font-bold">TIPO DE EDIFICAÇÃO</h1>
					...
					<div className="grid grid-cols-2">
						<div className="flex border border-black border-t-0 border-r-0">
							<div className="w-[60%] text-center flex items-center justify-center bg-gray-200 text-xs border-r border-black font-bold">ADAPTAÇÃO NO QGBT</div>
					...
					<div className="border border-black border-t-0 h-[200px]" />
				</div>
				<div className="flex flex-col mt-6">
					...
					<div className="grid grid-cols-3 grid-rows-3 border border-black">
						<div className="flex border-b border-black">
							...
							<div className="text-center text-xs w-[20%] border-r border-black" />
						</div>
						<div className="flex border-b border-black">
						...
						<div className="flex border-b border-black">
							...
							<div className="text-center bg-gray-200 flex items-center justify-center text-xs w-[60%] border-r border-black">FOTO DO QUADRO(QDG)</div>
							<div className="text-center text-xs w-[20%] border-r border-black" />
						</div>
						<div className="flex border-b border-black">
							<div className="text-center bg-gray-200 flex items-center justify-center text-xs w-[20%] border-r border-black">5</div>
							<div className="text-center bg-gray-200 flex items-center justify-center text-xs w-[60%] border-r border-black">FOTO DO LOCAL DO EQUIPAMENTO</div>
							<div className="text-center text-xs w-[20%] border-r border-black" />
						</div>
						<div className="flex border-b border-black">
						...
						<div className="flex border-b border-black">
							...
							<div className="text-center bg-gray-200 flex items-center justify-center text-xs w-[60%] border-r border-black">FOTO DA ESTRUTURA DO TELHADO</div>
							<div className="text-center text-xs w-[20%] border-r border-black" />
						</div>
						<div className="flex border-b border-black">
							<div className="text-center bg-gray-200 flex items-center justify-center text-xs w-[20%] border-r border-black">8</div>
							<div className="text-center bg-gray-200 flex items-center justify-center text-xs w-[60%] border-r border-black">LOCALIZAÇÃO DA RESIDÊNCIA</div>
							<div className="text-center text-xs w-[20%] border-r border-black" />
						</div>
						<div className="flex border-b border-black border-r-0">
							...
							<div className="text-center bg-gray-200 flex items-center justify-center text-xs w-[60%] border-r border-black">LOCALIZAÇÃO DO TRANSFORMADOR</div>
							<div className="text-center text-xs w-[20%]" />
						</div>
					</div>
					...
					<div className="grid grid-cols-3">
						<div className="flex border-b border-black">
							<div className="text-center text-xs bg-gray-200 flex items-center justify-center w-[80%] border-r border-black">FOTO DO POSTE DE DERIVAÇÃO</div>
							<div className="text-center text-xs w-[20%] border-r border-black" />
						</div>
						<div className="flex border-b border-black">
							<div className="text-center bg-gray-200 flex items-center justify-center text-xs w-[80%] border-r border-black">NÚMERO E LOCALIZAÇÃO DO POSTE</div>
							<div className="text-center text-xs w-[20%] border-r border-black" />
						</div>
						<div className="flex border-b border-black">
							<div className="text-center bg-gray-200 flex items-center justify-center text-xs w-[80%] border-r border-black">FOTO DO LOCAL DE ATERRAMENTO</div>
							<div className="text-center text-xs w-[20%] border-r border-black" />
						</div>
					</div>
				</div>
				<div className="flex flex-col mt-6">
					...
					<div className="h-[100px] border border-t-0 border-black mb-2" />
				</div>
			</div>
		</div>
	);
