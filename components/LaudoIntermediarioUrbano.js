...
function LaudoIntermediarioUrbano({ analysis }) {
	...
	function getCorrectedGen() {
		...
		const norte = analysis.alocacaoModulos.norte
			? ((Number(cityFactor.NORTE) * analysis.alocacaoModulos.norte * getAverageModulePower(analysis.equipamentos.modulos.potencia)) / 1000).toFixed(2)
			: 0;
		const nordeste = analysis.alocacaoModulos.nordeste
			? ((Number(cityFactor.NORDESTE) * analysis.alocacaoModulos.nordeste * getAverageModulePower(analysis.equipamentos.modulos.potencia)) / 1000).toFixed(2)
			: 0;
		const leste = analysis.alocacaoModulos.leste
			? ((Number(cityFactor.LESTE) * analysis.alocacaoModulos.leste * getAverageModulePower(analysis.equipamentos.modulos.potencia)) / 1000).toFixed(2)
			: 0;
		const sudeste = analysis.alocacaoModulos.sudeste
			? ((Number(cityFactor.SUDESTE) * analysis.alocacaoModulos.sudeste * getAverageModulePower(analysis.equipamentos.modulos.potencia)) / 1000).toFixed(2)
			: 0;
		...
		const sudoeste = analysis.alocacaoModulos.sudoeste
			? ((Number(cityFactor.SUDOESTE) * analysis.alocacaoModulos.sudoeste * getAverageModulePower(analysis.equipamentos.modulos.potencia)) / 1000).toFixed(2)
			: 0;
		const oeste = analysis.alocacaoModulos.oeste
			? ((Number(cityFactor.OESTE) * analysis.alocacaoModulos.oeste * getAverageModulePower(analysis.equipamentos.modulos.potencia)) / 1000).toFixed(2)
			: 0;
		const noroeste = analysis.alocacaoModulos.noroeste
			? ((Number(cityFactor.NOROESTE) * analysis.alocacaoModulos.noroeste * getAverageModulePower(analysis.equipamentos.modulos.potencia)) / 1000).toFixed(2)
			: 0;
		console.log(norte, nordeste, leste, sudeste, sul, sudoeste, oeste, noroeste);
		return (Number(norte) + Number(nordeste) + Number(leste) + Number(sudeste) + Number(sul) + Number(sudoeste) + Number(oeste) + Number(noroeste)).toFixed(2);
	}
	...
	function getProposedGen() {
		...
		return ((getTotalModuleQtde(analysis.equipamentos.modulos.qtde) * getAverageModulePower(analysis.equipamentos.modulos.potencia) * factor) / 1000).toFixed(2);
	}
		...
		<div className="h-[29.7cm] w-[21cm]">
			<div className="flex h-full w-full flex-col">
				...
				<div className="mt-6 flex flex-col">
					...
					<div className="grid grid-cols-2">
						<div className="grid-rows-5">
							...
							<div className="grid grid-cols-3 border-b border-black">
								...
								<p className="border-r border-black text-center text-xs font-bold">{analysis.alocacaoModulos.nordeste ? analysis.alocacaoModulos.nordeste : "-"}</p>
								<p className="border-r border-black text-center text-xs font-bold">
							...
							<div className="grid grid-cols-3 border-b border-black">
								...
								<p className="border-r border-black text-center text-xs font-bold">{analysis.alocacaoModulos.sudeste ? analysis.alocacaoModulos.sudeste : "-"}</p>
								<p className="border-r border-black text-center text-xs font-bold">
						...
						<div className="grid-rows-5">
							...
							<div className="grid grid-cols-3 border-b border-black">
								...
								<p className="border-r border-black text-center text-xs font-bold">{analysis.alocacaoModulos.sudoeste ? analysis.alocacaoModulos.sudoeste : "-"}</p>
								<p className="border-r border-black text-center text-xs font-bold">
							...
							<div className="grid grid-cols-3 border-b border-black">
								...
								<p className="border-r border-black text-center text-xs font-bold">{analysis.alocacaoModulos.noroeste ? analysis.alocacaoModulos.noroeste : "-"}</p>
								<p className="border-r border-black text-center text-xs font-bold">
					...
					<div className="grid grid-cols-6 border-b border-black">
						<div className="col-span-4 border-r border-black bg-[#15599a] py-1 text-center text-xs font-bold italic text-white">PERCENTUAL DE GERAÇÃO DEVIDO AO DESVIO AZIMUTAL</div>
