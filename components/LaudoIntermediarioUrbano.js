...
function LaudoIntermediarioUrbano({ analysis }) {
  ...
  function getCorrectedGen() {
    ...
    let cityFactor = fatorDeGeracaoPorOrientacao.find((genFactor) => genFactor.CIDADE === cidade && genFactor.UF === uf)
    if (!cityFactor) {
      cityFactor = fatorDeGeracaoPorOrientacao.find((genFactor) => genFactor.CIDADE === 'ITUIUTABA')
    }
    const norte = analysis.alocacaoModulos.norte
      ? ((Number(cityFactor.NORTE) * analysis.alocacaoModulos.norte * getAverageModulePower(analysis.equipamentos.modulos.potencia)) / 1000).toFixed(
          2
        )
      : 0
    const nordeste = analysis.alocacaoModulos.nordeste
      ? (
      ...
      : 0
    const leste = analysis.alocacaoModulos.leste
      ? ((Number(cityFactor.LESTE) * analysis.alocacaoModulos.leste * getAverageModulePower(analysis.equipamentos.modulos.potencia)) / 1000).toFixed(
          2
        )
      : 0
    const sudeste = analysis.alocacaoModulos.sudeste
      ? (
          (Number(cityFactor.SUDESTE) * analysis.alocacaoModulos.sudeste * getAverageModulePower(analysis.equipamentos.modulos.potencia)) /
          1000
        ).toFixed(2)
      : 0
    const sul = analysis.alocacaoModulos.sul
      ...
      : 0
    const sudoeste = analysis.alocacaoModulos.sudoeste
      ? (
      ...
      : 0
    const oeste = analysis.alocacaoModulos.oeste
      ? ((Number(cityFactor.OESTE) * analysis.alocacaoModulos.oeste * getAverageModulePower(analysis.equipamentos.modulos.potencia)) / 1000).toFixed(
          2
        )
      : 0
    const noroeste = analysis.alocacaoModulos.noroeste
      ? (
  ...
  function getAverageModulePower(modPower) {
    ...
    if (splittedPower.length > 1) {
      ...
      for (let i = 0; i < splittedPower.length; i++) {
        ...
        if (!Number.isNaN(powerAsNumber)) total = total + powerAsNumber
      }
    ...
    <div className="h-[29.7cm] w-[21cm]">
      <div className="flex h-full w-full flex-col">
        <div className="mt-2 flex w-full items-center justify-around border border-t-0 border-black py-2">
          <h1 className="font-bold text-[#15599a] uppercase">LAUDO TÉCNICO - URBANO</h1>
            ...
            <div className="flex w-[80%] flex-col">
              ...
              <div className="flex border border-b-0 border-black">
                <div className="flex w-[50%] flex-col">
                  <div className="grid grid-cols-2">
                    <p className="text-xxs bg-gray-200 text-center font-bold">TOPOLOGIA</p>
                    <p className="text-xxs text-center font-bold">{analysis.detalhes.topologia}</p>
                  </div>
                  <div className="grid grid-cols-2">
                    <p className="text-xxs bg-gray-200 text-center font-bold">QUANTIDADE</p>
                    <p className="text-xxs text-center font-bold">{analysis.equipamentos.inversor.qtde}</p>
                  </div>
                </div>
                <div className="flex w-[50%] flex-col">
                  <div className="grid grid-cols-2">
                    <p className="text-xxs bg-gray-200 text-center font-bold">MARCA DO INVERSOR</p>
                    <p className="text-xxs text-center font-bold">{analysis.equipamentos.inversor.modelo}</p>
                  </div>
                  <div className="grid grid-cols-2">
                    <p className="text-xxs bg-gray-200 text-center font-bold">POTÊNCIA</p>
                    <p className="text-xxs text-center font-bold">{analysis.equipamentos.inversor.potencia}</p>
                  </div>
                </div>
              </div>
              <h1 className="font-raleway border border-b-0 border-black bg-[#fead61] text-center text-sm font-bold text-white">
              ...
              <div className="flex border border-b-0 border-black">
                <div className="flex w-[50%] flex-col">
                  <div className="grid grid-cols-2">
                    <p className="text-xxs bg-gray-200 text-center font-bold">QUANTIDADE</p>
                    <p className="text-xxs text-center font-bold">{analysis.equipamentos.modulos.qtde}</p>
                  </div>
                </div>
                <div className="flex w-[50%] flex-col">
                  <div className="grid grid-cols-2">
                    <p className="text-xxs bg-gray-200 text-center font-bold">POTÊNCIA</p>
                    <p className="text-xxs text-center font-bold">{analysis.equipamentos.modulos.potencia}</p>
                  </div>
                </div>
              </div>
              <div className="flex border border-black">
                <p className="text-xxs w-[50%] bg-gray-200 text-center font-bold">MARCA DOS MÓDULOS</p>
                <p className="text-xxs w-[50%] text-center font-bold">{analysis.equipamentos.modulos.modelo}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex h-[600px] items-center border border-black">
            {analysis.desenho.url ? (
              ...
              <div className="flex h-full w-[793.7px] items-center justify-center">
                <p className="text-primary/60 font-bold italic">Oops, parece que não há nenhum desenho vinculado para essa análise...</p>
              </div>
            )}
          </div>
        </div>
        <div className="mt-2 flex flex-col">
          ...
          <div className="flex flex-col">
            ...
            {analysis.custos?.length > 0 ? (
              ...
              <div className="flex h-[50px] items-center justify-center border-r border-b border-black italic">SEM CUSTOS ADICIONAIS</div>
            )}
          </div>
        ...
        <div className="mt-6 flex flex-col">
          ...
          <div className="grid grid-cols-2">
            <div className="grid-rows-5">
              ...
              <div className="grid grid-cols-3 border-b border-black">
                <p className="border-r border-black bg-[#fead61] text-center text-xs font-bold text-white italic">NORTE</p>
              ...
              <div className="grid grid-cols-3 border-b border-black">
                <p className="border-r border-black bg-[#fead61] text-center text-xs font-bold text-white italic">NORDESTE</p>
                <p className="border-r border-black text-center text-xs font-bold">
              ...
              <div className="grid grid-cols-3 border-b border-black">
                <p className="border-r border-black bg-[#fead61] text-center text-xs font-bold text-white italic">LESTE</p>
                <p className="border-r border-black text-center text-xs font-bold">
              ...
              <div className="grid grid-cols-3 border-b border-black">
                <p className="border-r border-black bg-[#fead61] text-center text-xs font-bold text-white italic">SUDESTE</p>
                <p className="border-r border-black text-center text-xs font-bold">
            ...
            <div className="grid-rows-5">
              ...
              <div className="grid grid-cols-3 border-b border-black">
                <p className="border-r border-black bg-[#fead61] text-center text-xs font-bold text-white italic">SUL</p>
                <p className="border-r border-black text-center text-xs font-bold">
              ...
              <div className="grid grid-cols-3 border-b border-black">
                <p className="border-r border-black bg-[#fead61] text-center text-xs font-bold text-white italic">SUDOESTE</p>
                <p className="border-r border-black text-center text-xs font-bold">
              ...
              <div className="grid grid-cols-3 border-b border-black">
                <p className="border-r border-black bg-[#fead61] text-center text-xs font-bold text-white italic">OESTE</p>
                <p className="border-r border-black text-center text-xs font-bold">
              ...
              <div className="grid grid-cols-3 border-b border-black">
                <p className="border-r border-black bg-[#fead61] text-center text-xs font-bold text-white italic">NOROESTE</p>
                <p className="border-r border-black text-center text-xs font-bold">
          ...
          <div className="grid grid-cols-6 border-b border-black">
            <div className="col-span-4 border-r border-black bg-[#15599a] py-1 text-center text-xs font-bold text-white italic">
          ...
          <div className="grid grid-cols-6 border-b border-black">
            <div className="col-span-4 border-r border-black bg-[#fead61] py-1 text-center text-xs font-bold text-white italic">
          ...
          <div className="h-[300px] w-[600px]">
            <ResponsiveContainer width="100%">
              ...
              >
                ...
                <Tooltip />
                <Legend />
                <Bar dataKey="PROPOSTO" fill="#15599a" unit={'kWh'} />
                <Bar dataKey="PREVISTO" fill="#fead61" unit={'kWh'} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
                ...
                <div key={`${item.topico}-${index}`} className="mb-1 flex w-full flex-col">
                  <div className="flex w-full items-center justify-between">
                    <div className="flex w-full items-center justify-center gap-2 bg-black text-white">
                      <MdTopic />
                      <h1 className="text-sm leading-none font-bold tracking-tight">{item.topico}</h1>
                    </div>
                  </div>

                  <p className="text-primary/60 mt-1 w-full text-center text-xs">{item.descricao}</p>
                </div>
              ))
            ) : (
        ...
        <div className="mt-2 flex flex-col">
          ...
          <div className="flex h-fit min-h-[60px] items-center justify-center border border-t-0 border-black p-2 text-center text-xs">
            {analysis.conclusao.observacoes ? analysis.conclusao.observacoes : '-'}
          </div>
        </div>
        <div className="mt-2 grid grid-cols-2 gap-x-4">
          <div className="flex flex-col">
            <p className="text-xxs ml-2 text-start">Autorizado por:</p>
          ...
          <div className="flex flex-col">
            <p className="text-xxs ml-2 text-start">Realizado por:</p>
