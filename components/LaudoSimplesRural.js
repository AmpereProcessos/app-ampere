    ...
    <div className="h-[29.7cm] w-[21cm]">
      <div className="flex h-full w-full flex-col">
        ...
        <div className="flex flex-col">
          ...
          <div className="grid grid-cols-2 border-b border-black">
            <p className="text-xxs border-r border-black bg-gray-200 text-center font-bold">REALIMENTAR</p>
            <p className="text-xxs border-r border-black text-center">{analysis.servicosAdicionais.realimentar ? 'SIM' : 'NÃO'}</p>
          </div>
          <div className="flex">
            <div className="grid w-[50%] grid-rows-4">
              <div className="grid grid-cols-2 border-b border-black">
                <p className="text-xxs border-r border-black bg-gray-200 text-center font-bold">CASA DE MÁQUINAS</p>
              ...
              <div className="grid grid-cols-2 border-b border-black">
                <p className="text-xxs border-r border-black bg-gray-200 text-center font-bold">INSTALAÇÃO INTERNET</p>
                <p className="text-xxs border-r border-black text-center">
                  {analysis.servicosAdicionais.roteador ? analysis.servicosAdicionais.roteador : '-'}
                </p>
              </div>
              <div className="grid grid-cols-2 border-b border-black">
                <p className="text-xxs border-r border-black bg-gray-200 text-center font-bold">INSTALAÇÃO DE ALAMBRADO</p>
                <p className="text-xxs border-r border-black text-center">
                  {analysis.servicosAdicionais.alambrado ? analysis.servicosAdicionais.alambrado : '-'}
                </p>
              </div>
              <div className="grid grid-cols-2 border-b border-black">
                <p className="text-xxs border-r border-black bg-gray-200 text-center font-bold">TERRAPLANAGEM USINA DE SOLO</p>
                <p className="text-xxs border-r border-black text-center">
            ...
            <div className="grid w-[50%] grid-rows-4">
              <div className="grid grid-cols-2 border-b border-black">
                <p className="text-xxs border-r border-black bg-gray-200 text-center font-bold">CONSTRUÇÃO DE BARRACÃO</p>
                <p className="text-xxs border-r border-black text-center">
                  {analysis.servicosAdicionais.barracao ? analysis.servicosAdicionais.barracao : '-'}
                </p>
              </div>
              <div className="grid grid-cols-2 border-b border-black">
                <p className="text-xxs border-r border-black bg-gray-200 text-center font-bold">REDE PARA INTERLIGAR FAZENDA</p>
                <p className="text-xxs border-r border-black text-center">
                  {analysis.servicosAdicionais.redeReligacao ? analysis.servicosAdicionais.redeReligacao : '-'}
                </p>
              </div>
              <div className="grid grid-cols-2 border-b border-black">
                <p className="text-xxs border-r border-black bg-gray-200 text-center font-bold">BRITAGEM</p>
                <p className="text-xxs border-r border-black text-center">
                  {analysis.servicosAdicionais.britagem ? analysis.servicosAdicionais.britagem : '-'}
                </p>
              </div>
              <div className="grid grid-cols-2 border-b border-black">
                <p className="text-xxs border-r border-black bg-gray-200 text-center font-bold">LIMPEZA DO LOCAL USINA DE SOLO</p>
                <p className="text-xxs border-r border-black text-center">
