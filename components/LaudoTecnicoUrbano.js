					...
					<div className="flex flex-col">
						...
						<div className="flex flex-col">
							...
							{analysis.padrao.map((paInfo, index) => (
								<div key={`${paInfo.tipo}-${paInfo.tipoEntrada}-${paInfo.tipoSaida}-${paInfo.amperagem}-${index}`} className="flex w-full flex-col">
                  ...
                  <div className="grid grid-cols-2 border-b border-black">
					...
					<div className="flex flex-col">
						...
						<div className="flex flex-col">
							...
							<div className="flex min-h-[50px] h-fit items-center justify-center border border-t-0 border-black p-2 text-center text-xs">
					...
					<div className="flex flex-col">
						...
						{analysis.suprimentos?.itens.length > 0 ? (
							analysis.suprimentos.itens?.map((suprimento, index) => (
								<div key={`${suprimento.descricao}-${index}`} className="grid grid-cols-10">
