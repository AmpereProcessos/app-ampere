...
function MaterialCard({ project }) {
	...
	return (
		<div className="flex w-full flex-col border border-[#15599a] p-2 shadow-lg">
			<div className="flex items-center justify-between">
				...
				<div className="flex items-center gap-2">
					...
					<div className="flex flex-col items-center">
						...
						<h1 className="text-center text-xs text-gray-500">{infoHolder.compra?.dataEntrega ? dayjs(infoHolder.compra.dataEntrega).format("DD/MM/YYYY") : "-"}</h1>
					</div>
					<div className="flex flex-col items-center">
			...
			<div className="flex w-full flex-wrap items-center justify-center gap-x-4  border-t border-gray-300">
