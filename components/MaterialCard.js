...
function MaterialCard({ project }) {
  ...
  return (
    <div className="flex w-full flex-col border border-[#15599a] p-2 shadow-lg">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <div className="flex flex-col items-center">
            <h1 className="text-foreground text-center text-sm font-bold">FORNECEDOR</h1>
            <h1 className="text-foreground text-center text-xs">
              {infoHolder.compra?.fornecedor ? infoHolder.compra.fornecedor : "-"}
            </h1>
          </div>
          <div className="flex flex-col items-center">
            <h1 className="text-foreground text-center text-sm font-bold">DATA DE ENTREGA</h1>
            <h1 className="text-foreground text-center text-xs">
          ...
          <div className="flex flex-col items-center">
            <h1 className="text-foreground text-center text-sm font-bold">TEMPO DESDE ENTREGA</h1>
            <h1 className="text-foreground text-center text-xs">
              {infoHolder.tempoPassado ? `${infoHolder.tempoPassado} DIAS` : "-"}
            </h1>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-2 pb-2">
          ...
          <div className="flex w-fit flex-col items-center">
            <span className="font-raleway text-center text-sm font-bold">
      ...
      <div className="border-border flex w-full flex-wrap items-center justify-center gap-x-4 border-t">
        <div className="mt-2 flex w-[300px] flex-col items-center self-center">
          ...
          <textarea
            ...
            className="border-primary/80 text-foreground mb-2 h-[100px] w-full resize-none border p-2 text-center text-xs outline-hidden"
          />
        </div>
        <div className="mt-2 flex w-[300px] flex-col items-center self-center">
          <span className="font-raleway text-center text-sm font-bold uppercase">
      ...
      {infoHolder.material.entregaFaltando || infoHolder.material.avarias ? (
        <div className="flex flex-col items-center gap-2">
          ...
          {infoHolder.material.chamadoIrregularidade ? (
            ...
            <button
              onClick={openCall}
              className="rounded border border-[#15599a] p-2 font-bold text-[#15599a] hover:bg-[#15599a] hover:text-white"
            >
              ABRIR CHAMADO
            </button>
          )}
