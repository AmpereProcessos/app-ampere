	...
	return (
		<div className="flex flex-col w-full">
			<div className="grid grid-cols-9 items-center gap-3">
				<p className="list-none col-span-4 text-center text-gray-600 font-bold">{obj.nome}</p>
				<input
					type={"number"}
					disabled={true}
					className="outline-none text-center p-1 col-span-2 border border-gray-300"
