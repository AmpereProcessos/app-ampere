          ...
          <div className="flex flex-col h-full">
            ...
            <div className="overflow-y-auto">
              ...
              <div className="grid grid-rows-2 grid-cols-1 lg:grid-cols-2 lg:grid-rows-1 gap-x-2 border border-gray-200 p-2 mt-4">
                ...
                <span className="grow text-center font-raleway">
                  {modalInfo.usuarioEmissor}
                </span>
              </div>
              <div className="grid grid-rows-2 grid-cols-1 lg:grid-cols-2 lg:grid-rows-1 border border-gray-200 p-2 mt-4">
                <span className="text-center font-bold font-raleway">
                  ABERTURA
                </span>
                <span className="grow text-center font-raleway">
                  {dayjs(modalInfo.dataAbertura).format("DD/MM/YYYY")}
                </span>
              </div>
              {modalInfo.dataDeConclusao && (
                <div className="grid grid-rows-2 grid-cols-1 lg:grid-cols-2 lg:grid-rows-1 border border-gray-200 p-2 mt-4">
                  ...
                  <span className="grow text-center font-raleway">
                    {dayjs(modalInfo.dataDeConclusao).format("DD/MM/YYYY")}
                  </span>
                </div>
              )}
