...
export const responsibles = [
	{
		...
		apelido: "ADRIANO",
		ativo: false,
		avatar_url: "https://firebasestorage.googleapis.com/v0/b/sistemaampere.appspot.com/o/usuarios%2Favatar-adriano.jpg?alt=media&token=a30ec3dd-8a2e-4a24-b330-1f4e9b9f0db6",
	},
	{
		id: null,
		...
		apelido: "ARTHUR",
		ativo: false,
		avatar_url: "https://firebasestorage.googleapis.com/v0/b/sistemaampere.appspot.com/o/usuarios%2Favatar-arthurziin.jpg?alt=media&token=150fd914-04d5-4c0a-bf33-7daccdf81916",
	},
	{
	...
	},
	{
		...
		apelido: "NATHAN",
		ativo: false,
		avatar_url: "https://firebasestorage.googleapis.com/v0/b/sistemaampere.appspot.com/o/usuarios%2Favatar-nathan_peres?alt=media&token=7f672eea-0b33-4e49-b747-f2de2ee110ad",
	},
	{
	...
	},
	{
		...
		apelido: "LEANDRO",
		ativo: false,
		avatar_url: "https://firebasestorage.googleapis.com/v0/b/sistemaampere.appspot.com/o/usuarios%2Favatar-leandro_viali?alt=media&token=dffd6966-b6d4-460d-9baa-d467d933a8a7",
	},
	{
		...
		apelido: "GABRIELLA",
		ativo: false,
		avatar_url: "https://firebasestorage.googleapis.com/v0/b/sistemaampere.appspot.com/o/usuarios%2Favatar-gabriella_baltazar?alt=media&token=28392bcb-1f54-4dc7-9f31-98f189362231",
	},
	{
		...
		ativo: false,
		avatar_url: "https://firebasestorage.googleapis.com/v0/b/sistemaampere.appspot.com/o/usuarios%2Favatar-luis_eduardo?alt=media&token=57cbbdbe-709c-4778-b5e4-4d823bd41621",
	},
	{
	...
	},
	{
		...
		apelido: "FELIPE",
		ativo: true,
		avatar_url: "https://firebasestorage.googleapis.com/v0/b/sistemaampere.appspot.com/o/usuarios%2Fcrm%2Favatar-felipe_tadeu?alt=media&token=a1f97754-8a51-43fc-b9c9-72e35d80180e",
	},
];
							...
							<div className="mt-4 flex w-full items-center justify-center">
								<div className="flex grow justify-center gap-x-2">
									{infoHolder.status === "REALIZADO" ? (
										<div className={`w-fit cursor-pointer rounded-lg border border-green-500 p-3 text-center text-xs font-bold text-green-500 `}>REALIZADO</div>
									) : (
										<>
											<div
									...
									<div className="flex items-center gap-2">
										...
										{call.projeto.id ? (
											<Link href={`https://crm.ampereenergias.com.br/comercial/oportunidades/id/${call.projeto.id}`}>
												<div className="cursor-pointer font-raleway text-sm font-medium duration-300 ease-in-out hover:text-cyan-300">#{call.projeto.codigo || "N/A"}</div>
											</Link>
										) : (
											<p className="cursor-pointer font-raleway text-sm font-medium duration-300 ease-in-out hover:text-blue-300">#{call.projeto.codigo || "N/A"}</p>
										)}
									</div>
									<div className="flex items-center gap-2">
                      ...
                      <p className="font-raleway font-medium text-sm">{call.cliente.tipo || 'N/A'}</p>
									...
									<div className="flex w-full flex-col items-center justify-center gap-2 md:flex-row lg:gap-4">
										...
										<div className="flex items-center gap-2">
											...
											<p className="font-raleway text-sm font-medium">
												{call.cliente.endereco ? `${call.cliente.endereco} - ${call.cliente.numeroOuIdentificador}, ${call.cliente.bairro} - ${call.cliente.cep}` : "N/A"}
											</p>
										</div>
									</div>
									<div className="flex w-full flex-col items-center justify-center gap-2 md:flex-row lg:gap-4">
							...
							{call.premissas?.cargas ? (
								<div className="flex w-full flex-col text-gray-600">
									...
									<div className="grid grid-cols-5  lg:grid-cols-6">
										...
										<h1 className="hidden border-r border-white bg-gray-600 p-1 text-center text-xxs font-bold text-white lg:flex lg:text-xs">POTÊNCIA NOMINAL</h1>
									...
									{call.premissas.cargas.map((charge, index) => (
										<div key={index} className="grid grid-cols-5 border border-t-0 border-gray-300 lg:grid-cols-6">
											<h1 className="border-r border-gray-300 p-2 text-center text-xxs font-bold text-gray-600">{charge.descricao}</h1>
											<h1 className="hidden border-r border-gray-300 p-2 text-center text-xxs font-bold text-gray-600 lg:flex">{charge.qtde}</h1>
											<h1 className="border-r border-gray-300 p-2 text-center text-xxs font-bold text-gray-600">{charge.potencia}</h1>
											<h1 className="border-r border-gray-300 p-2 text-center text-xxs font-bold text-gray-600">{charge.qtde * charge.potencia}</h1>
											<h1 className="border-r border-gray-300 p-2 text-center text-xxs font-bold text-gray-600">{charge.horasFuncionamento}</h1>
											<h1 className="p-2 text-center text-xxs font-bold text-gray-600">{charge.qtde * charge.potencia * charge.horasFuncionamento}</h1>
										</div>
									))}
									<div className="grid grid-cols-5 items-center border border-t-0 border-gray-300 lg:grid-cols-6">
									...
									<div className="grid grid-cols-5 items-center border border-t-0 border-gray-300 lg:grid-cols-6">
										...
										<p className="col-span-1 p-2 text-center text-xs font-bold text-gray-600">{formatDecimalPlaces(getChargesTotals(call.premissas.cargas).totalPot, 2, 2)} kWp</p>
									</div>
								</div>
							) : null}
