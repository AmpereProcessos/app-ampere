          ...
          <div className="overscroll-y scrollbar-thin scrollbar-track-primary/20 scrollbar-thumb-primary/20 overflow-y-auto">
            ...
            <div className="border-border mt-4 flex flex-col items-center gap-x-2 border p-2 lg:flex-row">
              ...
              <input
                ...
                className={`text-foreground w-full text-center text-sm uppercase outline-hidden`}
                onChange={(e) => {
            ...
            <div className="border-border mt-4 flex flex-col gap-x-2 border p-2">
              ...
              <input
                ...
                className={`italic] text-foreground bg-primary/20 min-h-[50px] w-full p-4 text-center text-sm font-bold uppercase outline-hidden`}
                onChange={(e) => {
            ...
            <div className="mt-6 flex justify-center">
              <button
                onClick={deleteCall}
                className="rounded bg-red-300 p-2 font-bold text-white hover:bg-red-600"
              >
                EXCLUR CHAMADO
              </button>
            </div>
