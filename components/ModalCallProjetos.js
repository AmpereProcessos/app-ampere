			...
			<AnimatedModalWrapper modalIsOpen={modalIsOpen} width={"40%"} height={"87%"}>
				<div className="flex h-full flex-col">
					<div className="border-primary/20 flex items-center justify-between border-b px-2 pb-2 text-lg">
						<h1 className="pl-6 font-bold text-[#15599a] uppercase">{info.tipoDoChamado}</h1>
					...
					<div className="overscroll-y scrollbar-thin scrollbar-track-primary/20 scrollbar-thumb-primary/20 overflow-y-auto">
						...
						<div className="border-primary/20 mt-4 flex flex-col items-center gap-x-2 border p-2 lg:flex-row">
							<span className="font-raleway text-center font-bold">PROJETO</span>
							<input
								type={"text"}
								value={infoHolder.projeto}
								className={`text-primary/80 w-full text-center text-sm uppercase outline-hidden`}
								onChange={(e) => {
						...
						<div className="border-primary/20 mt-4 flex flex-col gap-x-2 border p-2">
							...
							<input
								...
								className={`italic] text-primary/80 bg-primary/20 min-h-[50px] w-full p-4 text-center text-sm font-bold uppercase outline-hidden`}
								onChange={(e) => {
