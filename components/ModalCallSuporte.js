        ...
        <div className="flex h-full flex-col">
          <div className="border-border flex items-center justify-between border-b px-2 pb-2 text-lg">
            <div className="flex flex-col items-center">
              ...
              <p className="text-foreground text-xs">{info._id}</p>
            </div>

            {info.demanda && (
              <span className="text-foreground border-border border p-2 text-xs font-bold">
          ...
          <p className="text-foreground mt-2 text-center text-xs italic">
            {info.fechamento
          ...
          <div className="overscroll-y scrollbar-thin scrollbar-track-primary/20 scrollbar-thumb-primary/20 overflow-y-auto">
            ...
            <div className="border-border mt-4 flex flex-col items-center gap-x-2 border p-2 lg:flex-row">
              ...
              <p className="font-raleway grow text-center">
            ...
            <div className="mt-4 flex justify-center">
              <a
                ...
                className="grow text-center text-sm text-blue-400"
              >
            ...
            <div className="border-border mt-4 flex flex-col items-center justify-center gap-x-2 border p-2 lg:flex-row">
            ...
            {info.tipoChamado.includes("GARANTIA") && (
              <>
                <div className="border-border mt-4 flex flex-col gap-1 border p-2">
                  <span className="font-raleway text-center font-bold">
            ...
            {info.tipoChamado == "GOTEIRA" || info.tipoChamado == "DEFEITOS E GARANTIA" ? (
              <div className="flex flex-col">
                ...
                <AnexoArquivo
                  ...
                  client={
                    infoHolder.nomeCliente ? `${infoHolder.nomeCliente}` : `${infoHolder.nomeUsina}`
                  }
                  categories={[
                    {
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="flex flex-col items-center gap-1">
                      {infoHolder.links.map((obj, index2) => (
                        <a
                          className="text-center text-xs font-bold text-[#15599a]"
                          key={index2}
                          href={obj.link}
                        >
            ...
            {info.idPai ? (
              <div className="mt-2 flex w-full flex-col gap-2">
                <h1 className="bg-primary/80 w-full rounded-md p-2 text-center font-medium text-white">
                  ORDENS DE SERVIÇO
                </h1>
                <OSCreationBlock
            ...
            {message.text && (
              <p className={`text-center ${message.color} mt-2 italic`}>{message.text}</p>
            )}
