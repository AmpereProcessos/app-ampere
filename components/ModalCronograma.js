					...
					<div className="flex h-full flex-col">
						...
						<div className="flex grow flex-col gap-y-2 overflow-y-auto overscroll-y-auto py-2">
							<div className="mt-4 grid grid-cols-1 grid-rows-2  md:grid-rows-1 lg:grid-cols-2">
								...
								<p className="text-center text-xs text-gray-600">{info.categoria}</p>
							</div>
							<div className="grid grid-cols-1 grid-rows-2 md:grid-rows-1 lg:grid-cols-2">
								...
								<p className="text-center text-xs text-gray-600">{info.servicoExecutado}</p>
							</div>
							<div className="mt-4 grid grid-cols-1 grid-rows-2  md:grid-rows-1 lg:grid-cols-2">
								<p className="text-center text-xs font-bold text-[#15599a]">CIDADE</p>
								<p className="text-center text-xs text-gray-600">{info.cidade}</p>
							</div>
							<div className="mt-4 grid grid-cols-1 grid-rows-2  md:grid-rows-1 lg:grid-cols-2">
								<p className="text-center text-xs font-bold text-[#15599a]">BAIRRO</p>
								<p className="text-center text-xs text-gray-600">{info.bairro}</p>
							</div>
							<div className="mt-4 grid grid-cols-1 grid-rows-2  md:grid-rows-1 lg:grid-cols-2">
								<p className="text-center text-xs font-bold text-[#15599a]">LOGRAOURO</p>
								<p className="text-center text-xs text-gray-600">{info.logradouro}</p>
							</div>
							<div className="mt-4 grid grid-cols-1 grid-rows-2  md:grid-rows-1 lg:grid-cols-2">
								<p className="text-center text-xs font-bold text-[#15599a]">Nº</p>
								<p className="text-center text-xs text-gray-600">{info.numeroResidencia}</p>
							</div>
							<div className="mt-4 grid grid-cols-1 grid-rows-2  md:grid-rows-1 lg:grid-cols-2">
								<p className="text-center text-xs font-bold text-[#15599a]">EQUIPE RESPONSÁVEL</p>
								<select value={equipe} onChange={(e) => handleEquipeChange(e.target.value)} className="text-xs text-gray-600 outline-none">
							...
							<div className="mt-4 grid grid-cols-1 grid-rows-2  md:grid-rows-1 lg:grid-cols-2">
								...
								<p className="text-center text-xs text-gray-600">{info.qtdeModulos}</p>
							</div>
							<div className="mt-4 grid grid-cols-1 grid-rows-2  md:grid-rows-1 lg:grid-cols-2">
								<p className="text-center text-xs font-bold text-[#15599a]">TOPOLOGIA</p>
								<p className="text-center text-xs text-gray-600">{info.topologia}</p>
							</div>
