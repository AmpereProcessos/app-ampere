		...
		<div style={OVERLAY_STYLES}>
			<div className="w-[90%] lg:w-[40%]" style={MODAL_STYLES}>
				<div className="flex flex-col h-full">
					<div className="flex w-full justify-between pb-2 border-b border-gray-300">
					...
					<div className="flex flex-col gap-2 py-4 px-3 h-full overflow-y-auto overscroll-y scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
						<div className="flex items-center  justify-center h-[200px]">
							{!image && info.avatar_url ? (
								...
								<div className="mb-3 rounded-full relative w-[120px] h-[120px] cursor-pointer">
									...
									/>
									<input onChange={(e) => setImage(e.target.files[0])} className="h-full w-full opacity-0" type="file" accept="image/png, image/jpeg" />
								</div>
							) : (
						...
						<div className="flex flex-col items-center w-full py-4 border border-gray-300">
						...
						<div className="flex flex-col items-center w-full py-4 border border-gray-300">
							...
							<div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-2 w-full px-2 mt-2">
								<button
									...
									className={`${info.visualizacao ? "opacity-30" : ""} text-center border border-[#15599a] text-[#15599a] font-bold p-2 rounded w-full`}
								>
									GERAL
								</button>
								<button
									...
									className={`${info.visualizacao == "VENDEDOR" ? "" : "opacity-30"} text-center border border-[#15599a] text-[#15599a] font-bold p-2 rounded w-full`}
								>
									VENDEDOR
								</button>
								<button
									...
									className={`${info.visualizacao == "REGIONAL" ? "" : "opacity-30"} text-center border border-[#15599a] text-[#15599a] font-bold p-2 rounded w-full`}
								>
									REGIONAL
								</button>
								<button
									...
									className={`${info.visualizacao == "INSIDE" ? "" : "opacity-30"} text-center border border-[#15599a] text-[#15599a] font-bold p-2 rounded w-full`}
								>
									INSIDE
								</button>
								<button
									...
									className={`${info.visualizacao == "OBRAS" ? "" : "opacity-30"} text-center border border-[#15599a] text-[#15599a] font-bold p-2 rounded w-full`}
								>
									OBRAS
								</button>
							</div>
							{info.visualizacao == "VENDEDOR" && (
								<div className="flex flex-col justify-center items-center w-full mt-2">
									...
									<select value={info.vendedor ? info.vendedor : "NÃO DEFINIDO"} onChange={(e) => setInfo({ ...info, vendedor: e.target.value })} className="p-2 outline-none text-gray-600">
							...
							{info.visualizacao == "REGIONAL" && (
								<div className="flex flex-col justify-center items-center w-full mt-2">
									...
									<select value={info.regional ? info.regional : "NÃO DEFINIDO"} onChange={(e) => setInfo({ ...info, regional: e.target.value })} className="p-2 outline-none text-gray-600">
							...
							{info.visualizacao == "OBRAS" ? (
								<div className="flex flex-col justify-center items-center w-full mt-2">
									...
									<select value={info.equipe ? info.equipe : "NÃO DEFINIDO"} onChange={(e) => setInfo({ ...info, equipe: e.target.value })} className="p-2 outline-none text-gray-600">
