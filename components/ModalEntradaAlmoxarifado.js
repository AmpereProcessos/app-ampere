        ...
        <div className="h-[80%] w-[90%] lg:h-[70%] lg:w-[60%]" style={MODAL_STYLES}>
          <div className="flex h-full flex-col">
            <div className="border-primary/20 flex min-h-[30px] justify-between border-b px-2 pb-2 text-lg">
              <h1 className="pl-6 font-bold text-[#15599a] uppercase">ENTRADA DE ITEM</h1>
              <button>
                <VscChromeClose
                  onClick={() => {
                    closeModal(false)
            ...
            <div className="scrollbar-thin scrollbar-track-primary/20 scrollbar-thumb-primary/20 flex grow flex-col gap-2 overflow-y-auto overscroll-y-auto px-2 py-2">
              ...
              {items.length > 0 ? (
                ...
                <p className="text-primary/60 text-center text-sm italic">Sem itens vinculados...</p>
              )}
              {/* <div className="w-full flex flex-col items-center gap-1">
                ...
                <input
                  ...
                  className="w-full p-2 outline-hidden text-center text-sm text-primary/70 border border-primary/20 rounded"
                />
              </div>
              <div className="w-full flex flex-col items-center gap-1">
