				...
				<div style={MODAL_STYLES}>
					<div className="flex flex-col h-full">
						<div className="flex justify-between px-2 text-lg pb-2 border-b border-gray-300">
							<h1 className="text-[#15599a] pl-6 uppercase font-bold">NOVO LEAD</h1>
							<button>
								<VscChromeClose
									onClick={() => {
						...
						<div className="flex flex-col gap-2 grow overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 mt-2">
							<div className="grid grid-cols-10 w-full border p-1 border-gray-300">
								<span className="font-bold text-center p-2 col-span-2">NOME</span>
								<input
									type="text"
									value={info.nome}
									onChange={(e) =>
							...
							<div className="grid grid-cols-10 w-full border p-1 border-gray-300">
								<span className="font-bold text-center p-2 col-span-2">TELEFONE</span>
								<input
									type="text"
									value={info.telefone}
									onChange={(e) =>
							...
							<div className="grid grid-cols-10 w-full border p-1 border-gray-300">
								<span className="font-bold text-center p-2 col-span-2">CIDADE</span>
							...
							<div className="grid grid-cols-10 w-full border p-1 border-gray-300">
								<span className="font-bold text-center p-2 col-span-2">CANAL</span>
								<div className="flex grow justify-center items-center col-span-8">
									<select
										type="text"
										value={info.canal}
							...
							<div className="grid grid-cols-10 w-full border p-1 border-gray-300">
								<span className="font-bold text-center p-2 col-span-2">CAMPANHA</span>
								<input
									type="text"
									value={info.campanha}
									onChange={(e) =>
							...
							<div className="grid grid-cols-10 w-full border p-1 border-gray-300">
								<span className="font-bold text-center p-2 col-span-2">DATA DE AQUISIÇÃO</span>
								<input
									type="date"
							...
							<div className="grid grid-cols-10 w-full border p-1 border-gray-300">
								<span className="font-bold text-center p-2 col-span-2">CONSUMO</span>
								<input
									type="number"
									value={info.consumo}
									onChange={(e) =>
							...
							<div className="grid grid-cols-10 w-full border p-1 border-gray-300">
								<span className="font-bold text-center p-2 col-span-2">VENDEDOR</span>
								<div className="flex grow justify-center items-center col-span-8">
									<select
										type="text"
										value={info.vendedor}
							...
							<div className="grid grid-cols-10 w-full border p-1 border-gray-300">
								<span className="font-bold text-center p-2 col-span-2">CÓDIGO CRM</span>
								<input
									type="text"
							...
							<div onClick={addLead} className="flex items-center justify-center">
								<button className="p-2 rounded bg-blue-300 hover:bg-[#15599a] text-white font-bold">ADICIONAR LEAD</button>
							</div>
						</div>
					</div>
				</div>
