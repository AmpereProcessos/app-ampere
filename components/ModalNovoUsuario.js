			...
			<div className="w-[90%] lg:w-[40%]" style={MODAL_STYLES}>
				<div className="flex flex-col h-full">
					...
					<div className="flex flex-col py-2 gap-2  overflow-y-auto overscroll-y scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
						...
						<div className="flex flex-col items-center w-full py-4 border border-gray-300">
							...
							<div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-2 w-full px-2 mt-2">
								<button
									...
									className={`${userInfo.visualizacao ? "opacity-30" : ""} text-center border border-[#15599a] text-[#15599a] font-bold p-2 rounded w-full`}
								>
									GERAL
								</button>
								<button
									...
									className={`${userInfo.visualizacao == "VENDEDOR" ? "" : "opacity-30"} text-center border border-[#15599a] text-[#15599a] font-bold p-2 rounded w-full`}
								>
									VENDEDOR
								</button>
								<button
									...
									className={`${userInfo.visualizacao == "REGIONAL" ? "" : "opacity-30"} text-center border border-[#15599a] text-[#15599a] font-bold p-2 rounded w-full`}
								>
									REGIONAL
								</button>
								<button
									...
									className={`${userInfo.visualizacao == "INSIDE" ? "" : "opacity-30"} text-center border border-[#15599a] text-[#15599a] font-bold p-2 rounded w-full`}
								>
									INSIDE
								</button>
								<button
									...
									className={`${userInfo.visualizacao == "OBRAS" ? "" : "opacity-30"} text-center border border-[#15599a] text-[#15599a] font-bold p-2 rounded w-full`}
								>
									OBRAS
								</button>
							</div>
						...
						{message.text && <p className={`text-center italic my-2 ${message.color}`}>{message.text}</p>}
						<button onClick={addUser} className="self-center text-center w-fit p-2 rounded border border-green-500 text-green-500 hover:text-white hover:bg-green-500 font-bold">
							CRIAR USUÁRIO
						</button>
					</div>
				</div>
