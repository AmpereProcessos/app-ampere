...
import { cidadesAtendidas, tiposDePadrao, tiposDeServico, vendedores } from "../utils/constants";
...
function ModalSolicitacaoVendas({ info, editable, setModalIsOpen, handleUpdates }) {
	const [dados, setDados] = useState(info);
	const [msg, setMessage] = useState({ text: "", color: "" });
	function saveChanges() {
		axios.put("/api/solicitacoes/contrato", { ...dados, aprovacao: null }).then((res) => {
				...
				<div className="flex h-full flex-col">
					<div className="flex justify-between border-b border-gray-300 px-2 pb-2 text-lg">
						...
						<div className="flex items-center gap-x-2">
							...
							{editable && <SaveButton text={"Salvar alterações"} icon={<FaSave />} handleClick={saveChanges} />}
							<button>
					...
					<div className="flex h-full flex-col gap-y-2 overflow-y-auto overscroll-y-auto">
						<div className="flex w-full flex-col border border-[#15599a] bg-[#fff] pb-2 shadow-lg">
							...
							<div className="flex flex-wrap justify-around gap-2">
								...
								/>
								<TextInput label={"Telefone"} editable={editable} value={dados.telefone} handleChange={(value) => setDados({ ...dados, telefone: phoneMask(value) })} />
								<TextInput label={"CPF/CNPJ"} editable={editable} value={dados.cpf_cnpj} handleChange={(value) => setDados({ ...dados, cpf_cnpj: formatCnpjCpf(value) })} />
								<TextInput label={"RG"} editable={editable} value={dados.rg} handleChange={(value) => setDados({ ...dados, rg: value })} />
								<DateInput
								...
								/>
								<TextInput label={"CEP"} editable={editable} value={dados.cep} handleChange={(value) => setDados({ ...dados, cep: formatCEP(value) })} />
								{editable && (
								...
								/>
								<TextInput label={"UF"} editable={editable} value={dados.uf} handleChange={(value) => setDados({ ...dados, uf: value })} />
								<TextInput
								...
								/>
								<NumberInput label={"Nº"} editable={editable} value={dados.numeroResCobranca} handleChange={(value) => setDados({ ...dados, numeroResCobranca: Number(value) })} />
								<TextInput label={"BAIRRO"} editable={editable} value={dados.bairro} handleChange={(value) => setDados({ ...dados, bairro: value.toUpperCase() })} />
								<TextInput label={"PONTO DE REFERÊNCIA"} editable={editable} value={dados.pontoDeReferencia} handleChange={(value) => setDados({ ...dados, pontoDeReferencia: value })} />
								<SelectInput
									label={"SEGMENTO"}
								...
								/>
								<NumberInput label={"CÓDIGO DO PROJETO CRM"} editable={editable} value={dados.codigoSVB} handleChange={(value) => setDados({ ...dados, codigoSVB: value })} />
								<SelectInput
									label={"ESTADO CIVIL"}
									editable={editable}
									options={[
								...
								/>
								<TextInput label={"EMAIL"} normalCase={true} editable={editable} value={dados.email} handleChange={(value) => setDados({ ...dados, email: value })} />
								<TextInput label={"PROFISSÃO"} editable={editable} value={dados.profissao} handleChange={(value) => setDados({ ...dados, profissao: value })} />
								<TextInput label={"ONDE TRABALHA"} editable={editable} value={dados.ondeTrabalha} handleChange={(value) => setDados({ ...dados, ondeTrabalha: value })} />
								<SelectInput
								...
								{dados.possuiDeficiencia == "SIM" && (
									<>
										{" "}
										<TextInput label={"SE SIM, QUAL ?"} editable={editable} value={dados.qualDeficiencia} handleChange={(value) => setDados({ ...dados, qualDeficiencia: value })} />
									</>
								)}
								<SelectInput
								...
								{dados.canalVenda == "INDICAÇÃO DE AMIGO" && (
									<>
										<TextInput label={"NOME INDICADOR"} editable={editable} value={dados.nomeIndicador} handleChange={(value) => setDados({ ...dados, nomeIndicador: value })} />
										<TextInput label={"TELEFONE INDICADOR"} editable={editable} value={dados.telefoneIndicador} handleChange={(value) => setDados({ ...dados, telefoneIndicador: value })} />
									</>
								)}
							</div>
						...
						<div className="flex w-full flex-col border border-[#15599a] bg-[#fff] pb-2 shadow-lg">
							<span className="py-2 text-center text-sm font-bold uppercase text-[#15599a]">DADOS PARA ENTRADA NA CEMIG</span>
							<div className="flex flex-wrap justify-around gap-2">
								<TextInput
								...
								/>
								<TextInput label={"CEP INSTALAÇÃO"} editable={editable} value={dados.cepInstalacao} handleChange={(value) => setDados({ ...dados, cepInstalacao: formatCEP(value) })} />
								{editable && (
								...
								/>
								<NumberInput label={"Nº"} editable={editable} value={dados.numeroResInstalacao} handleChange={(value) => setDados({ ...dados, numeroResInstalacao: value })} />
								<NumberInput label={"Nº DA INSTALAÇÃO"} editable={editable} value={dados.numeroInstalacao} handleChange={(value) => setDados({ ...dados, numeroInstalacao: value })} />
								<TextInput label={"BAIRRO"} editable={editable} value={dados.bairroInstalacao} handleChange={(value) => setDados({ ...dados, bairroInstalacao: value })} />
								<SelectInput
									label={"CIDADE"}
									editable={editable}
								...
								/>
								<TextInput label={"UF"} editable={editable} value={dados.ufInstalacao} handleChange={(value) => setDados({ ...dados, ufInstalacao: value })} />
								<TextInput
								...
								/>
								<TextInput label={"LATITUDE"} editable={editable} value={dados.latitude} handleChange={(value) => setDados({ ...dados, latitude: value })} />
								<TextInput label={"LONGITUDE"} editable={editable} value={dados.longitude} handleChange={(value) => setDados({ ...dados, longitude: value })} />
								<NumberInput
									label={"POTÊNIA PICO"}
									editable={editable}
									value={dados.potPico}
						...
						<div className="flex w-full flex-col border border-[#15599a] bg-[#fff] pb-2 shadow-lg">
							...
							<div className="flex flex-wrap justify-around gap-2">
								{dados.topologia != "NÃO DEFINIDO" && (
									<>
										<TextInput label={"MARCA DO INVERSOR/MICRO"} editable={editable} value={dados.marcaInversor} handleChange={(value) => setDados({ ...dados, marcaInversor: value })} />
										<NumberInput label={"QTDE INVERSOR/MICRO"} editable={editable} value={dados.qtdeInversor} handleChange={(value) => setDados({ ...dados, qtdeInversor: Number(value) })} />
										<NumberInput
							...
							<div className="mx-2 mt-2 flex flex-wrap justify-around gap-2 border-t border-gray-300 pt-2">
								<TextInput label={"MARCA DOS MÓDULOS"} editable={editable} value={dados.marcaModulos} handleChange={(value) => setDados({ ...dados, marcaModulos: value })} />
								<NumberInput label={"Nº DE MÓDULOS"} editable={editable} value={dados.qtdeModulos} handleChange={(value) => setDados({ ...dados, qtdeModulos: Number(value) })} />
								<NumberInput
						...
						<div className="flex w-full flex-col border border-[#15599a] bg-[#fff] pb-2 shadow-lg">
							...
							{dados.aumentoDeCarga == "SIM" && (
								<div className="mt-2 flex flex-wrap justify-around gap-2">
									...
									/>
									<NumberInput label={"VALOR DO PADRÃO"} editable={editable} value={dados.valorPadrao} handleChange={(value) => setDados({ ...dados, valorPadrao: Number(value) })} />
								</div>
							)}
						</div>
						<div className="flex w-full flex-col border border-[#15599a] bg-[#fff] pb-2 shadow-lg">
							...
							<div className="mt-2 flex flex-wrap justify-around gap-2">
								<TextInput label={"NOME DO PAGADOR"} editable={editable} value={dados.nomePagador} handleChange={(value) => setDados({ ...dados, nomePagador: value })} />
								<TextInput
								...
								/>
								<TextInput label={"CPF/CNPJ PARA NF"} editable={editable} value={dados.cpf_cnpjNF} handleChange={(value) => setDados({ ...dados, cpf_cnpjNF: formatCnpjCpf(value) })} />
							</div>
							<div className="mt-2 flex flex-wrap justify-around gap-2">
								<SelectInput
								...
								{dados.necessidaInscricaoRural == "SIM" && (
									<TextInput label={"INSCRIÇÃO RURAL"} editable={editable} value={dados.inscriçãoRural} handleChange={(value) => setDados({ ...dados, inscriçãoRural: value })} />
								)}
							</div>
							<div className="mt-2 flex flex-wrap justify-around gap-2">
								<SelectInput
							...
							<div className="mt-2 flex flex-wrap justify-around gap-2">
								...
								{dados.origemRecurso == "FINANCIAMENTO" && (
									<>
										...
										/>
										<TextInput label={"NOME DO GERENTE"} editable={editable} value={dados.nomeGerente} handleChange={(value) => setDados({ ...dados, nomeGerente: value })} />
										<TextInput
						...
						<div className="flex w-full flex-col border border-[#15599a] bg-[#fff] pb-2 shadow-lg">
							<span className="py-2 text-center text-sm font-bold uppercase text-[#15599a]">DOCUMENTOS NECESSÁRIOS</span>
							<div className="mt-2 flex flex-wrap justify-around gap-2">
								<div className="w-fit">
									<input
								...
								{dados.tipoDaInstalacao == "RURAL" && (
									<>
										...
										<div className="w-fit">
											<input
												checked={dados.comprovanteEnderecoCorrespondente ? true : false}
												disabled={true}
												onChange={(e) =>
													setDados({
														...dados,
											...
											/>
											<label className="ml-2" htmlFor="comprovanteEnderecoCorrespondente">
								...
								{dados.tipoDoTitular == "PESSOA JURIDICA" && (
									<>
										...
										<div className="w-fit">
											<input
												checked={dados.comprovanteEnderecoRepresentante ? true : false}
												disabled={true}
												onChange={(e) =>
													setDados({
														...dados,
											...
											/>
											<label className="ml-2" htmlFor="comprovanteEnderecoRepresentante">
								...
								{(dados.aumentoDeCarga == "SIM" || dados.tipoDaLigacao == "NOVA") && (
									<>
										<div className="w-fit">
											<input
