			...
			<div style={MODAL_STYLES}>
				<div className="flex h-full flex-col">
					...
					<div className="flex h-full flex-col gap-y-2 overflow-y-auto overscroll-y-auto">
						...
						<div className="bg-background flex w-full flex-col border border-[#15599a] pb-2 shadow-lg">
							<span className="py-2 text-center text-sm font-bold text-[#15599a] uppercase">DOCUMENTOS NECESSÁRIOS</span>
							<div className="mt-2 flex flex-wrap justify-around gap-2">
								<div className="w-fit">
									<input
							...
							<div className="bg-background flex w-full flex-col border border-[#15599a] pb-2 shadow-lg">
								<div className="mt-2 flex w-full flex-col items-center self-center px-2">
									<span className="font-raleway text-center text-sm font-bold uppercase">COMENTÁRIOS AO VENDEDOR</span>
									<textarea
										readOnly={true}
