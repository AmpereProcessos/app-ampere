...
import { cidadesAtendidas, vendedores, projetistas, credores, fornecedores, localEntregaOptions, customersAcquisitionChannels } from "../utils/constants";
			...
			<div style={OVERLAY_STYLES}>
				<div style={MODAL_STYLES}>
					<div className="flex flex-col h-full overflow-y-auto overscroll-y-auto">
						<div className="flex justify-between px-2 text-lg pb-2 border-b border-gray-300">
							...
							<div className="flex flex-col border border-[#15599a] pb-2 shadow-lg">
								...
								<div className="flex gap-2 justify-center flex-wrap">
									...
									<NumberInput
										...
										value={infoHolder.estruturaPersonalizada?.valor == "-" || infoHolder.estruturaPersonalizada?.valor == undefined ? 0 : infoHolder.estruturaPersonalizada?.valor}
										handleChange={(value) => {
											setChanges({
												...changes,
									...
									{infoHolder.estruturaPersonalizada?.aplicavel == "SIM" && (
										<SelectInput
											...
											value={infoHolder.estruturaPersonalizada.aplicavel ? (infoHolder.estruturaPersonalizada.status ? infoHolder.estruturaPersonalizada.status : "N/A") : "N/A"}
											options={[
							...
							<div className="flex flex-col border border-[#15599a] pb-2 shadow-lg">
								...
								<div className="flex gap-2 justify-center flex-wrap">
									...
									<DateInput
										...
										value={
											infoHolder.contrato?.dataLiberacao != undefined && infoHolder.contrato?.dataLiberacao != "-" ? new Date(infoHolder.contrato.dataLiberacao).toISOString().slice(0, 10) : 0
										}
										handleChange={(value) => {
											setChanges({
												...changes,
							...
							<div className="flex flex-col border border-[#15599a] pb-2 shadow-lg">
								...
								<div className="flex gap-2 justify-center flex-wrap">
									...
									<DateInput
										...
										value={
											infoHolder.compra?.dataLiberacao != undefined && infoHolder.compra?.dataLiberacao != "-" ? new Date(infoHolder.compra.dataLiberacao).toISOString().slice(0, 10) : 0
										}
										handleChange={(value) => {
											setChanges({
												...changes,
									...
									<DateInput
										...
										value={infoHolder.compra.dataPedido != undefined && infoHolder.compra.dataPedido != "-" ? new Date(infoHolder.compra.dataPedido).toISOString().slice(0, 10) : 0}
										handleChange={(value) => {
											setChanges({
												...changes,
									...
									<DateInput
										...
										value={
											infoHolder.compra?.dataPagamento != undefined && infoHolder.compra?.dataPagamento != "-" ? new Date(infoHolder.compra?.dataPagamento).toISOString().slice(0, 10) : 0
										}
										handleChange={(value) => {
											setChanges({
												...changes,
									...
									<DateInput
										...
										value={
											infoHolder.compra.previsaoEntrega != undefined && infoHolder.compra.previsaoEntrega != "-" ? new Date(infoHolder.compra.previsaoEntrega).toISOString().slice(0, 10) : 0
										}
										handleChange={(value) => {
											setChanges({
												...changes,
									...
									<DateInput
										...
										value={infoHolder.compra.dataEntrega != undefined && infoHolder.compra.dataEntrega != "-" ? new Date(infoHolder.compra.dataEntrega).toISOString().slice(0, 10) : 0}
										handleChange={(value) => {
											setChanges({
												...changes,
									...
									<SelectInput
										...
										value={infoHolder.compra?.localEntrega != undefined && infoHolder.compra?.localEntrega != "-" ? infoHolder.compra?.localEntrega : "NÃO DEFINIDO"}
								...
								<div className="flex gap-2 justify-center flex-wrap">
									...
									{infoHolder.dadosCemig?.distCreditos == "SIM" && (
										<NumberInput
											...
											value={infoHolder.dadosCemig?.qtdeDistCreditos != undefined && infoHolder.dadosCemig?.qtdeDistCreditos != "-" ? infoHolder.dadosCemig?.qtdeDistCreditos : 0}
											handleChange={(value) => {
												setChanges({
													...changes,
							...
							<div className="flex flex-col border border-[#15599a] pb-2 shadow-lg">
								...
								<div className="flex gap-2 justify-center flex-wrap">
									<NumberInput
										...
										value={infoHolder.sistema?.qtdeModulos != undefined && infoHolder.sistema?.qtdeModulos != "-" ? infoHolder.sistema?.qtdeModulos : 0}
										handleChange={(value) => {
											setChanges({
												...changes,
							...
							<div className="flex flex-col border border-[#15599a] pb-2 shadow-lg">
								...
								<div className="flex gap-2 justify-center flex-wrap">
									...
									<DateInput
										...
										value={infoHolder.vistoria?.dataPedido != undefined && infoHolder.vistoria?.dataPedido != "-" ? new Date(infoHolder.vistoria.dataPedido).toISOString().slice(0, 10) : 0}
										handleChange={(value) => {
											setChanges({
												...changes,
									...
									<DateInput
										...
										value={infoHolder.medidor?.data != undefined && infoHolder.medidor?.data != "-" ? new Date(infoHolder.medidor.data).toISOString().slice(0, 10) : 0}
										handleChange={(value) => {
											setChanges({
												...changes,
							...
							<div className="flex flex-col border border-[#15599a] pb-2 shadow-lg">
								...
								<div className="flex gap-2 justify-center flex-wrap">
									...
									<DateInput
										...
										value={infoHolder.obra?.entrada != undefined && infoHolder.obra?.entrada != "-" ? new Date(infoHolder.obra?.entrada).toISOString().slice(0, 10) : 0}
										handleChange={(value) => {
											setChanges({
												...changes,
									...
									<DateInput
										label={"SAIDA DE OBRA"}
										value={infoHolder.obra?.saida != undefined && infoHolder.obra?.saida != "-" ? new Date(infoHolder.obra?.saida).toISOString().slice(0, 10) : 0}
										handleChange={(value) => {
											setChanges({
												...changes,
