    ...
    <div style={OVERLAY_STYLES}>
      <div style={MODAL_STYLES}>
        <div className="flex h-full flex-col">
          <div className="border-border grid grid-cols-3 items-center border-b px-2 pb-2 text-lg">
            <h1 className="p-0 text-xs font-bold text-[#15599a] lg:pl-6 lg:text-base">
              {dados.nomeDoCliente}
            </h1>
            {dados.status != "CONCLUIDO" ? (
              ...
              <div className="flex items-center justify-center">
                <p className="w-fit self-center rounded bg-green-400 p-1 text-xs font-bold text-white lg:text-base">
                  CONCLUIDO
                </p>
              </div>
            )}
          ...
          <div className="flex h-full flex-col gap-y-2 overflow-y-auto overscroll-y-auto">
                ...
                <div className="bg-background flex w-full flex-col border border-[#15599a] p-4 shadow-lg">
                  ...
                  <div className="mt-2 flex flex-wrap items-center justify-around gap-2">
                    ...
                    <SelectInput
                      ...
                      editable={dados.status == "REJEITADA" ? true : false}
                      value={
                        dados.tipoFixacaoInversores ? dados.tipoFixacaoInversores : "NÃO DEFINIDO"
                      }
                      options={[
                        { label: "NÃO DEFINIDO", value: "NÃO DEFINIDO" },
            ...
            {dados.tipoDeSolicitacao == "VISITA TÉCNICA REMOTA - RURAL" && (
              <>
                <div className="bg-background flex w-full flex-col border border-[#15599a] p-4 shadow-lg">
                  <span className="text-md py-2 text-center font-bold text-[#15599a] uppercase">
                    VISITA TÉCNICA RURAL
                  </span>
                  <div className="mt-2 flex flex-col items-center">
                    <span className="py-2 text-center text-sm font-bold text-[#fead61] uppercase">
                      PADRÃO
                    </span>
                    <div className="mt-2 flex flex-wrap items-center justify-around gap-2">
                      <SelectInput
                  ...
                  <div className="mt-2 flex flex-col items-center">
                    ...
                    <div className="mt-2 flex flex-wrap items-center justify-around gap-2">
                      <SelectInput
                        ...
                        editable={dados.status == "REJEITADA" ? true : false}
                        value={
                          dados.padraoTrafoAcoplados ? dados.padraoTrafoAcoplados : "NÃO DEFINIDO"
                        }
                        options={[
                          { label: "NÃO DEFINIDO", value: "NÃO DEFINIDO" },
                          { label: "SIM", value: "SIM" },
                  ...
                  <div className="mt-2 flex flex-col items-center">
                    ...
                    <div className="mt-4 flex flex-wrap items-center justify-around gap-2">
                      ...
                      <TextInput
                        ...
                        editable={dados.status == "REJEITADA" ? true : false}
                        value={
                          dados.distanciaModulosInversores ? dados.distanciaModulosInversores : ""
                        }
                        handleChange={(value) =>
                          setDados({
                            ...dados,
                  ...
                  <div className="mt-2 flex flex-col items-center">
                    ...
                    <div className="mt-4 flex flex-wrap items-center justify-around gap-2">
                      ...
                      <SelectInput
                        ...
                        editable={dados.status == "REJEITADA" ? true : false}
                        value={
                          dados.limpezaLocalUsinaSolo ? dados.limpezaLocalUsinaSolo : "NÃO DEFINIDO"
                        }
                        options={[
                          { label: "NÃO DEFINIDO", value: "NÃO DEFINIDO" },
                          {
              ...
              <>
                <div className="bg-background flex w-full flex-col border border-[#15599a] p-4 shadow-lg">
                  ...
                  <div className="flex w-full flex-col items-center text-sm lg:text-base">
                    ...
                    <input
                      className={`text-foreground w-full text-center text-xs uppercase outline-hidden`}
            ...
            <div className="bg-background flex w-full flex-col border border-[#15599a] p-4 shadow-lg">
                ...
                <div className="mx-12 mt-2 flex flex-col gap-2">
                  ...
                  {dados.suprimentos?.map((suprimento, index) => (
                    <div key={index} className="grid w-full grid-cols-4">
                      <p className="text-foreground text-center text-xs font-bold">
                        {suprimento.insumo}
                      </p>
                      <p className="text-foreground text-center text-xs font-bold">
                        {suprimento.tipo}
              ...
              <div className="flex flex-col">
                ...
                <div className="mt-2 flex w-full flex-col items-center self-center">
                  ...
                  <div className="border-border my-2 flex h-[100px] w-full flex-col items-center overflow-y-auto overscroll-y-auto border p-2">
                    {dados.descritivo?.length ? (
                      dados.descritivo?.map((item, index) => (
                        <div key={index} className="grid w-full grid-cols-10 items-center gap-3">
                          <p className="text-xxs col-span-1 font-bold text-[#15599a] lg:text-xs">
                            {item.topico}
                          </p>
                          <p
                            className={`${item.texto.length > 100 ? "text-xxs" : "text-xs"} text-foreground col-span-8 text-center font-bold`}
                          >
                            {item.texto}
                          </p>
                          <div
                      ...
                      <div className="text-foreground flex h-full items-center justify-center text-center italic">
                        SEM DESCRITIVO
                      </div>
                    )}
                  </div>
              ...
              <div className="flex flex-col">
                ...
                <div className="flex flex-wrap justify-around gap-2">
                  ...
                  <SelectInput
                    ...
                    editable={dados.status == "REJEITADA" ? true : false}
                    value={
                      dados.respostaEspacoProjeto ? dados.respostaEspacoProjeto : "NÃO DEFINIDO"
                    }
                    options={[
                      { label: "NÃO DEFINIDO", value: "NÃO DEFINIDO" },
                      { label: "SIM", value: "SIM" },
                ...
                <div className="mx-12 mt-2 flex flex-col gap-2">
                  ...
                  {dados.custosAdicionais?.map((custo, index) => (
                    <div key={index} className="grid w-full grid-cols-5">
                      ...
                      <p className="text-foreground text-center text-xs font-bold">{custo.qtde}</p>
                      <p className="text-foreground text-center text-xs font-bold">
                        {custo.grandeza}
                      </p>
                      <p className="text-foreground text-center text-xs font-bold">{custo.valor}</p>
                      <p className="text-foreground text-center text-xs font-bold">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="grid grid-cols-2 grid-rows-4">
                <div className="grid grid-cols-3 items-center">
                  <p className="text-foreground text-center font-bold">NORTE</p>
                  <input
                    className="text-foreground p-2 text-center font-bold outline-hidden"
                    type={"number"}
                    readOnly={true}
                  ...
                  <p className="text-foreground text-center font-bold">
                    {dados.modNorte && fatorDeGeracaoPorOrientacao[dados.cidade]
                      ? (
                          (Number(fatorDeGeracaoPorOrientacao[dados.cidade]["NORTE"]) *
                            dados.modNorte *
                            dados.potModulos) /
                          1000
                        ).toFixed(2)
                ...
                <div className="grid grid-cols-3 items-center">
                  <p className="text-foreground text-center font-bold">NORDESTE</p>
                  <input
                    className="text-foreground p-2 text-center font-bold outline-hidden"
                    type={"number"}
                    readOnly={true}
                  ...
                  <p className="text-foreground text-center font-bold">
                    {dados.modNordeste && fatorDeGeracaoPorOrientacao[dados.cidade]
                      ? (
                          (Number(fatorDeGeracaoPorOrientacao[dados.cidade]["NORDESTE"]) *
                            dados.modNordeste *
                            dados.potModulos) /
                          1000
                        ).toFixed(2)
                ...
                <div className="grid grid-cols-3 items-center">
                  <p className="text-foreground text-center font-bold">LESTE</p>
                  <input
                    className="text-foreground p-2 text-center font-bold outline-hidden"
                    type={"number"}
                    readOnly={true}
                  ...
                  <p className="text-foreground text-center font-bold">
                    {dados.modLeste && fatorDeGeracaoPorOrientacao[dados.cidade]
                      ? (
                          (Number(fatorDeGeracaoPorOrientacao[dados.cidade]["LESTE"]) *
                            dados.modLeste *
                            dados.potModulos) /
                          1000
                        ).toFixed(2)
                ...
                <div className="grid grid-cols-3 items-center">
                  <p className="text-foreground text-center font-bold">SUDESTE</p>
                  <input
                    className="text-foreground p-2 text-center font-bold outline-hidden"
                    type={"number"}
                    readOnly={true}
                  ...
                  <p className="text-foreground text-center font-bold">
                    {dados.modSudeste && fatorDeGeracaoPorOrientacao[dados.cidade]
                      ? (
                          (Number(fatorDeGeracaoPorOrientacao[dados.cidade]["SUDESTE"]) *
                            dados.modSudeste *
                            dados.potModulos) /
                          1000
                        ).toFixed(2)
                ...
                <div className="grid grid-cols-3 items-center">
                  <p className="text-foreground text-center font-bold">SUL</p>
                  <input
                    className="text-foreground p-2 text-center font-bold outline-hidden"
                    type={"number"}
                    readOnly={true}
                  ...
                  <p className="text-foreground text-center font-bold">
                    {dados.modSul && fatorDeGeracaoPorOrientacao[dados.cidade]
                      ? (
                          (Number(fatorDeGeracaoPorOrientacao[dados.cidade]["SUL"]) *
                            dados.modSul *
                            dados.potModulos) /
                          1000
                        ).toFixed(2)
                ...
                <div className="grid grid-cols-3 items-center">
                  <p className="text-foreground text-center font-bold">SUDOESTE</p>
                  <input
                    className="text-foreground p-2 text-center font-bold outline-hidden"
                    type={"number"}
                    readOnly={true}
                  ...
                  <p className="text-foreground text-center font-bold">
                    {dados.modSudoeste && fatorDeGeracaoPorOrientacao[dados.cidade]
                      ? (
                          (Number(fatorDeGeracaoPorOrientacao[dados.cidade]["SUDOESTE"]) *
                            dados.modSudoeste *
                            dados.potModulos) /
                          1000
                        ).toFixed(2)
                ...
                <div className="grid grid-cols-3 items-center">
                  <p className="text-foreground text-center font-bold">OESTE</p>
                  <input
                    className="text-foreground p-2 text-center font-bold outline-hidden"
                    type={"number"}
                    readOnly={true}
                  ...
                  <p className="text-foreground text-center font-bold">
                    {dados.modOeste && fatorDeGeracaoPorOrientacao[dados.cidade]
                      ? (
                          (Number(fatorDeGeracaoPorOrientacao[dados.cidade]["OESTE"]) *
                            dados.modOeste *
                            dados.potModulos) /
                          1000
                        ).toFixed(2)
                ...
                <div className="grid grid-cols-3 items-center">
                  <p className="text-foreground text-center font-bold">NOROESTE</p>
                  <input
                    className="text-foreground p-2 text-center font-bold outline-hidden"
                    type={"number"}
                    readOnly={true}
                  ...
                  <p className="text-foreground text-center font-bold">
                    {dados.modNoroeste && fatorDeGeracaoPorOrientacao[dados.cidade]
                      ? (
                          (Number(fatorDeGeracaoPorOrientacao[dados.cidade]["NOROESTE"]) *
                            dados.modNoroeste *
                            dados.potModulos) /
                          1000
                        ).toFixed(2)
            ...
            {dados.status == "CONCLUIDO" ? (
              <div className="bg-background flex w-full items-center justify-center gap-2 border border-[#15599a] p-4 shadow-lg">
                ...
                <Link href={`/projetos/laudo/pdf/${dados._id}?tipo=${laudoType}`}>
                  <button className="rounded bg-[#fead61] p-2 font-bold hover:bg-[#15599a] hover:text-white">
                    LAUDO
                  </button>
                </Link>
              </div>
