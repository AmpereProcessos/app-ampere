...
import { cidadesAtendidas, distributionCompanies, fatorDeGeracaoPorOrientacao, suprimentoOption, tiposSolicitacaoVisitaTecnica } from "../utils/constants";
		...
		<div style={OVERLAY_STYLES}>
			<div style={MODAL_STYLES}>
				<div className="flex flex-col h-full">
					<div className="grid grid-cols-3 items-center px-2 text-lg pb-2 border-b border-gray-300">
						<h1 className="text-[#15599a] p-0 lg:pl-6 font-bold text-xs lg:text-base">{dados.nomeDoCliente}</h1>
						{dados.status != "CONCLUIDO" ? (
							...
							<div className="flex items-center justify-center">
								<p className="font-bold p-1 bg-green-400 text-white rounded w-fit self-center text-xs lg:text-base">CONCLUIDO</p>
							</div>
						)}
					...
					<div className="flex flex-col gap-y-2 h-full overflow-y-auto overscroll-y-auto">
						<div className="w-full flex flex-col border border-[#15599a] p-4 shadow-lg bg-[#fff]">
							<span className="text-sm text-center font-bold text-[#15599a] uppercase py-2">INFORMAÇÕES INICIAIS</span>
							<div className="flex gap-2 justify-around flex-wrap mt-2">
								<TextInput label={"NOME DO CLIENTE"} editable={false} value={dados.nomeDoCliente} handleChange={(value) => setDados({ ...dados, nomeDoCliente: value.toUpperCase() })} />
								<TextInput
								...
								/>
								<TextInput label={"Nº DO PROJETO SVB"} editable={false} value={dados.codigoSVB ? dados.codigoSVB : ""} handleChange={(value) => setDados({ ...dados, codigoSVB: value })} />
								<SelectInput
									label={"CIDADE"}
									editable={dados.status == "REJEITADA" ? true : false}
									value={dados.cidade}
								...
								/>
								<TextInput label={"CEP"} editable={dados.status == "REJEITADA" ? true : false} value={dados.cep} handleChange={(value) => setDados({ ...dados, cep: formatCEP(value) })} />
								<TextInput
									label={"BAIRRO"}
									editable={dados.status == "REJEITADA" ? true : false}
									value={dados.bairro}
							...
							<span className="text-sm text-center font-bold text-[#15599a] uppercase py-2">EQUIPAMENTO</span>
							<div className="flex gap-2 justify-around flex-wrap mt-2">
								<SelectInput
								...
								<div className="flex flex-col w-full px-2 self-center mt-2 items-center">
									<span className="uppercase font-bold font-raleway text-center text-sm">OBSERVAÇÕES PARA VISITA</span>
									<textarea
						...
						{dados.tipoDeSolicitacao == "VISITA TÉCNICA REMOTA - URBANA" && (
							<>
								...
								<div className="w-full flex flex-col border border-[#15599a] p-4 shadow-lg bg-[#fff]">
									<span className="text-sm text-center font-bold text-[#15599a] uppercase py-2">INSTALAÇÃO</span>
									<div className="flex gap-2 items-center justify-around flex-wrap mt-2">
										<SelectInput
									...
									<div className="flex flex-col w-full px-2 self-center mt-2 items-center">
										<span className="uppercase font-bold font-raleway text-center text-sm">OBSERVAÇÕES SOBRE A INSTALAÇÃO</span>
										<textarea
											placeholder={"Descrição aqui.."}
						...
						{dados.tipoDeSolicitacao == "VISITA TÉCNICA REMOTA - RURAL" && (
							<>
								<div className="w-full flex flex-col border border-[#15599a] p-4 shadow-lg bg-[#fff]">
									<span className="text-md text-center font-bold text-[#15599a] uppercase py-2">VISITA TÉCNICA RURAL</span>
									<div className="flex flex-col items-center mt-2">
										<span className="text-sm text-center font-bold text-[#fead61] uppercase py-2">PADRÃO</span>
										<div className="flex gap-2 items-center justify-around flex-wrap mt-2">
											<SelectInput
									...
									<div className="flex flex-col items-center mt-2">
										<span className="text-sm text-center font-bold text-[#fead61] uppercase py-2">TRANSFORMADOR</span>
										<div className="flex gap-2 items-center justify-around flex-wrap mt-2">
											<SelectInput
									...
									<div className="flex flex-col items-center mt-2">
										<span className="text-sm text-center font-bold text-[#fead61] uppercase py-2">ESTRUTURA DE MONTAGEM</span>
									...
									<div className="flex flex-col items-center mt-2">
										<span className="text-sm text-center font-bold text-[#fead61] uppercase py-2">SERVIÇOS ADICIONAIS</span>
										<div className="flex gap-2 items-center justify-around flex-wrap mt-4">
											<SelectInput
						...
						{dados.tipoDeSolicitacao == "DESENHO PERSONALIZADO" && (
							<>
								<div className="w-full flex flex-col border border-[#15599a] p-4 shadow-lg bg-[#fff]">
									<span className="text-sm text-center font-bold text-[#15599a] uppercase py-2">DESENHO PERSONALIZADO</span>
									<div className="flex flex-col w-full text-sm lg:text-base items-center">
										<span className="uppercase font-bold font-raleway text-center text-sm">OBSERVAÇÕES PERTINENTES</span>
										<input
									...
									<div className="flex flex-col w-full text-sm lg:text-base items-center mt-2">
										<span className="uppercase font-bold font-raleway text-center text-sm">LOCALIZAÇÃO DO LOCAL DE INSTALAÇÃO</span>
										<input
											className={`text-xs w-full text-center uppercase text-gray-600 outline-none`}
						...
						{dados.tipoDeSolicitacao == "ORÇAMENTAÇÃO" && (
							<>
								<div className="w-full flex flex-col border border-[#15599a] p-4 shadow-lg bg-[#fff]">
									<span className="text-sm text-center font-bold text-[#15599a] uppercase py-2">ORÇAMENTAÇÃO</span>
									<div className="flex gap-2 justify-around flex-wrap mt-2">
										<SelectInput
									...
									<div className="flex flex-col w-full text-sm lg:text-base items-center mt-2">
										<span className="uppercase font-bold font-raleway text-center text-sm">DESCRIÇÃO PARA ORÇAMENTAÇÃO</span>
										<input
											className={`text-xs w-full text-center uppercase text-gray-600 outline-none`}
						...
						<div className="w-full flex flex-col border border-[#15599a] p-4 shadow-lg bg-[#fff]">
							<span className="text-md text-center font-bold text-[#15599a] uppercase py-2">ARQUIVOS</span>
							<div className="flex items-center flex-wrap gap-2 justify-around">
								{dados.links.map((link) => (
									<a key={link.link} href={link.link} className="text-blue-400 font-bold cursor-pointer">
						...
						<div className="w-full flex flex-col border border-[#15599a] p-4 shadow-lg bg-[#fff]">
							<div className="flex flex-col">
								<span className="text-sm text-center font-bold text-[#15599a] uppercase py-2">CAMPOS ADICIONAIS P/OBRAS</span>
							...
							<div className="flex flex-col">
								<span className="text-sm text-center font-bold text-[#15599a] uppercase py-2">CAMPOS ADICIONAIS P/SUPRIMENTOS</span>
                  ...
                  <p className="text-gray-600 text-xs text-center">
                    {suprimentoHolder.medida}
							...
							<div className="flex flex-col">
								<span className="text-sm text-center font-bold text-[#15599a] uppercase py-2">CAMPOS ADICIONAIS P/PROJETOS</span>
								...
								<div className="flex flex-col w-full self-center mt-2 items-center">
									<span className="uppercase font-bold font-raleway text-center text-sm">OBSERVAÇÕES P/PROJETOS</span>
									<textarea
								...
								<div className="flex flex-col w-full self-center mt-2 items-center">
									<span className="uppercase font-bold font-raleway text-center text-sm">DESCRITIVO</span>
									...
									<div className="flex items-center flex-col h-[100px] border border-gray-300 w-full my-2 p-2 overflow-y-auto overscroll-y-auto">
										{dados.descritivo?.length ? (
											dados.descritivo?.map((item, index) => (
												<div key={index} className="grid grid-cols-10 gap-3 w-full items-center">
													<p className="text-xxs lg:text-xs text-[#15599a] font-bold col-span-1">{item.topico}</p>
													<p className={`${item.texto.length > 100 ? "text-xxs" : "text-xs"} text-gray-600 font-bold text-center col-span-8`}>{item.texto}</p>
													<div
														onClick={() => {
							...
							<div className="flex flex-col">
								<span className="text-sm text-center font-bold text-[#15599a] uppercase py-2">RESPOSTA VISITA TÉCNICA</span>
								...
								<div className="flex flex-col w-full self-center mt-2 items-center">
									<span className="uppercase font-bold font-raleway text-center text-sm">CONCLUSÃO</span>
									<textarea
							...
							<div className="flex flex-col">
								<span className="text-sm text-center font-bold text-[#15599a] uppercase py-2">CUSTOS ADICIONAIS</span>
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <p className="text-gray-600 text-xs text-center">
                      ...
                      {(custoAdicionalHolder.qtde * custoAdicionalHolder.valor)
                        ...
                        .replace(".", ",")}
								...
								<div className="flex flex-col mx-12 mt-2 gap-2">
									<div className="grid grid-cols-5 w-full">
										<p className="text-md text-[#fead61] font-bold text-center">DESCRIÇÃO</p>
										<p className="text-md text-[#fead61] font-bold text-center">QUANTIDADE</p>
										<p className="text-md text-[#fead61] font-bold text-center">GRANDEZA</p>
										<p className="text-md text-[#fead61] font-bold text-center">VALOR</p>
										<p className="text-md text-[#fead61] font-bold text-center">VALOR TOTAL</p>
									</div>
									{dados.custosAdicionais?.map((custo, index) => (
										<div key={index} className="grid grid-cols-5 w-full">
											<p className="text-xs text-gray-600 font-bold text-center">{custo.descricao}</p>
											<p className="text-xs text-gray-600 font-bold text-center">{custo.qtde}</p>
											<p className="text-xs text-gray-600 font-bold text-center">{custo.grandeza}</p>
											<p className="text-xs text-gray-600 font-bold text-center">{custo.valor}</p>
											<p className="text-xs text-gray-600 font-bold text-center">{(custo.valor * custo.qtde).toFixed(2)}</p>
										</div>
									))}
								</div>
							</div>
						...
						<div className="flex flex-col items-center">
							<span className="text-sm text-center font-bold text-[#15599a] uppercase py-2">ESTUDO DE GERAÇÃO - DESVIO AZIMUTAL</span>
							<div className="grid grid-cols-2 grid-rows-4">
								...
								<div className="grid grid-cols-3 items-center">
									<p className="text-center font-bold text-gray-700">NORDESTE</p>
									<input
										className="outline-none p-2 text-center font-bold text-gray-700"
										type={"number"}
										readOnly={true}
								...
								<div className="grid grid-cols-3 items-center">
									<p className="text-center font-bold text-gray-700">SUDOESTE</p>
									<input
										className="outline-none p-2 text-center font-bold text-gray-700"
										type={"number"}
										readOnly={true}
								...
								<div className="grid grid-cols-3 items-center">
									<p className="text-center font-bold text-gray-700">NOROESTE</p>
									<input
										className="outline-none p-2 text-center font-bold text-gray-700"
										type={"number"}
										readOnly={true}
						...
						<div className="w-full flex flex-col items-center justify-center gap-2 border border-[#15599a] p-4 shadow-lg bg-[#fff]">
							<span className="text-sm text-center font-bold text-[#15599a] uppercase py-2">IMAGEM PARA VISUALIZAÇÃO DO PROJETO</span>
						...
						{dados.status == "CONCLUIDO" ? (
							<div className="w-full flex items-center justify-center gap-2 border border-[#15599a] p-4 shadow-lg bg-[#fff]">
								...
								<Link href={`/projetos/laudo/pdf/${dados._id}?tipo=${laudoType}`}>
									<button className="p-2 rounded bg-[#fead61] font-bold hover:bg-[#15599a] hover:text-white">LAUDO</button>
								</Link>
							</div>
						) : null}
						...
						<div className="w-full flex items-center justify-center gap-2">
							{!dados.solicitacaoContrato && (
								<Link href={`/publico/formSolicitacao?cliente=${dados.nomeDoCliente}-${dados.codigoSVB}&id=${dados._id}`}>
									<button className="p-2 rounded bg-[#fead61] font-bold hover:bg-[#15599a] hover:text-white">SOLICITAR CONTRATO</button>
								</Link>
							)}
						</div>
					</div>
