...
function NPSCard({ project }: NPSCardProps) {
	...
	return (
		<div className="flex w-[450px] items-center rounded-md border border-gray-300">
			...
			<div className="flex grow flex-col p-3">
				...
				<div className="w-full">
					<textarea value={obsNps || undefined} onChange={(e) => setObsNps(e.target.value)} className="h-[50px] w-full resize-none bg-gray-100 p-2 text-center outline-none" />
				</div>
