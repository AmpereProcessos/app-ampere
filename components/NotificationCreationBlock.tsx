...
function NotificationCreationBlock({
  session,
  codProjeto,
  nomeDoProjeto,
}: NotificationCreationBlockProps) {
          ...
          >
            <div className="flex w-full flex-col self-center lg:w-[50%]">
              <div className="flex w-full items-center justify-center gap-2">
                ...
                <div className="flex items-center justify-center gap-2">
                  ...
                  <p className="text-foreground text-xs font-medium">
                    {session.user.nome || "Autor não identificado"}
                  </p>
                </div>
              </div>
              ...
              <div className="flex w-full items-center justify-end">
                <LoadingButton onClick={() => handleNotificationCreationMutation(infoHolder)}>
                  ENVIAR
                </LoadingButton>
              </div>
            </div>
