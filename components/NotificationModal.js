    ...
    <div style={MODAL_STYLES}>
      <div className="w-full flex flex-col h-full border border-gray-200 py-2 px-1 shadow-xl">
        <div className="flex items-center justify-between  border-b border-gray-200 pb-2">
          ...
          <VscChromeClose onClick={() => setNotificationIsOpen(false)} style={{ color: 'red', cursor: 'pointer' }} />
        </div>

        {info.destinatario && (
          <div className="flex flex-col items-center my-2 w-full">
            <h1 className="text-xs text-[#15599a] text-center italic">
              Informações para resposta sobre o projeto: <strong>{info.projetoReferencia}</strong>
            </h1>
                ...
                <div className="flex items-center justify-between pr-2 gap-2 mt-1">
                  <div>
                    <p className="text-xs text-gray-500">
                      {notificacao.dataDeEnvio ? dayjs(notificacao.dataDeEnvio).format('DD/MM/YYYY HH:mm') : null}
                    </p>
                  </div>
