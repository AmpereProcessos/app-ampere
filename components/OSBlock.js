...
function OSBlock({ order, clientName, index, projectID, getOSS }) {
  ...
  return (
    <div className="flex flex-col">
      <div className={`border-primary/20 grid grid-cols-4 items-start border-b py-2 lg:grid-cols-6`}>
        <div className="hidden flex-col items-center justify-center lg:flex">
          <p className="text-primary/60 text-xs">EMISSOR</p>
          <p className="text-primary/70 text-xs font-bold uppercase">{order.usuarioEmissor}</p>
        </div>
        <div className="hidden flex-col items-center justify-center lg:flex">
          <p className="text-primary/60 text-xs">CATEGORIA</p>
          <p className="text-primary/70 text-xs font-bold">{order.categoria}</p>
        </div>
        <div className="flex flex-col items-center justify-center">
          <p className="text-primary/60 text-xs">SERVIÇO</p>
          <p className="text-xxs text-primary/70 text-center font-bold lg:text-xs">{order.servicoExecutado}</p>
        </div>
        ...
        <div className="flex items-center justify-center">
          {closedDateHolder ? (
            <div className="flex flex-col items-center justify-center">
              <p className="text-primary/60 text-center text-xs">DATA DE FECHAMENTO</p>
              <p className="text-xxs text-primary/70 text-center font-bold lg:text-xs">
            ...
            <button
              onClick={closeOS}
              className="h-[30px] rounded border border-green-500 p-1 font-bold text-green-500 hover:bg-green-500 hover:text-white"
            >
              <TbCheckbox />
            </button>
          )}
        ...
        <div className="flex flex-col items-center justify-center">
          <button
            ...
            className="h-[30px] rounded border border-[#15599a] p-1 font-bold text-[#15599a] hover:bg-[#15599a] hover:text-white"
          >
            <FiEdit />
          </button>
        </div>
