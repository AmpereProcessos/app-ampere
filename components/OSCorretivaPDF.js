 ...
 */
function OSCorretivaPDF({ order }) {
  return (
    <div className="w-[21cm] h-[29.7cm]  p-4 px-12">
      <h1 className="text-center font-bold text-xl mb-6">ORDEM DE SERVIÇO - {order.categoria}</h1>
      <div className="grid grid-cols-2">
        ...
        <div className="flex flex-col justify-center gap-y-2 border border-black pl-2">
          <div className="flex justify-between border-black border-b">
            ...
            <p className="text-xs text-center pr-2">{order.dataInsercao ? new Date(order.dataInsercao).toLocaleDateString('pt-br') : '-'}</p>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-2 gap-x-2 px-6 pb-2">
            <div className="grid grid-rows-4">
              <div className="row-span-2 grid grid-cols-5">
                ...
                <p className="text-xs col-span-3 text-center border border-black">{order.detalhes.tipoEstrutura || '-'}</p>
              </div>
              <div className="row-span-2 grid grid-cols-5">
                ...
                <p className="text-xs text-center col-span-3 border border-black border-t-0">
                  {order.detalhes.tipoTelha ? order.detalhes.tipoTelha : '-'}{' '}
                </p>
              </div>
            </div>
            <div className="grid grid-rows-4">
              ...
              <div className="row-span-2 grid grid-cols-4 h-full items-center">
                <p className="text-xs col-span-2 text-center font-semibold uppercase">TOPOLOGIA</p>
