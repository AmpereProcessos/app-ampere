 ...
 */
function PadraoOSPDF({ order }) {
  return (
    <div className="w-[21cm] h-[29.7cm]  p-4 px-12">
      <h1 className="text-center font-bold text-xl mb-6">ORDEM DE SERVIÇO DE PADRÃO</h1>
      <div className="grid grid-cols-2">
        ...
        <div className="flex flex-col justify-center gap-y-2 border border-black pl-2">
          <div className="flex justify-between border-black border-b">
            ...
            <p className="text-xs text-center pr-2">{order.dataInsercao ? new Date(order.dataInsercao).toLocaleDateString('pt-br') : null}</p>
          </div>
          {/*<div className="flex justify-between border-black border-b">
        ...
        <div className="grid grid-cols-2 gap-x-2 px-6 pb-2">
          <div className="grid-rows-3">
            <div className="grid grid-cols-4">
              ...
              <p className="text-xs col-span-3 text-center border border-black">{order.favorecido.nome}</p>
            </div>
            <div className="grid grid-cols-4">
