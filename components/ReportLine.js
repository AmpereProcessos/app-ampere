  ...
  return (
    <div className="w-full flex flex-col py-1">
      <div className="w-full flex flex-col lg:flex-row items-center justify-between pr-2">
        ...
        <p className="text-xs text-center lg:text-sm font-medium text-gray-700 w-full lg:w-[20%]">
          RELATÓRIO Nº {count}
        </p>
      ...
      {showInfo ? (
        <div className="w-full flex flex-col items-center border-t border-gray-200 pt-1 mt-1">
          <div className="flex flex-col items-center w-full">
            <h1 className="text-sm font-normal text-gray-600 mb-1">
          ...
          <div className="w-full flex flex-col p-2 mt-4 lg:mt-2">
            <h1 className="text-sm font-extralight text-gray-600 mb-1 text-center">
              ANOTAÇÕES
            </h1>
            <p className="w-full text-center text-xs text-gray-800 bg-gray-100 font-thin border border-gray-200 p-2">
              {report.anotacoes
                ? report.anotacoes
                : "Sem anotações preenchidas."}
            </p>
          </div>
        </div>
      ) : null}
