  ...
  return (
    ...
    >
      <select
        ...
        className="flex py-2.5 text-center px-0 w-full text-sm text-gray-900 bg-transparent font-mono border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
      >
        {options &&
