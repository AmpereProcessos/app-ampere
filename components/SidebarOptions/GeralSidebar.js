...
import { BsFolderPlus, BsFillPatchCheckFill } from "react-icons/bs";
...
function GeralSidebar({
  ...
  function checkRoute(route, operationalOnly) {
    if (operationalOnly) {
      return (
        userAccessibleRoutes?.includes(route) && userVisualization == undefined
      );
    }
  ...
  console.log("ACCESSIBLE ROUTES", userAccessibleRoutes);
  return (
    <>
      <div>
