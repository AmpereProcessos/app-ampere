...
export const AppRoutes: TAppRouteGroup[] = [
  {
    title: "PRINCIPAL",
    icon: <Diamond className="h-4 min-h-4 w-4 min-w-4 text-foreground" />,
    items: [
      {
        title: "Dashboard",
        path: "/",
      ...
      },
      {
        ...
        checkUserAccess: (session: TAuthSession) => true,
        icon: (
          <TbRecharging className="h-4 min-h-4 w-4 min-w-4 text-[#15599a] dark:text-[#fead42]" />
        ),
      },
      {
  ...
  {
    title: "SETORES",
    icon: <FolderTree className="h-4 min-h-4 w-4 min-w-4 text-foreground" />,
    items: [
      {
        title: "Comercial",
        path: "/comercial",
        ...
        icon: (
          <BadgeDollarSign className="h-4 min-h-4 w-4 min-w-4 text-[#15599a] dark:text-[#fead42]" />
        ),
      },
      {
        title: "Suprimentos",
        ...
        icon: (
          <ShoppingCart className="h-4 min-h-4 w-4 min-w-4 text-[#15599a] dark:text-[#fead42]" />
        ),
      },
      {
        title: "Projetos",
        ...
        icon: (
          <MdEngineering className="h-4 min-h-4 w-4 min-w-4 text-[#15599a] dark:text-[#fead42]" />
        ),
      },
      {
        title: "Obras",
      ...
      },
      {
        ...
        icon: (
          <FaSolarPanel className="h-4 min-h-4 w-4 min-w-4 text-[#15599a] dark:text-[#fead42]" />
        ),
      },
      {
        title: "Pós-Venda",
      ...
      },
      {
        ...
        icon: (
          <BsFolderPlus className="h-4 min-h-4 w-4 min-w-4 text-[#15599a] dark:text-[#fead42]" />
        ),
      },
      {
        title: "Almoxarifado",
  ...
  {
    title: "OUTROS",
    icon: <List className="h-4 min-h-4 w-4 min-w-4 text-foreground" />,
    items: [
      {
        title: "Chats",
        path: "/chats",
        ...
        icon: (
          <MessageCircle className="h-4 min-h-4 w-4 min-w-4 text-[#15599a] dark:text-[#fead42]" />
        ),
      },
      {
        title: "Chamados",
      ...
      },
      {
        ...
        checkUserAccess: (session: TAuthSession) =>
          session.user.permissoes.administrativo.visualizar,
        icon: (
          <AiOutlinePercentage className="h-4 min-h-4 w-4 min-w-4 text-[#15599a] dark:text-[#fead42]" />
        ),
      },
      {
        title: "Entregas",
        ...
        icon: (
          <TbTruckDelivery className="h-4 min-h-4 w-4 min-w-4 text-[#15599a] dark:text-[#fead42]" />
        ),
      },
      {
        title: "Banco de OS",
        ...
        icon: (
          <MdDesignServices className="h-4 min-h-4 w-4 min-w-4 text-[#15599a] dark:text-[#fead42]" />
        ),
      },

      {
        ...
        checkUserAccess: (session: TAuthSession) => session.user.permissoes.posVenda.visualizar,
        icon: (
          <BsShieldFillCheck className="h-4 min-h-4 w-4 min-w-4 text-[#15599a] dark:text-[#fead42]" />
        ),
      },
      {
        title: "Monitoramento",
        ...
        checkUserAccess: (session: TAuthSession) => session.user.permissoes.suporte.visualizar,
        icon: (
          <BsSpeedometer2 className="h-4 min-h-4 w-4 min-w-4 text-[#15599a] dark:text-[#fead42]" />
        ),
      },
      {
        ...
        checkUserAccess: (session: TAuthSession) =>
          ...
          session.user.permissoes.ordensDeServico.visualizar,
        icon: (
          <MdOutlineBuildCircle className="h-4 min-h-4 w-4 min-w-4 text-[#15599a] dark:text-[#fead42]" />
        ),
      },
      {
        ...
        checkUserAccess: (session: TAuthSession) => session.user.permissoes.posVenda.visualizar,
        icon: (
          <BsCalendar2Week className="h-4 min-h-4 w-4 min-w-4 text-[#15599a] dark:text-[#fead42]" />
        ),
      },
      {
        title: "NPS",
        ...
        checkUserAccess: (session: TAuthSession) => session.user.permissoes.posVenda.visualizar,
        icon: (
          <BsFillPatchCheckFill className="h-4 min-h-4 w-4 min-w-4 text-[#15599a] dark:text-[#fead42]" />
        ),
      },
    ],
  },
...
function GeralSidebar({ session }: GeralSidebarProps) {
  return (
    <div className="flex flex-col gap-4">
      {AppRoutes.map((group) => (
        <div key={group.title} className="flex flex-col gap-2">
          <div className="flex items-center gap-1">
            {group.icon}
            <h2 className="text-foreground text-xs">{group.title}</h2>
          </div>
          {group.items
            ...
            .map((item) => (
              <Button key={item.title} asChild variant="ghost">
                <Link
                  href={item.path}
                  className="w-full flex items-center justify-start gap-2 hover:bg-primary/10"
                >
                  {item.icon}
      ...
      {/* <div className="mt-6">
				<h2 className="text-foreground text-xs">GESTÃO DE PROJETOS</h2>
				<Link href="/gestao-de-projetos/emAndamento">
					<div className="dark:hover:bg-primary/10 mt-2 flex cursor-pointer items-center py-2 pl-2 duration-300 ease-in hover:scale-105 hover:bg-blue-100">
						...
						<p className="text-foreground pl-3 text-xs">Em andamento</p>
					</div>
				</Link>
				...
				<Link href="/gestao-de-projetos/banco-de-dados">
					<div className="dark:hover:bg-primary/10 mt-2 flex cursor-pointer items-center py-2 pl-2 duration-300 ease-in hover:scale-105 hover:bg-blue-100">
						...
						<p className="text-foreground pl-3 text-xs">Banco de dados</p>
					</div>
				</Link>
			</div>
					...
					{checkRoute("PPS") ? (
						<Link href="/comercial">
							<div className="dark:hover:bg-primary/10 mt-2 flex cursor-pointer items-center py-2 pl-2 duration-300 ease-in hover:scale-105 hover:bg-blue-100">
								...
								<p className="text-foreground pl-3 text-xs">Comercial</p>
							</div>
						</Link>
					) : (
						false
					...
					{checkRoute("Suprimentos") ? (
						<Link href="/suprimentos">
							<div className="dark:hover:bg-primary/10 mt-2 flex cursor-pointer items-center py-2 pl-2 duration-300 ease-in hover:scale-105 hover:bg-blue-100">
								...
								<p className="text-foreground pl-3 text-xs">Suprimentos</p>
							</div>
						</Link>
					) : (
						false
					...
					{checkRoute("Obras") ? (
						<Link href="/obras">
							<div className="dark:hover:bg-primary/10 mt-2 flex cursor-pointer items-center py-2 pl-2 duration-300 ease-in hover:scale-105 hover:bg-blue-100">
								...
								<p className="text-foreground pl-3 text-xs">Obras</p>
							</div>
						</Link>
					) : (
						false
					...
					{checkRoute("O&M") ? (
						<Link href="/oem">
							<div className="dark:hover:bg-primary/10 mt-2 flex cursor-pointer items-center py-2 pl-2 duration-300 ease-in hover:scale-105 hover:bg-blue-100">
								...
								<p className="text-foreground pl-3 text-xs">O&M</p>
							</div>
						</Link>
					) : (
						false
					...
					{checkRoute("Pós-Venda") ? (
						<Link href="/posvenda">
							<div className="dark:hover:bg-primary/10 mt-2 flex cursor-pointer items-center py-2 pl-2 duration-300 ease-in hover:scale-105 hover:bg-blue-100">
								...
								<p className="text-foreground pl-3 text-xs">Pós-Venda</p>
							</div>
						</Link>
					) : (
						false
					...
					{session.user.permissoes.recursosHumanos.visualizar ? (
						<Link href="/adm/colaboradores">
							<div className="dark:hover:bg-primary/10 mt-2 flex cursor-pointer items-center py-2 pl-2 duration-300 ease-in hover:scale-105 hover:bg-blue-100">
								...
								<p className="text-foreground pl-3 text-xs">RH</p>
							</div>
						</Link>
					) : null}
					{checkRoute("ADM") ? (
						<Link href="/adm">
							<div className="dark:hover:bg-primary/10 mt-2 flex cursor-pointer items-center py-2 pl-2 duration-300 ease-in hover:scale-105 hover:bg-blue-100">
								...
								<p className="text-foreground pl-3 text-xs">ADM</p>
							</div>
						</Link>
					) : null}
				</div>
				<div className="mt-6">
					<h2 className="text-foreground text-xs">OUTROS</h2>

					{session.user.permissoes.chats.visualizar ? (
						<Link href="/chats">
							<div className="dark:hover:bg-primary/10 mt-2 flex cursor-pointer items-center py-2 pl-2 duration-300 ease-in hover:scale-105 hover:bg-blue-100">
								<MessageCircle className="dark:text-primary h-4 min-h-4 w-4 min-w-4 text-[#15599a]" />
								<p className="text-foreground pl-3 text-xs">Chats</p>
							</div>
						</Link>
					) : null}
					{session.user.permissoes.suporte.visualizar || session.user.permissoes.posVenda.visualizar ? (
						<Link href={"/oem/comissionamento"}>
							<div className="dark:hover:bg-primary/10 mt-2 flex cursor-pointer items-center py-2 pl-2 duration-300 ease-in hover:scale-105 hover:bg-blue-100">
								...
								<p className="text-foreground pl-3 text-xs">Comissionamento Pós-Obra</p>
							</div>
						</Link>
					) : (
						false
					...
					{session.user.permissoes.suporte.visualizar || session.user.permissoes.posVenda.visualizar ? (
						<Link href="/posvenda/nutricao">
							<div className="dark:hover:bg-primary/10 mt-2 flex cursor-pointer items-center py-2 pl-2 duration-300 ease-in hover:scale-105 hover:bg-blue-100">
								...
								<p className="text-foreground pl-3 text-xs">Nutrição Pós-Venda</p>
							</div>
						</Link>
					) : (
						false
					...
					{session.user.permissoes.certificacoes.visualizar ? (
						<Link href="/certificacoes">
							<div className="dark:hover:bg-primary/10 mt-2 flex cursor-pointer items-center py-2 pl-2 duration-300 ease-in hover:scale-105 hover:bg-blue-100">
								...
								<p className="text-foreground pl-3 text-xs">Certificações</p>
							</div>
						</Link>
					) : null}
					<Link href="/calls">
						<div className="dark:hover:bg-primary/10 mt-2 flex cursor-pointer items-center py-2 pl-2 duration-300 ease-in hover:scale-105 hover:bg-blue-100">
							...
							<p className="text-foreground pl-3 text-xs">Chamados</p>
						</div>
					</Link>
					{session.user.permissoes.administrativo.visualizar ? (
						<Link href="/admin/auditoria-financeira">
							<div className="dark:hover:bg-primary/10 mt-2 flex cursor-pointer items-center py-2 pl-2 duration-300 ease-in hover:scale-105 hover:bg-blue-100">
								...
								<p className="text-foreground pl-3 text-xs">Auditoria Financeira</p>
							</div>
						</Link>
					) : null}
					...
					{session.user.permissoes.suprimentos.visualizar ? (
						<Link href="/suprimentos/solicitacoesCompra">
							<div className="dark:hover:bg-primary/10 mt-2 flex cursor-pointer items-center py-2 pl-2 duration-300 ease-in hover:scale-105 hover:bg-blue-100">
								...
								<p className="text-foreground pl-3 text-xs">Solicitações de Compra</p>
							</div>
						</Link>
					) : (
						false
					...
					{(userIsManager || session.user.permissoes.administrativo.visualizar || session.user.permissoes.recursosHumanos.visualizar) && (
						<Link href="/admin/comissao">
							<div className="dark:hover:bg-primary/10 mt-2 flex cursor-pointer items-center py-2 pl-2 duration-300 ease-in hover:scale-105 hover:bg-blue-100">
								...
								<p className="text-foreground pl-3 text-xs">Comissões</p>
							</div>
						</Link>
					)}
					{session.user.permissoes.suprimentos.visualizar || session.user.permissoes.posVenda.visualizar ? (
						<Link href="/suprimentos/entregas">
							<div className="dark:hover:bg-primary/10 mt-2 flex cursor-pointer items-center py-2 pl-2 duration-300 ease-in hover:scale-105 hover:bg-blue-100">
								...
								<p className="text-foreground pl-3 text-xs">Entregas</p>
							</div>
						</Link>
					) : (
						false
					...
					{session.user.permissoes.ordensDeServico.visualizar ? (
						<Link href={"/ordens-de-servico"}>
							<div className="dark:hover:bg-primary/10 mt-2 flex cursor-pointer items-center py-2 pl-2 duration-300 ease-in hover:scale-105 hover:bg-blue-100">
								...
								<p className="text-foreground pl-3 text-xs">Banco de OS</p>
							</div>
						</Link>
					) : (
						false
					...
					{session.user.permissoes.almoxarifado.visualizar ? (
						<Link href={"/almoxarifado"}>
							<div className="dark:hover:bg-primary/10 mt-2 flex cursor-pointer items-center py-2 pl-2 duration-300 ease-in hover:scale-105 hover:bg-blue-100">
								...
								<p className="text-foreground pl-3 text-xs">Almoxarifado</p>
							</div>
						</Link>
					) : (
						false
					...
					{session.user.permissoes.posVenda.visualizar ? (
						<Link href="/seguro-fotovoltaico">
							<div className="dark:hover:bg-primary/10 mt-2 flex cursor-pointer items-center py-2 pl-2 duration-300 ease-in hover:scale-105 hover:bg-blue-100">
								...
								<p className="text-foreground pl-3 text-xs">Seguro Fotovoltaico</p>
							</div>
						</Link>
					) : (
						false
					...
					{session.user.permissoes.suporte.visualizar ? (
						<Link href="/oem/monitoramento">
							<div className="dark:hover:bg-primary/10 mt-2 flex cursor-pointer items-center py-2 pl-2 duration-300 ease-in hover:scale-105 hover:bg-blue-100">
								...
								<p className="text-foreground pl-3 text-xs">Monitoramento</p>
							</div>
						</Link>
					) : (
						false
					...
					{session.user.permissoes.execucao.visualizar || session.user.permissoes.ordensDeServico.visualizar ? (
						<Link href="/obras/gestao-obras">
							<div className="dark:hover:bg-primary/10 mt-2 flex cursor-pointer items-center py-2 pl-2 duration-300 ease-in hover:scale-105 hover:bg-blue-100">
								...
								<p className="text-foreground pl-3 text-xs">Gestão de Obras</p>
							</div>
						</Link>
					) : (
						false
					...
					{session.user.permissoes.posVenda.visualizar ? (
						<Link href="/posvenda/nps">
							<div className="dark:hover:bg-primary/10 mt-2 flex cursor-pointer items-center py-2 pl-2 duration-300 ease-in hover:scale-105 hover:bg-blue-100">
								...
								<p className="text-foreground pl-3 text-xs">NPS</p>
							</div>
						</Link>
					) : (
						false
