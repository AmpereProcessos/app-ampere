...
import FormSolicitacaoDadosInstalacaoRemontagem from "./FormSolicitacaoDadosInstalacaoRemontagem";
import VisualizacaoFormMontagemDesmontagem from "./VisualizacaoFormMontagemDesmontagem";
import FormSolicitacaoEquipamentosMontagemDesmontagem from "./FormSolicitacaoEquipamentosMontagemDesmontagem";
import FormSolicitacaoDadosEstruturaMontagemDesmontagem from "./FormSolicitacaoDadosEstruturaMontagemDesmontagem";
function SolicitacaoMontagemDesmontagem({
  cliente,
  links,
  formVisitaId,
  tipoDeServico,
  ...
  return (
    <>
      ...
      {estagio == 2 && (
        <FormSolicitacaoDadosInstalacaoRemontagem
          voltar={() => setEstagio(estagio - 1)}
          avancar={() => setEstagio(estagio + 1)}
          dados={dados}
          setDados={setDados}
      ...
      {estagio == 3 && (
        <FormSolicitacaoEquipamentosMontagemDesmontagem
          voltar={() => setEstagio(estagio - 1)}
          avancar={() => setEstagio(estagio + 1)}
          dados={dados}
          setDados={setDados}
      ...
      {estagio == 4 && (
        <FormSolicitacaoDadosEstruturaMontagemDesmontagem
          voltar={() => setEstagio(estagio - 1)}
          avancar={() => setEstagio(estagio + 1)}
          dados={dados}
          setDados={setDados}
      ...
      {estagio == 9 && (
        <VisualizacaoFormMontagemDesmontagem
          dados={dados}
          setDados={setDados}
...
export default SolicitacaoMontagemDesmontagem;
