...
export default function EditableTextCell({
	...
	const displayButton = (
		<button
			...
			className={cn(
				"h-8 w-full truncate rounded-md px-2 text-xs text-foreground/80 transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring/40",
				alignClass,
