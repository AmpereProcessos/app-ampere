...
function VendedorMetaCard({ vendedor, ano, getVendedoresInfo }) {
	...
	return (
		<div className={`grid grid-cols-14 ${opConcluded ? "bg-green-300" : "bg-[#fff]"} items-center border border-gray-300 w-full`}>
			<div className={`p-1 font-bold flex items-center justify-center text-center text-xxs lg:text-xs text-gray-600 border-r border-gray-300 h-[60px]`}>{infoHolder.nome}</div>
			<div className={`p-1 font-bold flex flex-col items-center justify-center text-center text-xxs lg:text-xs text-gray-600 border-r border-gray-300 h-[60px]`}>
				<input
			...
			<div className={`p-1 font-bold flex flex-col items-center justify-center text-center text-xxs lg:text-xs text-gray-600 border-r border-gray-300 h-[60px]`}>
				<button onClick={() => handleChanges(infoHolder._id)} className="flex items-center gap-x-2 bg-[#15599a] hover:bg-blue-500 p-1 text-white font-bold rounded text-sm">
					SALVAR <FaSave />
				</button>
			</div>
		</div>
