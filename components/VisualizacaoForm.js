...
function VisualizacaoForm({ dados, voltar, setDados, formVisitaId, linksVisita }) {
  ...
  return (
    <>
      ...
      <div className="bg-background flex w-full flex-col border border-[#15599a] pb-2 shadow-lg">
        <span className="py-2 text-center text-sm font-bold text-[#15599a] uppercase">DADOS PARA ENTRADA NA CEMIG</span>
        <div className="flex flex-wrap justify-around gap-2">
          <TextInput
      ...
      <div className="bg-background flex w-full flex-col border border-[#15599a] pb-2 shadow-lg">
        ...
        {dados.tipoDeServico == 'AUMENTO DE SISTEMA FOTOVOLTAICO' && dados.clienteAmpere != 'SIM' ? (
          <>
            <span className="mt-1 border-t border-blue-500 py-2 text-center text-sm font-bold text-[#fead61] uppercase">
            ...
            <div className="border-primary/20 mt-2 flex flex-wrap justify-around gap-2 border-t py-2">
              <TextInput
            ...
            <div className="flex flex-col items-center text-sm lg:text-base">
              ...
              <p className="text-primary/80 w-full text-center text-xs outline-hidden">
                {getJoinedInfo({
            ...
            <div className="flex flex-col items-center text-sm lg:text-base">
              <span className="font-raleway text-center text-sm font-bold uppercase">INFORMAÇÃO MÓDULOS (ANTERIOR)</span>
              <p className="text-primary/80 w-full text-center text-xs outline-hidden">
                {getJoinedInfo({
