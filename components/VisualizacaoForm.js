...
function VisualizacaoForm({ dados, voltar, setDados, formVisitaId, linksVisita }) {
		...
		<>
			...
			<div className="w-full flex flex-col border border-[#15599a] pb-2 shadow-lg bg-[#fff]">
				...
				<div className="flex gap-2 justify-around flex-wrap">
					...
					/>
					<TextInput label={"NºPROJETO SVB"} editable={true} value={dados.codigoSVB} handleChange={(value) => setDados({ ...dados, codigoSVB: value })} />
					<SelectInput
						label={"ESTADO CIVIL"}
						editable={true}
						options={[
			...
			<div className="w-full flex flex-col border border-[#15599a] pb-2 shadow-lg bg-[#fff]">
				<span className="text-sm text-center font-bold text-[#15599a] uppercase py-2">DADOS PARA ENTRADA NA CEMIG</span>
				<div className="flex gap-2 justify-around flex-wrap">
					<TextInput
					...
					/>
					<TextInput label={"CEP INSTALAÇÃO"} editable={true} value={dados.cepInstalacao} handleChange={(value) => setDados({ ...dados, cepInstalacao: formatCEP(value) })} />
					<button onClick={() => findCPF("enderecoInstalacao")} className="flex items-center p-1 h-[30px] bg-[#fead61] rounded">
						<AiOutlineSearch />
					</button>
					<TextInput label={"ENDEREÇO DE INSTALAÇÃO"} editable={true} value={dados.enderecoInstalacao} handleChange={(value) => setDados({ ...dados, enderecoInstalacao: value })} />
					...
					<TextInput label={"BAIRRO"} editable={true} value={dados.bairroInstalacao} handleChange={(value) => setDados({ ...dados, bairroInstalacao: value })} />
					<SelectInput
						label={"CIDADE"}
						editable={true}
					...
					/>
					<TextInput label={"LATITUDE"} editable={true} value={dados.latitude} handleChange={(value) => setDados({ ...dados, latitude: value })} />
					...
					/>
					<NumberInput label={"GERAÇÃO PREVISTA"} editable={true} value={dados.geracaoPrevista} handleChange={(value) => setDados({ ...dados, geracaoPrevista: value })} />
				</div>
			</div>
			<div className="w-full flex flex-col border border-[#15599a] pb-2 shadow-lg bg-[#fff]">
				...
				{dados.tipoDeServico == "AUMENTO DE SISTEMA FOTOVOLTAICO" && dados.clienteAmpere != "SIM" ? (
					<>
						<span className="text-sm text-center font-bold text-[#fead61] uppercase py-2 border-t border-blue-500 mt-1">DADOS DO SISTEMA (ANTERIOR)</span>
						<div className="flex justify-center">
							<SelectInput
						...
						<div className="flex gap-2 justify-around flex-wrap mt-2 py-2 border-t border-gray-300">
							<TextInput
