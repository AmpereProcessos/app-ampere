  ...
  return (
    <>
      ...
      <div className="bg-background flex w-full flex-col border border-[#15599a] pb-2 shadow-lg">
        ...
        <div className="mt-3 flex flex-col gap-x-2 gap-y-1 lg:grid lg:grid-cols-3">
          <h1 className="col-span-3 py-2 text-center font-bold text-[#fead61]">DRIVER</h1>
          <div className="flex items-center justify-center">
            <TextFloatingInput
        ...
        <div className="mt-3 flex flex-col gap-x-2 gap-y-1 lg:grid lg:grid-cols-3">
          <h1 className="col-span-3 py-2 text-center font-bold text-[#fead61]">MÓDULOS</h1>
          <div className="flex items-center justify-center">
            <TextFloatingInput
        ...
        <div className="border-primary/20 flex flex-col border-t p-2">
          <h1 className="py-2 text-center font-bold text-[#fead61]">BATERIAS</h1>
