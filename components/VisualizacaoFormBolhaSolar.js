...
function VisualizacaoFormBombaSolar({ dados, voltar, setDados, formVisitaId, linksVisita }) {
		...
		<>
			...
			<div className="w-full flex flex-col border border-[#15599a] pb-2 shadow-lg bg-[#fff]">
				...
				<div className="flex flex-col lg:grid lg:grid-cols-3 gap-2 justify-around flex-wrap p-2">
					...
					<div className="flex items-center justify-center">
						<TextFloatingInput width={"450px"} label={"TELEFONE"} editable={true} value={dados.telefone} handleChange={(value) => setDados({ ...dados, telefone: phoneMask(value) })} />
					</div>
					<div className="flex items-center justify-center">
						<TextFloatingInput
							width={"450px"}
					...
					<div className="flex items-center justify-center">
						<TextFloatingInput width={"450px"} label={"RG"} editable={true} value={dados.rg} handleChange={(value) => setDados({ ...dados, rg: value })} />
					</div>
					<div className="flex items-center justify-center">
						<DateFloatingInput
							width={"450px"}
					...
					<div className="flex items-center justify-center">
						<TextFloatingInput width={"450px"} label={"EMAIL"} editable={true} normalCase={true} value={dados.email} handleChange={(value) => setDados({ ...dados, email: value })} />
					</div>
					<div className="flex items-center justify-center">
						<TextFloatingInput
							width={"450px"}
					...
					<div className="flex items-center justify-center">
						<TextFloatingInput width={"450px"} label={"ONDE TRABALHA"} editable={true} value={dados.ondeTrabalha} handleChange={(value) => setDados({ ...dados, ondeTrabalha: value })} />
					</div>
					...
					<div className="flex items-center justify-center gap-2 flex-wrap">
						<TextFloatingInput width={"450px"} label={"CEP"} editable={true} value={dados.cep} handleChange={(value) => setDados({ ...dados, cep: formatCEP(value) })} />
					</div>
					<div className="flex items-center justify-center">
						<SelectFloatingInput
							width={"450px"}
					...
					<div className="flex items-center justify-center">
						<TextFloatingInput width={"450px"} label={"UF"} editable={true} value={dados.uf} handleChange={(value) => setDados({ ...dados, uf: value })} />
					</div>
					<div className="flex items-center justify-center">
						<TextFloatingInput
							width={"450px"}
					...
					<div className="flex items-center justify-center">
						<TextFloatingInput width={"450px"} label={"BAIRRO"} editable={true} value={dados.bairro} handleChange={(value) => setDados({ ...dados, bairro: value.toUpperCase() })} />
					</div>
					<div className="flex items-center justify-center">
						<TextFloatingInput
							width={"450px"}
			...
			<div className="w-full flex flex-col border border-[#15599a] pb-2 shadow-lg bg-[#fff]">
				...
				<div className="flex flex-col lg:grid grid-cols-3 gap-2">
					...
					<div className="flex items-center justify-center gap-x-2 flex-wrap">
						<TextFloatingInput editable={true} label={"CEP INSTALAÇÃO"} value={dados.cepInstalacao} handleChange={(value) => setDados({ ...dados, cepInstalacao: formatCEP(value) })} />
					</div>
					<div className="flex items-center justify-center">
						<TextFloatingInput
					...
					<div className="flex items-center justify-center">
						<TextFloatingInput label={"Nº"} editable={true} value={dados.numeroResInstalacao} handleChange={(value) => setDados({ ...dados, numeroResInstalacao: value })} />
					</div>
					<div className="flex items-center justify-center">
						<TextFloatingInput label={"BAIRRO"} editable={true} value={dados.bairroInstalacao} handleChange={(value) => setDados({ ...dados, bairroInstalacao: value.toUpperCase() })} />
					</div>
					<div className="flex items-center justify-center">
						<SelectFloatingInput
							label={"CIDADE"}
					...
					<div className="flex items-center justify-center">
						<TextFloatingInput label={"UF"} editable={true} value={dados.ufInstalacao} handleChange={(value) => setDados({ ...dados, ufInstalacao: value })} />
					</div>
					<div className="flex items-center justify-center col-span-3">
						<TextFloatingInput
					...
					<div className="flex items-center justify-center gap-2 flex-wrap col-span-3">
						<TextFloatingInput label={"LATITUDE"} value={dados.latitude} editable={true} handleChange={(value) => setDados({ ...dados, latitude: value })} />
						<TextFloatingInput label={"LONGITUDE"} editable={true} value={dados.longitude} handleChange={(value) => setDados({ ...dados, longitude: value })} />
					</div>
				</div>
			</div>
			<div className="w-full flex flex-col border border-[#15599a] pb-2 shadow-lg bg-[#fff]">
				<span className="text-sm text-center font-bold text-[#15599a] uppercase py-2">DADOS DA BOMBA SOLAR</span>
				<div className="flex flex-col lg:grid lg:grid-cols-3 gap-x-2 gap-y-1 mt-3">
					<h1 className="text-[#fead61] col-span-3 text-center font-bold py-2">DRIVER</h1>
					<div className="flex items-center justify-center">
						<TextFloatingInput label={"MARCA DO DRIVER"} editable={true} value={dados.marcaInversor} handleChange={(value) => setDados({ ...dados, marcaInversor: value })} />
					</div>
					<div className="flex items-center justify-center">
						<TextFloatingInput label={"QTDE DRIVER"} editable={true} value={dados.qtdeInversor} handleChange={(value) => setDados({ ...dados, qtdeInversor: value })} />
					</div>
					<div className="flex items-center justify-center">
						<TextFloatingInput label={"POTÊNCIA DRIVER (CV)"} unit={"W"} editable={true} value={dados.potInversor} handleChange={(value) => setDados({ ...dados, potInversor: value })} />
					</div>
				</div>
				<div className="flex flex-col lg:grid lg:grid-cols-3 gap-x-2 gap-y-1 mt-3">
					<h1 className="text-[#fead61] col-span-3 text-center font-bold py-2">MÓDULOS</h1>
					<div className="flex items-center justify-center">
						<TextFloatingInput label={"MARCA DOS MÓDULOS"} editable={true} value={dados.marcaModulos} handleChange={(value) => setDados({ ...dados, marcaModulos: value })} />
					</div>
					<div className="flex items-center justify-center">
						<TextFloatingInput label={"Nº DE MÓDULOS"} editable={true} value={dados.qtdeModulos} handleChange={(value) => setDados({ ...dados, qtdeModulos: value })} />
					</div>
					<div className="flex items-center justify-center">
						<TextFloatingInput label={"POTÊNCIA DOS MÓDULOS"} unit={"W"} editable={true} value={dados.potModulos} handleChange={(value) => setDados({ ...dados, potModulos: value })} />
					</div>
				</div>
				<div className="flex flex-col border-t border-gray-300 p-2">
					...
					<div className="flex flex-col lg:grid lg:grid-cols-4 items-center mt-2">
						...
						<div className="flex justify-center items-center w-full">
							<NumberFloatingInput label={"QTDE DE BATERIAS"} editable={true} value={dados.qtdeBateria} handleChange={(value) => setDados({ ...dados, qtdeBateria: Number(value) })} />
						</div>
						<div className="flex justify-center items-center w-full">
							<SelectFloatingInput
				...
				<div className="flex flex-col border-t border-gray-300 p-2">
					<h1 className="text-center text-[#15599a] text-sm font-bold mt-2">INFORMAÇÃO SOBRE A BOMBA</h1>
					<div className="flex flex-col lg:grid lg:grid-cols-3 items-center mt-2">
						<div className="flex items-center justify-center">
							<TextFloatingInput label={"MARCA BOMBA"} editable={true} value={dados.marcaBomba} handleChange={(value) => setDados({ ...dados, marcaBomba: value.toUpperCase() })} />
						</div>
						<div className="flex items-center justify-center">
							<NumberFloatingInput label={"QTDE BOMBA"} editable={true} value={dados.qtdeBomba} handleChange={(value) => setDados({ ...dados, qtdeBomba: Number(value) })} />
						</div>
						<div className="flex items-center justify-center">
							<NumberFloatingInput label={"POTÊNCIA BOMBA (CV)"} editable={true} value={dados.potBomba} handleChange={(value) => setDados({ ...dados, potBomba: Number(value) })} />
						</div>
					</div>
				</div>
			...
			<div className="w-full flex flex-col border border-[#15599a] pb-2 shadow-lg bg-[#fff]">
				...
				<div className="flex flex-col lg:grid lg:grid-cols-3 gap-2 mt-2 p-2">
					...
					<div className="flex items-center justify-center">
						<TextFloatingInput width={"450px"} label={"NOME DO PAGADOR"} editable={true} value={dados.nomePagador} handleChange={(value) => setDados({ ...dados, nomePagador: value })} />
					</div>
					<div className="flex items-center justify-center">
						<TextFloatingInput
							width={"450px"}
