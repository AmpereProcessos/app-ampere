  ...
  return (
    <>
      <div className="bg-background flex w-full flex-col border border-[#15599a] pb-2 shadow-lg">
        <h1 className="mt-1 text-center text-xl font-bold text-[#fead61]">REVISÃO DAS INFORMAÇÕES</h1>
      </div>
      <div className="bg-background flex w-full flex-col border border-[#15599a] pb-2 shadow-lg">
        <span className="py-2 text-center text-sm font-bold text-[#15599a] uppercase">DADOS PARA CONTRATO</span>
      ...
      <div className="bg-background flex w-full flex-col border border-[#15599a] pb-2 shadow-lg">
        <span className="py-2 text-center text-sm font-bold text-[#15599a] uppercase">DADOS DA INSTALAÇÃO</span>
        <div className="flex flex-col gap-2 p-2 lg:grid lg:grid-cols-3">
          ...
          <h1 className="col-span-3 py-2 text-center font-bold text-[#fead61]">ENDEREÇO DA INSTALAÇÃO ATUAL</h1>
          ...
          <h1 className="col-span-3 py-2 text-center font-bold text-[#fead61]">ENDEREÇO DA INSTALAÇÃO REMONTAGEM</h1>
            ...
            <>
              ...
              <div className="flex items-center justify-center">
                <TextInput
                  ...
                  handleChange={(value) => setDados({ ...dados, ufInstalacaoRemontagem: value })}
                />
              </div>
              <div className="flex items-center justify-center">
                <TextInput
              ...
              <div className="col-span-3 flex flex-wrap items-center justify-center gap-2">
                <TextInput
                  ...
                  editable={true}
                  handleChange={(value) => setDados({ ...dados, latitudeRemontagem: value })}
                />
                <TextInput
          ...
          <h1 className="col-span-3 py-2 text-center font-bold text-[#fead61]">DADOS DO SISTEMA (SOMENTE QUANTIDADES A SER DESMONTADAS/MONTADAS)</h1>
          <div className="col-span-3 flex flex-wrap items-center justify-center gap-2">
            <NumberInput
              label={'POTÊNCIA PICO'}
              editable={true}
      ...
      <div className="bg-background flex w-full flex-col border border-[#15599a] pb-2 shadow-lg">
        <span className="py-2 text-center text-sm font-bold text-[#15599a] uppercase">DADOS DO SISTEMA</span>
        ...
        <div className="border-primary/20 mx-2 mt-2 flex flex-wrap justify-around gap-2 border-t pt-2">
          <TextInput
      ...
      {msg.text ? (
        <p className={`text-center text-sm font-bold ${msg.color}`}>{msg.text}</p>
      ) : (
        <div className="flex flex-wrap justify-center gap-2">
          <button onClick={voltar} className="rounded bg-[#15599a] p-2 font-bold text-white">
            VOLTAR
          </button>
          <button onClick={criarSolicitacao} className="rounded bg-[#fead61] p-2 font-bold">
            CRIAR SOLICITAÇÃO
          </button>
        </div>
      )}
