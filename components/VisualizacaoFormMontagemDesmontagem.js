...
function VisualizacaoFormMontagemDesmontagem({ dados, voltar, setDados, formVisitaId, linksVisita }) {
		...
		<>
			...
			<div className="w-full flex flex-col border border-[#15599a] pb-2 shadow-lg bg-[#fff]">
				...
				<div className="flex gap-2 justify-around flex-wrap">
					<TextInput label={"Nome/Razão Social"} editable={true} value={dados.nomeDoContrato} handleChange={(value) => setDados({ ...dados, nomeDoContrato: value.toUpperCase() })} />
					<TextInput label={"Telefone"} editable={true} value={dados.telefone} handleChange={(value) => setDados({ ...dados, telefone: phoneMask(value) })} />
					<TextInput label={"CPF/CNPJ"} editable={true} value={dados.cpf_cnpj} handleChange={(value) => setDados({ ...dados, cpf_cnpj: formatCnpjCpf(value) })} />
					<TextInput label={"RG"} editable={true} value={dados.rg} handleChange={(value) => setDados({ ...dados, rg: value })} />
					<DateInput
					...
					/>
					<TextInput label={"UF"} editable={true} value={dados.uf} handleChange={(value) => setDados({ ...dados, uf: value })} />
					<TextInput
					...
					/>
					<TextInput label={"Nº"} editable={true} value={dados.numeroResCobranca} handleChange={(value) => setDados({ ...dados, numeroResCobranca: Number(value) })} />
					<TextInput label={"BAIRRO"} editable={true} value={dados.bairro} handleChange={(value) => setDados({ ...dados, bairro: value.toUpperCase() })} />
					<TextInput label={"PONTO DE REFERÊNCIA"} editable={true} value={dados.pontoDeReferencia} handleChange={(value) => setDados({ ...dados, pontoDeReferencia: value })} />
					<SelectInput
						label={"SEGMENTO"}
					...
					/>
					<NumberInput label={"CÓDIGO DO PROJETO CRM"} editable={true} value={dados.codigoSVB} handleChange={(value) => setDados({ ...dados, codigoSVB: value })} />
					<SelectInput
						label={"ESTADO CIVIL"}
						editable={true}
						options={[
					...
					/>
					<TextInput label={"EMAIL"} editable={true} normalCase={true} value={dados.email} handleChange={(value) => setDados({ ...dados, email: value })} />
					<TextInput label={"PROFISSÃO"} editable={true} value={dados.profissao} handleChange={(value) => setDados({ ...dados, profissao: value })} />
					<TextInput label={"ONDE TRABALHA"} editable={true} value={dados.ondeTrabalha} handleChange={(value) => setDados({ ...dados, ondeTrabalha: value })} />
					<SelectInput
					...
					{dados.possuiDeficiencia == "SIM" && (
						<>
							{" "}
							<TextInput label={"SE SIM, QUAL ?"} editable={true} value={dados.qualDeficiencia} handleChange={(value) => setDados({ ...dados, qualDeficiencia: value })} />
						</>
					)}
					<SelectInput
					...
					{dados.canalVenda == "INDICAÇÃO DE AMIGO" && (
						<>
							<TextInput label={"NOME INDICADOR"} editable={true} value={dados.nomeIndicador} handleChange={(value) => setDados({ ...dados, nomeIndicador: value })} />
							<TextInput label={"TELEFONE INDICADOR"} editable={true} value={dados.telefoneIndicador} handleChange={(value) => setDados({ ...dados, telefoneIndicador: value })} />
						</>
					)}
				</div>
			...
			<div className="w-full flex flex-col border border-[#15599a] pb-2 shadow-lg bg-[#fff]">
				...
				<div className="flex gap-2 justify-around flex-wrap">
					<TextInput label={"NOME DO CONTATO 1"} editable={true} value={dados.nomeContatoJornadaUm} handleChange={(value) => setDados({ ...dados, nomeContatoJornadaUm: value })} />
					<TextInput
					...
					/>
					<TextInput label={"NOME DO CONTATO 2"} editable={true} value={dados.nomeContatoJornadaDois} handleChange={(value) => setDados({ ...dados, nomeContatoJornadaDois: value })} />
					<TextInput
					...
					<div className="flex flex-col w-full px-2 self-center mt-2 items-center">
						...
						<textarea
							...
							className="w-full text-center h-[80px] bg-gray-200 resize-none p-2 outline-none border border-gray-600"
							onChange={(e) => setDados({ ...dados, cuidadosContatoJornada: e.target.value })}
						/>
					</div>
				</div>
			</div>
			<div className="w-full flex flex-col border border-[#15599a] pb-2 shadow-lg bg-[#fff]">
				...
				<div className="flex flex-col lg:grid lg:grid-cols-3 gap-2 p-2">
					<h1 className="text-[#fead61] col-span-3 text-center font-bold py-2">INFORMAÇÕES DA INSTALAÇÃO DO CLIENTE</h1>
					...
					<h1 className="text-[#fead61] col-span-3 text-center font-bold py-2">ENDEREÇO DA INSTALAÇÃO ATUAL</h1>
					<div className="flex items-center justify-center gap-x-2 flex-wrap">
						<TextInput editable={true} label={"CEP INSTALAÇÃO"} value={dados.cepInstalacao} handleChange={(value) => setDados({ ...dados, cepInstalacao: formatCEP(value) })} />
						<button onClick={() => findCPF("enderecoInstalacao")} className="flex items-center p-1 h-[30px] bg-[#fead61] rounded">
							<AiOutlineSearch />
						</button>
					</div>
					<div className="flex items-center justify-center">
					...
					<div className="flex items-center justify-center">
						<TextInput label={"Nº"} editable={true} value={dados.numeroResInstalacao} handleChange={(value) => setDados({ ...dados, numeroResInstalacao: value })} />
					</div>
					<div className="flex items-center justify-center">
						<NumberInput label={"Nº DA INSTALAÇÃO"} editable={true} value={dados.numeroInstalacao} handleChange={(value) => setDados({ ...dados, numeroInstalacao: value })} />
					</div>
					<div className="flex items-center justify-center">
						<TextInput label={"BAIRRO"} editable={true} value={dados.bairroInstalacao} handleChange={(value) => setDados({ ...dados, bairroInstalacao: value.toUpperCase() })} />
					</div>
					<div className="flex items-center justify-center">
						<SelectInput
							label={"CIDADE"}
					...
					<div className="flex items-center justify-center">
						<TextInput label={"UF"} editable={true} value={dados.ufInstalacao} handleChange={(value) => setDados({ ...dados, ufInstalacao: value })} />
					</div>
					<div className="flex items-center justify-center">
						<TextInput
					...
					<div className="flex items-center justify-center gap-2 flex-wrap col-span-3">
						<TextInput label={"LATITUDE"} value={dados.latitude} editable={true} handleChange={(value) => setDados({ ...dados, latitude: value })} />
						<TextInput label={"LONGITUDE"} editable={true} value={dados.longitude} handleChange={(value) => setDados({ ...dados, longitude: value })} />
					</div>
					<h1 className="text-[#fead61] col-span-3 text-center font-bold py-2">ENDEREÇO DA INSTALAÇÃO REMONTAGEM</h1>
						...
						<>
							...
							<div className="flex items-center justify-center">
								<SelectInput
									...
									handleChange={(value) => setDados({ ...dados, tipoDaInstalacaoRemontagem: value })}
									options={[
										{
											label: "RURAL",
											value: "RURAL",
							...
							<div className="flex items-center justify-center">
								<TextInput
									...
									handleChange={(value) => setDados({ ...dados, numeroResInstalacaoRemontagem: value })}
								/>
							</div>
							<div className="flex items-center justify-center">
								<NumberInput
									...
									handleChange={(value) => setDados({ ...dados, numeroInstalacaoRemontagem: value })}
								/>
							</div>
							<div className="flex items-center justify-center">
								<TextInput
							...
							<div className="flex items-center justify-center">
								<SelectInput
									...
									handleChange={(value) => setDados({ ...dados, cidadeInstalacaoRemontagem: value })}
								/>
							</div>
							<div className="flex items-center justify-center">
								<TextInput label={"UF (NOVO LOCAL)"} editable={true} value={dados.ufInstalacaoRemontagem} handleChange={(value) => setDados({ ...dados, ufInstalacaoRemontagem: value })} />
							</div>
							<div className="flex items-center justify-center">
								<TextInput
							...
							<div className="flex items-center justify-center gap-2 flex-wrap col-span-3">
								<TextInput label={"LATITUDE (NOVO LOCAL)"} value={dados.latitudeRemontagem} editable={true} handleChange={(value) => setDados({ ...dados, latitudeRemontagem: value })} />
								<TextInput
									label={"LONGITUDE (NOVO LOCAL)"}
									editable={true}
									value={dados.longitudeRemontagem}
									handleChange={(value) => setDados({ ...dados, longitudeRemontagem: value })}
								/>
							</div>
						</>
					) : null}
					<h1 className="text-[#fead61] col-span-3 text-center font-bold py-2">DADOS DO SISTEMA (SOMENTE QUANTIDADES A SER DESMONTADAS/MONTADAS)</h1>
			...
			<div className="w-full flex flex-col border border-[#15599a] pb-2 shadow-lg bg-[#fff]">
				...
				<div className="flex gap-2 justify-around flex-wrap">
					{dados.topologia != "NÃO DEFINIDO" && (
						<>
							<TextInput label={"MARCA DO INVERSOR/MICRO"} editable={true} value={dados.marcaInversor} handleChange={(value) => setDados({ ...dados, marcaInversor: value })} />
							<NumberInput label={"QTDE INVERSOR/MICRO"} editable={true} value={dados.qtdeInversor} handleChange={(value) => setDados({ ...dados, qtdeInversor: Number(value) })} />
							<NumberInput
				...
				<div className="flex gap-2 justify-around flex-wrap mt-2 pt-2 border-t border-gray-300 mx-2">
					<TextInput label={"MARCA DOS MÓDULOS"} editable={true} value={dados.marcaModulos} handleChange={(value) => setDados({ ...dados, marcaModulos: value })} />
					<NumberInput label={"Nº DE MÓDULOS"} editable={true} value={dados.qtdeModulos} handleChange={(value) => setDados({ ...dados, qtdeModulos: Number(value) })} />
					<NumberInput label={"POTÊNCIA DOS MÓDULOS"} editable={true} unit={"W"} value={dados.potModulos} handleChange={(value) => setDados({ ...dados, potModulos: Number(value) })} />
				</div>
			</div>
			<div className="w-full flex flex-col border border-[#15599a] pb-2 shadow-lg bg-[#fff]">
				...
				<div className="flex gap-2 justify-around flex-wrap">
					...
					{dados.responsavelEstrutura != "NÃO SE APLICA" && (
						<>
							...
							/>
							<NumberInput label={"VALOR DA ESTRUTURA"} editable={true} value={dados.valorEstrutura} handleChange={(value) => setDados({ ...dados, valorEstrutura: Number(value) })} />
						</>
					)}
				</div>
			</div>
			<div className="w-full flex flex-col border border-[#15599a] pb-2 shadow-lg bg-[#fff]">
				...
				{(dados.possuiOeM == "SIM" || dados.clienteSegurado == "SIM") && dados.tipoDeServico != "OPERAÇÃO E MANUTENÇÃO" ? (
					<div className="flex gap-2 justify-around flex-wrap mt-2">
						<SelectInput
							label={"FORMA de PAGAMENTO"}
							editable={true}
				...
				<div className="w-full flex flex-col border border-[#15599a] pb-2 shadow-lg bg-[#fff]">
					...
					{dados.aumentoDeCarga == "SIM" && (
						<div className="flex gap-2 justify-around flex-wrap mt-2">
							...
							/>
							<NumberInput label={"VALOR DO PADRÃO"} editable={true} value={dados.valorPadrao} handleChange={(value) => setDados({ ...dados, valorPadrao: Number(value) })} />
						</div>
					)}
				</div>
			) : null}
			...
			<div className="w-full flex flex-col border border-[#15599a] pb-2 shadow-lg bg-[#fff]">
				...
				<div className="flex gap-2 justify-around flex-wrap mt-2">
					<TextInput label={"NOME DO PAGADOR"} editable={true} value={dados.nomePagador} handleChange={(value) => setDados({ ...dados, nomePagador: value })} />
					<TextInput label={"CONTATO DO PAGADOR"} editable={true} value={dados.contatoPagador} handleChange={(value) => setDados({ ...dados, contatoPagador: phoneMask(value) })} />
					<TextInput label={"CPF/CNPJ PARA NF"} editable={true} value={dados.cpf_cnpjNF} handleChange={(value) => setDados({ ...dados, cpf_cnpjNF: formatCnpjCpf(value) })} />
				</div>
				<div className="flex gap-2 justify-around flex-wrap mt-2">
					<SelectInput
					...
					{dados.necessidaInscricaoRural == "SIM" && (
						<TextInput label={"INSCRIÇÃO RURAL"} editable={true} value={dados.inscriçãoRural} handleChange={(value) => setDados({ ...dados, inscriçãoRural: value })} />
					)}
				</div>
				{!["OPERAÇÃO E MANUTENÇÃO", "MANUTENÇÃO CORRETIVA", "MANUTENÇÃO PREVENTIVA", "MONTAGEM E DESMONTAGEM"].includes(dados.tipoDeServico) ? (
					<div className="flex gap-2 justify-around flex-wrap mt-2">
						<SelectInput
				...
				<div className="flex gap-2 justify-around flex-wrap mt-2">
					...
					{dados.origemRecurso == "FINANCIAMENTO" && (
						<>
							...
							/>
							<TextInput label={"NOME DO GERENTE"} editable={true} value={dados.nomeGerente} handleChange={(value) => setDados({ ...dados, nomeGerente: value })} />
							<TextInput label={"CONTATO DO GERENTE"} editable={true} value={dados.contatoGerente} handleChange={(value) => setDados({ ...dados, contatoGerente: phoneMask(value) })} />
						</>
					)}
					<NumberInput
					...
					/>
					<NumberInput label={"VALOR DA PARCELA"} editable={true} value={dados.valorParcela} tag={"R$"} handleChange={(value) => setDados({ ...dados, valorParcela: Number(value) })} />
					<SelectInput
				...
				<div className="flex flex-col w-full px-2 self-center mt-2 items-center">
					...
					<textarea
						...
						className="w-full text-center h-[80px] bg-gray-200 resize-none p-2 outline-none border border-gray-600"
						onChange={(e) => setDados({ ...dados, descricaoNegociacao: e.target.value })}
					/>
				</div>
			</div>
			<div className="w-full flex flex-col border border-[#15599a] pb-2 shadow-lg bg-[#fff]">
...
export default VisualizacaoFormMontagemDesmontagem;
