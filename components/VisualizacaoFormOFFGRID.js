		...
		<>
			...
			<div className="w-full flex flex-col border border-[#15599a] pb-2 shadow-lg bg-[#fff]">
				...
				<div className="flex flex-col lg:grid lg:grid-cols-3 gap-x-2 gap-y-1 mt-3">
					...
					<div className="flex items-center justify-center">
						<TextFloatingInput label={"MARCA DO INVERSOR"} editable={true} value={dados.marcaInversor} handleChange={(value) => setDados({ ...dados, marcaInversor: value })} />
					</div>
					<div className="flex items-center justify-center">
						<TextFloatingInput label={"QTDE INVERSOR"} editable={true} value={dados.qtdeInversor} handleChange={(value) => setDados({ ...dados, qtdeInversor: value })} />
					</div>
					<div className="flex items-center justify-center">
						<TextFloatingInput label={"POTÊNCIA INVERSOR"} unit={"W"} editable={true} value={dados.potInversor} handleChange={(value) => setDados({ ...dados, potInversor: value })} />
					</div>
				</div>
				<div className="flex flex-col lg:grid lg:grid-cols-3 gap-x-2 gap-y-1 mt-3">
