...
function InfoClienteBlock({ editable, infoHolder, setInfo, clientChanges, setClientChanges }: InfoClienteBlockProps) {
  ...
  return (
    <div className="border-primary flex w-full flex-col rounded-md border">
      <div className="bg-primary text-primary-foreground flex w-full items-center justify-center gap-2 p-2">
        <h1 className="font-bold">CLIENTE</h1>
        {editable ? (
          <button
            type="button"
            onClick={() => setEditMenuIsOpen((prev) => !prev)}
            className="hover:bg-primary-foreground hover:text-primary rounded-full p-1 text-xs duration-300 ease-in-out"
          >
...
function ClientEditBlock({ client, updateClient, clientChanges, updateClientChanges }: ClientEditBlockProps) {
  ...
  return (
    ...
    >
      <h1 className="bg-primary/80 self-center rounded-lg px-2 py-1 text-xs font-bold tracking-tight text-white">INFORMAÇÕES PESSOAIS</h1>
      ...
      <h1 className="bg-primary/80 self-center rounded-lg px-2 py-1 text-xs font-bold tracking-tight text-white">INFORMAÇÕES DE CONTATO</h1>
      <div className="flex w-full flex-col items-center gap-2 lg:flex-row">
        <div className="w-full lg:w-1/3">
          <TextInput
      ...
      <h1 className="bg-primary/80 self-center rounded-lg px-2 py-1 text-xs font-bold tracking-tight text-white">INFORMAÇÕES DE ENDEREÇO</h1>
