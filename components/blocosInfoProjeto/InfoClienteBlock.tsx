...
function ClientEditBlock({
  client,
  updateClient,
  clientChanges,
  updateClientChanges,
}: ClientEditBlockProps) {
  ...
  return (
    ...
    >
      <InfoBlockSection
        ...
        headerIcon={<UserRound className="h-4 w-4 min-h-4 min-w-4" />}
      >
          ...
          <div className="w-full lg:w-1/3">
            <TextInput
              ...
              handleChange={(value) => {
                ...
                updateClientChanges({
                  indicador: { ...client.indicador, contato: formatToPhone(value) },
                });
              }}
              width="100%"
            />
      ...
      <InfoBlockSection
        ...
        headerIcon={<Phone className="h-4 w-4 min-h-4 min-w-4" />}
      >
        <div className="flex w-full flex-col items-center gap-2 lg:flex-row">
          <div className="w-full lg:w-1/3">
            <TextInput
      ...
      <InfoBlockSection
        headerTitle="INFORMAÇÕES DE ENDEREÇO"
        ...
        <div className="flex w-full flex-col items-center gap-2 lg:flex-row">
          ...
          <div className="w-full lg:w-1/3">
            ...
            <SelectInput
              ...
              options={
                client.uf
                  ? estadosECidades[client.uf as keyof typeof estadosECidades].map(
                      (city, index) => ({ id: index + 1, value: city, label: city }),
                    )
                  : null
              }
              handleChange={(value) => {
      ...
      <div className="flex w-full grow flex-col gap-2">
        <div className="flex w-full flex-col items-center justify-between gap-2 lg:flex-row">
          <div className="flex flex-col items-center gap-1 lg:items-start">
            <p className="text-foreground text-[0.65rem] font-medium">GERAIS</p>
        ...
        <div className="flex w-full flex-col items-center justify-between gap-2 lg:flex-row">
          <div className="flex flex-col items-center gap-1 lg:items-start">
            <p className="text-foreground text-[0.65rem] font-medium">CONTATOS</p>
            <div className="flex flex-wrap items-center justify-center gap-2 lg:justify-start">
              <div className="flex items-center gap-1">
                <Phone size={12} />
                <p className="text-xs leading-none font-medium tracking-tight">
          ...
          <div className="flex flex-col items-center gap-1 lg:items-end">
            <p className="text-foreground text-[0.65rem] font-medium">AQUISIÇÃO</p>
            <div className="flex flex-wrap items-center justify-center gap-2 lg:justify-start">
              <div className="flex items-center gap-1">
                <Filter size={12} />
                <p className="text-xs leading-none font-medium tracking-tight">
        ...
        <div className="flex w-full flex-col items-center justify-between gap-2 lg:flex-row">
          <div className="flex flex-col items-center gap-1 lg:items-start">
            <p className="text-foreground text-[0.65rem] font-medium">LOCALIZAÇÃO</p>
            <div className="flex flex-wrap items-center justify-center gap-2 lg:justify-start">
              <div className="flex items-center gap-1">
          ...
          <div className="flex flex-col items-center gap-1 lg:items-end">
            <p className="text-foreground text-[0.65rem] font-medium">ESTADO CIVIL</p>
            <div className="flex flex-wrap items-center justify-center gap-2 lg:justify-start">
              <div className="flex items-center gap-1">
                <FaRing size={15} />
                <p className="text-xs leading-none font-medium tracking-tight">
        ...
        <div className="flex w-full flex-col items-center justify-between gap-2 lg:flex-row">
          <div className="flex flex-col items-center gap-1 lg:items-start">
            <p className="text-foreground text-[0.65rem] font-medium">TRABALHO</p>
            <div className="flex flex-wrap items-center justify-center gap-2 lg:justify-start">
              <div className="flex items-center gap-1">
          ...
          <div className="flex flex-col items-center gap-1 lg:items-end">
            <p className="text-foreground text-[0.65rem] font-medium">DEFICIÊNCIA</p>
            <div className="flex flex-wrap items-center justify-center gap-2 lg:justify-start">
              <div className="flex items-center gap-1">
                <Accessibility size={15} />
                <p className="text-xs leading-none font-medium tracking-tight">
                  {client?.deficiencia || "NÃO DEFINIDO"}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col items-center gap-1">
          <p className="text-foreground text-[0.65rem] font-medium">INDICAÇÃO</p>
      ...
      <div className="flex w-full items-center justify-end gap-2">
        ...
        <div className="flex items-center gap-1">
          <Avatar
            ...
            width={20}
          />
          <p className="text-foreground text-[0.65rem] font-medium">{client?.autor.nome}</p>
        </div>
      </div>
    </motion.div>
  );
