		...
		<div className="flex flex-col rounded-md border border-[#15599a] pb-2 shadow-lg">
			...
			{isContractAttached && isPendingPurchaseAnalysisLiberation ? (
				<div className="px my-2 flex w-full flex-col rounded-xl border border-yellow-500 bg-yellow-100 py-1 px-2 italic text-yellow-500">
					...
					<p className="w-full text-center text-[0.65rem]">NOTAMOS QUE EXISTE UM CONTRATO ASSINADO ANEXADO, LEMBRE-SE DE LIBERAR O PROJETO PARA ANÁLISE DE COMPRA, SE APLICÁVEL.</p>
				</div>
			) : null}
			...
			<div className="flex w-full items-center justify-end">
				...
				>
					<FaLocationDot />
					<h1 className="text-xs font-medium tracking-tight">{!showLocationInformation ? "MOSTRAR LOCALIZAÇÃO DE ENTREGA" : "FECHAR DADOS DE LOCALIZAÇÃO DE ENTREGA"}</h1>
				</button>
			</div>
