...
function InfoEstruturaBlock({ comercialEdition, technicalEdition, infoHolder, setInfo, changes, setChanges, project, showPaymentInfo = true }) {
  return (
    <div className="flex flex-col border border-[#15599a] pb-2 shadow-lg rounded-md">
      ...
      <div className="flex gap-2 justify-center flex-wrap">
        ...
        <DateInput
          ...
          editable={comercialEdition}
          value={
            infoHolder.estruturaPersonalizada?.dataEntrega != undefined && infoHolder.estruturaPersonalizada.dataEntrega != '-'
              ? new Date(infoHolder.estruturaPersonalizada.dataEntrega).toISOString().slice(0, 10)
              : null
          }
          handleChange={(value) => {
            setChanges({
              ...changes,
              'estruturaPersonalizada.dataEntrega': isNaN(value) ? new Date(value).toISOString() : null,
            })
            setInfo({
              ...infoHolder,
              estruturaPersonalizada: {
