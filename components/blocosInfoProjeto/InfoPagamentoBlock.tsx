  ...
  return (
    <div className="flex flex-col rounded-md border border-primary pb-2 shadow-lg gap-6">
      ...
      <div className="w-full flex flex-col gap-2 px-2">
        ...
        <InfoBlockSection
          headerTitle="LOCALIZAÇÃO DO PAGADOR"
          headerIcon={<MapPin className="w-4 h-4 min-w-4 min-h-4" />}
        >
            ...
            <div className="w-full lg:w-1/3">
              <SelectInput
                ...
                options={BrazilianCitiesOptionsFromUF(
                  infoHolder.pagamento?.pagador?.localizacao?.uf || "",
                )}
                selectedItemLabel="NÃO DEFINIDO"
                onReset={() => {
                  setChanges((prev) => ({
        ...
        <InfoBlockSection
          headerTitle="RECEBIMENTO"
          headerIcon={<CreditCard className="h-4 w-4 min-h-4 min-w-4" />}
        >
          <div className="flex w-full flex-col items-center justify-center gap-2 lg:flex-row">
            {showADMOnly ? (
        ...
        <InfoBlockSection
          headerTitle="FATURAMENTO"
          headerIcon={<Receipt className="h-4 w-4 min-h-4 min-w-4" />}
        >
