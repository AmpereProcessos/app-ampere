          ...
          handleChange={(value) => {
            setChanges({
              ...
              "projeto.projetista.codigo":
                projetistas.filter((projetista) => projetista.nome == value)[0]
                  .cod || "-",
            });
            setInfo({
              ...infoHolder,
          ...
          <div className="flex flex-col w-[350px] items-center">
            ...
            <div className="flex">
              <input
                disabled={!editor}
                checked={
                  infoHolder.parecer.parecerReprovado === "SIM" ? true : false
                }
                onChange={(e) => {
                  setChanges({
                    ...changes,
              ...
              <div className="flex">
                <input
                  ...
                  onChange={(e) => {
                    setChanges({
                      ...changes,
                      "vistoria.equipeDeCampoNecessaria": e.target.checked
                        ? "SIM"
                        : "NÃO",
                    });
                    setInfo({
        ...
        <div className="flex flex-col w-[350px] items-center">
          ...
          <div className="flex">
            <input
              disabled={!editor}
              checked={
                infoHolder.projeto?.projetoConcluido === "SIM" ? true : false
              }
              onChange={(e) => {
                setChanges({
                  ...changes,
