    ...
    <div className="flex flex-col rounded-md border border-[#15599a] pb-2 shadow-lg">
      ...
      <div className="flex items-center justify-center py-2">
        ...
        {showPaymentInfo && (
          <NumberInput
            ...
            editable={editor}
            value={infoHolder.sistema?.valorProjeto != undefined && infoHolder.sistema?.valorProjeto != '-' ? infoHolder.sistema?.valorProjeto : 0}
            handleChange={(value) => {
              setChanges({
                ...changes,
      ...
      <div className="flex flex-wrap justify-center gap-2">
        ...
        <TextInput
          ...
          editable={editor}
          value={infoHolder.sistema?.potModulos != undefined && infoHolder.sistema?.potModulos != '-' ? infoHolder.sistema?.potModulos : ''}
          handleChange={(value) => {
            setChanges({
              ...changes,
          ...
          <div className="flex flex-col items-center border-t border-gray-200 py-2 lg:grid lg:grid-cols-4">
            ...
            <div className="flex w-full items-center justify-center">
              <SelectInput
                ...
                editable={true}
                value={infoHolder.sistema.tipoBateria ? infoHolder.sistema.tipoBateria : 'NÃO DEFINIDO'}
                options={[
