	...
	return (
		<div className="flex flex-col rounded-md border border-primary pb-2 shadow-lg gap-6">
			...
			<div className="w-full flex flex-col gap-2 px-2">
				...
				<InfoBlockSection headerTitle="ENDEREÇO DE EXECUÇÃO" headerIcon={<MapPin className="h-4 w-4 min-h-4 min-w-4" />}>
					<div className="flex w-full flex-col items-center gap-2 lg:flex-row">
						<div className="w-full lg:w-1/3">
							<TextInput
								label={"CEP"}
				...
				<InfoBlockSection headerTitle="DETALHES DA VENDA" headerIcon={<ListCollapse className="h-4 w-4 min-h-4 min-w-4" />}>
					<div className="flex w-full flex-col items-center gap-2 lg:flex-row">
						<div className="w-full lg:w-1/4">
							<SelectInput
				...
				<InfoBlockSection headerTitle="VINCULAÇÕES" headerIcon={<LinkIcon className="h-4 w-4 min-h-4 min-w-4" />}>
					<div className="flex w-full flex-col items-center gap-2 lg:flex-row">
						<div className="w-full lg:w-1/4">
							<TextInput
				...
				<InfoBlockSection headerTitle="OPERAÇÃO E MANUTENÇÃO" headerIcon={<FaSolarPanel className="h-4 w-4 min-h-4 min-w-4" />}>
				...
				<InfoBlockSection headerTitle="SEGURO" headerIcon={<Shield className="h-4 w-4 min-h-4 min-w-4" />}>
					<div className="flex w-full flex-col items-center justify-center gap-2">
						<div className="flex items-center justify-center">
							<div className="w-fit">
								<CheckboxInput
