		...
		<div className="flex flex-col rounded-md border border-primary pb-2 shadow-lg gap-6">
			...
			<div className="flex w-full flex-col gap-2">
				<div className="flex items-center gap-2 bg-primary/20 px-2 py-1 rounded w-fit">
					...
					<h1 className="text-xs tracking-tight font-medium text-start w-fit">DADOS GERAIS</h1>
				</div>
			...
			<div className="flex w-full flex-col gap-2">
				<div className="flex items-center gap-2 bg-primary/20 px-2 py-1 rounded w-fit">
					...
					<h1 className="text-xs tracking-tight font-medium text-start w-fit">ENDEREÇO DE EXECUÇÃO</h1>
				</div>
				<div className="flex w-full flex-col items-center gap-2 px-2 lg:flex-row">
					<div className="w-full lg:w-1/3">
						<TextInput
			...
			<div className="flex w-full flex-col gap-2">
				<div className="flex items-center gap-2 bg-primary/20 px-2 py-1 rounded w-fit">
					<ListCollapse className="h-4 w-4 min-h-4 min-w-4" />
					<h1 className="text-xs tracking-tight font-medium text-start w-fit">DETALHES DA VENDA</h1>
				</div>
				<div className="flex w-full flex-col items-center gap-2 px-2 lg:flex-row">
					<div className="w-full lg:w-1/4">
						<SelectInput
			...
			<div className="flex w-full flex-col gap-2">
				<div className="flex items-center gap-2 bg-primary/20 px-2 py-1 rounded w-fit">
					<FaSolarPanel className="h-4 w-4 min-h-4 min-w-4" />
			...
			<div className="flex w-full flex-col gap-2">
				<div className="flex items-center gap-2 bg-primary/20 px-2 py-1 rounded w-fit">
					...
					<h1 className="text-xs tracking-tight font-medium text-start w-fit">SEGURO</h1>
				</div>
				<div className="flex w-full flex-col items-center justify-center gap-2 px-2">
					<div className="flex items-center justify-center">
						<div className="w-fit">
			...
			<div className="my-2 flex w-full items-center px-2">
				<textarea
					...
					className="border-primary/80 h-[80px] w-full resize-none border bg-primary/20 p-2 text-center text-xs outline-hidden"
				/>
			</div>
