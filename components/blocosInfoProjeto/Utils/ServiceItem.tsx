    ...
    <div className="border-primary/20 flex w-full flex-col rounded-md border p-2">
      <div className="flex w-full items-center justify-between gap-2">
        <div className="flex items-center gap-1">
          ...
          <p className="text-xs leading-none font-medium tracking-tight lg:text-sm">{service.descricao}</p>
        </div>
        {showRemoveButton ? (
          <button
      ...
      <div className="mt-1 flex w-full items-center justify-end gap-2 pl-2">
        <div className="flex items-center gap-1">
          ...
          <p className="text-primary/60 text-[0.6rem] font-light lg:text-xs">
