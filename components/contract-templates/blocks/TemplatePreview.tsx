...
import { CONTRACT_TEMPLATE_VARIABLES_PREVIEW, getTemplateProcessed } from "@/lib/contract-templates/processing";
...
function ContractTemplatePreview({ templateContent }: TemplatePreviewProps) {
	const processedTemplate = getTemplateProcessed({ templateContent, variables: CONTRACT_TEMPLATE_VARIABLES_PREVIEW });
	console.log("[DEBUG] Processed Template", processedTemplate);
	return (
		<ResponsiveDialogDrawerSection sectionTitleText="EDITOR DE TEMPLATE" sectionTitleIcon={<Eye size={15} />}>
			<div
				...
				className="prose prose-sm max-w-none
					...
					prose-li:text-primary/80 prose-li:my-2"
			/>
