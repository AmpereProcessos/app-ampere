	...
	return (
		<div className="my-2 flex w-full flex-col">
			<div className="flex flex-col items-center justify-between bg-[#fead61] py-2 text-white">
				...
				<p className="text-primary/80 px-2 text-[0.6rem] font-bold italic lg:text-xs">
			...
			<div className="flex flex-wrap justify-center gap-2">
				<div className="flex w-fit flex-col items-center">
					<label className="ml-2 text-center font-bold text-[#15599a]">FOTO DO CONJUNTO ESCADA (ESCADA AMARRADA, CONES, CORRENTE E PLACA DE ALERTA)</label>
