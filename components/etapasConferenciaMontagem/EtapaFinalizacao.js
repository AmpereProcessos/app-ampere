	...
	return (
		<div className="my-2 flex w-full flex-col">
			<div className="flex flex-col items-center justify-between rounded-sm bg-[#fead61] p-2 text-white">
				...
				<h1 className="text-center text-xs font-bold text-gray-600">
			...
			<div className="my-2 flex flex-col items-center gap-y-2 border-y border-gray-300 py-2">
				<div className="flex w-full flex-col gap-y-2">
					...
					<div className="mt-2 flex flex-col items-center pl-5">
						...
						<div className="grid w-full grid-cols-10 gap-2 lg:w-[60%]">
							<BsFillSunFill style={{ color: "#fead61", fontSize: "25px" }} /> <p className="col-span-9 font-medium">CONFERIR SE RETIROU TODA A SOBRA DE MATERIAIS</p>
						</div>
						<div className="grid w-full grid-cols-10 gap-2 lg:w-[60%]">
							<BsFillSunFill style={{ color: "#fead61", fontSize: "25px" }} />
					...
					<div className="mt-2 flex flex-col items-center pl-5">
						...
						<div className="grid w-full grid-cols-10 gap-2 lg:w-[60%]">
							...
							<p className="col-span-9 font-medium">
								NO TÉRMINO DA MONTAGEM DOS INVERSORES, LAVAR AS MÃOS E PANOS DE LIMPEZA E REALIZAR A HIGIENIZAÇÃO DOS INVERSORES, QDG, STRING, CANOS E CONDULETES
							</p>
						</div>
						<div className="grid w-full grid-cols-10 gap-2 lg:w-[60%]">
							<BsFillSunFill style={{ color: "#fead61", fontSize: "25px" }} />
							<p className="col-span-9 font-medium">
								FAZER INSPEÇÃO VISUAL NO LOCAL DA MONTAGEM DOS INVERSORES SE ESTA TUDO CORRETO, LEMBRE-SE QUE A MONTAGEM DOS INVERSORES SÃO A VITRINE DA AMPÉRE
							</p>
						</div>
					</div>
				</div>
				<div className="flex w-full flex-col gap-y-2">
					...
					<div className="mt-2 flex flex-col items-center pl-5">
						<div className="grid w-full grid-cols-10 gap-2 lg:w-[60%]">
							<BsFillSunFill style={{ color: "#fead61", fontSize: "25px" }} />
							<p className="col-span-9 font-medium">CERTIFICAR-SE QUE TODOS OS LIXOS DE TODAS AS ETAPAS FORAM RETIRADOS E DESCARTADOS NOS SEUS DEVIDOS LUGARES</p>
						</div>
						<div className="grid w-full grid-cols-10 gap-2 lg:w-[60%]">
							<BsFillSunFill style={{ color: "#fead61", fontSize: "25px" }} />
						...
						<div className="grid w-full grid-cols-10 gap-2 lg:w-[60%]">
							<BsFillSunFill style={{ color: "#fead61", fontSize: "25px" }} />
							<p className="col-span-9 font-medium">ANTES DE SAIR DA CASA DO CLIENTE FAZER UMA ULTIMA INSPEÇÃO VISUAL PRA VERIFICAR SE TUDO ESTÁ CORRETO</p>
						</div>
						<div className="grid w-full grid-cols-10 gap-2 lg:w-[60%]">
							<BsFillSunFill style={{ color: "#fead61", fontSize: "25px" }} />
							<p className="col-span-9 font-medium">ANTES DE SAIR DA CASA DO CLIENTE PERGUNTAR SE ESTA TUDO CORRETO OU SE PODEMOS FAZER MAIS ALGUMA COISA POR ELE</p>
						</div>
						<div className="grid w-full grid-cols-10 gap-2 lg:w-[60%]">
							<BsFillSunFill style={{ color: "#fead61", fontSize: "25px" }} />
							<p className="col-span-9 font-medium">
								DESPEDIR-SE DO CLIENTE E FALAR PRA ELE QUE O ENGENHEIRO RESPONSÁVEL VAI FAZER UMA INSPEÇÃO E CONFIGURAÇÕES E AJUSTES FINAIS SE HOUVER NECESSIDADE
							</p>
						</div>
					</div>
				</div>
			...
			<div className="mt-3 flex flex-wrap justify-center gap-2">
				<div className="flex w-fit flex-col items-center">
					<label className="ml-2 text-center font-bold text-[#15599a]">FILMAGEM DO TESTE DE ÁGUA (VISTO DO TELHADO)</label>
							...
							{files.filmagemTesteAguaDoTelhado ? (
								<div className="flex flex-col items-center">
									...
									<span className="block text-center font-normal text-gray-400">
										{files.filmagemTesteAguaDoTelhado.length == 1 ? files.filmagemTesteAguaDoTelhado[0].name : `${files.filmagemTesteAguaDoTelhado[0].name}...`}
									</span>
								</div>
							) : (
								<div className="flex flex-col items-center">
				...
				<div className="flex w-fit flex-col items-center">
					<label className="ml-2 text-center font-bold text-[#15599a]">FILMAGEM DO PÓS TESTE DE ÁGUA (VISTO DA LAJE)</label>
					<div className="relative mt-2 flex h-fit items-center justify-center rounded-lg border-2 border-dotted border-blue-700 bg-gray-100 p-2">
						<div className="absolute">
							{files.filmagemPosTesteAguaNaLaje ? (
								<div className="flex flex-col items-center">
									<i className="fa fa-folder-open fa-4x text-blue-700"></i>
									<span className="block text-center font-normal text-gray-400">
										{files.filmagemPosTesteAguaNaLaje.length == 1 ? files.filmagemPosTesteAguaNaLaje[0].name : `${files.filmagemPosTesteAguaNaLaje[0].name}...`}
									</span>
								</div>
							) : (
								<div className="flex flex-col items-center">
				...
				<div className="flex w-fit flex-col items-center">
					<label className="ml-2 text-center font-bold text-[#15599a]">FOTO/FILMAGEM DA ANTENA/DATALOGGER/DTU PÓS-CONFIGURAÇÃO</label>
					<div className="relative mt-2 flex h-fit items-center justify-center rounded-lg border-2 border-dotted border-blue-700 bg-gray-100 p-2">
						<div className="absolute">
							{files.fotoDataloggerPosConfig ? (
								<div className="flex flex-col items-center">
									<i className="fa fa-folder-open fa-4x text-blue-700"></i>
									<span className="block text-center font-normal text-gray-400">
										{files.fotoDataloggerPosConfig.length == 1 ? files.fotoDataloggerPosConfig[0].name : `${files.fotoDataloggerPosConfig[0].name}...`}
									</span>
								</div>
							) : (
								<div className="flex flex-col items-center">
							...
							<div className="absolute">
								{files.fotoMedicoesCADisjuntorAntes ? (
									<div className="flex flex-col items-center">
										<i className="fa fa-folder-open fa-4x text-blue-700"></i>
										<span className="block text-center font-normal text-gray-400">
											{files.fotoMedicoesCADisjuntorAntes.length == 1 ? files.fotoMedicoesCADisjuntorAntes[0].name : `${files.fotoMedicoesCADisjuntorAntes[0].name}...`}
										</span>
									</div>
								) : (
									<div className="flex flex-col items-center">
							...
							<div className="absolute">
								{files.fotoMedicoesCADisjuntorDepois ? (
									<div className="flex flex-col items-center">
										<i className="fa fa-folder-open fa-4x text-blue-700"></i>
										<span className="block text-center font-normal text-gray-400">
											{files.fotoMedicoesCADisjuntorDepois.length == 1 ? files.fotoMedicoesCADisjuntorDepois[0].name : `${files.fotoMedicoesCADisjuntorDepois[0].name}...`}
										</span>
									</div>
								) : (
									<div className="flex flex-col items-center">
