		...
		<div className="my-2 flex w-full flex-col">
			...
			<div className="my-2 flex flex-col items-center gap-y-2 border-y border-gray-300 py-2">
				...
				<div className="grid w-full grid-cols-10 gap-2 lg:w-[60%]">
					<BsFillSunFill style={{ color: "#fead61", fontSize: "25px" }} />
					<p className="col-span-9 font-medium">
						CONEXÃO DOS CABOS DE CORRENTE ALTERNADA SEMPRE COM CONECTORES CORRETOS PARA CONEXÃO, CONECTORES DE PERFURAÇÃO OU BIMETÁLICO QUANDO HOUVER NECESSIDADE
					</p>
				</div>
				<div className="grid w-full grid-cols-10 gap-2 lg:w-[60%]">
					<BsFillSunFill style={{ color: "#fead61", fontSize: "25px" }} />
					<p className="col-span-9 font-medium">
						QUANDO USAR CONECTORES BIMETÁLICO PARA CONEXÃO COM A REDE, FAZER O ISOLAMENTO CORRETO, 1° ETAPA PASSAR UMA CAMADA DE FITA DE BAIXA TENSÃO, 2° ETAPA CAMADA DE FITA DE ALTA
				...
				<div className="grid w-full grid-cols-10 gap-2 lg:w-[60%]">
					<BsFillSunFill style={{ color: "#fead61", fontSize: "25px" }} />
					<p className="col-span-9 font-medium">
						FAZER INSPEÇÃO VISUAL SE TODAS AS CONEXÕES ESTÃO CORRETAS, SE ESTÃO ISOLADAS CORRETAMENTE, E SE OS CONECTORES DE PERFURAÇÃO QUEBRARAM OS PARAFUSOS E ISOLAR A PONTA DO CABO DE
						DERIVAÇÃO
					</p>
				</div>
				<div className="grid w-full grid-cols-10 gap-2 lg:w-[60%]">
				...
				<div className="grid w-full grid-cols-10 gap-2 lg:w-[60%]">
					<BsFillSunFill style={{ color: "#fead61", fontSize: "25px" }} />
					<p className="col-span-9 font-medium">
						DURANTE TODO PROCESSO DE MONTAGEM TANTO DOS MÓDULOS, LANÇAMENTO DE CABOS OU MONTAGEM MECÂNICA, DEIXAR CEM PORCENTO AS FERRAMENTAS ORGANIZADAS, NÃO DEIXAR FERRAMENTAS ESPALHAS
						POR TODA A CASA DO CLIENTE, ISSO ACONTECE MUITO
					</p>
				</div>
				<div className="grid w-full grid-cols-10 gap-2 lg:w-[60%]">
					<BsFillSunFill style={{ color: "#fead61", fontSize: "25px" }} />
			...
			<div className="flex flex-wrap justify-center gap-2">
				<div className="flex w-fit flex-col items-center">
					<label className="ml-2 text-center font-bold text-[#15599a]">FOTOS/FILMAGEM DO CABEAMENTO LANÇADO NA LAJE (ROLDANAS FIXADAS, ELETRODUTOS, MANGUEIRA HIPERFLEX, ETC)</label>
				...
				<div className="flex w-fit flex-col items-center">
					<label className="ml-2 text-center font-bold text-[#15599a]">FOTOS/FILMAGEM DA CONEXÃO DO SISTEMA COM A REDE DO CLIENTE (NO QUADRO OU RAMAL)</label>
					<div className="relative mt-2 flex h-fit items-center justify-center rounded-lg border-2 border-dotted border-blue-700 bg-gray-100 p-2">
						<div className="absolute">
