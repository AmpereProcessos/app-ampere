			...
			<div className="border-primary/20 my-2 flex flex-col items-center gap-y-2 border-y py-2">
				...
				<div className="grid w-full grid-cols-10 gap-2 lg:w-[60%]">
					...
					<p className="col-span-9 font-medium">
						ANTES DE COMEÇAR A MONTAGEM DOS INVERSORES FAZER INSPEÇÃO VISUAL PARA EVITAR QUE OS EQUIPAMENTOS MOLHEM OU PEGUEM SOL
					</p>
				</div>
				<div className="grid w-full grid-cols-10 gap-2 lg:w-[60%]">
					<BsFillSunFill style={{ color: "#fead61", fontSize: "25px" }} />
				...
				<div className="grid w-full grid-cols-10 gap-2 lg:w-[60%]">
					<BsFillSunFill style={{ color: "#fead61", fontSize: "25px" }} />
					<p className="col-span-9 font-medium">
						CONCLUINDO A MONTAGEM FAZER INSPEÇÃO VISUAL DE TODA A MONTAGEM, PARA GARANTIR QUE NÃO ESTEJA FALTANDO NADA, PRINCIPALMENTE PARAFUSO DE BOX RETO
						E ADESIVOS DA AMPÉRE
					</p>
				</div>
				<div className="grid w-full grid-cols-10 gap-2 lg:w-[60%]">
					<BsFillSunFill style={{ color: "#fead61", fontSize: "25px" }} />
