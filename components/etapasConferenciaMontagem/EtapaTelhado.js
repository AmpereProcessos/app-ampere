	...
	return (
		<div className="my-2 flex w-full flex-col">
			...
			<div className="my-2 flex flex-col items-center gap-y-2 border-y border-gray-300 py-2">
				...
				<div className="grid w-full grid-cols-10 gap-2 lg:w-[60%]">
					<BsFillSunFill style={{ color: "#fead61", fontSize: "25px" }} />
					<p className="col-span-9 font-medium">VERIFICAR SE TODAS AS CONEXÕES DE CORRENTE ALTERANADA DOS MICROS ESTEJAM ESTANHADAS E ISOLADAS CORRETAMENTE</p>
				</div>
				<div className="grid w-full grid-cols-10 gap-2 lg:w-[60%]">
					<BsFillSunFill style={{ color: "#fead61", fontSize: "25px" }} />
				...
				<div className="grid w-full grid-cols-10 gap-2 lg:w-[60%]">
					<BsFillSunFill style={{ color: "#fead61", fontSize: "25px" }} />
					<p className="col-span-9 font-medium">ANTES DA MONTAGEM DOS MÓDULOS FAZER INSPEÇÃO VISUAL SE ESTÁ TUDO CORRETO E CONFERIR SE TEM TELHAS QUEBRADAS</p>
				</div>
				<div className="grid w-full grid-cols-10 gap-2 lg:w-[60%]">
					<BsFillSunFill style={{ color: "#fead61", fontSize: "25px" }} />
					<p className="col-span-9 font-medium">DURANTE A FIXAÇÃO DOS MÓDULOS FAZER CONFERÊNCIA SE OS MÓDULOS ESTÃO SENDO CONECTADOS CORRETAMENTE TANTO EM SÉRIE OU NOS MICROS</p>
				</div>
				<div className="grid w-full grid-cols-10 gap-2 lg:w-[60%]">
					<BsFillSunFill style={{ color: "#fead61", fontSize: "25px" }} />
					<p className="col-span-9 font-medium">DURANTE A FIXAÇÃO DOS MÓDULOS FAZER OUTRA INSPEÇÃO VISUAL MÓDULO A MÓDULO COM O INTUITO DE RETIRAR TELHAS QUEBRADAS</p>
				</div>
				<div className="grid w-full grid-cols-10 gap-2 lg:w-[60%]">
					<BsFillSunFill style={{ color: "#fead61", fontSize: "25px" }} />
					<p className="col-span-9 font-medium">
						DURANTE TODA A MONTAGEM NO TELHADO LEVAR SACOLAS PARA IR ARMAZENANDO O LIXO QUE APARECE DURANTE O PROCESSO. (LIXO EM RUFOS E CALHAS, LIXO EM SAÍDAS DE ÁGUA, ABRAÇADEIRAS
						DESCARTADAS)
					</p>
				</div>
				<div className="grid w-full grid-cols-10 gap-2 lg:w-[60%]">
