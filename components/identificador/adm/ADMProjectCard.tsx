      ...
      <div className="flex flex-col p-2">
        ...
        <div className="flex items-center justify-between pb-2">
          ...
          <div className="flex flex-col items-center gap-1">
            ...
            <p className={`text-foreground rounded p-1 text-sm font-bold`}>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex flex-col items-end gap-1">
            ...
            <p className="text-foreground text-end text-xs">
              {project.compra?.statusLiberacao ? project.compra.statusLiberacao : "-"}
            </p>
          </div>
        </div>
        <div className="mt-1 flex w-full flex-wrap items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <p className="text-foreground text-[0.65rem] leading-none font-medium tracking-tight lg:text-xs">
              ...
              {project.receita && project.receita?.fracionamento.length > 1
                ? "RECEBIMENTOS"
                : "RECEBIMENTO"}
            </p>
          </div>
