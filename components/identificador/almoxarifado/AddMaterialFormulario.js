    ...
    <div className="flex flex-col w-full gap-2 mt-2">
      <div className="flex items-center justify-center w-full gap-2">
        <button
          ...
          className={`text-center p-2 rounded w-fit border border-[#15599a] font-bold ${
            mode == "ESTOCÁVEIS"
        ...
        <button
          ...
          className={`text-center p-2 rounded w-fit border border-[#fead41] font-bold ${
            mode == "NÃO ESTOCÁVEIS"
      ...
      {mode == "ESTOCÁVEIS" ? (
        <div className="flex flex-col lg:flex-row items-center w-full gap-4 lg:gap-2 mt-2">
          ...
          <input
            ...
            className="outline-none text-center border border-gray-200 w-full lg:w-[30%] h-[41px]"
            onChange={(e) =>
              setInfoHolder((prev) => ({
                ...prev,
        ...
        <div className="flex flex-col lg:flex-row items-center w-full gap-4 lg:gap-2 mt-2">
          ...
          <div className="w-full lg:w-[10%]">
            <TextFloatingInput
              ...
              handleChange={(value) =>
                setInfoHolder((prev) => ({ ...prev, grandeza: value }))
              }
              width={"100%"}
              marginBottom={"0px"}
            />
