	...
	return (
		<div className="border-primary/20 flex w-full flex-col rounded-md border p-3 lg:w-[450px]">
			<div className="flex w-full items-center justify-between gap-2">
				...
				>
					<h1 className="text-[0.65rem] font-medium text-white lg:text-xs">{formulary.dataEfetivacao ? "FINALIZADO" : "EM ABERTO"}</h1>
				</div>
			</div>
			...
			<div className="mt-1 flex w-full flex-wrap items-center justify-between">
				<div className="flex items-center gap-2">
					<FaDiamond />
					<p className="text-primary/60 text-[0.65rem] leading-none font-medium tracking-tight lg:text-xs">{formulary.categoria}</p>
				</div>
			...
			<div className="mt-2 flex w-full flex-wrap items-center justify-between">
				<div className="flex items-center gap-2">
					<FaCity />
					<p className="text-primary/60 text-[0.65rem] leading-none font-medium tracking-tight lg:text-xs">{formulary.localizacao.cidade}</p>
				</div>
				<div className="flex items-center gap-2">
					<FaUsers color={"rgb(30,64,175)"} />
					<p className="text-primary/60 text-[0.65rem] leading-none font-medium tracking-tight lg:text-xs">{formulary.responsaveis}</p>
				</div>
			</div>
			<div className="mt-2 flex w-full items-center justify-between">
				<div className="flex items-center gap-2">
					<BsCalendarPlus />
					<p className="text-primary/60 text-xs font-medium">{formatDateAsLocale(formulary.dataInsercao, true)}</p>
				</div>
