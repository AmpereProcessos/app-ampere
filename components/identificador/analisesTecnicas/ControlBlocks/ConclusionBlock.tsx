          ...
          <div className="w-full lg:w-1/3">
            <CheckboxInput
              ...
              handleChange={(value) => {
                setInfoHolder((prev) => ({
                  ...prev,
                  conclusao: { ...prev.conclusao, espaco: value },
                }));
          ...
          <div className="w-full lg:w-1/3">
            <CheckboxInput
              ...
              handleChange={(value) => {
                setInfoHolder((prev) => ({
                  ...prev,
                  conclusao: { ...prev.conclusao, inclinacao: value },
                }));
          ...
          <div className="w-full lg:w-1/3">
            <CheckboxInput
              ...
              handleChange={(value) => {
                setInfoHolder((prev) => ({
                  ...prev,
                  conclusao: { ...prev.conclusao, sombreamento: value },
                }));
          ...
          <div className="w-full lg:w-1/3">
            <SelectInput
              ...
              handleChange={(value) => {
                setInfoHolder((prev) => ({
                  ...prev,
                  conclusao: { ...prev.conclusao, padrao: value },
                }));
              ...
              onReset={() => {
                setInfoHolder((prev) => ({
                  ...prev,
                  conclusao: { ...prev.conclusao, padrao: null },
                }));
          ...
          <div className="w-full lg:w-1/3">
            <SelectInput
              ...
              handleChange={(value) => {
                setInfoHolder((prev) => ({
                  ...prev,
                  conclusao: { ...prev.conclusao, estrutura: value },
                }));
              ...
              onReset={() => {
                setInfoHolder((prev) => ({
                  ...prev,
                  conclusao: { ...prev.conclusao, estrutura: null },
                }));
