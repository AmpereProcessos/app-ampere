		...
		<div className="mt-4 flex w-full flex-col">
			...
			<div className="mt-2 flex w-full flex-col gap-2">
				...
				{infoHolder.padrao.length > 0 ? (
					...
					<p className="flex w-full grow items-center justify-center py-2 text-center font-medium italic tracking-tight text-gray-500">Nenhum padrão adicionado à lista...</p>
				)}
			</div>
		</div>
	);
