          ...
          <div className="flex w-full flex-col justify-around gap-2 lg:flex-row">
            <div className="w-full lg:w-1/3">
              <SelectInput
                ...
                handleChange={(value) =>
                  setPaInfoHolder((prev) => ({ ...prev, novaLigacao: value }))
                }
            ...
            <div className="w-full lg:w-1/3">
              <SelectInput
                ...
                handleChange={(value) =>
                  setPaInfoHolder((prev) => ({ ...prev, novaAmperagem: value }))
                }
      ...
      <div className="mt-2 flex w-full flex-col gap-2">
        ...
        {infoHolder.padrao.length > 0 ? (
          infoHolder.padrao.map((paInfo, index) => (
            <div key={index} className="border-border flex w-full flex-col border p-2 shadow-xs">
              <div className="flex w-full items-center justify-between">
                <h1 className="text-foreground leading-none font-medium tracking-tight">
                ...
                <div className="mt-2 flex w-full flex-col">
                  ...
                  <div className="mt-1 flex w-full flex-wrap items-center justify-around">
                    <div className="flex w-1/2 items-center gap-2 lg:w-fit">
                      ...
                      <p className="text-xs lg:text-sm">
                        <strong className="text-cyan-500">NOVA AMPERAGEM:</strong>{" "}
                        {paInfo.novaAmperagem}
                      </p>
                    </div>
                    <div className="flex w-1/2 items-center gap-2 lg:w-fit">
                      <LuUtilityPole />
                      <p className="text-xs lg:text-sm">
                        <strong className="text-cyan-500">NOVA LIGAÇÃO:</strong>{" "}
                        {paInfo.novaLigacao}
                      </p>
                    </div>
                  </div>
