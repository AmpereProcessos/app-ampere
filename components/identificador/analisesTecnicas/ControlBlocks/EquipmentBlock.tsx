...
import { TEquipment, TTechnicalAnalysis, TTechnicalAnalysisDTO } from "@/utils/schemas/technical-analysis";
	...
	return (
		<div className="mt-4 flex w-full flex-col">
			...
			{previousEquipmentMenuIsOpen ? (
				<PreviousEquipmentMenu infoHolder={infoHolder as TTechnicalAnalysis} setInfoHolder={setInfoHolder as React.Dispatch<React.SetStateAction<TTechnicalAnalysis>>} />
			) : null}
		</div>
	);
}
