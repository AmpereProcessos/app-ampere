  ...
  return (
    <div className="mt-4 flex w-full flex-col">
      ...
      <div className="mt-2 flex w-full flex-col gap-2">
        ...
        <div className="flex w-full items-center justify-center self-center lg:w-1/3">
          <CheckboxInput
            ...
            handleChange={(value) => {
              setInfoHolder((prev) => ({
                ...prev,
                execucao: { ...prev.execucao, espacoQGBT: value },
              }));
        ...
        <TechnicalAnalysisServiceOrders
          session={session}
          technicalAnalysisMainServiceOrderId={infoHolder.idOrdemServico}
          technicalAnalysisId={infoHolder._id}
        />
      </div>
    </div>
  );
...
function TechnicalAnalysisServiceOrders({
  session,
  technicalAnalysisMainServiceOrderId,
  technicalAnalysisId,
}: TechnicalAnalysisServiceOrdersProps) {
  ...
  const {
    ...
    isSuccess,
    error,
  } = useServiceOrdersByTechnicalAnalysis({ technicalAnalysisId });
        ...
        {!technicalAnalysisMainServiceOrderId ? (
          ...
          >
            ...
            <h1 className="text-xs font-medium tracking-tight">
              GERAR ORDEM DE SERVIÇO DA ANÁLISE
            </h1>
          </button>
        ) : null}
      </div>
