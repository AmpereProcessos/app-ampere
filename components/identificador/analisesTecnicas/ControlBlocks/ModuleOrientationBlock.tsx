				...
				<div className="grid grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-4">
					<div className="grid grid-cols-3 items-center rounded border border-cyan-500 p-1">
						<div className="flex items-center justify-start gap-2">
							<div className="flex items-center justify-center rounded-full border border-cyan-500 p-1 text-cyan-500">{renderIcon(orientationIcons["NORTE"])}</div>
					...
					<div className="grid grid-cols-3 items-center rounded border border-cyan-500 p-1">
						<div className="flex items-center justify-start gap-2">
							<div className="flex items-center justify-center rounded-full border border-cyan-500 p-1 text-cyan-500">{renderIcon(orientationIcons["NORDESTE"])}</div>
					...
					<div className="grid grid-cols-3 items-center rounded border border-cyan-500 p-1">
						<div className="flex items-center justify-start gap-2">
							<div className="flex items-center justify-center rounded-full border border-cyan-500 p-1 text-cyan-500">{renderIcon(orientationIcons["LESTE"])}</div>
					...
					<div className="grid grid-cols-3 items-center rounded border border-cyan-500 p-1">
						<div className="flex items-center justify-start gap-2">
							<div className="flex items-center justify-center rounded-full border border-cyan-500 p-1 text-cyan-500">{renderIcon(orientationIcons["SUDESTE"])}</div>
					...
					<div className="grid grid-cols-3 items-center rounded border border-cyan-500 p-1">
						<div className="flex items-center justify-start gap-2">
							<div className="flex items-center justify-center rounded-full border border-cyan-500 p-1 text-cyan-500">{renderIcon(orientationIcons["SUL"])}</div>
					...
					<div className="grid grid-cols-3 items-center rounded border border-cyan-500 p-1">
						<div className="flex items-center justify-start gap-2">
							<div className="flex items-center justify-center rounded-full border border-cyan-500 p-1 text-cyan-500">{renderIcon(orientationIcons["SUDOESTE"])}</div>
					...
					<div className="grid grid-cols-3 items-center rounded border border-cyan-500 p-1">
						<div className="flex items-center justify-start gap-2">
							<div className="flex items-center justify-center rounded-full border border-cyan-500 p-1 text-cyan-500">{renderIcon(orientationIcons["OESTE"])}</div>
					...
					<div className="grid grid-cols-3 items-center rounded border border-cyan-500 p-1">
						<div className="flex items-center justify-start gap-2">
							<div className="flex items-center justify-center rounded-full border border-cyan-500 p-1 text-cyan-500">{renderIcon(orientationIcons["NOROESTE"])}</div>
