import { getModulesAveragePower } from "@/utils/methods/extracting";
...
function ModuleOrientationBlock({
  infoHolder,
  setInfoHolder,
  changes,
  setChanges,
}: ModuleOrientationBlockProps) {
  return (
        ...
        <div className="grid grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-4">
          <div className="grid grid-cols-3 items-center rounded border border-cyan-500 p-1">
            <div className="flex items-center justify-start gap-2">
              ...
              <p className="text-foreground text-center text-xs font-bold lg:text-base">NORTE</p>
            </div>
            ...
            <input
              ...
              onChange={(e) => {
                setInfoHolder((prev) => ({
                  ...prev,
                  alocacaoModulos: { ...prev.alocacaoModulos, norte: Number(e.target.value) },
                }));
                setChanges((prev) => ({
                  ...prev,
                  "alocacaoModulos.norte": Number(e.target.value),
                }));
              }}
            />

            <p className="text-foreground text-center text-xs font-bold lg:text-base">
          ...
          <div className="grid grid-cols-3 items-center rounded border border-cyan-500 p-1">
            <div className="flex items-center justify-start gap-2">
              ...
              <p className="text-foreground text-center text-xs font-bold lg:text-base">NORDESTE</p>
            </div>
            <input
              className="text-foreground p-2 text-center font-bold outline-hidden"
              type={"number"}
              ...
              onChange={(e) => {
                setInfoHolder((prev) => ({
                  ...prev,
                  alocacaoModulos: { ...prev.alocacaoModulos, nordeste: Number(e.target.value) },
                }));
                setChanges((prev) => ({
                  ...prev,
                  "alocacaoModulos.nordeste": Number(e.target.value),
                }));
              }}
            />
          ...
          <div className="grid grid-cols-3 items-center rounded border border-cyan-500 p-1">
            <div className="flex items-center justify-start gap-2">
              ...
              <p className="text-foreground text-center text-xs font-bold lg:text-base">LESTE</p>
            </div>
            <input
              className="text-foreground p-2 text-center font-bold outline-hidden"
              type={"number"}
              ...
              onChange={(e) => {
                setInfoHolder((prev) => ({
                  ...prev,
                  alocacaoModulos: { ...prev.alocacaoModulos, leste: Number(e.target.value) },
                }));
                setChanges((prev) => ({
                  ...prev,
                  "alocacaoModulos.leste": Number(e.target.value),
                }));
              }}
            />
          ...
          <div className="grid grid-cols-3 items-center rounded border border-cyan-500 p-1">
            <div className="flex items-center justify-start gap-2">
              ...
              <p className="text-foreground text-center text-xs font-bold lg:text-base">SUDESTE</p>
            </div>
            <input
              className="text-foreground p-2 text-center font-bold outline-hidden"
              type={"number"}
              ...
              onChange={(e) => {
                ...
                setChanges((prev) => ({
                  ...prev,
                  "alocacaoModulos.sudeste": Number(e.target.value),
                }));
              }}
            />
          ...
          <div className="grid grid-cols-3 items-center rounded border border-cyan-500 p-1">
            <div className="flex items-center justify-start gap-2">
              ...
              <p className="text-foreground text-center text-xs font-bold lg:text-base">SUL</p>
            </div>
            <input
              className="text-foreground p-2 text-center font-bold outline-hidden"
              type={"number"}
          ...
          <div className="grid grid-cols-3 items-center rounded border border-cyan-500 p-1">
            <div className="flex items-center justify-start gap-2">
              ...
              <p className="text-foreground text-center text-xs font-bold lg:text-base">SUDOESTE</p>
            </div>
            <input
              className="text-foreground p-2 text-center font-bold outline-hidden"
              type={"number"}
              ...
              onChange={(e) => {
                ...
                setChanges((prev) => ({
                  ...prev,
                  "alocacaoModulos.sudoeste": Number(e.target.value),
                }));
              }}
            />
          ...
          <div className="grid grid-cols-3 items-center rounded border border-cyan-500 p-1">
            <div className="flex items-center justify-start gap-2">
              ...
              <p className="text-foreground text-center text-xs font-bold lg:text-base">OESTE</p>
            </div>
            <input
              className="text-foreground p-2 text-center font-bold outline-hidden"
              type={"number"}
              ...
              onChange={(e) => {
                ...
                setChanges((prev) => ({
                  ...prev,
                  "alocacaoModulos.oeste": Number(e.target.value),
                }));
              }}
            />
          ...
          <div className="grid grid-cols-3 items-center rounded border border-cyan-500 p-1">
            <div className="flex items-center justify-start gap-2">
              ...
              <p className="text-foreground text-center text-xs font-bold lg:text-base">NOROESTE</p>
            </div>
            <input
              className="text-foreground p-2 text-center font-bold outline-hidden"
              type={"number"}
              ...
              onChange={(e) => {
                ...
                setChanges((prev) => ({
                  ...prev,
                  "alocacaoModulos.noroeste": Number(e.target.value),
                }));
              }}
            />
