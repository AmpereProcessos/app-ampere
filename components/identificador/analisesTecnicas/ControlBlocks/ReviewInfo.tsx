  ...
  if (isSuccess)
    ...
    return (
      <div className="bg-background flex w-full grow flex-col px-2">
        <span className="py-2 text-center text-xl font-bold text-green-500 uppercase">REVISÃO DAS INFORMAÇÕES</span>
        <div className="w-full grow flex-col">
          <div className="bg-background flex w-full grow flex-col px-2">
            <span className="py-2 text-center text-lg font-bold text-[#15599a] uppercase">DADOS GERAIS</span>
          ...
          <div className="bg-background flex w-full flex-col pb-2">
            <span className="py-2 text-center text-lg font-bold text-[#15599a] uppercase">DADOS DO SISTEMA</span>
            <p className="text-primary/60 text-center text-lg italic">
              {getJoinedSystemInfo({
          ...
          <div className="bg-background flex w-full flex-col pb-2">
            <span className="py-2 text-center text-lg font-bold text-[#15599a] uppercase">DADOS DO PADRÃO</span>
            ...
            <div className="mt-2 flex w-full flex-col gap-2">
              {requestInfo.padrao.map((paInfo, index) => (
                <div key={index} className="border-primary/20 flex w-full flex-col border p-2 shadow-xs">
                  <div className="flex w-full items-center justify-between">
                    <h1 className="text-primary/60 leading-none font-medium tracking-tight">
          ...
          <div className="bg-background flex w-full flex-col pb-2">
            <span className="py-2 text-center text-lg font-bold text-[#15599a] uppercase">DADOS DO ESTRUTURA</span>
            <div className="flex w-full flex-col items-center gap-2 lg:flex-row">
          ...
          <div className="bg-background flex w-full flex-col pb-2">
            <span className="py-2 text-center text-lg font-bold text-[#15599a] uppercase">DADOS DA INSTALAÇÃO</span>
          ...
          {requestInfo.tipoSolicitacao == 'VISITA TÉCNICA REMOTA - RURAL' ? (
            <div className="bg-background flex w-full flex-col pb-2">
              <span className="py-2 text-center text-lg font-bold text-[#15599a] uppercase">SERVIÇOS ADICIONAIS</span>
              <div className="flex w-full grow flex-col gap-2">
                <div className="flex w-full flex-col items-center gap-2 lg:flex-row">
                  <div className="flex w-full items-center justify-center lg:w-[50%]">
                    <SelectInput
          ...
          <div className="w-fll bg-background flex flex-col pb-2">
            <span className="py-2 text-center text-lg font-bold text-[#15599a] uppercase">ARQUIVOS</span>
            {files
              ? Object.keys(files).map((key, index) => {
                  return (
                    <div key={index} className="flex items-center justify-center gap-2">
                      <p className="text-primary/60 text-sm italic">{files[key].title}</p>
                      <ImAttachment />
                    </div>
                  )
                })
              : requestInfo.arquivos.map((file, index) => (
                  <div key={index} className="flex items-center justify-center gap-2">
                    <p className="text-primary/60 text-sm italic">{file.descricao}</p>
                    <ImAttachment />
                  </div>
                ))}
          </div>
        ...
        <div className="mt-2 flex w-full flex-wrap justify-end gap-2">
          ...
          className="rounded p-2 font-bold text-primary/60 duration-300 hover:scale-105"
          >
          Voltar
          </button> */}
          <button
