				...
				<div className="flex w-full flex-wrap items-center justify-end gap-2">
					...
					>
						...
						<h1 className="text-xs font-medium tracking-tight">
							{!newSupplyItemMenuIsOpen ? "ABRIR MENU DE NOVO ITEM DE SUPRIMENTO" : "FECHAR MENU DE NOVO ITEM DE SUPRIMENTO"}
						</h1>
					</button>
				</div>
				...
				<div className="border-primary bg-background flex w-full flex-col gap-1 rounded border p-2 shadow-xs dark:bg-[#121212]">
					<div className="flex w-full flex-col items-center justify-between gap-2 lg:flex-row">
						...
						<div className="flex items-center gap-1">
							...
							<h1 className="text-primary/80 py-0.5 text-center text-[0.6rem] font-medium italic">{formatToMoney(item.qtde * (item.preco || 0))}</h1>
						</div>
					</div>
					<div className="flex w-full flex-col items-center justify-between gap-2 lg:flex-row">
