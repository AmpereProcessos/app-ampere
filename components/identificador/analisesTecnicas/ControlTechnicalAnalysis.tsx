						...
						{isSuccess ? (
							<>
								<div className="flex grow flex-col gap-y-2 overflow-y-auto overscroll-y-auto px-2 py-2 scrollbar-thin scrollbar-track-gray-100 scrollbar-thumb-gray-300">
											...
											<div className="flex items-center gap-2">
												...
												{analysis.oportunidade.id ? (
													<Link href={`https://crm.ampereenergias.com.br/comercial/oportunidades/id/${analysis.oportunidade.id}`}>
														<p className="cursor-pointer font-raleway text-sm font-medium duration-300 ease-in-out hover:text-cyan-300">#{analysis.oportunidade.identificador || "N/A"}</p>
													</Link>
												) : (
													<p className="cursor-pointer font-raleway text-sm font-medium duration-300 ease-in-out hover:text-blue-300">#{analysis.oportunidade.identificador || "N/A"}</p>
												)}
											</div>
											<div className="flex items-center gap-2">
									...
									<ExecutionBlock session={session} infoHolder={infoHolder} setInfoHolder={setInfoHolder} changes={changes} setChanges={setChanges} />
