  ...
  return (
    <div className="my-2 flex w-full flex-col items-center gap-1">
      {totalPages > 1 ? (
        <>
          <p className="text-foreground w-full text-center text-sm leading-none tracking-tight">
            Um número grande de análises foi encontrado, separamos em páginas para facilitar a
            visualização. Clique na página desejada para visualizar os demais análises.
          </p>
      ...
      <p className="text-foreground w-full text-center text-sm leading-none tracking-tight">
        {analysisMatched
          ? analysisMatched > 0
            ? `${analysisMatched} análises encontrados.`
            : `${analysisMatched} análise encontrado.`
          : "..."}
      </p>
      <p className="text-foreground w-full text-center text-sm leading-none tracking-tight">
        {analysisShowing
          ? analysisShowing > 0
            ? `Mostrando ${analysisShowing} análises.`
            : `Mostrando ${analysisShowing} análise.`
          : "..."}
      </p>
    </div>
  );
