        ...
        <div className="mt-6 flex flex-col">
          ...
          <div className="flex w-full flex-col">
            <div className="grid grid-cols-10 border border-black">
              <div className="col-span-1 flex items-center justify-center border-r border-black bg-gray-200 text-center text-xs font-bold">
                NºCAIXA
              </div>
              <div className="col-span-2 flex items-center justify-center border-r border-black bg-gray-200 text-center text-xs font-bold">
                AMPERAGEM
              </div>
              <div className="col-span-2 flex items-center justify-center border-r border-black bg-gray-200 text-center text-xs font-bold">
                MONO/BI/TRI
