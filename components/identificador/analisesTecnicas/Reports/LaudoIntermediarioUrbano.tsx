...
function LaudoIntermediarioUrbano({ analysis }: LaudoIntermediarioUrbanoProps) {
	...
	function getCorrectedGen() {
		...
		let nordeste = analysis.alocacaoModulos.nordeste
			? ((Number(cityFactor["NORDESTE"]) * analysis.alocacaoModulos.nordeste * getModulesAveragePower(analysis.equipamentos as TProductItem[])) / 1000).toFixed(2)
			: 0;
		...
		let sudoeste = analysis.alocacaoModulos.sudoeste
			? ((Number(cityFactor["SUDOESTE"]) * analysis.alocacaoModulos.sudoeste * getModulesAveragePower(analysis.equipamentos as TProductItem[])) / 1000).toFixed(2)
			: 0;
		...
		let noroeste = analysis.alocacaoModulos.noroeste
			? ((Number(cityFactor["NOROESTE"]) * analysis.alocacaoModulos.noroeste * getModulesAveragePower(analysis.equipamentos as TProductItem[])) / 1000).toFixed(2)
			: 0;
