...
import GenFactors from "@/utils/jsons/fatores-geracao.json";
...
import { getModulesAveragePower, getModulesQty } from "@/utils/methods/extracting";
...
function LaudoIntermediarioUrbano({ analysis }: LaudoIntermediarioUrbanoProps) {
  ...
  function getProposedGen() {
    ...
    return (
      (getModulesQty(analysis.equipamentos as TProductItem[]) *
        getModulesAveragePower(analysis.equipamentos as TProductItem[]) *
        factor) /
      1000
    );
          ...
          <div className="flex">
            <div className="grid w-[60%] grid-rows-5">
              <div className="grid grid-cols-2 border-b border-black">
                <p className="border-r border-black bg-[#fead61] p-1 text-center text-xs font-bold text-white">
                  CLIENTE
                </p>
              ...
              <div className="grid grid-cols-2 border-b border-black">
                ...
                <p className="border-r border-black p-1 text-center text-xs">
        ...
        <div className="mt-6 flex flex-col">
          ...
          <div className="grid grid-cols-2">
            <div className="grid-rows-5">
              <div className="grid grid-cols-3 border-b border-black">
                <p className="border-r border-black bg-[#15599a] p-1 text-center text-xs font-bold text-white">
                  ORIENTAÇÃO
                </p>
                <p className="border-r border-black bg-[#15599a] p-1 text-center text-xs font-bold text-white">
                  QTDE PLACAS
              ...
              <div className="grid grid-cols-3 border-b border-black">
                <p className="border-r border-black bg-[#fead61] text-center text-xs font-bold text-white italic">
                  NORTE
                </p>
          ...
          <div className="grid grid-cols-6 border-b border-black">
            ...
            <div className="col-span-2 border-r border-black py-1 text-center text-xs font-bold">
              {formatDecimalPlaces(getProposedGen())} kWh
            </div>
          </div>
          <div className="grid grid-cols-6 border-b border-black">
            ...
            <div className="col-span-2 border-r border-black py-1 text-center text-xs font-bold">
              {formatDecimalPlaces(getCorrectedGen())} kWh
            </div>
          </div>
          <div className="grid grid-cols-6 border-b border-black">
            <div className="col-span-4 border-r border-black bg-[#15599a] py-1 text-center text-xs font-bold text-white italic">
