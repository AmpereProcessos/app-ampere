...
function LaudoSimplesRural({ analysis }: LaudoSimplesRuralProps) {
  function getAdditionalCostsSum(costs: TTechnicalAnalysisDTO["custos"], addTaxes = false) {
    const sum = costs.reduce((acc, current) => {
      ...
      const total = addTaxes
        ? costTotal / (1 - (STANDARD_PROFIT_MARGIN + STANDARD_TAX))
        : costTotal / (1 - STANDARD_PROFIT_MARGIN);
      return acc + total;
    }, 0);
    return sum;
  }
    ...
    <div className="h-[29.7cm] w-[21cm]">
      <div className="flex h-full w-full flex-col">
        <div className="mt-2 flex w-full items-center justify-around border border-t-0 border-black py-2">
          <h1 className="font-bold text-[#15599a] uppercase">LAUDO TÉCNICO COMERCIAL - RURAL</h1>
          <div className="h-[47px] w-[47px]">
            <Image style={{ width: "47px", height: "47px" }} src={Logo} alt="Logo" />
          </div>
        </div>
        <div className="flex flex-col">
          <h1 className="border-x border-black bg-[#15599a] text-center text-sm font-bold text-white">
          ...
          <div className="flex">
            <div className="grid w-[60%] grid-rows-5">
              ...
              <div className="grid grid-cols-2 border-b border-black">
                ...
                <p className="border-r border-black text-center text-xs">
                  {analysis.requerente.apelido || analysis.requerente.nome}
                </p>
              </div>
              <div className="grid grid-cols-2 border-b border-black">
                <p className="border-r border-black text-center text-xs">ENDEREÇO</p>
                <p className="border-r border-black text-center text-xs">
                  {analysis.localizacao.endereco}
                </p>
              </div>
              <div className="grid grid-cols-2 border-b border-black">
                <p className="border-r border-black text-center text-xs">BAIRRO</p>
                <p className="border-r border-black text-center text-xs">
                  {analysis.localizacao.bairro}
                </p>
              </div>
              <div className="grid grid-cols-2 border-b border-black">
          ...
          <div className="flex">
            ...
            <div className="flex w-[80%] flex-col">
              <div className="flex w-full items-center">
                ...
                <p className="w-1/2 p-1 text-center text-[0.6rem] font-bold">
                  {analysis.detalhes.topologia}
                </p>
              </div>
              ...
              <div className="flex w-full flex-col border border-black">
                <div className="flex w-full items-center">
                  <div className="w-1/3 bg-gray-200 p-1 text-center text-[0.6rem] font-bold">
                    QUANTIDADE
                  </div>
                  <div className="w-1/3 bg-gray-200 p-1 text-center text-[0.6rem] font-bold">
                    MODELO
              ...
              <h1 className="font-raleway border border-t-0 border-b-0 border-black bg-[#fead61] text-center text-sm font-bold text-white">
        ...
        <div className="mt-4 flex flex-col">
          <h1 className="border border-b-0 border-black bg-[#15599a] text-center text-sm font-bold text-white">
            ...
            {analysis.desenho.url ? (
              ...
              <div className="flex h-full w-[793.7px] items-center justify-center">
                <p className="text-foreground font-bold italic">
                  Oops, parece que não há nenhum desenho vinculado para essa análise...
                </p>
              </div>
            )}
          </div>
        ...
        <div className="mt-4 flex flex-col">
          <h1 className="border border-black bg-[#15599a] text-center text-sm font-bold text-white">
            CUSTOS ADICIONAIS
          </h1>
          <div className="flex flex-col">
            <div className="grid grid-cols-10 border-b border-black bg-[#fead61]">
              <p className="col-span-3 border-r border-black p-1 text-center text-xs font-bold text-white">
                DESCRIÇÃO
              </p>
              <p className="col-span-2 border-r border-black p-1 text-center text-xs font-bold text-white">
                QUANTIDADE
              </p>
              <p className="col-span-1 border-r border-black p-1 text-center text-xs font-bold text-white">
                GRANDEZA
              </p>
              <p className="col-span-2 border-r border-black p-1 text-center text-xs font-bold text-white">
                VALOR
            ...
            {analysis.custos?.length > 0 ? (
              analysis.custos.map((cost, index) => (
                <div key={index} className="grid grid-cols-10 border-b border-black">
                  <p className="col-span-3 border-r border-black p-1 text-center text-xs font-bold">
                    {cost.descricao}
                  </p>
                  <p className="col-span-2 border-r border-black p-1 text-center text-xs font-bold">
                    {cost.qtde}
                  </p>
                  <p className="col-span-1 border-r border-black p-1 text-center text-xs font-bold">
                    {cost.grandeza}
                  </p>
                  <p className="col-span-2 border-r border-black p-1 text-center text-xs font-bold">
                  ...
                  <p className="col-span-2 border-r border-black p-1 text-center text-xs font-bold">
                    {cost.total
                      ? formatToMoney(cost.totalVendaSimples || 0)
                      : formatToMoney(cost.totalVendaSimples || 0)}
                  </p>
                </div>
              ))
            ) : (
              <div className="flex h-[50px] items-center justify-center border-r border-b border-black italic">
          ...
          <div className="grid grid-cols-10">
            ...
            <div className="col-span-7 flex h-full flex-col">
              <div className="grid grid-cols-7 border-b border-black">
                <div className="col-span-5 border-r border-black bg-[#fead61] p-1 text-center font-bold text-white">
                  VALOR À VISTA
                </div>
                <div className="col-span-2 border-r border-black bg-[#fead61] p-1 text-center font-bold text-white">
                  R${" "}
                  {analysis.custos
                    ? getAdditionalCostsSum(analysis.custos).toFixed(2).replace(".", ",")
                    : "-"}
                </div>
              </div>
              <div className="grid grid-cols-7 border-b border-black">
                <div className="col-span-5 border-r border-black bg-[#15599a] p-1 text-center font-bold text-white">
                  VALOR FINANCIAMENTO
                </div>
                <div className="col-span-2 border-r border-black bg-[#15599a] p-1 text-center font-bold text-white">
                  R${" "}
                  {analysis.custos
                    ? getAdditionalCostsSum(analysis.custos, true).toFixed(2).replace(".", ",")
                    : "-"}
                </div>
              </div>
            </div>
        ...
        <div className="flex flex-col">
          <h1 className="border border-t-0 border-black bg-[#15599a] text-center text-sm font-bold text-white">
            SERVIÇOS EXTRAS
          </h1>
          <div className="grid grid-cols-2 border-b border-black">
            <p className="text-xxs border-r border-black bg-gray-200 text-center font-bold">
              REALIMENTAR
            </p>
            <p className="text-xxs border-r border-black text-center">
              {analysis.servicosAdicionais.realimentar ? "SIM" : "NÃO"}
            </p>
          </div>
          <div className="flex">
            <div className="grid w-[50%] grid-rows-4">
              <div className="grid grid-cols-2 border-b border-black">
                ...
                <p className="text-xxs border-r border-black text-center">
                  {analysis.servicosAdicionais.casaDeMaquinas
                    ? analysis.servicosAdicionais.casaDeMaquinas
                    : "-"}
                </p>
              </div>
              <div className="grid grid-cols-2 border-b border-black">
                ...
                <p className="text-xxs border-r border-black text-center">
                  {analysis.servicosAdicionais.roteador
                    ? analysis.servicosAdicionais.roteador
                    : "-"}
                </p>
              </div>
              <div className="grid grid-cols-2 border-b border-black">
                ...
                <p className="text-xxs border-r border-black text-center">
                  {analysis.servicosAdicionais.alambrado
                    ? analysis.servicosAdicionais.alambrado
                    : "-"}
                </p>
              </div>
              <div className="grid grid-cols-2 border-b border-black">
                ...
                <p className="text-xxs border-r border-black text-center">
                  {analysis.servicosAdicionais.terraplanagem
                    ? analysis.servicosAdicionais.terraplanagem
                    : "-"}
                </p>
              </div>
            ...
            <div className="grid w-[50%] grid-rows-4">
              <div className="grid grid-cols-2 border-b border-black">
                ...
                <p className="text-xxs border-r border-black text-center">
                  {analysis.servicosAdicionais.barracao
                    ? analysis.servicosAdicionais.barracao
                    : "-"}
                </p>
              </div>
              <div className="grid grid-cols-2 border-b border-black">
                ...
                <p className="text-xxs border-r border-black text-center">
                  {analysis.servicosAdicionais.redeReligacao
                    ? analysis.servicosAdicionais.redeReligacao
                    : "-"}
                </p>
              </div>
              <div className="grid grid-cols-2 border-b border-black">
                ...
                <p className="text-xxs border-r border-black text-center">
                  {analysis.servicosAdicionais.britagem
                    ? analysis.servicosAdicionais.britagem
                    : "-"}
                </p>
              </div>
              <div className="grid grid-cols-2 border-b border-black">
                ...
                <p className="text-xxs border-r border-black text-center">
                  {analysis.servicosAdicionais.limpezaLocal
                    ? analysis.servicosAdicionais.limpezaLocal
                    : "-"}
                </p>
              </div>
        ...
        <div className="mt-2 flex flex-col">
          <h1 className="border border-t-0 border-black bg-[#fead61] text-center font-bold text-white">
            ...
            {analysis.descritivo?.length > 0 ? (
              analysis.descritivo?.map((item, index) => (
                <div key={index} className="mb-1 flex w-full flex-col">
                  ...
                  <p className="text-foreground mt-1 w-full text-center text-xs">
                    {item.descricao}
                  </p>
                </div>
              ))
        ...
        <div className="mt-2 flex flex-col">
          <h1 className="bg-[#15599a] text-center text-sm font-bold text-white">
            RESPOSTA DA VISITA TÉCNICA
          </h1>
          <div className="flex flex-col">
            <div className="grid grid-cols-2">
              <div className="col-span-2 grid grid-cols-2 border-b border-black">
                <p className="border-r border-black bg-[#fead61] py-1 text-center text-sm font-bold text-white">
                  ESPAÇO PARA PROJETO
                </p>
                <p className="border-r border-black py-1 text-center text-sm font-bold">
                  {analysis.conclusao.espaco ? "SIM" : "NÃO"}
                </p>
              </div>
        ...
        <div className="mt-2 flex flex-col">
          <h1 className="border border-t-0 border-black bg-[#15599a] text-center font-bold text-white">
            CONCLUSÃO
          </h1>
