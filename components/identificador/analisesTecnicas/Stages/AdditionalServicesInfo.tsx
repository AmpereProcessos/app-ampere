          ...
          <div className="flex w-full items-center justify-center lg:w-[50%]">
            <SelectInput
              ...
              handleChange={(value) =>
                setInfoHolder((prev) => ({
                  ...prev,
                  servicosAdicionais: { ...prev.servicosAdicionais, casaDeMaquinas: value },
                }))
              }
              onReset={() => {
                setInfoHolder((prev) => ({
                  ...prev,
                  servicosAdicionais: { ...prev.servicosAdicionais, casaDeMaquinas: null },
                }));
              }}
          ...
          <div className="flex w-full items-center justify-center lg:w-[50%]">
            <SelectInput
              ...
              handleChange={(value) =>
                setInfoHolder((prev) => ({
                  ...prev,
                  servicosAdicionais: { ...prev.servicosAdicionais, alambrado: value },
                }))
              }
              onReset={() => {
                setInfoHolder((prev) => ({
                  ...prev,
                  servicosAdicionais: { ...prev.servicosAdicionais, alambrado: null },
                }));
              }}
              selectedItemLabel="NÃO DEFINIDO"
            />
          ...
          <div className="flex w-full items-center justify-center lg:w-[50%]">
            <SelectInput
              ...
              handleChange={(value) =>
                setInfoHolder((prev) => ({
                  ...prev,
                  servicosAdicionais: { ...prev.servicosAdicionais, britagem: value },
                }))
              }
              onReset={() => {
                setInfoHolder((prev) => ({
                  ...prev,
                  servicosAdicionais: { ...prev.servicosAdicionais, britagem: null },
                }));
              }}
              selectedItemLabel="NÃO DEFINIDO"
            />
          ...
          <div className="flex w-full items-center justify-center lg:w-[50%]">
            <SelectInput
              ...
              handleChange={(value) =>
                setInfoHolder((prev) => ({
                  ...prev,
                  servicosAdicionais: { ...prev.servicosAdicionais, barracao: value },
                }))
              }
              onReset={() => {
                setInfoHolder((prev) => ({
                  ...prev,
                  servicosAdicionais: { ...prev.servicosAdicionais, barracao: null },
                }));
              }}
              selectedItemLabel="NÃO DEFINIDO"
            />
          ...
          <div className="flex w-full items-center justify-center lg:w-[50%]">
            <SelectInput
              ...
              handleChange={(value) =>
                setInfoHolder((prev) => ({
                  ...prev,
                  servicosAdicionais: { ...prev.servicosAdicionais, roteador: value },
                }))
              }
              onReset={() => {
                setInfoHolder((prev) => ({
                  ...prev,
                  servicosAdicionais: { ...prev.servicosAdicionais, roteador: null },
                }));
              }}
              selectedItemLabel="NÃO DEFINIDO"
            />
          ...
          <div className="flex w-full items-center justify-center lg:w-[50%]">
            <SelectInput
              ...
              handleChange={(value) =>
                setInfoHolder((prev) => ({
                  ...prev,
                  servicosAdicionais: { ...prev.servicosAdicionais, redeReligacao: value },
                }))
              }
              onReset={() => {
                setInfoHolder((prev) => ({
                  ...prev,
                  servicosAdicionais: { ...prev.servicosAdicionais, redeReligacao: null },
                }));
              }}
              selectedItemLabel="NÃO DEFINIDO"
            />
          ...
          <div className="flex w-full items-center justify-center lg:w-[50%]">
            <SelectInput
              ...
              handleChange={(value) =>
                setInfoHolder((prev) => ({
                  ...prev,
                  servicosAdicionais: { ...prev.servicosAdicionais, limpezaLocal: value },
                }))
              }
              onReset={() => {
                setInfoHolder((prev) => ({
                  ...prev,
                  servicosAdicionais: { ...prev.servicosAdicionais, limpezaLocal: null },
                }));
              }}
              selectedItemLabel="NÃO DEFINIDO"
            />
          ...
          <div className="flex w-full items-center justify-center lg:w-[50%]">
            <SelectInput
              ...
              handleChange={(value) =>
                setInfoHolder((prev) => ({
                  ...prev,
                  servicosAdicionais: { ...prev.servicosAdicionais, terraplanagem: value },
                }))
              }
              onReset={() => {
                setInfoHolder((prev) => ({
                  ...prev,
                  servicosAdicionais: { ...prev.servicosAdicionais, terraplanagem: null },
                }));
              }}
              selectedItemLabel="NÃO DEFINIDO"
            />
