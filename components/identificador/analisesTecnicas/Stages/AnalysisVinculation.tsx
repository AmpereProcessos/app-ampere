...
import { useUserTechnicalAnalysis } from "@/utils/methods/query/technical-analysis";
								...
								<div key={`${analysis.nome}-${index}`} className="flex w-full items-center rounded-md border border-gray-300">
									...
									<div className="flex grow flex-col p-3">
										<div className="flex w-full items-start justify-between">
											...
											<h1 className={`w-fit self-center rounded border p-1 text-center text-[0.6rem] font-black ${getStatusColor(analysis.status)}`}>{analysis.status || "NÃO DEFINIDO"}</h1>
										</div>
