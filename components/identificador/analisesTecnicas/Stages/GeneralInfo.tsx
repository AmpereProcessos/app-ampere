		...
		<div className="bg-background flex w-full grow flex-col px-2">
			...
			<div className="flex w-full grow flex-col gap-2">
				...
				<div className="flex w-full flex-col gap-1 rounded border border-orange-700 p-2">
					<p className="text-primary/60 my-2 w-full text-center text-sm leading-none tracking-tight">
						Deseja utilizar uma <strong className="text-orange-700">análise técnica existente de referência</strong>, para alterações ou afins ? Marque a
						opção abaixo para abrir o menu de seleção.
					</p>
