              ...
              {showKits ? (
               ...
               />
				...
				<p className="text-primary/60 my-2 w-full self-center text-center text-sm leading-none tracking-tight lg:w-[60%]">
					Preencha abaixo as informações do padrão de energia instalação e clique em <strong className="font-bold text-green-500">adicionar (+)</strong>.
					Se necessário, você pode adicionar mais de um padrão de energia à lista.
				</p>
