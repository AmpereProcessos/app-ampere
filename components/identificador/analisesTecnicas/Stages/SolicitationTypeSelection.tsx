...
function SolicitationTypeSelection({ selectType }: SolicitationTypeSelectionProps) {
  return (
    <div className="scrollbar-thin scrollbar-track-primary/20 scrollbar-thumb-primary/20 flex max-h-full flex-col overflow-y-auto px-2 py-1">
      <span className="py-2 text-center text-lg font-black text-[#15599a] uppercase">
            ...
            <div className="flex w-full flex-col gap-2">
              {type.descriptions.map((desc, index) => (
                <p
                  ...
                  className="text-foreground w-full text-sm leading-none font-medium tracking-tight lg:text-base"
                >
                  {desc}
                </p>
              ))}
      ...
      {/* <div className="flex w-full items-center gap-2">
             <div
               ...
               className="flex h-[300px] w-full cursor-pointer flex-col items-center gap-2 rounded-sm border border-border p-3 shadow-lg duration-300 ease-in-out hover:scale-[1.02] hover:bg-blue-100 dark:hover:bg-primary/10 lg:w-[50%]"
             >
               <MdAssessment style={{ color: '#fead61', fontSize: '35px' }} />
               <h1 className="text-center text-lg font-bold">VISITA TÉCNICA REMOTA - URBANA</h1>
               <p className="text-center text-sm text-foreground">Requisite ao nosso time de engenharia uma avaliação técnica.</p>
            ...
            <div className="flex w-full items-center gap-2">
             ...
             >
               ...
               <p className="text-center text-sm text-foreground">Uma vez requisitada, um resultado será informado em um prazo de 72 horas úteis.</p>
             </div>
             <div
            ...
            <div className="flex w-full items-center gap-2">
             ...
             >
               ...
               <p className="text-center text-sm text-foreground">Requisite ao nosso time de engenharia um desenho personalizado.</p>
               <Image src={DrawIcon} alt="DESENHO TÉCNICO" height={50} />
               <p className="text-center text-sm text-foreground">Uma vez requisitado, um resultado será informado em um prazo de 72 horas úteis.</p>
             </div>
             <div
             ...
             >
               ...
               <p className="text-center text-sm text-foreground">Requisite ao nosso time de engenharia uma orçamentação personalizada.</p>
            ...
            <div className="flex w-full items-center gap-2">
             ...
             >
               ...
               <p className="text-center text-sm text-foreground">Requisite ao nosso time de engenharia a análise de um aumento de projeto.</p>
