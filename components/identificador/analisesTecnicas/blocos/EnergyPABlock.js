...
function EnergyPABlock({ infoHolder, setInfoHolder, changes, setChanges }) {
	const [paInfoHolder, setPaInfoHolder] = useState({
		alteracao: false,
		tipo: "CONTRA À REDE",
		tipoEntrada: "AÉREO",
		tipoSaida: "AÉREO",
	...
	return (
		<div className="mt-4 flex w-full flex-col">
			...
			<div className="mt-2 flex w-full flex-col gap-2">
				<div className="flex w-full flex-col gap-2 lg:flex-row justify-around">
					<div className="w-full lg:w-1/4">
						<SelectInput
							...
							onReset={() => setPaInfoHolder((prev) => ({ ...prev, ligacao: null }))}
					...
					<div className="w-full lg:w-1/4">
						<SelectInput
							...
							onReset={() => setPaInfoHolder((prev) => ({ ...prev, amperagem: null }))}
							selectedItemLabel="NÃO DEFINIDO"
							width={"100%"}
						/>
					</div>
					<div className="w-full lg:w-1/4">
						<SelectInput
							...
							onReset={() => setPaInfoHolder((prev) => ({ ...prev, tipo: null }))}
							selectedItemLabel="NÃO DEFINIDO"
							width={"100%"}
						/>
					</div>
				...
				<div className="flex w-full flex-col gap-2 lg:flex-row justify-around">
					<div className="w-full lg:w-1/4">
						<SelectInput
							...
							onReset={() => setPaInfoHolder((prev) => ({ ...prev, tipoEntrada: null }))}
							selectedItemLabel="NÃO DEFINIDO"
							width={"100%"}
						/>
					</div>
					<div className="w-full lg:w-1/4">
						<SelectInput
							...
							onReset={() => setPaInfoHolder((prev) => ({ ...prev, tipoSaida: null }))}
							selectedItemLabel="NÃO DEFINIDO"
							width={"100%"}
						/>
					</div>
				...
				<div className="w-full flex items-center justify-center self-center lg:w-1/3">
					<CheckboxInput
			...
			<div className="mt-2 flex w-full flex-col gap-2">
				<h1 className="w-full p-1 bg-gray-500 text-white font-bold text-center rounded-tr-sm rounded-tl-sm">LISTA DE PADRÕES</h1>
				{infoHolder.padrao.map((paInfo, index) => (
					<div key={index} className="flex w-full flex-col border border-gray-300 shadow-sm p-2">
						...
						<div className="flex w-full flex-wrap items-center justify-around mt-2">
							<div className="flex items-center gap-2 w-1/2 lg:w-fit">
								<TbCategoryFilled />
						...
						{paInfo.alteracao ? (
							<div className="flex flex-col w-full mt-2">
								<div className="flex items-center gap-2 text-red-500 w-full justify-center">
									<TbAlertTriangleFilled size={18} />
									<p className="text-xs lg:text-base font-bold">ALTERAÇÃO</p>
								</div>
								<div className="flex w-full flex-wrap items-center justify-around mt-1">
									<div className="flex items-center gap-2 w-1/2 lg:w-fit">
