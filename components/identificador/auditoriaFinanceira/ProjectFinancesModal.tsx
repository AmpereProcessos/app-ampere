						...
						<div className="flex grow flex-col gap-2 overflow-y-auto overscroll-y-auto px-2 py-4 scrollbar-thin scrollbar-track-gray-100 scrollbar-thumb-gray-300">
							...
							<div className="flex w-full flex-wrap justify-around gap-2">
								{costForecasts.map((forecast, index) => (
									<div key={index} className="flex w-full flex-col rounded-md border border-gray-300 p-4 lg:w-[450px]">
										...
										<div className="mt-1 flex w-full flex-wrap items-center justify-between">
											<div className="flex items-center gap-2">
												...
												<p className="text-[0.65rem] font-medium leading-none tracking-tight text-gray-500 lg:text-xs">IMPOSTO: {formatDecimalPlaces(forecast.imposto * 100)}%</p>
											</div>
											<div className="flex items-center gap-2">
												<MdSignalCellularAlt size={15} color="#fead41" />
												<p className="text-[0.65rem] font-medium leading-none tracking-tight text-gray-500 lg:text-xs">MARGEM: {formatDecimalPlaces(forecast.margemLucro * 100)}%</p>
											</div>
										</div>
									</div>
								))}
