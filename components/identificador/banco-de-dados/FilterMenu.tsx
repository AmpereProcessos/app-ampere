...
import type { TPersonalizedProjectsFilter } from "@/utils/schemas/projects";
        ...
        <div className="flex w-full flex-col flex-wrap items-center justify-start gap-2 lg:flex-row">
            ...
            <div className="flex items-center justify-center gap-x-2">
              <div className="w-full lg:w-[250px]">
                <DateInput
                  ...
                  label={"DEPOIS DE"}
                  value={
                    filtersHolder.period.after ? formatDate(filtersHolder.period.after) : undefined
                  }
                  handleChange={(value) =>
                    setFiltersHolder((prev) => ({
                      ...prev,
                      period: { ...prev.period, after: formatDateInputChange(value, "string") },
                    }))
                  }
                  labelClassName="text-xs font-medium tracking-tight text-black"
                />
              ...
              <div className="w-full lg:w-[250px]">
                <DateInput
                  ...
                  label={"ANTES DE"}
                  value={
                    filtersHolder.period.before
                      ? formatDate(filtersHolder.period.before)
                      : undefined
                  }
                  handleChange={(value) =>
                    setFiltersHolder((prev) => ({
                      ...prev,
                      period: { ...prev.period, before: formatDateInputChange(value, "string") },
                    }))
                  }
                  labelClassName="text-xs font-medium tracking-tight text-black"
                />
          ...
          <div className="w-full lg:w-[300px]">
            <TextInput
              ...
              handleChange={(value) =>
                setFiltersHolder((prev) => ({ ...prev, neighborhood: value }))
              }
          ...
          <div className="w-full md:w-[250px]">
            <MultipleSelectWithImages
              ...
              handleChange={(value) =>
                setFiltersHolder((prev) => ({ ...prev, seller: value as string[] }))
              }
          ...
          <div className="w-full md:w-[250px]">
            <MultipleSelectInput
              ...
              handleChange={(value) =>
                setFiltersHolder((prev) => ({ ...prev, insider: value as string[] }))
              }
            ...
            <div className="w-full lg:w-[300px]">
              <NumberInput
                ...
                handleChange={(value) =>
                  setFiltersHolder((prev) => ({
                    ...prev,
                    modulesQty: { ...prev.modulesQty, greater: value },
                  }))
                }
                width="100%"
                labelClassName="text-xs font-medium tracking-tight text-black"
            ...
            <div className="w-full lg:w-[300px]">
              <NumberInput
                ...
                handleChange={(value) =>
                  setFiltersHolder((prev) => ({
                    ...prev,
                    modulesQty: { ...prev.modulesQty, less: value },
                  }))
                }
                width="100%"
                labelClassName="text-xs font-medium tracking-tight text-black"
