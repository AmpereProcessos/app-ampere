			...
			{totalPages > 1 ? (
				<>
					<p className="text-primary/60 w-full text-center text-sm leading-none tracking-tight">
						Um número grande de projetos foi encontrado, separamos em páginas para facilitar a visualização. Clique na página desejada para visualizar os
						demais projetos.
					</p>
					<div className="flex flex-col items-center justify-center gap-x-4 gap-y-2 md:flex-row">
						...
						<div className="flex grow items-center gap-2">{renderPagesIcons({ totalPages, activePage, selectPage, disabled: queryLoading })}</div>
						<button
							disabled={queryLoading}
							onClick={() => {
