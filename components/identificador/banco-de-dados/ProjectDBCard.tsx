...
function ProjectDBCard({ project, handleClick }: ProjectDBCardProps) {
  return (
    <div className="bg-background flex w-full rounded-md border md:w-[350px] lg:w-[500px]">
      <div
        className={`h-full w-[7px] ${getBarColor(project.tipoDeServico)} rounded-tl-md rounded-bl-md`}
      />
      <div className="flex grow flex-col gap-2 p-3">
        <div className="flex w-full items-center justify-between gap-2">
          ...
          <h1 className="rounded-full bg-black px-2 py-1 text-[0.55rem] font-bold text-white lg:text-xs">
            {project.qtde}
          </h1>
        </div>
