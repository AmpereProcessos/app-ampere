...
function ApportionmentItem({ apportionment }) {
  return (
    <div className="p-2 rounded border border-gray-200 flex flex-col w-full">
      ...
      <div className="flex w-full  mt-2">
        <div className="flex items-center justify-start gap-1 w-1/3">
          ...
          <p className="text-gray-500 font-raleway font-light">
            {apportionment.orcamento
              ? formatToMoney(apportionment.orcamento)
              : "N/A"}
          </p>
        </div>
        <div className="flex items-center justify-center gap-1 w-1/3">
          ...
          <p className="text-gray-500 font-raleway font-light">
            {apportionment.categorias ? apportionment.categorias.length : `0`}{" "}
            categorias
          </p>
        </div>
        <div className="flex items-center  gap-1 w-1/3 justify-end">
          <button className="flex items-center justify-center gap-1  border border-[#fead41] text-[#fead41] hover:bg-[#fead41] hover:text-white duration-300 ease-in-out rounded p-1 w-fit">
            <AiFillEdit />
            <p className="font-raleway font-light">EDITAR</p>
          </button>
        </div>
      </div>
    </div>
