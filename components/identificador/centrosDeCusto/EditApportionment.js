...
import {
  useEditApportionment,
  useInsertApportionment,
} from "../../../utils/methods/mutation/costApportionments";
        ...
        <div className="flex h-full w-full flex-col">
          <div className="border-border flex items-center justify-between border-b px-2 pb-2 text-lg">
            <div className="flex flex-col items-center">
              ...
              <h1 className="text-foreground pl-6 text-xs font-light italic">#{infoHolder?._id}</h1>
            </div>
            <button>
          ...
          {apportionmentError ? (
            <div className="flex grow flex-col items-center justify-center gap-1 text-red-500">
              ...
              <p className="text-foreground text-center text-sm italic">
                Houve um erro as informações sobre esse centro de custo.
              </p>
              <p className="text-foreground text-center text-sm italic">
                Confira o funcionamento da sua internet.
              </p>
              <p className="text-foreground text-center text-sm italic">
                Em persistência do erro, comunique o setor de tecnologia.
              </p>
            </div>
          ) : null}
