...
function EditApportionment({ apportionmentId, closeModal }) {
	...
	const { data: apportionment, isLoading: apportionmentLoading, isSuccess: apportionmentSuccess, isError: apportionmentError } = useCostApportionmentByID(apportionmentId);
				...
				<div className="flex h-full w-full flex-col">
					...
					{apportionmentError ? (
						<div className="flex grow flex-col items-center justify-center gap-1 text-red-500">
							...
							<p className="text-center text-sm italic text-gray-500">Houve um erro as informações sobre esse centro de custo.</p>
