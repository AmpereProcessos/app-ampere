    ...
    <div className="flex w-full flex-col gap-3">
      <div className="flex w-full flex-col gap-2">
        ...
        <h3 className="text-muted-foreground w-full text-sm tracking-tight">
          Define aqui as informações gerais do chamado
        </h3>
      </div>
  ...
  return (
    <div className="flex w-full flex-col gap-3">
      <div className="flex w-full flex-col gap-2">
        ...
        <h3 className="text-muted-foreground w-full text-sm tracking-tight">
          Define aqui as informações de pagamento do chamado
        </h3>
      </div>
            ...
            <DateInput
              ...
              handleChange={(value) =>
                updateCall({
                  metadados: {
                    ...metadados,
                    dataPagamento: formatDateInputChange(value, "string") as string,
                  },
                })
              }
              width="100%"
  ...
  return (
    <div className="flex w-full flex-col gap-3">
      <div className="flex w-full flex-col gap-2">
        ...
        <h3 className="text-muted-foreground w-full text-sm tracking-tight">
          Define aqui o projeto do chamado
        </h3>
      </div>
      ...
      {project ? (
        <div className="border-primary bg-background flex w-full flex-col gap-1 rounded-md border p-2 dark:bg-[#121212]">
          <div className="flex items-center gap-2">
            <MdDashboard className="h-4 min-h-4 w-4 min-w-4" />
            <h1 className="bg-secondary text-xxs text-foreground rounded-lg px-2 py-0.5 text-center font-bold italic">
        ...
        <ProjectVinculationMenu
          ...
          handleSelect={(info) => {
            vinculateProject({
              ...
              identificador: info.qtde.toString(),
            });
  ...
  return (
    <div className="flex w-full flex-col gap-3">
      <div className="flex w-full flex-col gap-2">
        ...
        <h3 className="text-muted-foreground w-full text-sm tracking-tight">
          Adicione aqui as atualizações do chamado
        </h3>
      </div>
      <MorphingPopover
        transition={{
      ...
      >
        ...
        <MorphingPopoverContent className="border-border w-full rounded-lg border shadow-sm">
          ...
          <div className="flex w-full items-center justify-center">
            <div className="bg-primary/10 flex w-full items-center justify-center rounded p-2">
              <h1 className="text-[0.6rem] font-medium whitespace-pre-wrap">
                {update.descricao || "OBSERVAÇÃO NÃO DEFINIDA"}
              </h1>
            </div>
          </div>
        </div>
...
function Attachments({ callId, session }: AttachmentsProps) {
  ...
  const handleOnMutate = async () =>
    await queryClient.invalidateQueries({ queryKey: ["file-references-by-call", callId] });
  ...
  return (
    <div className="flex w-full flex-col gap-3">
      <div className="flex w-full flex-col gap-2">
        ...
        <h3 className="text-muted-foreground w-full text-sm tracking-tight">
          Anexe aqui os arquivos do chamado
        </h3>
      </div>
      ...
      {attachments && attachments.length > 0 ? (
        attachments.map((attachment) => (
          <FileReferenceCard key={attachment._id} info={attachment} />
        ))
      ) : (
