		...
		<div className="w-full flex flex-col gap-3">
			<div className="w-full flex flex-col gap-2">
				<div className="w-full flex items-center gap-1">
					...
					<h1 className="text-sm tracking-tight font-bold">INFORMAÇÕES GERAIS</h1>
				</div>
			...
			<div className="w-full flex flex-col gap-2 items-center lg:flex-row">
				<div className="w-full lg:w-1/2">
					<TextInput label={"TÍTULO"} placeholder={"Preencha o título do chamado"} value={title} handleChange={(value) => updateCall({ titulo: value })} width="100%" />
				</div>
				<div className="w-full lg:w-1/2">
					<SelectInput
						label={"STATUS"}
		...
		<div className="w-full flex flex-col gap-3">
			<div className="w-full flex flex-col gap-2">
				<div className="w-full flex items-center gap-1">
					...
					<h1 className="text-sm tracking-tight font-bold">PAGAMENTO</h1>
				</div>
		...
		<div className="w-full flex flex-col gap-3">
			<div className="w-full flex flex-col gap-2">
				<div className="w-full flex items-center gap-1">
					...
					<h1 className="text-sm tracking-tight font-bold">PROJETO</h1>
				</div>
			...
			{project ? (
				<div className="flex w-full flex-col gap-1 rounded-md border border-primary bg-[#fff] p-2 dark:bg-[#121212]">
					<div className="flex items-center gap-2">
						<MdDashboard className="w-4 h-4 min-w-4 min-h-4" />
						<h1 className="rounded-lg bg-secondary px-2 py-0.5 text-center text-[0.5rem] font-bold italic text-primary/80">{project.identificador}</h1>
...
function Updates({ session }: { session: Session }) {
		...
		<div className="w-full flex flex-col gap-3">
			<div className="w-full flex flex-col gap-2">
				<div className="w-full flex items-center gap-1">
					...
					<h1 className="text-sm tracking-tight font-bold">ATUALIZAÇÕES</h1>
				</div>
			...
			>
				<MorphingPopoverTrigger className="w-full flex items-center justify-center">
					<Button className="text-sm gap-2 flex items-center" variant={"ghost"}>
						<Plus className="w-4 h-4 min-w-4 min-h-4" />
						ADICIONAR ATUALIZAÇÃO
					</Button>
				</MorphingPopoverTrigger>
				<MorphingPopoverContent className="rounded-lg border border-primary/30 shadow w-full">
		...
		<div className="w-full flex flex-col gap-3">
			<div className="w-full flex flex-col gap-2">
				<div className="w-full flex items-center gap-1">
					...
					<h1 className="text-sm tracking-tight font-bold">ANEXOS</h1>
				</div>
			...
			<div className="flex w-full items-center justify-end">
				...
				>
					<MdAttachFile />
					<h1 className="text-xs font-medium tracking-tight">{!newFileReferencesMenuIsOpen ? "ABRIR MENU DE NOVOS ANEXOS" : "FECHAR MENU DE NOVOS ANEXOS"}</h1>
				</Button>
			</div>
			...
			{attachments && attachments.length > 0 ? (
				...
				<h1 className="text-sm font-medium w-full text-center">Nenhum arquivo anexado</h1>
			)}
		</div>
	);
}
