...
import {
  ...
  useOpenPPSCalls,
  usePPSCall,
} from "../../../../utils/methods/query/ppsCalls";
...
function ClosedCalls() {
  ...
  const {
    ...
    filters,
    setFilters,
  } = useClosedPPSCalls(dateParams.after, dateParams.before);
                ...
                <div className="flex items-center justify-center gap-x-2">
                  <div className="w-full lg:w-[250px]">
                    <DateInput
                      ...
                      handleChange={(value) =>
                        setDateParams((prev) => ({ ...prev, after: formatDateInputChange(value) }))
                      }
                    />
                  </div>
                  <div className="w-full lg:w-[250px]">
                    <DateInput
                      ...
                      handleChange={(value) =>
                        setDateParams((prev) => ({ ...prev, before: formatDateInputChange(value) }))
                      }
                    />
                  </div>
                </div>
                <div className="flex flex-col flex-wrap items-center justify-center gap-2 lg:flex-row">
                  ...
                  <div className="w-full lg:w-[250px]">
                    <SelectInput
                      ...
                      options={respChamadosPPS.map((resp, index) => ({
                        id: index + 1,
                        label: resp.label,
                        value: resp.value,
                      }))}
