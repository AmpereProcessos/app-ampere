    ...
    return (
      <div className={cn("flex flex-col items-center justify-center p-8 text-center", className)}>
        ...
        <p className="text-sm text-foreground italic">
          Selecione um número de telefone para ver os chats
        </p>
      </div>
    );
  }
      ...
      <div className={cn("flex flex-col items-center justify-center p-8 text-center", className)}>
        ...
        <p className="text-xs text-muted-foreground mt-1">
          {debouncedSearchQuery
            ...
            : "Inicie uma nova conversa clicando no botão +"}
        </p>
      </div>
    );
  }
      ...
      <div className="flex flex-col gap-2 p-3">
        ...
        {!isLoadingMore && nextCursor && initialResult?.hasMore && (
          <Button
            ...
            className="w-full mt-2 text-foreground hover:text-primary hover:bg-primary/5"
          >
    ...
    >
      ...
      <div className="flex-1 min-w-0 flex flex-col gap-1">
        ...
        <div className="flex items-center justify-between gap-2 w-full">
          <h3
            className={cn("font-semibold text-sm truncate text-left", hasUnread && "text-primary")}
          >
          ...
          {chat.ultimaMensagemData && (
            <span
              className={cn(
                ...
                hasUnread ? "text-primary font-medium" : "text-foreground",
              )}
            >
        ...
        <div className="flex items-center justify-between gap-2 w-full">
          <div className="flex items-center gap-1.5 min-w-0 flex-1">
            {chat.ultimaMensagemConteudoTipo === "TEXTO" ? (
              ...
              <>
                <ImageIcon className="w-3.5 h-3.5 text-foreground flex-shrink-0" />
                <p
                  className={cn(
                    "text-xs truncate",
                    hasUnread ? "text-foreground font-medium" : "text-foreground",
