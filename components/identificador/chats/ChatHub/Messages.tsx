    ...
    return (
      <div className={cn("flex-1 flex items-center justify-center bg-background/50", className)}>
        <div className="flex flex-col items-center gap-2">
          ...
          <div className="text-sm text-foreground">Carregando mensagens...</div>
        </div>
      </div>
    );
  }
      ...
      <div className={cn("flex-1 flex items-center justify-center bg-background/50", className)}>
        {emptyState || (
          <div className="flex flex-col items-center justify-center p-8 text-center">
            ...
            <h3 className="text-base font-semibold text-foreground mb-1">Nenhuma mensagem ainda</h3>
        ...
        {shouldShowTimestamp && (
          <div
            className={cn(
              ...
              isUser ? "text-blue-100/90" : "text-foreground",
            )}
          >
