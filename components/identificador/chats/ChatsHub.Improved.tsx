...
function ChatHubList({
  ...
  // Load more chats
  const moreChatsResult = useLoadMoreChats(
    selectedPhoneNumber,
...
function ChatHubContentHeader({
  chat,
  onBack,
  isDesktop,
  whatsappPhoneNumberId,
}: ChatHubContentHeaderProps) {
  ...
  return (
    <div className="w-full flex items-center justify-between border-b border-border p-3">
      <div className="flex items-center gap-3">
        ...
        <div className="flex flex-col">
          ...
          <p className="text-xs text-foreground">{chat.cliente?.telefone}</p>
        </div>
      </div>
      <div className="flex items-center gap-2">
