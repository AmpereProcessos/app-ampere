...
function ChatsHub({ session, userHasMessageSendingPermission, whatsappConnection }: ChatsHubProps) {
  ...
  return (
    <div className="w-full max-h-[calc(100vh-200px)] grow flex flex-col items-center justify-center rounded-lg shadow-lg border border-border overflow-hidden">
      ...
      {!isConnected && (
        <div className="w-full bg-amber-100 text-amber-800 text-xs px-2 py-1 text-center">
      ...
      {isDesktop ? (
        <div className="w-full h-full flex">
          <div className="flex flex-col gap-3 w-1/3 h-full border-r border-border">
            <div className="w-full flex flex-col gap-2 border-b border-border px-3 py-3">
    ...
    <div className="flex flex-col gap-2 overflow-y-auto">
      {chats.map((chat) => (
        <button
          ...
          className={cn(
            "w-full flex gap-3 p-3 hover:bg-primary/10 rounded-lg transition-colors",
      ...
      <StickToBottom.Content className="p-3">
        ...
        {messages && messages.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center h-full">
            <p className="text-foreground">Nenhuma mensagem ainda</p>
