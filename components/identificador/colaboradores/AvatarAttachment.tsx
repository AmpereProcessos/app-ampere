    ...
    <div className="flex w-full flex-col">
      <div className="flex w-full items-center gap-2">
        ...
        <div className={`relative flex grow flex-col gap-1`}>
          <label htmlFor={"avatar-input"} className="font-sans font-bold text-primary">
            AVATAR
          </label>
          <div className="border-border flex h-[47px] w-full items-center gap-2 rounded-md border p-3">
            {file ? (
              <p className="text-foreground grow text-center leading-none tracking-tight">
                {formatLongString(file.name, 30)}
              </p>
            ) : (
              <p className="text-foreground grow text-center leading-none tracking-tight">
            ...
            {file ? (
              <BsCheck2All size={25} color={"rgb(34,197,94)"} />
            ) : (
