...
import Flags from "./blocos/Flags";
...
function EditEmployee({ userId, session, closeModal, callbacks }: EditEmployeeProps) {
  ...
  return (
    <ResponsiveDialogDrawer
      ...
      actionFunction={() =>
        handleUpdateEmployeeMutation({ id: userId, changes: infoHolder, file: avatarHolder.file })
      }
    ...
    >
      <Flags
        ...
        showEmployeeStatusControl={true}
        showAccessStatusControl={true}
      />
      <EmployeeGeneral
        infoHolder={infoHolder}
        updateInfoHolder={updateInfoHolder}
