	...
	return (
		<div className="flex w-full flex-col rounded-md border border-gray-300 p-4 lg:w-[450px]">
			<div className="flex w-full items-center gap-2">
				...
				<h1 onClick={() => openModal(employee._id)} className="cursor-pointer text-sm font-black uppercase leading-none tracking-tight hover:text-cyan-500 lg:text-sm">
					{employee.nome}
				</h1>
			</div>
			...
			<div className="mt-1 flex w-full flex-wrap items-center justify-between">
				<div className="flex items-center gap-2">
					<FaBirthdayCake />
					<p className="text-[0.65rem] font-medium leading-none tracking-tight text-gray-500 lg:text-xs">{formatDateAsLocale(employee.dataNascimento) || "NÃO DEFINIDO"}</p>
				</div>
				<div className="flex items-center gap-2">
					<PiOfficeChairFill />
