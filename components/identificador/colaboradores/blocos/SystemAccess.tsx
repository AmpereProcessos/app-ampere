...
function SystemAccess({ infoHolder, setInfoHolder, initialMode }: SystemAccessProps) {
  ...
  return (
    <div className="flex w-full flex-col gap-y-2">
      <div className="bg-primary/80 flex w-full items-center gap-2 rounded py-1 text-white">
            ...
            <div className="w-full lg:w-1/2">
              {infoHolder.visualizacao.tipo == 'OPERACIONAL' ? (
                <div className={`relative flex w-full flex-col gap-1`}>
                  <h1 className="text-start font-sans font-bold text-[#353432]">REFERÊNCIA DA VISUALIZAÇÃO</h1>
