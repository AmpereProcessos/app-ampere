...
function AnaliseBlock({ project }: AnaliseBlockProps) {
					...
					<div className="mt-1 flex w-full flex-col rounded bg-gray-100 p-1">
						...
						<div className="flex w-full items-center gap-2">
							...
							<div className="flex grow items-center justify-between">
								<div className="flex items-center gap-2">
									<ImPower />
									<p className={`${Math.abs(project.potenciaPico - (project.proposta.potenciaPico || 0)) < 5 ? "text-green-500" : "text-[#F31559]"} font-medium`}>
	...
	// return (
	//   <div className="flex w-full flex-col border border-gray-300 p-1">
