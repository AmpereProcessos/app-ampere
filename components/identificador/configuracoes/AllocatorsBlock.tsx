...
import type { TAllocatorDTO } from "@/utils/schemas/allocators";
    ...
    <div className="flex h-full grow flex-col">
      <div className="border-border flex w-full flex-col items-center justify-between border-b pb-2 lg:flex-row">
        <div className="flex flex-col">
          ...
          <p className="text-sm text-foreground">Gerencie, adicione e edite os alocadores</p>
          <p className="text-sm text-foreground">
            {isSuccess ? allocators.length : "0"} alocadores atualmente cadastrados
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          <div className="flex items-center gap-1">
            ...
            <p className="text-foreground text-[0.65rem] font-medium">
              {formatDateAsLocale(allocator.dataInsercao, true)}
            </p>
          </div>
        </div>
        <button
