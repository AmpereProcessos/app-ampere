		...
		<div className="flex h-full grow flex-col">
			<div className="border-primary/20 flex w-full flex-col items-center justify-between border-b pb-2 lg:flex-row">
				<div className="flex flex-col">
					...
					<p className="text-sm text-primary/60">Gerencie, adicione e edite os alocadores</p>
					<p className="text-sm text-primary/60">{isSuccess ? allocators.length : "0"} alocadores atualmente cadastrados</p>
				</div>
