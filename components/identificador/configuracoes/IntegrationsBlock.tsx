    ...
    <div className="flex h-full grow flex-col gap-3">
      <div className="border-border flex w-full flex-col items-center justify-between border-b pb-2 lg:flex-row">
        <div className="flex flex-col">
          ...
          <p className="text-sm text-foreground">Gerencie as integrações da plataforma</p>
        </div>
      </div>
...
function ContaAzulIntegration() {
  ...
  const {
    data: contaAzulV2Integration,
    queryKey,
    isLoading,
    isSuccess,
    isError,
    error,
  } = useContaAzulV2Integration();
            ...
            <div className="w-full flex items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-1">
                ...
                <p className="text-xs text-start">
                  DATA DE EXPIRAÇÃO:{" "}
                  {formatDateAsLocale(contaAzulV2Integration.dados.dataExpiracao, true)}
                </p>
              </div>
            </div>
            <div className="w-full flex items-center gap-3 px-4 py-2 rounded-lg bg-primary/10 break-all text-[0.65rem]">
              ...
              <div className="h-full flex items-center justify-center">
                ...
                <Button
                  ...
                  variant={"ghost"}
                  className="p-3 rounded-full"
                  onClick={() => copyToClipboard(contaAzulV2Integration.dados.tokenAcesso)}
                >
