...
export default function WhatsappConnectionBlock({ session }: WhatsappConnectionBlockProps) {
	...
	return (
		<div className="flex h-full grow flex-col">
			...
			{isSuccess ? (
				whatsappIntegration ? (
					<WhatsappConnectionBlockConnected whatsappIntegration={whatsappIntegration} />
				) : (
...
function WhatsappConnectionBlockConnected({ whatsappIntegration }: WhatsappConnectionBlockConnectedProps) {
	...
	return (
		<div className="flex w-full flex-col gap-2 py-2">
			<div className="flex items-center gap-1">
				<BadgeCheck className="w-4 h-4 min-w-4 min-h-4 text-green-500" />
