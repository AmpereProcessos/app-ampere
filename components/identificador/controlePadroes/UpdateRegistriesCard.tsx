      ...
      <div className="w-full flex items-center flex-wrap gap-3">
        {registry.qtdeAnterior && registry.qtdeNovo ? (
          ...
          >
            ...
            <h1 className="text-[0.65rem] tracking-tight font-semibold">
              ...
              <strong>{formatDecimalPlaces(registry.qtdeAnterior)}</strong> PARA:{" "}
        ...
        registry.precoAnterior !== registry.precoNovo ? (
          ...
          >
            ...
            <h1 className="text-[0.65rem] tracking-tight font-semibold">
              ALTERAÇÃO DE PREÇO DE: {formatToMoney(registry.precoAnterior)} PARA:{" "}
              {formatToMoney(registry.precoNovo)}
            </h1>
          </div>
        ) : null}
      </div>
