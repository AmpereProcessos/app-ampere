...
import {
  TUsePurchaseControlsByFiltersFilters,
...
function PurchaseControlsFilterMenu({
  filters,
  updateFilters,
  queryLoading,
  resetSelectedPage,
}: PurchaseControlsFilterMenuProps) {
        ...
        <div className="flex w-full flex-col flex-wrap items-center justify-start gap-2 lg:flex-row">
          ...
          <div className="flex w-full flex-col items-center gap-2 lg:w-fit lg:flex-row">
              ...
              <DateInput
                ...
                handleChange={(value) =>
                  setFiltersHolder((prev) => ({
                    ...prev,
                    period: { ...prev.period, after: value },
                  }))
                }
                width="100%"
              />
            ...
            <div className="w-full lg:w-[180px]">
              <DateInput
                ...
                handleChange={(value) =>
                  setFiltersHolder((prev) => ({
                    ...prev,
                    period: { ...prev.period, before: value },
                  }))
                }
                width="100%"
              />
            ...
            <SelectInput
              ...
              handleChange={(value) =>
                setFiltersHolder((prev) => ({ ...prev, period: { ...prev.period, type: value } }))
              }
              onReset={() =>
                setFiltersHolder((prev) => ({ ...prev, period: { ...prev.period, type: null } }))
              }
          ...
          <MultipleSelectInput
            ...
            handleChange={(value) =>
              setFiltersHolder((prev) => ({ ...prev, tags: value as string[] }))
            }
          ...
          <div className="flex flex-wrap items-center gap-2">
            <div className="w-fit">
              <CheckboxInput
                ...
                handleChange={(value) =>
                  setFiltersHolder((prev) => ({ ...prev, pendingOrder: value }))
                }
              />
            </div>
            <div className="w-fit">
              <CheckboxInput
                ...
                handleChange={(value) =>
                  setFiltersHolder((prev) => ({ ...prev, pendingDelivery: value }))
                }
              />
            </div>
          </div>
