...
function NewPurchaseControlCompositionKit({ affectedQueryKey, closeModal }: NewPurchaseControlCompositionKitProps) {
  ...
  if (isDesktop)
    return (
      <Dialog open={true} onOpenChange={closeModal}>
        <DialogContent className="h-[45vh] w-[50%] min-w-[50%]">
          <DialogHeader>
          ...
          <div className="flex-1 overflow-hidden px-4">
            <ScrollArea className="h-full">
              <PurchaseControlCompositionKitData
                data={infoHolder}
