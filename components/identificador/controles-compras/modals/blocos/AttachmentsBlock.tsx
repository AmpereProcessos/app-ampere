...
function PurchaseControlFileReferences({ attachmentPrefix, session, projectId, purchaseId }: PurchaseControlFileReferencesProps) {
  ...
  const queryParam: TFileReferencesQueryParams = { purchaseId: purchaseId, projectId: showProjectFiles ? projectId : undefined }
...
export default PurchaseControlFileReferences
