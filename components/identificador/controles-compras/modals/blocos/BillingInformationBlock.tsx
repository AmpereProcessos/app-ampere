...
function PurchaseControlBillingInformationBlock({
  infoHolder,
  setInfoHolder,
}: PurchaseControlBillingInformationBlockProps) {
  ...
  function addBilling(bill: TPurchaseControl["faturamentos"][number]) {
    if (bill.titulo.trim().length == 0)
      return toast.error("Preencha um título para o registro de faturamento.");
  ...
  function removeBilling(index: number) {
    setInfoHolder((prev) => ({
      ...prev,
      faturamentos: prev.faturamentos.filter((f, i) => i != index),
    }));
  }
  return (
      ...
      <div className="flex w-full items-center justify-end">
        ...
        >
          ...
          <h1 className="text-xs font-medium tracking-tight">
            {!newBillingMenuIsOpen
              ? "ABRIR MENU DE NOVO FATURAMENTO"
              : "FECHAR MENU DE NOVO FATURAMENTO"}
          </h1>
        </button>
      </div>
          ...
          <div className="flex w-full flex-col items-center gap-2 lg:flex-row">
            ...
            <div className="w-full lg:w-1/3">
              <TextInput
                ...
                handleChange={(value) =>
                  setBillingHolder((prev) => ({ ...prev, codigoNotaFiscal: value }))
                }
                width="100%"
              />
            </div>
            <div className="w-full lg:w-1/3">
              <DateInput
                ...
                handleChange={(value) =>
                  setBillingHolder((prev) => ({
                    ...prev,
                    data: formatDateInputChange(value) as string,
                  }))
                }
                width="100%"
              />
            ...
            <div className="flex flex-col items-center gap-1 lg:flex-row lg:gap-2">
              ...
              <div className="flex flex-wrap items-center justify-center gap-2 lg:justify-start">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <h1 className="text-primary py-0.5 text-center text-[0.6rem] font-bold">
                    {formatDateAsLocale(billing.data) || "N/A"}
                  </h1>
                </div>
              </div>
            </div>
              ...
              <div className="flex w-full flex-col items-center gap-2 lg:flex-row">
                ...
                <div className="w-full lg:w-1/3">
                  <TextInput
                    ...
                    handleChange={(value) =>
                      setItemHolder((prev) => ({ ...prev, codigoNotaFiscal: value }))
                    }
                    width="100%"
                  />
                </div>
