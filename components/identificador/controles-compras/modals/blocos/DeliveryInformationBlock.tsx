        ...
        <div className="flex w-full flex-col items-center gap-2 lg:flex-row">
          ...
          <div className="w-full lg:w-1/3">
            <SelectInput
              ...
              selectedItemLabel="NÃO DEFINIDO"
              onReset={() =>
                setInfoHolder((prev) => ({ ...prev, entrega: { ...prev.entrega, localizacao: { ...prev.entrega.localizacao, uf: '' } } }))
              }
          ...
          <div className="w-full lg:w-1/3">
            <SelectInput
              ...
              selectedItemLabel="NÃO DEFINIDO"
              onReset={() =>
                setInfoHolder((prev) => ({ ...prev, entrega: { ...prev.entrega, localizacao: { ...prev.entrega.localizacao, cidade: '' } } }))
              }
              width="100%"
            />
          </div>
