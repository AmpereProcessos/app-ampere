			...
			<div className="my-3 flex w-full flex-col items-center justify-center gap-2 lg:flex-row">
				<CheckboxWithDate
					...
					handleChange={(value) => {
						...
						if (isPurchaseAllowed && infoHolder.liberacao.data === formatDateInputChange(value)) return setInfoHolder((prev) => ({ ...prev, liberacao: { data: null, autor: {} } }));

						return setInfoHolder((prev) => ({
							...prev,
							liberacao: {
								data: formatDateInputChange(value, "string"),
