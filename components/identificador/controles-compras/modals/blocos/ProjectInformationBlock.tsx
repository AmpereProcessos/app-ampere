...
function PurchaseControlProjectInformationBlock({ session, purchase, updatePurchase, project, addProductToComposition }: PurchaseControlProjectInformationBlockProps) {
			...
			<div className="flex w-full grow flex-col gap-2">
				...
				<div className="flex w-full flex-col items-center justify-center gap-x-4 gap-y-2 lg:flex-row">
					<div className="flex w-full flex-col lg:w-1/2">
						<h1 className="w-full text-center text-[0.6rem] font-medium tracking-tight text-primary lg:text-start">OBSERVAÇÕES GERAIS SOBRE A NEGOCIAÇÃO</h1>
               ...
               {project.pagamentoCreditoAplicavel ? (
				...
				{project.idVisitaTecnica ? (
					<div className="flex w-full flex-col gap-2">
						...
						{technicalAnalysisBlockIsOpen ? <TechnicalAnalysisBlock analysisId={project.idVisitaTecnica} addProductToComposition={addProductToComposition} /> : null}
					</div>
				) : null}
			</div>
		</div>
