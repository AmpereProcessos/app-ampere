...
function PurchaseControlUpdatesInformationBlock({
  session,
  infoHolder,
  setInfoHolder,
}: PurchaseControlUpdatesInformationBlockProps) {
      ...
      <div className="flex w-full items-center justify-end">
        ...
        >
          ...
          <h1 className="text-xs font-medium tracking-tight">
            {!newUpdateMenuIsOpen
              ? "ABRIR MENU DE NOVA ATUALIZAÇÃO"
              : "FECHAR MENU DE NOVA ATUALIZAÇÃO"}
          </h1>
        </button>
      </div>
      {newUpdateMenuIsOpen ? (
