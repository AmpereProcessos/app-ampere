            ...
            <div className="flex w-full flex-col items-center gap-2 lg:flex-row">
              ...
              <div className="w-full lg:w-1/3">
                <NumberInput
                  ...
                  handleChange={(value) =>
                    setItemHolder((prev) => ({ ...prev, qtdeFaturamento: value, qtde: value * (itemHolder.fatorConversao || 1) }))
                  }
              ...
              <div className="w-full lg:w-1/3">
                <NumberInput
                  ...
                  handleChange={(value) =>
                    setItemHolder((prev) => ({ ...prev, valorFaturamento: value, valor: value / (itemHolder.fatorConversao || 1) }))
                  }
