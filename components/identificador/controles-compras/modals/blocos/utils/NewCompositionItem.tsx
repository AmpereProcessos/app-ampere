        ...
        <div className="flex w-full flex-col items-center gap-2 lg:flex-row">
          ...
          <div className="w-full lg:w-1/3">
            <NumberInput
              ...
              handleChange={(value) =>
                updateCompositionItemHolder({ qtdeFaturamento: value, qtde: value * (compositionItemHolder.fatorConversao || 1) })
              }
          ...
          <div className="w-full lg:w-1/3">
            <NumberInput
              ...
              handleChange={(value) =>
                updateCompositionItemHolder({ valorFaturamento: value, valor: value / (compositionItemHolder.fatorConversao || 1) })
              }
