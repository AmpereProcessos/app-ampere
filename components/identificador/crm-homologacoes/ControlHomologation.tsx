        ...
        <div className="flex h-full w-full flex-col">
          <div className="border-border flex flex-col items-center justify-between border-b px-2 pb-2 text-lg lg:flex-row">
            <div className="flex flex-col">
              ...
              <h3 className="text-foreground text-[0.65rem] font-bold dark:text-white">
                #{homologationId}
              </h3>
            </div>
              ...
              <div className="scrollbar-thin scrollbar-track-primary/20 scrollbar-thumb-primary/20 flex grow flex-col gap-y-2 overflow-y-auto overscroll-y-auto px-2 py-1">
                <div className="my-2 flex flex-col items-center justify-center">
                  ...
                  {infoHolder.oportunidade.id ? (
                    <Link
                      href={`https://crm.ampereenergias.com.br/comercial/oportunidades/id/${infoHolder.oportunidade.id}`}
                    >
                ...
                <PendenciesInformation
                  infoHolder={infoHolder}
                  setInfoHolder={setInfoHolder as Dispatch<SetStateAction<THomologation>>}
                />
