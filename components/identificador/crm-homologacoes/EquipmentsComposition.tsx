...
} from "@/utils/schemas/crm/homologation.schema";
        ...
        <div className="flex w-full flex-col items-center gap-2 lg:flex-row">
          <div className="w-full lg:w-3/4">
            <SelectInput
              label="MÓDULO"
              value={
                moduleHolder.id ? Modules.filter((module) => module.id == moduleHolder.id)[0] : null
              }
              handleChange={(value) =>
        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-1 rounded-md bg-[#15599a] px-2 py-1 text-white">
            ...
            <p className="text-xs font-medium tracking-tight">
              {getModulesPeakPotByProducts(infoHolder.equipamentos as TProductItem[])} kWp EM
              MÓDULOS
            </p>
          </div>
          <div className="flex items-center gap-1 rounded-md bg-[#fead41] px-2 py-1 text-white">
            ...
            <p className="tracking-tigh text-xs font-medium">
              {getInverterPeakPowerByProducts(infoHolder.equipamentos as TProductItem[])} kWp EM
              INVERSORES
            </p>
          </div>
        </div>
      ...
      <div className="flex w-full flex-wrap items-center justify-around gap-2">
        {infoHolder.equipamentos.length > 0 ? (
          infoHolder.equipamentos.map((product, index) => (
            <div className="border-border flex w-full flex-col rounded-md border p-2 lg:w-[450px]">
