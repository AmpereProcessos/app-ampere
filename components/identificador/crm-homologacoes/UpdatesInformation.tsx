...
import type { THomologationDTO } from "@/utils/schemas/crm/homologation.schema";
...
function UpdatesInformation({ session, infoHolder, setInfoHolder }: UpdatesInformationProps) {
  ...
  return (
    <div className="flex w-full flex-col gap-2">
      <h1 className="w-full rounded bg-cyan-800 p-1 text-center font-bold text-white">
        ATUALIZAÇÕES
      </h1>
          ...
          <DatetimeInput
            ...
            handleChange={(value) => {
              ...
              setUpdateHolder((prev) => ({
                ...prev,
                data: formatDateInputChange(value) || new Date().toISOString(),
              }));
            }}
            width="100%"
          />
