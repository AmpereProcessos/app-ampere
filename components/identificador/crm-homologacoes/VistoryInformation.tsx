...
function VistoryInformation({ infoHolder, setInfoHolder }: VistoryInformationProps) {
  return (
    <div className="flex w-full flex-col gap-2">
      <h1 className="bg-primary/80 w-full rounded p-1 text-center font-bold text-white">INFORMAÇÕES SOBRE A VISTORIA</h1>
      <div className="flex w-full flex-col items-center gap-2 lg:flex-row">
        <div className="w-full lg:w-1/2">
          <DateInput
            ...
            handleChange={(value) =>
              setInfoHolder((prev) => ({ ...prev, vistoria: { ...prev.vistoria, dataSolicitacao: formatDateInputChange(value) } }))
            }
            width="100%"
          />
        </div>
        <div className="w-full lg:w-1/2">
          <DateInput
            ...
            handleChange={(value) =>
              setInfoHolder((prev) => ({ ...prev, vistoria: { ...prev.vistoria, dataEfetivacao: formatDateInputChange(value) } }))
            }
            width="100%"
          />
        </div>
