...
function ProjectVinculationMenu({ handleLink, handleUnlink }: ProjectVinculationMenuProps) {
  ...
  const [selectedClient, setSelectedClient] = useState<TSelectableProject>({
    id: null,
    nome: null,
    identificador: null,
  });
      ...
      <AnimatePresence>
        {menuIsOpen ? (
          <motion.div
            ...
            animate="visible"
            exit="exit"
            className="border-border mt-2 flex w-full items-end gap-2 border p-3 shadow-xs"
          >
            <div className="grow">
              <SelectVirtualizedInput
                ...
                handleChange={(value) => {
                  ...
                  setSelectedClient({
                    id: equivalent?._id || "",
                    nome: equivalent?.nomeDoContrato || "",
                    identificador: equivalent?.qtde || "",
                  });
                }}
                onReset={() => {
