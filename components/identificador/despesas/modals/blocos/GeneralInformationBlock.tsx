...
function ExpenseGeneralInformationBlock({
  infoHolder,
  setInfoHolder,
}: ExpenseGeneralInformationBlockProps) {
  return (
    <div className="flex w-full grow flex-col gap-4">
      ...
      <div className="flex w-full flex-col gap-2">
        ...
        <h1 className="bg-primary/10 text-primary w-fit self-center rounded-md p-2 text-[0.65rem] leading-none tracking-tight">
          OBS: O PARÂMETRO DE EFETIVAÇÃO SE REFERE A DATA EM QUE A DESPESA ENTRA NO REGIME DE
          COMPETÊNCIA.
        </h1>
