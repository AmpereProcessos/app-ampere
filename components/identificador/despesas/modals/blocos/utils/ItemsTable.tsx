...
type ExpenseItemsTableProps = {
  ...
  updateCompositionItem: (info: {
    index: number;
    item: Partial<TExpense["itens"][number]>;
  }) => void;
  ...
  return (
    <div className="border-primary/80 flex w-full flex-col rounded border-0 lg:border">
      ...
      <ExpenseTotalMenu
        ...
        handleUpdate={(info) => updateExpenseTotal(info)}
      />
    </div>
  );
}
        ...
        <div className="bg-background hidden w-full flex-col gap-1 lg:flex dark:bg-[#121212]">
          <div className="flex w-full items-center gap-2 p-1">
            ...
            <h1 className="w-[20%] text-center text-xs tracking-tight">
              {item.preco ? formatToMoney(item.preco) : "-"}
            </h1>
            <h1 className="w-[20%] text-center text-xs tracking-tight">
              {item.preco ? formatToMoney(item.qtde * item.preco) : "-"}
            </h1>
          </div>
        </div>
    ...
    <>
      <AnimatePresence>
        <div className="flex w-full flex-col">
          <h1 className="bg-primary/80 text-secondary w-full p-1 text-center text-sm font-bold">
            TOTAL
          </h1>
