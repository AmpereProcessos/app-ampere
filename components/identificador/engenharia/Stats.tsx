  ...
  return (
    <div className="border-primary/20 flex w-full flex-col gap-2 rounded-xl border p-3 shadow-xs">
      ...
      <div className="flex w-full flex-col items-center justify-center gap-3 lg:flex-row">
        <div className="bg-background border-primary/20 flex min-h-[130px] w-full flex-col rounded-xl border p-3 shadow-xs lg:w-1/6">
          ...
          <div className="flex w-full flex-col">
            ...
            <p className="text-primary/60 text-xs">{formatDecimalPlaces(stats?.emAndamento.potencia || 0)} kWp</p>
          </div>
        </div>
        <div className="bg-background border-primary/20 flex min-h-[130px] w-full flex-col rounded-xl border p-3 shadow-xs lg:w-1/6">
          <div className="flex items-center justify-between">
            <h1 className="text-xs font-medium tracking-tight uppercase">HOMOLOGAÇÕES SOLICITADAS</h1>
          ...
          <div className="flex w-full flex-col">
            ...
            <p className="text-primary/60 text-xs">{formatDecimalPlaces(stats?.homologacoesSolicitadas.potencia || 0)} kWp</p>
            <p className="text-primary/60 text-xs">{formatDecimalPlaces(stats?.homologacoesSolicitadas.tempoMedio || 0)} HORAS (MÉDIA)</p>
          </div>
        </div>
        <div className="bg-background border-primary/20 flex min-h-[130px] w-full flex-col rounded-xl border p-3 shadow-xs lg:w-1/6">
          <div className="flex items-center justify-between">
            <h1 className="text-xs font-medium tracking-tight uppercase">HOMOLOGAÇÕES EFETIVADAS</h1>
          ...
          <div className="flex w-full flex-col">
            ...
            <p className="text-primary/60 text-xs">{formatDecimalPlaces(stats?.homologacoesEfetivadas.potencia || 0)} kWp</p>
            <p className="text-primary/60 text-xs">{formatDecimalPlaces(stats?.homologacoesEfetivadas.tempoMedio || 0)} HORAS (MÉDIA)</p>
          </div>
        </div>
        <div className="bg-background border-primary/20 flex min-h-[130px] w-full flex-col rounded-xl border p-3 shadow-xs lg:w-1/6">
          <div className="flex items-center justify-between">
            <h1 className="text-xs font-medium tracking-tight uppercase">HOMOLOGAÇÕES REPROVADAS</h1>
          ...
          <div className="flex w-full flex-col">
            ...
            <p className="text-primary/60 text-xs">{formatDecimalPlaces(stats?.homologacoesReprovadas.potencia || 0)} kWp</p>
          </div>
        </div>
        <div className="bg-background border-primary/20 flex min-h-[130px] w-full flex-col rounded-xl border p-3 shadow-xs lg:w-1/6">
          <div className="flex items-center justify-between">
          ...
          <div className="flex w-full flex-col">
            ...
            <p className="text-primary/60 text-xs">{formatDecimalPlaces(stats?.vistoriasSolicitadas.potencia || 0)} kWp</p>
            <p className="text-primary/60 text-xs">{formatDecimalPlaces(stats?.vistoriasSolicitadas.tempoMedio || 0)} HORAS (MÉDIA)</p>
          </div>
        </div>
        <div className="bg-background border-primary/20 flex min-h-[130px] w-full flex-col rounded-xl border p-3 shadow-xs lg:w-1/6">
          <div className="flex items-center justify-between">
          ...
          <div className="flex w-full flex-col">
            ...
            <p className="text-primary/60 text-xs">{formatDecimalPlaces(stats?.vistoriasEfetivadas.potencia || 0)} kWp</p>
            <p className="text-primary/60 text-xs">{formatDecimalPlaces(stats?.vistoriasEfetivadas.tempoMedio || 0)} HORAS (MÉDIA)</p>
          </div>
        </div>
      </div>
      <div className="flex w-full flex-col items-center justify-center gap-3 lg:flex-row">
        <div className="bg-background border-primary/20 flex w-full flex-col rounded-xl border p-3 shadow-xs lg:w-1/2">
          <div className="flex items-center justify-between">
            <h1 className="text-xs font-medium tracking-tight uppercase">DESENHOS EXECUTIVOS FEITOS</h1>
        ...
        <div className="bg-background border-primary/20 flex w-full flex-col rounded-xl border p-3 shadow-xs lg:w-1/2">
          <div className="flex items-center justify-between">
            <h1 className="text-xs font-medium tracking-tight uppercase">DIAGRAMAS EXECUTIVOS FEITOS</h1>
