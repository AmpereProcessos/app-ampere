...
function OverallReportGeneralStats({ generalData }: OverallReportGeneralStatsProps) {
	return (
		<div className="flex flex-col gap-6 rounded-sm border border-gray-400 bg-[#fff] p-6 shadow-sm">
			<div className="w-full flex flex-col gap-2">
				<div className="w-full flex flex-col gap-1">
					...
					<p className="text-sm text-primary/50">Informações gerais sobre vendas, serviços executados, homologações e suprimentos</p>
				</div>
				<div className="w-full flex items-center gap-2 flex-col lg:flex-row">
					...
					<div className="flex flex-col gap-2 rounded-xl border border-gray-400 bg-[#fff] p-3 w-full lg:w-1/2">
						<div className="flex items-center gap-2">
							<Heart className="w-4 h-4 min-w-4 min-h-4" />
			...
			<div className="w-full flex flex-col gap-2">
				<div className="w-full flex flex-col gap-1">
					<div className="flex items-center gap-2">
						<Wrench className="w-4 h-4 min-w-4 min-h-4" />
						<h2 className="text-lg font-bold tracking-tight">SERVIÇOS EXECUTADOS</h2>
					</div>
					<p className="text-sm text-primary/50">Informações gerais sobre serviços (obras, manutenções, etc.) executados</p>
				</div>
				<div className="w-full flex items-center gap-2 flex-col lg:flex-row">
					<div className="flex flex-col gap-2 rounded-xl border border-gray-400 bg-[#fff] p-3 w-full lg:w-1/3">
						<div className="flex items-center gap-2">
							<MdDashboard className="w-4 h-4 min-w-4 min-h-4" />
					...
					<div className="flex flex-col gap-2 rounded-xl border border-gray-400 bg-[#fff] p-3 w-full lg:w-1/3">
						<div className="flex items-center gap-2">
							<Earth className="w-4 h-4 min-w-4 min-h-4" />
				...
				<div className="flex flex-col gap-2 rounded-xl border border-gray-400 bg-[#fff] p-3 w-full">
					<div className="flex items-center gap-2">
						<Earth className="w-4 h-4 min-w-4 min-h-4" />
					...
					<div className="w-full flex items-center justify-start flex-wrap gap-2">
						{generalData.instalacoes.porEstado.map((state) => (
							<div key={`estado-servico-${state.titulo}`} className="flex items-center justify-between gap-6 rounded-xl border border-gray-400 px-2 py-1">
								<div className="flex items-center gap-2 bg-gray-600 text-white rounded-lg px-2 py-1">
			...
			<div className="w-full flex flex-col gap-2">
				<div className="w-full flex flex-col gap-1">
					...
					<p className="text-sm text-primary/50">Informações gerais sobre homologações realizadas</p>
				</div>
				<div className="w-full flex items-center gap-2 flex-col lg:flex-row">
				...
				<div className="flex flex-col gap-2 rounded-xl border border-gray-400 bg-[#fff] p-3 w-full">
					...
					<div className="w-full flex items-center justify-start flex-wrap gap-2">
						{generalData.homologacoes.porEstado.map((state) => (
							<div key={`estado-homologacao-${state.titulo}`} className="flex items-center justify-between gap-6 rounded-xl border border-gray-400 px-2 py-1">
								<div className="flex items-center gap-2 bg-gray-600 text-white rounded-lg px-2 py-1">
									<p className="text-[0.65rem] font-medium">{state.titulo}</p>
								</div>
			...
			<div className="w-full flex flex-col gap-2">
				<div className="w-full flex flex-col gap-1">
					...
					<p className="text-sm text-primary/50">Informações gerais sobre suprimentos realizados</p>
				</div>
				<div className="w-full flex items-center gap-2 flex-col lg:flex-row">
					<div className="flex flex-col gap-2 rounded-xl border border-gray-400 bg-[#fff] p-3 w-full lg:w-1/4">
						<div className="flex items-center gap-2">
