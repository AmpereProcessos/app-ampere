	...
	return (
		<div className="flex w-full flex-col gap-3">
			<div className="bg-primary/20 flex w-fit items-center justify-start gap-2 rounded-lg px-4 py-1.5">
				...
				<h1 className="w-full text-start text-xs leading-none font-medium tracking-tight">REGISTROS DE ATUALIZAÇÕES</h1>
			</div>
			...
			{isSuccess ? (
				<div className="w-full flex flex-col gap-2">
					{logs.length > 0 ? (
						...
						<p className="text-primary/60 w-full text-center font-medium tracking-tight italic">Não há registros de atualizações.</p>
					)}
				</div>
			) : null}
		</div>
