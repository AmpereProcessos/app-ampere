...
function NotificationsModal({ session, notifications, closeModal }: NotificationsModalProps) {
  ...
  console.log('OLá')
  return (
    <div className="fixed right-[-120px] top-[230px] z-[100] h-[350px] w-[300px] translate-x-[-50%] translate-y-[-50%] rounded-md bg-[#fff] p-[10px]">
      ...
      <div className="flex h-full max-w-full flex-col overflow-y-auto overscroll-y-auto scrollbar-thin scrollbar-track-gray-100 scrollbar-thumb-gray-300">
        {notifications.length > 0 ? (
          notifications.map((notificacao, index) => (
            ...
            >
              <h1 className="text-sm font-bold italic text-gray-600">
