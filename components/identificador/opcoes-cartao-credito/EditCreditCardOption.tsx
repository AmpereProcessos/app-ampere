...
function EditCreditCardOption({ optionId, closeModal }: EditCreditCardOptionProps) {
  ...
  const { mutate: handleUpdate, isLoading: updateLoading } = useMutationWithFeedback({
  ...
  return (
    <div id="edit-credit-card-option" className="fixed bottom-0 left-0 right-0 top-0 z-[100] bg-[rgba(0,0,0,.85)]">
      <div className="fixed left-[50%] top-[50%] z-[100] h-[80%] w-[90%] translate-x-[-50%] translate-y-[-50%] rounded-md bg-[#fff] p-[10px] lg:h-[60%] lg:w-[50%]">
