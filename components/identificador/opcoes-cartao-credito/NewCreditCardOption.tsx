...
import {
  createCreditCardOption,
  updateCreditCardOption,
} from "@/utils/methods/mutation/credit-card-options";
import { useMutationWithFeedback } from "@/utils/methods/mutation/general-hook";
import { useCreditCardOptionById } from "@/utils/methods/query/credit-card-options";
import type { TCreditCardOption } from "@/utils/schemas/credit-card-options";
      ...
      <div className="bg-background fixed top-[50%] left-[50%] z-100 h-[80%] w-[90%] translate-x-[-50%] translate-y-[-50%] rounded-md p-[10px] lg:w-[50%]">
        <div className="flex h-full flex-col">
          <div className="border-border flex flex-col items-center justify-between border-b px-2 pb-2 text-lg lg:flex-row">
            <h3 className="text-xl font-bold text-primary dark:text-white">CRIAR OPÇÃO</h3>
            <button
              onClick={() => closeModal()}
              type="button"
