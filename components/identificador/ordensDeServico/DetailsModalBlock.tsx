            ...
            <div className="mt-2 flex w-full flex-col items-center gap-2 lg:flex-row">
              <div className="w-full lg:w-1/3">
                <SelectInput
                  ...
                  handleChange={(value) =>
                    setInfoHolder((prev) => ({
                      ...prev,
                      detalhes: { ...prev.detalhes, topologia: value },
                    }))
                  }
                  onReset={() =>
                    setInfoHolder((prev) => ({
                      ...prev,
                      detalhes: { ...prev.detalhes, topologia: "" },
                    }))
                  }
                  width={"100%"}
                />
              ...
              <div className="w-full lg:w-1/3">
                <SelectInput
                  ...
                  options={tiposDeEstruturas.map((structure, index) => ({
                    ...structure,
                    id: index + 1,
                  }))}
                  selectedItemLabel={"NÃO DEFINIDO"}
                  handleChange={(value) =>
                    setInfoHolder((prev) => ({
                      ...prev,
                      detalhes: { ...prev.detalhes, tipoEstrutura: value },
                    }))
                  }
                  onReset={() =>
                    setInfoHolder((prev) => ({
                      ...prev,
                      detalhes: { ...prev.detalhes, tipoEstrutura: "" },
                    }))
                  }
                  width={"100%"}
                />
              ...
              <div className="w-full lg:w-1/3">
                <SelectInput
                  ...
                  handleChange={(value) =>
                    setInfoHolder((prev) => ({
                      ...prev,
                      detalhes: { ...prev.detalhes, tipoTelha: value },
                    }))
                  }
                  onReset={() =>
                    setInfoHolder((prev) => ({
                      ...prev,
                      detalhes: { ...prev.detalhes, tipoTelha: "" },
                    }))
                  }
                  width={"100%"}
                />
                ...
                <div className="w-full lg:w-1/4">
                  <TextInput
                    ...
                    handleChange={(value) =>
                      setInfoHolder((prev) => ({
                        ...prev,
                        detalhes: { ...prev.detalhes, pontoAgua: value },
                      }))
                    }
                    width={"100%"}
                  />
                ...
                <div className="w-full lg:w-1/4">
                  <TextInput
                    ...
                    handleChange={(value) =>
                      setInfoHolder((prev) => ({
                        ...prev,
                        detalhes: { ...prev.detalhes, senhaWifi: value },
                      }))
                    }
                    width={"100%"}
                  />
                  ...
                  <div className="w-fit">
                    <CheckboxInput
                      ...
                      handleChange={(value) =>
                        setInfoHolder((prev) => ({
                          ...prev,
                          detalhes: { ...prev.detalhes, configuracaoMonitoramento: value },
                        }))
                      }
                    />
                  </div>
                  ...
                  <div className="w-fit">
                    <CheckboxInput
                      ...
                      handleChange={(value) =>
                        setInfoHolder((prev) => ({
                          ...prev,
                          detalhes: { ...prev.detalhes, possuiTrafo: value },
                        }))
                      }
                    />
                  </div>
                ...
                <div className="w-full lg:w-1/4">
                  <SelectInput
                    ...
                    handleChange={(value) =>
                      setInfoHolder((prev) => ({
                        ...prev,
                        detalhes: { ...prev.detalhes, tipoPadrao: value },
                      }))
                    }
                    onReset={() =>
                      setInfoHolder((prev) => ({
                        ...prev,
                        detalhes: { ...prev.detalhes, tipoPadrao: "" },
                      }))
                    }
                    width={"100%"}
                  />
                ...
                <div className="w-full lg:w-1/4">
                  <SelectInput
                    ...
                    handleChange={(value) =>
                      setInfoHolder((prev) => ({
                        ...prev,
                        detalhes: { ...prev.detalhes, tipoSaidaPadrao: value },
                      }))
                    }
                    onReset={() =>
                      setInfoHolder((prev) => ({
                        ...prev,
                        detalhes: { ...prev.detalhes, tipoSaidaPadrao: "N/A" },
                      }))
                    }
                    width={"100%"}
                  />
                ...
                <div className="flex w-full justify-center lg:w-1/4">
                  <SelectInput
                    ...
                    handleChange={(value) =>
                      setInfoHolder((prev) => ({
                        ...prev,
                        detalhes: { ...prev.detalhes, amperagemPadrao: value },
                      }))
                    }
                    onReset={() =>
                      setInfoHolder((prev) => ({
                        ...prev,
                        detalhes: { ...prev.detalhes, amperagemPadrao: "" },
                      }))
                    }
                    width={"100%"}
                  />
                ...
                <div className="flex w-full justify-center lg:w-1/4">
                  <SelectInput
                    ...
                    handleChange={(value) =>
                      setInfoHolder((prev) => ({
                        ...prev,
                        detalhes: { ...prev.detalhes, responsabilidadePadrao: value },
                      }))
                    }
                    onReset={() =>
                      setInfoHolder((prev) => ({
                        ...prev,
                        detalhes: { ...prev.detalhes, responsabilidadePadrao: "NÃO SE APLICA" },
                      }))
                    }
                    width={"100%"}
                  />
            ...
            <div className="mt-2 flex w-full flex-col flex-wrap items-center justify-center gap-2 md:flex-row lg:gap-4">
              {infoHolder.categoria == "MANUTENÇÃO PREVENTIVA" ? (
                <div className="border-primary/60 flex flex-col rounded-md border p-3">
                  ...
                  <h1 className="text-foreground text-center text-xs font-medium uppercase">
                    {infoHolder.detalhes.pontoAgua || "N/A"}
                  </h1>
                </div>
              ) : null}
              {infoHolder.categoria == "MANUTENÇÃO PREVENTIVA" ? (
                <div className="border-primary/60 flex flex-col rounded-md border p-3">
                  ...
                  <h1 className="text-foreground text-center text-xs font-medium uppercase">
                    {infoHolder.detalhes.senhaWifi || "N/A"}
                  </h1>
                </div>
              ) : null}
              {infoHolder.categoria == "MANUTENÇÃO PREVENTIVA" ? (
              ...
              {infoHolder.categoria == "MANUTENÇÃO PREVENTIVA" ? (
                <div className="border-primary/60 flex flex-col rounded-md border p-3">
                  ...
                  <h1 className="text-foreground text-center text-xs font-medium uppercase">
                    {infoHolder.detalhes.possuiTrafo ? "SIM" : "N/A"}
                  </h1>
                </div>
              ) : null}
              ...
              <div className="border-primary/60 flex flex-col rounded-md border p-3">
                ...
                <h1 className="text-foreground text-center text-xs font-medium uppercase">
                  {infoHolder.detalhes.tipoEstrutura || "N/A"}
                </h1>
              </div>
              <div className="border-primary/60 flex flex-col rounded-md border p-3">
                <div className="flex items-center gap-2">
                ...
                <h1 className="text-foreground text-center text-xs font-medium uppercase">
                  {infoHolder.detalhes.topologia || "N/A"}
                </h1>
              </div>
              <div className="border-primary/60 flex flex-col rounded-md border p-3">
                <div className="flex items-center gap-2">
                  <MdRoofing />
                  <p className="text-foreground text-xs font-medium uppercase">TIPO DE TELHA</p>
                </div>
                <h1 className="text-foreground text-center text-xs font-medium uppercase">
                  {infoHolder.detalhes.tipoTelha || "N/A"}
                </h1>
              </div>
              {infoHolder.categoria == "PADRÃO" ? (
                <div className="border-primary/60 flex flex-col rounded-md border p-3">
                  <div className="flex items-center gap-2">
                    <MdElectricMeter />
                    <p className="text-foreground text-xs font-medium uppercase">TIPO DE PADRÃO</p>
                  </div>
                  <h1 className="text-foreground text-center text-xs font-medium uppercase">
                    {infoHolder.detalhes.tipoPadrao || "N/A"}
                  </h1>
                </div>
              ) : null}
              {infoHolder.categoria == "PADRÃO" ? (
              ...
              {infoHolder.categoria == "PADRÃO" ? (
                <div className="border-primary/60 flex flex-col rounded-md border p-3">
                  <div className="flex items-center gap-2">
                    <MdOutlineSettingsInputComponent />
                    <p className="text-foreground text-xs font-medium uppercase">AMPERAGEM</p>
                  </div>
                  <h1 className="text-foreground text-center text-xs font-medium uppercase">
                    {infoHolder.detalhes.amperagemPadrao || "N/A"}
                  </h1>
                </div>
              ) : null}
            </div>
