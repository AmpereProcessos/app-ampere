            ...
            <div className="mt-4 flex w-full flex-col items-center justify-center gap-2 md:flex-row lg:gap-4">
              <div className="flex items-center gap-2">
                ...
                <p className="font-raleway text-sm font-medium">
                  {infoHolder.equipamentos.modulos.qtde}x{" "}
                  {infoHolder.equipamentos.modulos.modelo || "N/A"}{" "}
                  {infoHolder.equipamentos.modulos.potencia}W
                </p>
              </div>
              <div className="flex items-center gap-2">
                ...
                <p className="font-raleway text-sm font-medium">
                  ...
                  {infoHolder.equipamentos?.inversor.qtde}x{" "}
                  {infoHolder.equipamentos?.inversor.modelo || "N/A"}{" "}
                  {infoHolder.equipamentos?.inversor.potencia}W
                </p>
              </div>
            </div>
        ...
        <div className="mt-4 flex w-full flex-col items-start gap-2 lg:flex-row">
          <div className="h-full w-full lg:w-[50%]">
            <TakeMaterialsBlock
              ...
              useMissingMaterialInformation={null}
            />
          </div>
          <div className="h-full w-full lg:w-[50%]">
            <AvailableMaterialsBlock
              osInfo={infoHolder}
              setOsInfo={setInfoHolder}
              useKitInformation={null}
            />
          </div>
        </div>
      </AnimatePresence>
