              ...
              <div className="w-full lg:w-[50%]">
                <TextInput
                  ...
                  handleChange={(value) =>
                    setInfoHolder((prev) => ({
                      ...prev,
                      favorecido: { ...prev.favorecido, nome: value },
                    }))
                  }
                  width={"100%"}
                />
              ...
              <div className="w-full lg:w-[50%]">
                <TextInput
                  ...
                  handleChange={(value) =>
                    setInfoHolder((prev) => ({
                      ...prev,
                      favorecido: { ...prev.favorecido, contato: formatToPhone(value) },
                    }))
                  }
                  width={"100%"}
                />
              ...
              <div className="flex w-full items-center gap-2 lg:w-[50%]">
                <div className="w-[20%]">
                  <SelectInput
                    ...
                    options={Object.keys(estadosECidades).map((op, index) => ({
                      id: index + 1,
                      label: op,
                      value: op,
                    }))}
                  ...
                  <SelectInput
                    ...
                    options={
                      infoHolder.localizacao?.uf
                        ? estadosECidades[
                            infoHolder.localizacao.uf as keyof typeof estadosECidades
                          ]?.map((op, index) => ({
                            id: index + 1,
                            label: op,
                            value: op,
            ...
            <div className="flex w-full flex-col gap-2 lg:flex-row">
              ...
              <div className="w-full lg:w-[50%]">
                <TextInput
                  ...
                  placeholder={
                    "Preencha o número ou identificador da residência do cliente favorecido..."
                  }
            ...
            <div className="mt-2 flex w-full flex-col items-center justify-center gap-2 md:flex-row lg:gap-4">
              <div className="text-foreground flex items-center gap-2">
                ...
                <p className="font-raleway text-sm font-medium">
                  {infoHolder.favorecido?.nome || "N/A"}
                </p>
              </div>
              <div className="text-foreground flex items-center gap-2">
                <AiFillPhone size={"20px"} color="rgb(31,41,55)" />
                <p className="font-raleway text-sm font-medium">
                  {infoHolder.favorecido?.contato || "N/A"}
                </p>
              </div>
            </div>
            <div className="mt-2 flex w-full flex-col items-center justify-center gap-2 md:flex-row lg:gap-4">
              <div className="flex items-center gap-2">
                ...
                <p className="font-raleway text-sm font-medium">
                  {infoHolder.localizacao
                    ? `${infoHolder.localizacao.cidade} - ${infoHolder.localizacao.uf} `
                    : "N/A"}
                </p>
              </div>
              <div className="flex items-center gap-2">
