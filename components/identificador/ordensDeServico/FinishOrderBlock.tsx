      ...
      {menuIsOpen ? (
        <div className="mt-2 flex items-center gap-2">
          <DateInput
            ...
            labelClassName="font-bold text-xs text-foreground"
            value={infoHolder.dataEfetivacao ? formatDate(infoHolder.dataEfetivacao) : undefined}
            handleChange={(value) =>
              setInfoHolder((prev) => ({ ...prev, dataEfetivacao: formatDateInputChange(value) }))
            }
          />
        ...
        <>
          <div className="border-primary/80 text-foreground mt-4 flex w-fit items-center justify-center gap-2 self-center rounded border p-1">
