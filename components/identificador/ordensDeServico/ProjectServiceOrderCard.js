...
function ProjectServiceOrderCard({ order, projectId, handleClick }) {
	return (
		<div className="flex h-[80px] max-h-[150px] min-h-[80px] w-full items-center rounded-md border border-gray-300">
			...
			<div className="flex h-full grow flex-col p-3">
				<div className="flex h-full w-full items-center justify-between">
					<div className="flex flex-col gap-2">
						<h1 className="text-center text-sm font-bold leading-none tracking-tight text-[#15599a] duration-300 ease-in-out  lg:text-start">{order.descricao}</h1>
