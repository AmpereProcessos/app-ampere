      ...
      <div className="flex w-full flex-col gap-2">
        <div className="flex w-full flex-wrap items-center justify-end gap-2">
          ...
          <button
            ...
            className={cn(
              "bg-primary hover:bg-primary/80 flex items-center gap-1 rounded-lg px-2 py-1 text-white duration-300 ease-in-out",
            )}
          >
            <MdDesignServices />
        ...
        {isLoading ? (
          <h1 className="text-muted-foreground w-full animate-pulse text-center">
          ...
          orders.length > 0 ? (
            ...
            <div className="flex h-[60px] items-center justify-center">
              <p className="text-muted-foreground text-center italic">
                Não há ordens de serviço vinculadas a esse projeto...
              </p>
            </div>
          )
        ) : null}
