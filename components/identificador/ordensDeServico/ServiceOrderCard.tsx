...
function ServiceOrderCard({ serviceOrder, handleClick }: ServiceOrderCardProps) {
	return (
		<div className="flex w-full items-center rounded-md border border-gray-300 lg:w-[500px] lg:min-w-[500px]">
			<div className={`h-full w-[7px] min-w-[7px] rounded-bl-md rounded-tl-md ${!!serviceOrder.dataEfetivacao ? "bg-green-500" : "bg-blue-500"}`}></div>
			<div className="flex grow flex-col p-3">
				<div className="flex w-full items-center justify-between">
					...
					<h1 className={`rounded-full ${!!serviceOrder.dataEfetivacao ? "bg-green-500" : "bg-blue-500"} px-2 py-1 text-center text-[0.65rem] font-bold text-white lg:text-xs`}>
					...
					<div className="flex items-center gap-2">
						...
						<div className="flex items-center gap-2">
							<Link href={`/ordens-de-servico/pdf/${serviceOrder._id}`}>
								<div className="flex cursor-pointer items-center gap-1 text-gray-500 duration-300 ease-in-out hover:text-cyan-500">
