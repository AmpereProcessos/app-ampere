...
function ServiceOrderCard({ serviceOrder, handleClick }: ServiceOrderCardProps) {
  return (
    <div className="border-border flex w-full items-center rounded-md border lg:w-[500px] lg:min-w-[500px]">
      <div
      ...
      <div className="flex grow flex-col p-3">
        ...
        <div className="mt-2 flex w-full items-center justify-between gap-2">
          <div className="flex items-center gap-2">
            <MdCategory />
            <p className="text-xs leading-none font-bold tracking-tight text-[#15599a]">
              {serviceOrder.categoria}
            </p>
          </div>
          <div className="flex items-center gap-2">
            <IoMdAlert />
            <p className="text-foreground text-xs leading-none tracking-tight">
              {serviceOrder.urgencia}
            </p>
          </div>
        </div>
        <div className="mt-2 flex w-full items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2">
            <FaUser />
            <p className="text-foreground text-xs leading-none tracking-tight">
              {serviceOrder.responsavel.nome || "NÃO DEFINIDO"}
            </p>
          </div>
        </div>
        <h1 className="text-foreground mt-2 text-sm">OBSERVAÇÕES</h1>
        <div className="overscroll-y text-foreground scrollbar-thin scrollbar-track-primary/20 scrollbar-thumb-primary/20 bg-primary/20 flex h-[80px] max-h-[80px] w-full items-center justify-center overflow-y-auto p-3 text-xs">
        ...
        <div className="lg:0 mt-2 flex w-full flex-col-reverse items-center justify-between gap-1 lg:flex-row lg:gap-2">
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              <Link href={`/ordens-de-servico/pdf/${serviceOrder._id}`}>
                <div className="text-foreground flex cursor-pointer items-center gap-1 duration-300 ease-in-out hover:text-cyan-500">
          ...
          <div className="flex items-center gap-1">
            ...
            />
            <p className="text-foreground text-[0.65rem] font-medium">
              {serviceOrder.autor?.nome || "INDEFINIDO"}
            </p>
          </div>
        </div>
      </div>
