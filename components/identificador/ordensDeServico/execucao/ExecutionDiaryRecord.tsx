		...
		<div className="border-primary/20 flex w-full flex-col rounded-md border p-3 shadow-xs">
			...
			{!item.saida ? (
				<div className="mt-4 flex w-full flex-col lg:mt-2">
					<h1 className="font-sans leading-none font-bold tracking-tight text-primary">ANOTAÇÕES</h1>
					<textarea
				...
				<h1 className="text-primary/60 bg-primary/20 my-1 w-full rounded-md py-3 text-center text-sm leading-none tracking-tight">{item.anotacoes}</h1>
			)}
