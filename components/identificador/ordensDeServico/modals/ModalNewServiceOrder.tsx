...
import {
  getAvailableProjectMaterials,
  getMissingProjectMaterials,
...
function ModalNewServiceOrder({
  session,
  closeModal,
  callbacks,
  projectId,
}: ModalNewServiceOrderProps) {
  ...
  function useProjectInLocoEquipmentsInformation() {
    ...
    if (availableMaterials.length === 0)
      return toast.error("Não há materiais disponíveis definidos para o projeto.");
    setOsInfo((prev) => ({
      ...prev,
  ...
  function useProjectToTakeEquipmentsInformation() {
    ...
    if (missingMaterials.length === 0)
      return toast.error("Não há materiais de retirada definidos para o projeto.");
    setOsInfo((prev) => ({
      ...prev,
          ...
          <div className="scrollbar-thin scrollbar-track-primary/20 scrollbar-thumb-primary/20 flex h-full w-full flex-col gap-4 overflow-x-hidden overflow-y-auto overscroll-y-auto px-2 py-4">
            ...
            <ServiceOrderEquipmentsInformationBlock
              ...
              useProjectInLocoEquipmentsInformation={
                project ? useProjectInLocoEquipmentsInformation : undefined
              }
              useProjectToTakeEquipmentsInformation={
                project ? useProjectToTakeEquipmentsInformation : undefined
              }
            />
