...
function ServiceOrderEquipmentsInformationBlock({
  ...
  function addEquipment(
    info: Exclude<TServiceOrder["equipamentos"]["retirada"], null | undefined>[number],
    type: "take" | "in-loco",
  ) {
    if (type === "take")
      updateInfoHolder({
  ...
  const isServiceOrderInformationEqualToProject = Object.values({
    ...
    invertersQty: project
      ? infoHolder.equipamentos.inversor.qtde ===
        project.produtos
          ?.filter((p) => p.categoria === "INVERSOR")
          .reduce((acc, current) => acc + current.qtde, 0)
      : false,
    ...
    modulesPower: project
      ...
      : false,
    modulesQty: project
      ? infoHolder.equipamentos.modulos.qtde ===
        project.produtos
          ?.filter((p) => p.categoria === "MÓDULO")
          .reduce((acc, current) => acc + current.qtde, 0)
      : false,
...
function ModulesInformation({ infoHolder, updateInfoHolder }: ModulesInformationProps) {
  return (
    <div className="border-border flex w-full flex-col gap-2 rounded-lg border p-2">
      <div className="flex items-center gap-2">
        <FaSolarPanel />
        <h1 className="text-foreground text-xs font-medium tracking-tight">
          ...
          <TextInput
            ...
            handleChange={(value) =>
              updateInfoHolder({
                equipamentos: {
                  ...infoHolder.equipamentos,
                  modulos: { ...infoHolder.equipamentos.modulos, modelo: value },
                },
              })
            }
            width={"100%"}
          ...
          <NumberInput
            ...
            handleChange={(value) =>
              updateInfoHolder({
                equipamentos: {
                  ...infoHolder.equipamentos,
                  modulos: { ...infoHolder.equipamentos.modulos, qtde: value },
                },
              })
            }
            width={"100%"}
          ...
          <TextInput
            ...
            handleChange={(value) =>
              updateInfoHolder({
                equipamentos: {
                  ...infoHolder.equipamentos,
                  modulos: { ...infoHolder.equipamentos.modulos, potencia: value },
                },
              })
            }
            width={"100%"}
...
function InvertersInformation({ infoHolder, updateInfoHolder }: InvertersInformationProps) {
  return (
    <div className="border-border flex w-full flex-col gap-2 rounded-lg border p-2">
      <div className="flex items-center gap-2">
        <TbTopologyFull />
        <h1 className="text-foreground text-xs font-medium tracking-tight">INVERSORES</h1>
      </div>
      <div className="flex w-full flex-col items-center gap-2 lg:flex-row">
        <div className="w-full lg:w-1/3">
          <TextInput
            ...
            handleChange={(value) =>
              updateInfoHolder({
                equipamentos: {
                  ...infoHolder.equipamentos,
                  inversor: { ...infoHolder.equipamentos.inversor, modelo: value },
                },
              })
            }
            width={"100%"}
          ...
          <NumberInput
            ...
            handleChange={(value) =>
              updateInfoHolder({
                equipamentos: {
                  ...infoHolder.equipamentos,
                  inversor: { ...infoHolder.equipamentos.inversor, qtde: value },
                },
              })
            }
            width={"100%"}
          ...
          <TextInput
            ...
            handleChange={(value) =>
              updateInfoHolder({
                equipamentos: {
                  ...infoHolder.equipamentos,
                  inversor: { ...infoHolder.equipamentos.inversor, potencia: value },
                },
              })
            }
            width={"100%"}
...
function TakeEquipmentBlock({
  equipmentsToTake,
  addEquipmentToTake,
  removeEquipmentToTake,
  useProjectToTakeEquipmentsInformation,
}: TakeEquipmentBlockProps) {
  const [newEquipmentToTakeHolder, setNewEquipmentToTakeHolder] = useState<
    Exclude<TServiceOrder["equipamentos"]["retirada"], null | undefined>[number]
  >({
    qtde: null,
    descricao: "",
  });
  function handleAddEquipmentToTake(
    info: Exclude<TServiceOrder["equipamentos"]["retirada"], null | undefined>[number],
  ) {
    if (!info.qtde || info.qtde <= 0) return toast.error("Preencha uma quantidade válida.");
    if (info.descricao.trim().length < 3)
      return toast.error("Preencha uma descrição de ao menos 3 caractéres.");
    return addEquipmentToTake(info);
  }
  return (
    <div className="border-border flex h-full w-full flex-col gap-2 rounded-lg border p-2">
      <div className="flex w-full flex-wrap items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          <Box size={15} />
          <h1 className="text-foreground text-xs font-medium tracking-tight">
            MATERIAIS P/ RETIRADA
          </h1>
        </div>
        {useProjectToTakeEquipmentsInformation && (
          <button
          ...
          >
            <MdContentCopy size={12} />
            <h1 className="text-[0.65rem] font-medium tracking-tight">
              UTILIZAR INFORMAÇÕES DO PROJETO
            </h1>
          </button>
        )}
      </div>
          ...
          equipmentsToTake.length > 0 ? (
            equipmentsToTake.map((equipment, index) => (
              ...
              >
                ...
                <button
                  type="button"
                  onClick={() => removeEquipmentToTake(index)}
            ...
            <div className="flex w-full grow items-center justify-center">
              <p className="text-foreground text-center text-sm italic">
                Nenhum material adicionado para retirada...
              </p>
            </div>
          )
        ) : (
      ...
      <div className="border-primary/60 flex w-full items-center gap-1 border-t pt-1">
        <div className="grow">
          <NumberInput
            label="QTDE"
            showLabel={false}
            ...
            handleChange={(value) =>
              setNewEquipmentToTakeHolder((prev) => ({ ...prev, qtde: value }))
            }
        ...
        <div className="grow">
          <TextInput
            ...
            handleChange={(value) =>
              setNewEquipmentToTakeHolder((prev) => ({ ...prev, descricao: value }))
            }
...
function InLocoEquipmentBlock({
  equipmentsInLoco,
  addEquipmentInLoco,
  removeEquipmentInLoco,
  useProjectInLocoEquipmentsInformation,
}: InLocoEquipmentBlockProps) {
  const [newEquipmentInLocoHolder, setNewEquipmentInLocoHolder] = useState<
    Exclude<TServiceOrder["equipamentos"]["retirada"], null | undefined>[number]
  >({
    qtde: null,
    descricao: "",
  });
  function handleAddEquipmentInLoco(
    info: Exclude<TServiceOrder["equipamentos"]["retirada"], null | undefined>[number],
  ) {
    if (!info.qtde || info.qtde <= 0) return toast.error("Preencha uma quantidade válida.");
    if (info.descricao.trim().length < 3)
          ...
          equipmentsInLoco.length > 0 ? (
            equipmentsInLoco.map((equipment, index) => (
              ...
              >
                ...
                <button
                  type="button"
                  onClick={() => removeEquipmentInLoco(index)}
                  className="flex items-center justify-center text-sm text-red-300 hover:text-red-500"
                >
                  <AiFillDelete />
                </button>
            ...
            <div className="flex w-full grow items-center justify-center">
              <p className="text-foreground text-center text-sm italic">
                Nenhum material adicionado aos disponíveis in loco...
              </p>
            </div>
          )
        ) : (
      ...
      <div className="border-primary/60 flex w-full items-center gap-1 border-t pt-1">
        <div className="grow">
          <NumberInput
            ...
            handleChange={(value) =>
              setNewEquipmentInLocoHolder((prev) => ({ ...prev, qtde: value }))
            }
            placeholder="Preencha aqui a quantidade do equipamento..."
            width="100%"
          />
        ...
        <div className="grow">
          <TextInput
            ...
            handleChange={(value) =>
              setNewEquipmentInLocoHolder((prev) => ({ ...prev, descricao: value }))
            }
            placeholder="Preencha aqui a descrição do equipamento..."
            width="100%"
          />
