    ...
    <div className="flex w-full flex-col items-center gap-4">
      <div className="flex w-full flex-wrap items-center justify-center gap-2">
        <div className="flex items-center gap-2">
          ...
          <p className="text-primary/60 text-xs font-medium">{infoHolder?.autor?.nome || 'Autor não identificado'}</p>
        </div>
        <div className="flex items-center gap-2">
          <BsCalendarPlus />
          <p className="text-primary/60 text-xs font-medium">{formatDateAsLocale(infoHolder?.dataInsercao, true)}</p>
        </div>
      </div>
      ...
      <div className="flex w-full flex-col gap-2">
        ...
        <h1 className="bg-primary/60 w-full p-1 text-center text-xs font-medium text-white">RESPONSÁVEIS</h1>
        <div className="flex w-full flex-col items-center gap-2 lg:flex-row">
          <div className="w-full lg:w-1/2">
            <SelectInput
        ...
        <h1 className="bg-primary/60 w-full p-1 text-center text-xs font-medium text-white">LIBERAÇÃO DA ORDEM DE SERVIÇO</h1>
        <div className="flex w-full flex-col items-center gap-2 lg:flex-row">
          <div className="w-full lg:w-1/2">
            <DateInput
        ...
        <h1 className="text-primary/80 text-sm font-medium tracking-tight">URGÊNCIA DA ORDEM DE SERVIÇO</h1>
