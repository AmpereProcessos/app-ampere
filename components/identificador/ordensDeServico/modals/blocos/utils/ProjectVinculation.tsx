...
function ServiceOrderProjectVinculation({ serviceOrderId, queryClient, affectedQueryKey, infoHolder, updateInfoHolder }: ProjectVinculationProps) {
	...
	async function handleVinculate(projectSimplified: TProjectDTODBSimplified) {
		updateInfoHolder({ projeto: { id: projectSimplified._id, nome: projectSimplified.nomeDoContrato } });
		if (serviceOrderId) {
