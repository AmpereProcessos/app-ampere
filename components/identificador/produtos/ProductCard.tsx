...
function ProductCard({ product }: ProductCardProps) {
	return (
		<div className="mt-1 flex w-full flex-col rounded-md border border-gray-300 p-2">
			<div className="flex w-full flex-col items-start justify-between gap-2 lg:flex-row lg:items-center">
				<div className="flex items-center gap-1">
					<div className="flex h-[30px] w-[30px] items-center justify-center rounded-full border border-black p-1 text-[20px]">{renderProductCategoryIcon(product.categoria, 15)}</div>
