...
function TagsMenu({ infoHolder, updateInfoHolder }: TagsMenuProps) {
	...
	return (
		<div className="flex w-full flex-col items-center gap-1">
			...
			<p className="w-full text-center text-sm tracking-tight text-gray-500">Utilize das tags para facilitar os filtros e a identificação das propriedades.</p>
			<TextInput label="NOME DA TAG" placeholder="Preencha o nome da tag..." value={tagHolder} handleChange={(value) => setTagHolder(value)} width="100%" />
