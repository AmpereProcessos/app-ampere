...
import type {
  TProperty,
  TPropertyMetadataVehicle,
  TPropertyUsageVehicleUsageMetadata,
...
function VehicleProperties({ isDesktop, infoHolder, updateInfoHolder }: VehiclePropertiesProps) {
  ...
  function handleDeleteReview(index: number) {
    updateInfoHolder({
      metadados: {
        ...infoHolder.metadados,
        revisoes: infoHolder.metadados?.revisoes.filter((_, i) => i !== index),
      },
    });
  }
  ...
  return (
    <div className="flex w-full flex-col gap-2">
      ...
      <div className="flex w-full flex-col items-center gap-2 lg:flex-row">
        <div className="w-full lg:w-1/2">
          <NumberInput
            ...
            handleChange={(value) =>
              updateInfoHolder({ metadados: { ...infoHolder.metadados, kmInicial: value } })
            }
            width="100%"
          />
        </div>
        <div className="w-full lg:w-1/2">
          <NumberInput
            ...
            handleChange={(value) =>
              updateInfoHolder({ metadados: { ...infoHolder.metadados, kmAcumulado: value } })
            }
            width="100%"
          />
        </div>
      ...
      <div className="flex w-full flex-col gap-2">
        <h1 className="w-fit text-start text-[0.65rem] font-medium tracking-tight">
          INFORMAÇÕES DA REVISÃO DO VEÍCULO{" "}
        </h1>
        <div className="flex w-full flex-col items-center gap-2 lg:flex-row">
          <div className="w-full lg:w-1/2">
            <NumberInput
              ...
              handleChange={(value) =>
                updateInfoHolder({
                  metadados: { ...infoHolder.metadados, kmIntervaloRevisao: value },
                })
              }
              width="100%"
            />
          ...
          <div className="w-full lg:w-1/2">
            <NumberInput
              ...
              handleChange={(value) =>
                updateInfoHolder({
                  metadados: { ...infoHolder.metadados, kmProximaRevisao: value },
                })
              }
              width="100%"
            />
        ...
        {infoHolder.metadados?.revisoes.length > 0 ? (
          <>
            <h1 className="text-foreground w-fit text-start text-[0.65rem] font-medium tracking-tight">
              REVISÕES DO VEÍCULO{" "}
            </h1>
        ...
        <div className="flex w-full items-center justify-end">
          <Button
            ...
            size={"fit"}
            className="gap- flex items-center px-2 py-1"
            variant="ghost"
          >
            <Plus size={15} />
      ...
      <Dialog open onOpenChange={(v) => (!v ? closeModal() : null)}>
        <DialogContent className="dark:bg-background flex h-fit max-h-[70vh] flex-col">
          ...
          <div className="flex w-full flex-col items-center gap-2 lg:flex-row">
            ...
            <div className="w-full lg:w-1/2">
              <DateInput
                ...
                handleChange={(value) =>
                  updateReviewInfo({ data: formatDateInputChange(value) as string })
                }
                width="100%"
              />
            </div>
          ...
          <DialogFooter>
            ...
            <Button
              onClick={() => addReview(reviewInfo)}
              disabled={reviewInfo.km === null || !reviewInfo.data}
            >
              ADICIONAR
            </Button>
          </DialogFooter>
