...
export default function VehicleUsageKilometerAttachment({
  ...
  return (
    <div className="flex w-full flex-col gap-2">
      ...
      <div className="border-border bg-card flex w-full grow flex-col gap-4 rounded-md border p-4 shadow-xs sm:p-6">
        <div className="flex w-full flex-col gap-1">
          <div className="flex w-full flex-col items-start gap-2 lg:flex-row lg:items-center">
            ...
            <div className="bg-secondary text-secondary-foreground flex items-center gap-1 rounded-md px-2 py-1">
              <Lock className="h-3 min-h-3 w-3 min-w-3" />
              <p className="text-[0.6rem] font-bold tracking-tight">OBRIGATÓRIO</p>
            </div>
          </div>
        </div>
        <p className="text-muted-foreground text-xs leading-none font-light">{helper}</p>
