...
function FractionnementCard({
  fractionnement,
  fractionnementIndex,
  infoHolder,
  setInfoHolder,
  deleteFractionnement,
}: FractionnementCardProps) {
      ...
      <div className="flex w-full items-start justify-between gap-2">
        <div className="flex items-center gap-2">
          <h1 className="text-xs leading-none font-black tracking-tight lg:text-sm">
            FRAÇÃO DE {formatDecimalPlaces(fractionnement.porcentagem)}%
          </h1>
      ...
      <div className="flex w-full flex-col items-center gap-2 lg:flex-row">
        ...
        <div className="w-full lg:w-1/4">
          <DateInput
            ...
            labelClassName="text-sm tracking-tight"
            value={
              fractionnement.dataPrevisaoRecebimento
                ? formatDate(fractionnement.dataPrevisaoRecebimento)
                : undefined
            }
            handleChange={(value) =>
              updateFractionnementIndex({
                info: { ...fractionnement, dataPrevisaoRecebimento: formatDateInputChange(value) },
              })
            }
            width="100%"
          />
          ...
          <DateInput
            ...
            value={
              fractionnement.dataRecebimento
                ? formatDate(fractionnement.dataRecebimento)
                : undefined
            }
            handleChange={(value) =>
              updateFractionnementIndex({
                info: { ...fractionnement, dataRecebimento: formatDateInputChange(value) },
              })
            }
            width="100%"
          />
