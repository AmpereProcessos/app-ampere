	...
	return (
		<div className="flex w-full flex-col gap-2">
			...
			<h1 className="text-primary/60 my-2 w-full self-center text-center text-sm font-medium lg:w-[80%]">
				Os fracionamentos se referem aos <strong className="text-[#fead41]">recebimentos da receita</strong> , ou seja, as parcelas em que a receita será
				divida. Portanto, serão utilizadas como parametro para o <strong className="text-[#fead41]">regime de referência / regime de caixa.</strong>
			</h1>
