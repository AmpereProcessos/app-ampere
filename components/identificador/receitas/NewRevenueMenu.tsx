...
function NewRevenueMenu({
  ...
  return (
    <div className="border-primary/60 mt-2 flex w-[90%] flex-col gap-2 self-center rounded border p-2">
      ...
      <h1 className="font-raleway bg-primary/20 text-foreground w-fit self-center rounded-md p-2 text-xs leading-none font-medium tracking-tight">
      ...
      <div className="mt-2 flex w-full items-center justify-end">
        <button
          ...
          className="disabled:border-primary/60 disabled:text-foreground w-fit rounded border border-green-500 px-4 py-1 text-sm font-medium text-green-500 hover:bg-green-500 hover:text-white"
        >
          CRIAR RECEITA
        </button>
      </div>
