...
import { BsCalendarCheck, BsCalendarEvent, BsCalendarFill, BsCalendarPlus, BsCheck2All, BsCircleHalf, BsEyeFill, BsEyeSlashFill, BsFillPatchCheckFill } from "react-icons/bs";
	...
	return (
		<div className="flex w-full flex-col rounded-md border border-gray-300 p-4 lg:w-[450px]">
			<div className="flex w-full items-center justify-between gap-2">
				<h1 onClick={() => openModal(revenue._id)} className="cursor-pointer text-xs font-black leading-none tracking-tight hover:text-cyan-500 lg:text-sm">
					{revenue.nome}
				</h1>
