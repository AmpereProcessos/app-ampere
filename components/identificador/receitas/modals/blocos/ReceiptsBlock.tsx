		...
		<div className="flex w-full grow flex-col gap-4">
			...
			<div className="flex w-full flex-col gap-2">
				...
				<div className="flex w-full items-center justify-end">
					...
					>
						<MdAddBox />
						<h1 className="text-xs font-medium tracking-tight">{!newReceiptMenuIsOpen ? "ABRIR MENU DE NOVO RECEBIMENTO" : "FECHAR MENU DE NOVO RECEBIMENTO"}</h1>
					</button>
				</div>
				...
				<RevenueReceiptsTable receipts={infoHolder.fracionamento} revenueId={revenueId} revenueTotal={infoHolder.total} updateReceipt={updateReceipt} removeReceipt={removeReceipt} />
			</div>
		</div>
	);
}
