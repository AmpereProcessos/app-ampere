    ...
    <div className="border-border bg-card flex w-full flex-col gap-1 rounded border p-2 shadow-xs">
      <div className="flex w-full flex-col items-center justify-between gap-2 md:flex-row">
        <div className="flex items-center gap-2">
          ...
          <a
            href={info.url}
            className="cursor-pointer text-sm leading-none font-bold tracking-tight duration-300 ease-in-out hover:text-cyan-500"
          >
            {info.titulo}
          </a>
          <h1 className="bg-secondary text-xxs text-foreground rounded-lg px-2 py-0.5 text-center font-medium italic">
            {info.formato}
          </h1>
        </div>
      </div>
      ...
      <div className="flex flex-col flex-wrap items-center justify-between gap-2 lg:flex-row">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="flex items-center gap-1">
            ...
            <p className="text-foreground text-[0.65rem] font-medium">{info.autor.nome}</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <button
