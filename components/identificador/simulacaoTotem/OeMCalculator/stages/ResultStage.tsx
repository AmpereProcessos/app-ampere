			...
			<div className="flex w-full grow flex-col">
				...
				<div className="my-3 flex w-full flex-col">
					<h1 className="text-center font-bold tracking-tight">
						<strong className="text-[#15599a]">{nome}</strong>, a manutenção e limpeza de um sistema fotovoltaico é essencial para garantir o seu pleno
						funcionamento, de forma que você obtenha o melhor do seu investimento.
					</h1>
					...
					<div className="my-2 flex w-full flex-col">
						<h1 className="text-primary/60 w-full text-center tracking-tight">
							A execução de uma manutenção e limpeza, para um sistema como o seu <strong className="text-[#fead41]">({numModulos} módulos)</strong> , pode te
							fazer <strong className="text-green-600">recuperar um montante anual</strong> estimado de:
						</h1>
