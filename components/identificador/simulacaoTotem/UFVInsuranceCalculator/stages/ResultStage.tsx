		...
		<div className={`bg-background font-raleway flex grow flex-col`}>
			...
			<div className="flex w-full grow flex-col">
				...
				<div className="my-6 flex w-full flex-col lg:my-3">
					<h1 className="my-2 mb-6 px-4 text-center text-sm font-bold tracking-tight lg:text-base">
						<strong className="text-[#15599a]">{nome}</strong>, proteja seu investimento em energia solar com nosso seguro especializado para sistemas
						fotovoltaicos. Garantimos segurança, tranquilidade e continuidade operacional, independentemente dos imprevistos que possam surgir.
					</h1>
					...
					<div className="my-2 flex w-full flex-col gap-2 px-2">
						<h1 className="text-primary/60 w-full text-center tracking-tight">
							Não corra riscos desnecessários. Invista na segurança do seu sistema fotovoltaico e tenha a certeza de que, independentemente do que aconteça,
							você está protegido com uma cobertura confiável e abrangente.
						</h1>
								...
								{protectionDescription.map((value) => (
									<div className="flex w-full items-center gap-0 lg:gap-1">
										<div className="flex w-2/3 flex-col items-center justify-center gap-1 lg:flex-row lg:justify-start">
											...
											{value.additional ? <p className="text-primary/60 text-center text-xs leading-none font-light lg:text-sm">{value.additional}</p> : null}
										</div>
										<div className="flex w-1/3 items-center justify-center">
											{value.warranty ? <TbCircleCheckFilled color="rgb(22,163,74)" /> : <IoMdCloseCircle color="rgb(220,38,38)" />}
										</div>
										<div className="flex w-1/3 items-center justify-center">
											{value.insurance ? <TbCircleCheckFilled color="rgb(22,163,74)" /> : <IoMdCloseCircle color="rgb(220,38,38)" />}
										</div>
									</div>
								))}
							</div>
			...
			<div className="mt-6 flex w-full flex-col">
				...
				<div className="text-primary/60 w-full self-center px-2 py-2 text-center text-sm font-medium tracking-tight lg:w-[70%] lg:text-lg">
					A <strong className="text-[#fead41]">Ampère Energias</strong> é uma empresa que nasceu no Triangulo Mineiro, com a missão de ser a melhor empresa
					de soluções em energia do Brasil, oferecendo soluções completas e com qualidade para os nossos clientes, levando economia e qualidade, com
					praticidade e facilidade. A Ampère conta com{" "}
					<strong className="text-[#fead41]">
						mais de 1500 sistemas fotovoltaicos comercializados na região, sendo uma das maiores integradoras de sistemas fotovoltaicos de Minas Gerais.
					</strong>
				</div>
			</div>
