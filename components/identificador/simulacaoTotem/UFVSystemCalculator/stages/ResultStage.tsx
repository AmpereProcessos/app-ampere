      ...
      <div className="flex w-[90%] flex-col justify-center gap-2 self-center px-4 py-12">
        ...
        <div className="relative flex w-full flex-col items-start gap-4 leading-none">
          ...
          <p className="text-lg font-medium">
            Com os dados que nos passou, criamos uma estimativa de projeto para você.
          </p>
        </div>
        <p className="mt-4 text-lg font-medium">
          De acordo com seu consumo, sugerimos uma geração mensal de{" "}
          {props.energiaGerada.toFixed(2).replace(".", ",")} kWh, que pode ser alcançada com{" "}
          {props.numModulos} placas de {props.potModulos} Wp.
        </p>
        ...
        <p className="text-lg font-medium">
          ...
          {props.valorInvestido ? formatToMoney(props.valorInvestido) : ""}.
        </p>
        ...
        <div className="mt-6 flex flex-col items-center justify-center gap-4 lg:flex-row">
          <div className="border-primary/60 flex min-h-[65px] w-full flex-col rounded-lg border bg-gray-200 p-2 shadow-md lg:w-1/3">
            <h1 className="text-[16px] tracking-tight text-black">Geração mensal aproximada</h1>
            <div className="flex items-end justify-center gap-1">
              <h1 className="font-raleway flex items-end justify-end text-[35px] font-black text-black lg:text-[40px]">
                {props.energiaGerada.toLocaleString("pt-br", {
                  minimumFractionDigits: 2,
                  maximumFractionDigits: 2,
                })}
              </h1>
              <p className="mb-1 flex grow-0 items-end justify-center text-sm text-black">KWh</p>
            </div>
          </div>
          <div className="border-primary/60 flex min-h-[65px] w-full flex-col rounded-lg border bg-gray-200 p-2 shadow-md lg:w-1/3">
            <h1 className="text-[16px] tracking-tight text-black">Investimento aproximado</h1>
            <div className="flex items-start justify-center gap-1">
              <p className="mt-2 flex grow-0 items-end justify-center text-sm text-black">R$</p>
              <h1 className="font-raleway flex items-end justify-end text-[35px] font-black text-black lg:text-[40px]">
          ...
          <div className="border-primary/60 flex min-h-[65px] w-full flex-col rounded-lg border bg-gray-200 p-2 shadow-md lg:w-1/3">
            <h1 className="text-[16px] tracking-tight text-black">
              Placas necessárias ({props.potModulos} Wp)
            </h1>
            <div className="flex items-start justify-center gap-1">
              <h1 className="font-raleway flex items-end justify-end text-[35px] font-black text-black lg:text-[40px]">
        ...
        <div className="flex flex-col items-center justify-center gap-4 lg:flex-row">
          <div className="flex w-full flex-col lg:w-1/3">
            ...
            <div className="border-primary/60 flex min-h-[90px] w-full flex-col rounded-lg border bg-[rgba(58,181,74,255)] p-2 shadow-md">
              <h1 className="text-[16px] tracking-tight text-white">
                <strong>60</strong> parcelas de:
              </h1>
              <div className="flex items-start justify-center gap-1">
                <p className="text-primary/20 mt-2 flex grow-0 items-end justify-center text-sm">
                  R$
                </p>
          ...
          <div className="flex w-full flex-col lg:w-1/3">
            <h1 className="font-bold text-black">Observações</h1>
            <div className="border-border flex min-h-[90px] w-full flex-col items-center justify-center rounded-lg border bg-gray-200 p-2 text-xs font-semibold text-black shadow-md lg:text-sm">
              *Todos os valores apresentados nessa simulação são estimativas, podendo, desse modo,
              variar de acordo com condições externas. Para valores reais, consultar com
              especialistas.*
            </div>
          </div>
        </div>
        <h1 className="text-foreground text-[35px] font-bold">Economia e Retorno</h1>
        <div className="flex flex-col items-center justify-center gap-4 lg:flex-row">
          <div className="border-primary/60 flex min-h-[50px] w-full flex-col rounded-lg border bg-gray-200 p-2 py-1 text-black shadow-md lg:w-1/2">
            <h1 className="text-[16px] tracking-tight text-black">
              Sua economia ao longo do ano será de:
            </h1>
          ...
          <div className="border-primary/60 flex min-h-[50px] w-full flex-col rounded-lg border bg-gray-200 p-2 py-1 shadow-md lg:w-1/2">
            ...
            <div className="flex items-end justify-center gap-2">
              <p className="font-raleway text-[35px] font-black text-black lg:text-[40px]">
                {beutifyNumberAsString(props.anosCompletosPayback)}
              </p>
              <p className="mb-1 text-black">anos e</p>
              <p className="font-raleway text-[35px] font-black text-black lg:text-[40px]">
                {beutifyNumberAsString(props.mesesCompletosPayback)}
              </p>
              <p className="mb-1 text-black">meses</p>
            </div>
          </div>
        </div>
        <h1 className="text-lg font-medium">Mas não é só isso...</h1>
        <h1 className="text-lg font-medium">
          Ter um Sistema Ampère em sua casa não é apenas uma escolha econômica e ambientalmente
          consciente, mas também um símbolo de status na sociedade.
        </h1>
        <h1 className="text-lg font-medium">
          Ao optar por nossa empresa, você está escolhendo a qualidade e a segurança que só uma
          marca forte, que oferece 1 ano de garantia da instalação e possui mais de 2.000 clientes
          no portfólio como a nossa, pode oferecer.
        </h1>
        <h1 className="text-lg font-medium">
          Aqui seu projeto passa por mais de 10 engenheiros antes de chegar até você, desde o
          atendimento até o suporte técnico após a instalação!
        </h1>
        <div className="justify center flex w-full gap-4">
          <h1 className="text-lg font-medium">
            <strong>{nome}</strong>, aguardamos seu contato no telefone{" "}
            <strong className="text-[#fead41]">(34) 3700-7001</strong> !
          </h1>
        </div>
      </div>
        ...
        <div className="flex items-center justify-center gap-3">
          ...
          <div className="flex flex-col items-center justify-center">
            <div className="relative w-full leading-none">
              <p className="m-0 inline text-[15px] leading-[1.2] font-normal text-white">
                A energia que move o mundo
              </p>
              <p className="m-0 inline text-xs leading-[1.2] font-normal text-white"> </p>
              <p className="m-0 inline text-[15px] leading-[1.2] font-black text-[rgba(254,173,65,1)]">
                vem de você
              </p>
              <p className="m-0 inline text-xs leading-[1.2] font-normal text-white">!</p>
            </div>
...
function getInfo(billValue: number) {
  ...
  const { moduleQty, modulePower, investiment, effectivePeakPower } =
    getUFVSystemInvestmentByEnergyBill(billValue);
  ...
  let anosCompletosPayback = Number(
    ((investiment - (investiment % economiaAnual)) / economiaAnual).toFixed(0),
  );
