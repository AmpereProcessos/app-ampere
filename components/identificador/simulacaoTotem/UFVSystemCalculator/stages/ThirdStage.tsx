        ...
        <div className="w-full">
          {submitLoading ? (
            ...
            <button
              ...
              className="flex w-[350px] flex-1 flex-grow cursor-pointer flex-col items-center justify-center rounded-lg bg-gradient-to-l from-[rgba(13,53,92,1)] to-[rgba(21,89,154,1)] p-3 duration-300 hover:scale-[1.02]"
            >
