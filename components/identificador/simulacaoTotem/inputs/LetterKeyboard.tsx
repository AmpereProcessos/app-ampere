          ...
          <div key={key} className="flex w-full items-center justify-center gap-1 lg:gap-2">
            {lett.map((letter, letterIndex) => (
              <div
                ...
                className="xs:text-[0.9rem] border-primary/20 dark:hover:bg-primary/10 flex cursor-pointer items-center justify-center rounded-md border p-2 text-xs shadow-xs hover:bg-blue-100 lg:p-4 lg:text-sm"
              >
                <p>{letter}</p>
              </div>
            ))}
        ...
        {showEmailDomains ? (
          <div className="grid w-full grid-cols-3 gap-2">
            <div
              ...
              className="border-primary/20 dark:hover:bg-primary/10 flex cursor-pointer items-center justify-center rounded-md border p-4 text-[0.7rem] shadow-xs hover:bg-blue-100 lg:text-sm"
            >
              <p>{'HOTMAIL.COM'}</p>
            </div>
            <div
