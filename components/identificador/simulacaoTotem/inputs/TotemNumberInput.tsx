...
function TotemNumberInput({
  ...
  return (
    <div
      ref={divReff}
      className={`relative flex min-h-[50px] w-full flex-col gap-1 lg:w-[${width ? width : "350px"}]`}
    >
      {showLabel ? (
      ...
      <div
        ...
        className="border-border flex w-full grow items-center gap-2 rounded-lg border p-3 shadow-xs"
      >
        {showTag ? <p>R$</p> : null}
