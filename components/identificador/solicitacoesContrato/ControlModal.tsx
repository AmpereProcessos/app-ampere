			...
			<div className="fixed left-[50%] top-[50%] z-[100] h-[80%] w-[90%] translate-x-[-50%] translate-y-[-50%] rounded-md bg-[#fff] p-[10px] lg:w-[75%]">
				<div className="flex h-full w-full flex-col">
					<div className="flex items-center justify-between border-b border-gray-300 px-2 pb-2">
						...
						<button type="button" onClick={() => closeModal()} className="flex items-center justify-center rounded-lg p-1 duration-300 ease-linear hover:scale-105 hover:bg-red-200">
					...
					{isSuccess && !!infoHolder._id ? (
						<>
							<div className="flex grow flex-col gap-y-4 overflow-y-auto overscroll-y-auto px-2 py-1 scrollbar-thin scrollbar-track-gray-100 scrollbar-thumb-gray-300">
								...
								<ElectricalInstallationDependentsInformationBlock infoHolder={infoHolder} setInfoHolder={setInfoHolder} userHasEditPermission={userHasEditPermission} />
									...
									{infoHolder.aprovacao ? (
										<>
											<div className="flex items-center gap-1">
												...
												<h1 className="text-sm font-medium tracking-tight text-gray-500">APROVADO EM: {formatDateAsLocale(infoHolder.dataAprovacao, true)}</h1>
											</div>
