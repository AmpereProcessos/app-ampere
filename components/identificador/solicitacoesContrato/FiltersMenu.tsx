...
function ContractRequestsFilterMenu({
  filters,
  updateFilters,
  queryLoading,
  resetSelectedPage,
}: ContractRequestsFilterMenuProps) {
      ...
      >
        ...
        <div className="flex w-full flex-col flex-wrap items-center justify-start gap-2 lg:flex-row">
          ...
          <MultipleSelectInput
            ...
            handleChange={(value) =>
              setFiltersHolder((prev) => ({ ...prev, serviceTypes: value as string[] }))
            }
          ...
          <div className="flex flex-wrap items-center gap-2">
            <div className="w-fit">
              <CheckboxInput
                ...
                handleChange={(value) =>
                  setFiltersHolder((prev) => ({ ...prev, pendingApproval: value }))
                }
              />
            </div>
            <div className="w-fit">
              <CheckboxInput
                ...
                handleChange={(value) =>
                  setFiltersHolder((prev) => ({ ...prev, pendingConfection: value }))
                }
              />
            </div>
          </div>
