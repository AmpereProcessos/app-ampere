  ...
  return (
    <div className="flex flex-col rounded-md border border-[#fead41] pb-2 shadow-lg">
      ...
      <div className="flex w-full flex-col items-center gap-2 px-2">
        {opportunity ? (
          <div className="flex w-full flex-col gap-1 rounded-md border border-gray-200 lg:w-[600px]">
            <h1 className="w-full rounded-tr-md rounded-tl-md bg-[#fead41] py-2 text-center text-sm font-black leading-none tracking-tight text-white">
              PROJETO
            </h1>
