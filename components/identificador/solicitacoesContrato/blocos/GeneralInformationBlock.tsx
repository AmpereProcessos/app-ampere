...
import { customersAcquisitionChannels, serviceTypes } from "@/utils/select-options";
				...
				<div className="w-full lg:w-1/4">
					<SelectWithImages
						...
						handleChange={(value) => {
							...
							setInfoHolder((prev) => ({
								...prev,
								idVendedor: selectedUser?._id,
								nomeVendedor: value,
								telefoneVendedor: selectedUser?.telefone || "",
								avatarVendedor: selectedUser?.avatar_url || undefined,
							}));
						}}
						onReset={() => {
							setInfoHolder((prev) => ({
				...
				<div className="w-full lg:w-1/4">
					<DateInput
						...
						handleChange={(value) =>
							setInfoHolder((prev) => ({
								...prev,
								dataDeNascimento: formatDateInputChange(value, "string") as string,
							}))
						}
						width="100%"
					/>
