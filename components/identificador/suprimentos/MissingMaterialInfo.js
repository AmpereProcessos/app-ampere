...
function ProjectMissingMaterialInfo({ infoHolder, setInfoHolder, setChanges }) {
  ...
  function addMaterial() {
    ...
    const equipStr = equipmentHolder.qtde
      ? `${equipmentHolder.qtde}-${equipmentHolder.descricao}`
      : `${equipmentHolder.descricao}`;
    const newKitInfoStr = infoHolder.material?.materialFaltante
    ...
    setInfoHolder((prev) => ({
      ...prev,
      material: { ...prev.material, materialFaltante: newKitInfoStr },
    }));
