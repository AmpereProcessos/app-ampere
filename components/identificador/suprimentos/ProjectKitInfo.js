	...
	return (
		<div className="flex h-full max-h-[300px] min-h-[300px] w-full flex-col rounded-lg border border-cyan-500 p-3">
			<div className="flex w-full items-center justify-between">
				<h1 className="text-center font-sans font-bold text-primary">EQUIPAMENTOS DO KIT</h1>
				{addMenuIsOpen ? (
					<button
					...
					<button type="button" onClick={() => setAddMenuIsOpen(true)} className="flex items-center justify-center text-green-500">
			...
			{addMenuIsOpen ? (
				<div className="flex w-full items-center gap-1">
					...
					<div className="flex w-[10%] items-center justify-center">
						<button type="button" onClick={() => addMaterial()} className="flex items-center justify-center text-green-500">
							<IoIosAdd />
						</button>
					</div>
				</div>
