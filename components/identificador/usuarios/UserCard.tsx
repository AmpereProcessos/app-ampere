		...
		<div className="border-primary/20 flex w-full flex-col rounded-md border p-4 lg:w-[600px]">
			<div className="flex w-full items-center justify-between gap-2">
				<div className="flex items-center gap-2">
					<h1 onClick={() => openModal(user._id)} className="cursor-pointer text-xs leading-none font-black tracking-tight hover:text-cyan-500 lg:text-sm">
			...
			<div className="mt-2 flex w-full items-center gap-2">
				<div className="flex items-center gap-2">
					<MdOutlineEmail />
					<p className="text-primary/60 text-[0.65rem] leading-none font-medium tracking-tight lg:text-xs">{user.email}</p>
				</div>
				<div className="flex items-center gap-2">
					<MdOutlinePhone />
					<p className="text-primary/60 text-[0.65rem] leading-none font-medium tracking-tight lg:text-xs">{user.telefone || "NÃO DEFINIDO"}</p>
				</div>
			</div>
			<div className="mt-4 flex w-full items-center justify-between gap-1">
				...
				<div className={`flex items-center gap-1`}>
					<BsCalendarPlus />
					<p className="text-primary/60 text-xs font-medium">{formatDateAsLocale(user.dataInsercao) || "N/A"}</p>
				</div>
			</div>
		</div>
	);
