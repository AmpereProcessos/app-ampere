...
function DatetimeInput({ width, label, labelClassName = "font-sans font-bold  text-[#353432]", showLabel = true, value, min, editable = true, handleChange }: DatetimeProps) {
	...
	return (
		<div className={`flex w-full flex-col gap-1 lg:w-[${width ? width : "350px"}]`}>
			...
			<input
				...
				id={inputIdentifier}
				type="datetime-local"
				className="w-full h-[47px] rounded-md border border-gray-300 p-3 text-sm outline-none placeholder:italic"
			/>
		</div>
	);
}
