...
function MonthYearPicker({
  ...
  return (
    ...
    >
      ...
      {selectMenuIsOpen ? (
        <div className="absolute top-[50px] z-[100] flex h-[150px] max-h-[150px] w-full flex-col self-center overflow-y-auto overscroll-y-auto rounded-md border border-gray-200 bg-[#fff] p-2 py-1 shadow-sm scrollbar-thin scrollbar-track-gray-100 scrollbar-thumb-gray-300">
          <select
