						...
						{items ? (
							items.map((item, index) => (
								<div
									...
									className={`hover:bg-primary/20 flex w-full cursor-pointer items-center rounded p-1 px-2 ${selectedId == item.id ? "bg-primary/20" : ""}`}
								>
									<p className="text-primary grow text-sm font-medium">{item.label}</p>
