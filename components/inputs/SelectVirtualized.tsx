							...
							{item.type === "reset" ? (
								<>
									...
									>
										...
										<HiCheck
											className={cn("ml-auto shrink-0", selectedId == null ? "opacity-100" : "opacity-0")}
...
function SelectInputVirtualized<T>({
	...
	return (
		<div className={cn("relative flex w-full flex-col gap-1", !width && "lg:w-[350px]")} style={rootStyle}>
			{showLabel ? (
				<label
					htmlFor={triggerId}
