...
function TagsInput({
  ...
  return (
    <div className={`flex w-full flex-col gap-1 lg:w-[${width ? width : "350px"}]`}>
      ...
      <div
        className={cn(
          "flex min-h-[48px] w-full flex-wrap items-center gap-1 rounded-md border border-border p-2 shadow-xs duration-500 ease-in-out focus-within:border-primary",
          holderClassName,
        )}
      >
