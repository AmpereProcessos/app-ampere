  ...
  return (
    <div className="grow p-6">
      ...
      <div className="grid w-full grid-cols-1 grid-rows-10 gap-y-2 lg:grid-cols-10 lg:grid-rows-1 lg:gap-x-3">
        <div className="bg-background border-border col-span-2 flex h-[250px] flex-col border p-4 shadow-xl">
      ...
      <div className="mt-4 grid grid-cols-1 grid-rows-2 gap-y-2 lg:grid-cols-10 lg:grid-rows-1 lg:gap-x-3">
        <div className="bg-background border-border col-span-2 flex h-[400px] flex-col border p-4 shadow-xl">
        ...
        <div className="bg-background border-border col-span-8 flex h-[400px] flex-col border p-4 shadow-xl">
      ...
      <div className="bg-background border-border mt-4 flex grow flex-col border p-4 shadow-xl">
        <div className="flex w-full items-center justify-between">
          <h1 className="h-[25px] w-[200px] animate-pulse bg-gray-200"> </h1>
          <button
            onClick={() => filterBirthday(!filters.birthdayToday)}
            className="h-[42px] w-[205px] animate-pulse bg-gray-200 p-2"
          >
            {" "}
          </button>
        </div>
        <div className="mt-2 flex w-full grow flex-wrap justify-between gap-y-2">
          {[1, 2, 3, 4]?.map((item, index) => (
            <div
              key={index}
              className="bg-background border-border flex h-[60px] w-[350px] flex-col items-center border p-2 text-center text-xs"
            >
