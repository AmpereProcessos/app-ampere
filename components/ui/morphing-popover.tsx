      ...
      {context.isOpen && (
        <>
          <motion.div
            ...
            aria-modal="true"
            className={cn(
              'bg-background absolute overflow-hidden rounded-md border border-zinc-950/10 p-2 text-zinc-950 shadow-md dark:border-zinc-50/10 dark:bg-zinc-700 dark:text-zinc-50',
              className
            )}
            initial="initial"
            animate="animate"
