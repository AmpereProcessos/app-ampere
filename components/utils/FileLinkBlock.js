  ...
  return (
    <div ref={divRef} className="flex w-full flex-col rounded-md border border-cyan-500 p-2">
      <div className="flex w-full items-center gap-2">
        ...
        <a
          href={obj.link}
          className="text-foreground text-sm leading-none font-bold tracking-tight duration-300 ease-in-out hover:text-cyan-500"
        >
          {obj.title}
        </a>
      </div>
      <div className="mt-1 flex w-full items-center justify-between gap-2">
        <h1 className="text-foreground text-center text-xs font-medium italic">{obj.format}</h1>
