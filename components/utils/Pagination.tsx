import { renderPagesIcons } from "@/utils/methods/rendering";
  ...
  return (
    <div className="my-2 flex w-full flex-col items-center gap-3">
      {totalPages > 1 ? (
        <>
          <p className="w-full text-center text-sm leading-none tracking-tight text-foreground">
            Um número grande de resultados foi encontrado, separamos em páginas para facilitar a
            visualização. Clique na página desejada para visualizar os demais resultados.
          </p>
          <div className="flex flex-col items-center justify-center gap-1 lg:flex-row lg:gap-4 flex-wrap">
            <button
      ...
      <div className="flex w-full flex-col gap-1">
        <p className="w-full text-center text-sm leading-none tracking-tight text-foreground">
          {itemsMatchedText ? itemsMatchedText : "..."}
        </p>
        <p className="w-full text-center text-sm leading-none tracking-tight text-foreground">
          {itemsShowingText ? itemsShowingText : "..."}
        </p>
      </div>
    </div>
  );
