...
import type { TWhatsappTemplateBodyParameter } from "@/utils/schemas/whatsapp-templates";
...
type TemplateBodyEditorProps = {
	...
	formatoParametros: "named" | "positional";
	parametros: TWhatsappTemplateBodyParameter[];
	onParametrosChange: (parametros: TWhatsappTemplateBodyParameter[]) => void;
};

function TemplateBodyEditor({ content, contentChangeCallback, formatoParametros, parametros, onParametrosChange }: TemplateBodyEditorProps) {
	...
	const insertVariable = () => {
		...
		if (formatoParametros === "positional") {
	...
	return (
		<ResponsiveDialogDrawerSection sectionTitleText="CORPO DA MENSAGEM" sectionTitleIcon={<FileText size={15} />}>
