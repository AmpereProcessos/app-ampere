...
function TemplateBodyEditor({
  ...
  return (
    <ResponsiveDialogDrawerSection
      sectionTitleText="CORPO DA MENSAGEM"
      sectionTitleIcon={<FileText size={15} />}
    >
      <div className="flex items-center flex-wrap gap-2 border-b border-primary/10 p-3">
        ...
        <div className="ml-auto flex items-center gap-2">
          <span
            className={`text-sm font-medium ${isOverLimit ? "text-red-500" : "text-foreground"}`}
          >
            {charCount} / {maxChars}
          </span>
        </div>
      ...
      <EditorContent
        editor={editor}
        className="prose max-w-none p-6 min-h-[200px]"
