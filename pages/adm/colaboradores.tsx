...
//           <div className="flex items-center gap-2 rounded-lg bg-primary/80 p-1 px-2">
...
//         <div key={index} className="flex w-full flex-col border border-primary/20 p-2">
//           <div className="flex w-full items-center justify-between">
...
//             <div className="flex items-center gap-2">
//               <FaCity />
//               <h1 className="text-xs text-primary/60">{exp.cidade}</h1>
//             </div>
//             <div className="flex items-center gap-2">
//               <FaSignature />
//               <h1 className="text-xs text-primary/60">ASSINADO EM: {exp.assinatura}</h1>
//             </div>

//             <div className="flex items-center gap-2">
//               <FaTools />
//               <h1 className="text-xs text-primary/60">CONCLUÍDO EM: {exp.finalizacao}</h1>
//             </div>
//           </div>
//           <h1 className="text-xs tracking-tight text-primary/60">ITENS</h1>
