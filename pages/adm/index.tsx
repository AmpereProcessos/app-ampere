	...
	return (
		<div className="grow p-6">
			...
			<div className="mt-4  flex flex-wrap justify-around gap-3">
				...
				{isSuccess ? projects.map((project, index) => <ADMProjectCard key={project._id} project={project} index={index} handleClick={(id) => handleOpenModal(id)} />) : null}
			</div>
			...
			{modalProject.isOpen && modalProject.projectId ? (
				<ModalADM projectId={modalProject.projectId} modalIsOpen={modalProject.isOpen} closeModal={() => setModalProject({ isOpen: false, projectId: null })} />
			) : null}
		</div>
	);
}
