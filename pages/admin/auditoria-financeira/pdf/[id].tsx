        ...
        <div className="my-4 flex w-full items-center justify-around gap-2">
          <div className="flex w-1/2 flex-col rounded-xl border border-black p-2 lg:w-1/3">
            <div className="grid w-full grid-cols-6 items-center">
              ...
              <h1 className="text-foreground col-span-4 text-center font-medium">
                TOTAL EM RECEITAS
              </h1>
        ...
        <div className="flex w-full items-center justify-center">
          <div className="flex w-1/2 flex-col rounded-xl border border-black p-2 lg:w-1/3">
            <div className="grid w-full grid-cols-6 items-center">
              ...
              <h1 className="text-foreground col-span-4 text-center font-medium">RESULTADOS</h1>
              <div className="col-span-1"></div>
            </div>

            <p className="w-full text-center text-2xl font-black text-black">
              R$ {formatDecimalPlaces(resultado)}
            </p>
            <p className="w-full text-center text-sm font-black text-cyan-500">
        ...
        <div className="flex w-full flex-col gap-1">
          {finances.receitasLista && finances.receitasLista.length > 0 ? (
            finances.receitasLista.map((revenue, index) => (
              <div key={index} className="border-border flex w-full flex-col rounded-md border p-2">
                <div className="flex w-full items-center justify-between gap-2">
                  ...
                  <div
                    className={`flex min-w-fit items-center gap-2 rounded-full bg-green-700 px-2 py-1`}
                  >
                ...
                {revenue.itens.map((item, itemIndex) => (
                  <div key={itemIndex} className="flex w-full items-center justify-between gap-2">
                    <h1 className="text-foreground text-[0.7rem] leading-none tracking-tight">
                    ...
                    <h1 className="text-foreground text-[0.7rem] font-medium">
            ...
            finances.despesasLista.map((expense, index) => (
              <div key={index} className="border-border flex w-full flex-col rounded-md border p-2">
                <div className="flex w-full items-center justify-between gap-2">
                  ...
                  <div
                    className={`flex min-w-fit items-center gap-2 rounded-full bg-[#ed174c] px-2 py-1`}
                  >
                    <h1 className="text-[0.65rem] font-medium text-white lg:text-xs">
