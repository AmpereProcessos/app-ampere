		...
		return (
			<div className="bg-background relative flex h-[297mm] w-[210mm] flex-col overflow-hidden">
				<div className="flex items-center justify-center gap-4 border border-black bg-black p-3">
					...
					<h1 className="text-center text-xl leading-none font-black tracking-tight text-white">RELATÓRIO FINANCEIRO DO PROJETO</h1>
				</div>
				...
				<div className="my-4 flex w-full items-center justify-around gap-2">
					<div className="flex w-1/2 flex-col rounded-xl border border-black p-2 lg:w-1/3">
						<div className="grid w-full grid-cols-6 items-center">
							...
							<h1 className="text-primary/80 col-span-4 text-center font-medium">TOTAL EM RECEITAS</h1>
					...
					<div className="flex w-1/2 flex-col rounded-xl border border-black p-2 lg:w-1/3">
						<div className="grid w-full grid-cols-6 items-center">
							...
							<h1 className="text-primary/80 col-span-4 text-center font-medium">TOTAL EM DESPESAS</h1>
							<div className="col-span-1"></div>
						</div>
				...
				<div className="flex w-full items-center justify-center">
					<div className="flex w-1/2 flex-col rounded-xl border border-black p-2 lg:w-1/3">
						<div className="grid w-full grid-cols-6 items-center">
							...
							<h1 className="text-primary/80 col-span-4 text-center font-medium">RESULTADOS</h1>
							<div className="col-span-1"></div>
						</div>
						...
						finances.receitasLista.map((revenue, index) => (
							<div key={index} className="border-primary/20 flex w-full flex-col rounded-md border p-2">
								<div className="flex w-full items-center justify-between gap-2">
									<div className="flex items-center gap-2">
										<h1 className="cursor-pointer text-xs leading-none font-black tracking-tight lg:text-sm">{revenue.categoria}</h1>
									</div>
					...
					{finances.despesasLista && finances.despesasLista.length > 0 ? (
						finances.despesasLista.map((expense, index) => (
							<div key={index} className="border-primary/20 flex w-full flex-col rounded-md border p-2">
								<div className="flex w-full items-center justify-between gap-2">
									<div className="flex items-center gap-2">
										<h1 className="cursor-pointer text-xs leading-none font-black tracking-tight lg:text-sm">{expense.categoria}</h1>
									</div>
