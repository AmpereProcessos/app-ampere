    ...
    return (
      <div className="flex grow flex-col p-6">
          ...
          <div className="my-2 flex items-center justify-center gap-2">
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                type="number"
                className="w-[200px] rounded-sm border border-gray-200 p-1 text-center text-gray-600 outline-none"
              />
            </div>
            <button
        ...
        <div className="my-2 flex w-full flex-col items-center">
          ...
          <div className="grid w-full grid-cols-13 items-center rounded-tr-lg rounded-tl-lg border border-gray-200">
          ...
          {sellersInfo ? (
            sellers.map((vendedor, index) => (
              <div key={index} className="grid w-full grid-cols-13 items-center border border-gray-200">
                <div
                  className={`flex h-[60px] items-center justify-center border-r border-gray-200 p-1 text-center text-xxs font-bold text-gray-600 lg:text-xs`}
                >
                  {vendedor.nome}
                </div>
                <div
                  ...
                  } h-[60px] border-r border-gray-200`}
                >
                  {index == 0 ? (
                    <>
        ...
        <div className="my-2 flex w-full flex-col items-center">
          ...
          <div className="grid w-full grid-cols-14 items-center rounded-tr-lg rounded-tl-lg border border-gray-200">
            <h1 className="rounded-tl-lg border-r border-white bg-[#15599a] p-1 text-center font-bold text-white">NOME</h1>
            <h1 className="border-r border-white bg-[#15599a] p-1 text-center font-bold text-white">JANEIRO</h1>
            <h1 className="border-r border-white bg-[#15599a] p-1 text-center font-bold text-white">FEVEREIRO</h1>
            <h1 className="border-r border-white bg-[#15599a] p-1 text-center font-bold text-white">MARÇO</h1>
