			...
			<div className="flex grow flex-col p-6">
				<div className="flex flex-col items-center border-b border-[#15599a] pb-2">
					...
					<div className="my-2 flex items-center justify-center gap-2">
						...
						<button onClick={() => getStats(filters.year)} className="self-end rounded bg-[#15599a] p-1 text-center font-bold text-[#fead61] hover:bg-[#fead61] hover:text-[#15599a]">
							BUSCAR DADOS
						</button>
					</div>
				</div>
				<div className="my-2 flex w-full flex-col items-center">
					...
					<div className="my-2 flex flex-wrap items-center gap-2">
						...
						/>
						<button onClick={filterSellers} className="h-[36px] self-end rounded bg-[#15599a] p-2 text-center font-bold text-[#fead61] hover:bg-[#fead61] hover:text-[#15599a]">
							FILTRAR
						</button>
					</div>
					<div className="grid w-full grid-cols-13 items-center rounded-tr-lg rounded-tl-lg border border-gray-300">
					...
					{sellersInfo ? (
						sellers.map((vendedor, index) => (
							<div key={index} className="grid w-full grid-cols-13 items-center border border-gray-300">
								<div className={`flex h-[60px] items-center justify-center border-r border-gray-300 p-1 text-center text-xxs font-bold text-gray-600 lg:text-xs`}>{vendedor.nome}</div>
								<div
								...
								>
									{index == 0 ? (
										<>
											<p className={`w-full border-b pb-1 text-center ${getMonthlyPerformance(vendedor.nome, 1).borderColor}`}>META: {getMonthlyPerformance(vendedor.nome, 1).meta}</p>
											<p className="pt-1 text-center">ALCANÇADO: {getMonthlyPerformance(vendedor.nome, 1).valorVendido}</p>
										</>
									) : (
										<>
											<p className={`w-full border-b pb-1 text-center ${getMonthlyPerformance(vendedor.nome, 1).borderColor}`}>{getMonthlyPerformance(vendedor.nome, 1).meta}</p>
								...
								>
									{index == 0 ? (
										<>
											<p className={`w-full border-b pb-1 text-center ${getMonthlyPerformance(vendedor.nome, 2).borderColor}`}>META: {getMonthlyPerformance(vendedor.nome, 2).meta}</p>
											<p className="pt-1 text-center">ALCANÇADO: {getMonthlyPerformance(vendedor.nome, 2).valorVendido}</p>
										</>
									) : (
										<>
											<p className={`w-full border-b pb-1 text-center ${getMonthlyPerformance(vendedor.nome, 2).borderColor}`}>{getMonthlyPerformance(vendedor.nome, 2).meta}</p>
								...
								>
									{index == 0 ? (
										<>
											<p className={`w-full border-b pb-1 text-center ${getMonthlyPerformance(vendedor.nome, 3).borderColor}`}>META: {getMonthlyPerformance(vendedor.nome, 3).meta}</p>
											<p className="pt-1 text-center">ALCANÇADO: {getMonthlyPerformance(vendedor.nome, 3).valorVendido}</p>
										</>
									) : (
										<>
											<p className={`w-full border-b pb-1 text-center ${getMonthlyPerformance(vendedor.nome, 3).borderColor}`}>{getMonthlyPerformance(vendedor.nome, 3).meta}</p>
								...
								>
									{index == 0 ? (
										<>
											<p className={`w-full border-b pb-1 text-center ${getMonthlyPerformance(vendedor.nome, 4).borderColor}`}>META: {getMonthlyPerformance(vendedor.nome, 4).meta}</p>
											<p className="pt-1 text-center">ALCANÇADO: {getMonthlyPerformance(vendedor.nome, 4).valorVendido}</p>
										</>
									) : (
										<>
											<p className={`w-full border-b pb-1 text-center ${getMonthlyPerformance(vendedor.nome, 4).borderColor}`}>{getMonthlyPerformance(vendedor.nome, 4).meta}</p>
								...
								>
									{index == 0 ? (
										<>
											<p className={`w-full border-b pb-1 text-center ${getMonthlyPerformance(vendedor.nome, 5).borderColor}`}>META: {getMonthlyPerformance(vendedor.nome, 5).meta}</p>
											<p className="pt-1 text-center">ALCANÇADO: {getMonthlyPerformance(vendedor.nome, 5).valorVendido}</p>
										</>
									) : (
										<>
											<p className={`w-full border-b pb-1 text-center ${getMonthlyPerformance(vendedor.nome, 5).borderColor}`}>{getMonthlyPerformance(vendedor.nome, 5).meta}</p>
								...
								>
									{index == 0 ? (
										<>
											<p className={`w-full border-b pb-1 text-center ${getMonthlyPerformance(vendedor.nome, 6).borderColor}`}>META: {getMonthlyPerformance(vendedor.nome, 6).meta}</p>
											<p className="pt-1 text-center">ALCANÇADO: {getMonthlyPerformance(vendedor.nome, 6).valorVendido}</p>
										</>
									) : (
										<>
											<p className={`w-full border-b pb-1 text-center ${getMonthlyPerformance(vendedor.nome, 6).borderColor}`}>{getMonthlyPerformance(vendedor.nome, 6).meta}</p>
								...
								>
									{index == 0 ? (
										<>
											<p className={`w-full border-b pb-1 text-center ${getMonthlyPerformance(vendedor.nome, 7).borderColor}`}>META: {getMonthlyPerformance(vendedor.nome, 7).meta}</p>
											<p className="pt-1 text-center">ALCANÇADO: {getMonthlyPerformance(vendedor.nome, 7).valorVendido}</p>
										</>
									) : (
										<>
											<p className={`w-full border-b pb-1 text-center ${getMonthlyPerformance(vendedor.nome, 7).borderColor}`}>{getMonthlyPerformance(vendedor.nome, 7).meta}</p>
								...
								>
									{index == 0 ? (
										<>
											<p className={`w-full border-b pb-1 text-center ${getMonthlyPerformance(vendedor.nome, 8).borderColor}`}>META: {getMonthlyPerformance(vendedor.nome, 8).meta}</p>
											<p className="pt-1 text-center">ALCANÇADO: {getMonthlyPerformance(vendedor.nome, 8).valorVendido}</p>
										</>
									) : (
										<>
											<p className={`w-full border-b pb-1 text-center ${getMonthlyPerformance(vendedor.nome, 8).borderColor}`}>{getMonthlyPerformance(vendedor.nome, 8).meta}</p>
								...
								>
									{index == 0 ? (
										<>
											<p className={`w-full border-b pb-1 text-center ${getMonthlyPerformance(vendedor.nome, 9).borderColor}`}>META: {getMonthlyPerformance(vendedor.nome, 9).meta}</p>
											<p className="pt-1 text-center">ALCANÇADO: {getMonthlyPerformance(vendedor.nome, 9).valorVendido}</p>
										</>
									) : (
										<>
											<p className={`w-full border-b pb-1 text-center ${getMonthlyPerformance(vendedor.nome, 9).borderColor}`}>{getMonthlyPerformance(vendedor.nome, 9).meta}</p>
								...
								>
									{index == 0 ? (
										<>
											<p className={`w-full border-b pb-1 text-center ${getMonthlyPerformance(vendedor.nome, 10).borderColor}`}>META: {getMonthlyPerformance(vendedor.nome, 10).meta}</p>
											<p className="pt-1 text-center">ALCANÇADO: {getMonthlyPerformance(vendedor.nome, 10).valorVendido}</p>
										</>
									) : (
										<>
											<p className={`w-full border-b pb-1 text-center ${getMonthlyPerformance(vendedor.nome, 10).borderColor}`}>{getMonthlyPerformance(vendedor.nome, 10).meta}</p>
								...
								>
									{index == 0 ? (
										<>
											<p className={`w-full border-b pb-1 text-center ${getMonthlyPerformance(vendedor.nome, 11).borderColor}`}>META: {getMonthlyPerformance(vendedor.nome, 11).meta}</p>
											<p className="pt-1 text-center">ALCANÇADO: {getMonthlyPerformance(vendedor.nome, 11).valorVendido}</p>
										</>
									) : (
										<>
											<p className={`w-full border-b pb-1 text-center ${getMonthlyPerformance(vendedor.nome, 11).borderColor}`}>{getMonthlyPerformance(vendedor.nome, 11).meta}</p>
											<p className="pt-1 text-center">{getMonthlyPerformance(vendedor.nome, 11).valorVendido}</p>
										</>
									)}
								</div>
								<div className={`flex flex-col items-center justify-center p-1 text-center text-xxs font-bold lg:text-xs ${getMonthlyPerformance(vendedor.nome, 12).color} h-[60px]`}>
									{index == 0 ? (
										<>
											<p className={`w-full border-b pb-1 text-center ${getMonthlyPerformance(vendedor.nome, 12).borderColor}`}>META: {getMonthlyPerformance(vendedor.nome, 12).meta}</p>
											<p className="pt-1 text-center">ALCANÇADO: {getMonthlyPerformance(vendedor.nome, 12).valorVendido}</p>
										</>
									) : (
										<>
											<p className={`w-full border-b pb-1 text-center ${getMonthlyPerformance(vendedor.nome, 12).borderColor}`}>{getMonthlyPerformance(vendedor.nome, 12).meta}</p>
				...
				<div className="my-2 flex w-full flex-col items-center">
					...
					<div className="grid w-full grid-cols-14 items-center rounded-tr-lg rounded-tl-lg border border-gray-300">
						<h1 className="rounded-tl-lg border-r border-white bg-[#15599a] p-1 text-center font-bold text-white">NOME</h1>
						<h1 className="border-r border-white bg-[#15599a] p-1 text-center font-bold text-white">JANEIRO</h1>
						<h1 className="border-r border-white bg-[#15599a] p-1 text-center font-bold text-white">FEVEREIRO</h1>
						<h1 className="border-r border-white bg-[#15599a] p-1 text-center font-bold text-white">MARÇO</h1>
					...
					{filteredSellersInfo ? (
						filteredSellersInfo.map((vendedor, index) => <VendedorMetaCard key={vendedor.nome} vendedor={vendedor} ano={filters.yearFetched} getVendedoresInfo={getVendedoresInfo} />)
					) : (
						<></>
					)}
				</div>
