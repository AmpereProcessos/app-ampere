        ...
        <div className="flex w-full grow flex-col">
          ...
          {isSuccess
            ? materials.map((material, index) => (
                ...
                >
                  <h1 className="w-[10%] text-center text-xs font-medium text-black">
                    {index + 1}
                  </h1>
                  <div className="flex w-[50%] flex-col">
                    ...
                    <div className="flex w-full items-center gap-1">
                      ...
                      <h1 className="text-foreground text-[0.65rem] tracking-tight">
                        {material.codigo || "CÓDIGO NÃO DEFINIDO"}
                      </h1>
                    </div>
                  </div>
                  <h1 className="w-[20%] text-center text-xs font-medium text-black">
                    {formatDecimalPlaces(material.qtde)}
                  </h1>
                  <h1 className="w-[20%] text-center text-xs font-medium text-black">
                    {formatToMoney(material.preco)}
                  </h1>
                </div>
              ))
            : null}
