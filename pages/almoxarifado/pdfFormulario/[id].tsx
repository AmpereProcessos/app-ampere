...
import type { TNewWarehouseFormulary, TNewWarehouseFormularyDTO } from "@/utils/schemas/warehouse-formularies";
			...
			<div className="flex h-[29.7cm] w-[21cm] flex-col">
				...
				<div className="flex w-full flex-col">
					...
					{formulary.materiais.map((material) => (
						<div className="flex items-center gap-2 border-x border-b border-black p-2" key={material.id}>
							...
							<h1 className="w-[15%] text-center text-xs font-medium text-black">{formatDecimalPlaces(material.qtdeRetirada - material.qtdeDevolucao)}</h1>
