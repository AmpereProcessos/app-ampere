      ...
      <div className="flex flex-col bg-[#fff] grow items-center">
        ...
        <div className="grid grid-rows-10 grid-cols-1 lg:grid-cols-10 lg:grid-rows-1 gap-y-4 lg:gap-2 p-6  w-full xl:w-[70%]">
                ...
                {!newImage && info.avatar_url ? (
                  <>
                    ...
                    <div className="flex items-center justify-center rounded-full w-[150px] h-[150px] absolute opacity-0 hover:opacity-60 bg-gray-400">
                      ...
                      />
                      <p className="absolute text-white font-bold translate-x-[-10%] translate-y-[-10%]">Editar</p>
                    </div>
                  </>
                ) : newImage ? (
                  <>
          ...
          <div className="row-span-9 lg:col-span-8 p-4 flex flex-col min-h-[350px] border border-gray-300 shadow-lg rounded-md">
            <h1 className="text-xl text-center font-bold text-[#15599a] border-b border-[#15599a] pb-2">INFORMAÇÕES DO USUÁRIO</h1>
            <div className="flex flex-col grow gap-4 pt-2">
              <div className="grid grid-rows-2 grid-cols-1 lg:grid-cols-10 lg:grid-rows-1 gap-2 py-2 items-center w-full border-b border-gray-200">
                <p className="col-span-1 lg:col-span-3 font-bold text-gray-700 text-sm lg:text-md text-center lg:text-start">NOME:</p>
                <p className="lg:col-span-7 text-center lg:text-start text-gray-500">{info.nome}</p>
              </div>
              <div className="grid grid-rows-2 grid-cols-1 lg:grid-cols-10 lg:grid-rows-1 gap-2 py-2 items-center w-full border-b border-gray-200">
                <p className="col-span-1 lg:col-span-3 font-bold text-gray-700 text-sm lg:text-md text-center lg:text-start">EMAIL:</p>
                <p className="lg:col-span-7 text-center lg:text-start text-gray-500">{info.email}</p>
              </div>
              <div className="grid grid-rows-2 grid-cols-1 lg:grid-cols-10 lg:grid-rows-1 gap-2 py-2 items-center w-full border-b border-gray-200">
                <p className="col-span-1 lg:col-span-3 font-bold text-gray-700 text-sm lg:text-md text-center lg:text-start">AVATAR DISPONÍVEL EM:</p>
                <a
              ...
              <div className="grid grid-rows-2 grid-cols-1 lg:grid-cols-10 lg:grid-rows-1 gap-2 py-2 items-center w-full border-b border-gray-200">
                <p className="col-span-1 lg:col-span-3 font-bold text-gray-700 text-sm lg:text-md text-center lg:text-start">DATA DE NASCIMENTO:</p>
              ...
              <div className="grid grid-rows-2 grid-cols-1 lg:grid-cols-10 lg:grid-rows-1 gap-2 py-2 items-center w-full border-b border-gray-200">
                <p className="col-span-1 lg:col-span-3 font-bold text-gray-700 text-sm lg:text-md text-center lg:text-start">RG</p>
                <p className="lg:col-span-7 text-center lg:text-start text-gray-500">{info.rg ? info.rg : 'AINDA NÃO DEFINIDO'}</p>
              </div>
              <div className="grid grid-rows-2 grid-cols-1 lg:grid-cols-10 lg:grid-rows-1 gap-2 py-2 items-center w-full border-b border-gray-200">
                <p className="col-span-1 lg:col-span-3 font-bold text-gray-700 text-sm lg:text-md text-center lg:text-start">CPF</p>
                <p className="lg:col-span-7 text-center lg:text-start text-gray-500">{info.cpf ? info.cpf : 'AINDA NÃO DEFINIDO'}</p>
              </div>
            </div>
          </div>
        </div>
        <div className="grid grid-rows-10 grid-cols-1 lg:grid-cols-10 lg:grid-rows-1 gap-y-4 lg:gap-2 p-6  w-full xl:w-[70%]">
          <div className="row-span-1 lg:col-span-2 p-4 flex flex-col items-center w-full max-h-[850px] min-h-[350px] border border-gray-300 shadow-lg rounded-md">
            <h1 className="text-gray-700 font-bold text-xl pb-2 border-b border-gray-300">ROTAS ACESSÍVEIS</h1>
            <div className="flex flex-col gap-2 grow w-full my-2 overflow-y-auto overscroll-y scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
              {info.accessibleRoutes.map((route, index) => (
                <p key={index} className="uppercase p-2 font-bold text-center rounded-lg w-full border-2 border-[#fead61] text-[#fead61]">
                  {route}
                </p>
              ))}
            </div>
          ...
          <div className="row-span-9 lg:col-span-8 p-4 flex flex-col max-h-[850px] min-h-[350px] border border-gray-300 shadow-lg rounded-md">
            <h1 className="text-xl text-center font-bold text-[#15599a] border-b border-[#15599a] pb-2">NOTIFICAÇÕES</h1>
            {notifyInfo.destinatario && (
              <div className="flex flex-col items-center my-2 w-full">
                ...
                {notifyMsg && <p className={`text-center text-xs my-1 ${notifyMsg.color}`}>{notifyMsg.text}</p>}
                <button onClick={notify} className="bg-blue-200 hover:text-white hover:bg-blue-600 p-1 rounded-lg mt-2">
                ...
                not.length > 0 ? (
                  not.map((notificacao, index) => (
                    ...
                    >
                      ...
                      <p className="text-xs text-gray-500 font-raleway text-center">{notificacao.mensagem}</p>
                  ...
                  <div className="h-full flex justify-center items-center">
                    <p className="italic text-gray-500 text-sm">Sem notificações...</p>
                  </div>
                )
              ) : (
                <LoadingPage />
