					...
					<div className="overscroll-y mt-2 flex grow flex-wrap justify-around gap-2 overflow-y-auto scrollbar-thin scrollbar-track-gray-100 scrollbar-thumb-gray-300">
						{filteredInProgress ? (
							filteredInProgress.map((call) => (
								<div onClick={() => handleOpenModal(call)} key={call._id} className="max-h-[150px] min-h-[120px] w-[420px] cursor-pointer border border-gray-300 p-3 hover:bg-blue-100">
									<div className="mb-2 flex justify-between">
										...
										<p className={`rounded-lg border p-1 text-xs font-bold ${statusStyles[call.status].textColor} ${statusStyles[call.status].borderColor}`}>{call.status}</p>
									</div>
					...
					<div className="overscroll-y mt-2 flex grow flex-wrap justify-around gap-2 overflow-y-auto scrollbar-thin scrollbar-track-gray-100 scrollbar-thumb-gray-300">
						{filteredClosedCalls ? (
							filteredClosedCalls.map((call) => (
								<div onClick={() => handleOpenModal(call)} key={call._id} className="h-[100px] w-full cursor-pointer border border-gray-300 p-3 hover:bg-blue-100 lg:w-[420px]">
									<div className="mb-2 flex justify-between">
										<div className="flex items-center gap-2">
											<TbCash
												style={{
