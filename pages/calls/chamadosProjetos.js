    ...
    return (
      <div className="flex flex-col gap-y-2 grow p-6">
        <div className="flex items-center justify-between w-full border border-gray-200 bg-[#fff] shadow-xl p-4">
          <p className="font-bold uppercase text-center text-2xl text-[#15599a] font-['Roboto']">CHAMADOS DE PROJETOS</p>
              ...
              filteredOpenCalls.map((call) => (
                ...
                >
                  <div className="grid grid-cols-5 justify-between items-center w-full">
                    <h1 className="col-span-3 uppercase text-sm font-semibold">{call.projeto && call.projeto}</h1>
                    {call.status && (
                      <p
              ...
              filteredClosedCalls.map((call) => (
                ...
                >
                  <div className="grid grid-cols-3 gap-x-2 items-center w-full">
                    <h1 className="uppercase text-sm col-span-2 font-semibold">{call.projeto && call.projeto}</h1>
                    <p
                      className={`text-xs font-bold border p-1 col-span-1 rounded-lg ${statusStyles[call.status].textColor} ${
                  ...
                  <div className="grid grid-cols-2 mt-2 items-center w-full">
                    <p className="text-xs text-gray-500 uppercase">Responsável:</p>
                    <p className="text-xs text-gray-500 text-center">{call.responsavel}</p>
                  </div>
                  <div className="grid grid-cols-2 mt-2 items-center w-full">
                    <p className="text-xs text-gray-500 uppercase">Tipo de chamado:</p>
                    <p className="text-xs text-gray-500 text-center">{call.tipoDoChamado}</p>
                  </div>
                </div>
              ))
            ) : (
