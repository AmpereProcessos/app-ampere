			...
			<div className="flex grow flex-col gap-y-2 p-6">
				...
				<div className="grid grid-cols-1 grid-rows-5  gap-3 lg:grid-cols-5 lg:grid-rows-1">
					<div className="flex h-[150px] flex-col border border-gray-300 bg-[#fff] p-4 shadow-xl">
						...
						<p className="flex grow items-center justify-center text-center text-xl font-bold text-[#fead61]">CONFECCIONAR: {stats.assinatura && stats.assinatura.confeccionar}</p>
					...
					<div className="flex h-[150px] flex-col border border-gray-300 bg-[#fff] p-4 shadow-xl">
						...
						<p className="flex grow items-center justify-center text-center text-xl font-bold text-[#fead61]">SOLICITAR: {stats.parecer && stats.parecer.solicitar}</p>
						<p className="text-center text-gray-600">
					...
					<div className="flex h-[150px] flex-col border border-gray-300 bg-[#fff] p-4 shadow-xl">
						...
						<p className="flex grow items-center justify-center text-center text-xl font-bold text-[#fead61]">PROJETOS: {stats.comissionamento && stats.comissionamento.parcial}</p>
						<p className="text-center text-gray-600">
					...
					<div className="flex h-[150px] flex-col border border-gray-300 bg-[#fff] p-4 shadow-xl">
						...
						<p className="flex grow items-center justify-center text-center text-xl font-bold text-[#fead61]">DISTRIBUIÇÕES: {stats.distribuicoes && stats.distribuicoes}</p>
						<p className="text-center text-gray-600">
					...
					<div className="flex h-[150px] flex-col border border-gray-300 bg-[#fff] p-4 shadow-xl">
						...
						<p className="flex grow items-center justify-center text-center text-xl font-bold text-[#fead61]">SOLICITAR: {stats.vistoria.pendente && stats.vistoria.pendente}</p>
						<p className="text-center text-gray-600">
							...
							filteredClosedCalls.map((call) => (
								...
								>
									<div className="grid w-full grid-cols-3 items-center gap-x-2">
										...
										<p className={`col-span-1 rounded-lg border p-1 text-xs font-bold ${statusStyles[call.status].textColor} ${statusStyles[call.status].borderColor}`}>{call.status}</p>
									</div>
