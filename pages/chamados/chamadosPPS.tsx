...
function ChamadosPPS() {
  ...
  return <ChamadosPPSContent session={session} />;
}

export default ChamadosPPS;

function ChamadosPPSContent({ session }: { session: TAuthSession }) {
  // Context and utils
  ...
  return (
    <div className="bg-primary/20 flex w-full grow flex-col gap-y-2 p-6">
      <div className="bg-background border-border flex w-full flex-col items-center justify-between border p-4 shadow-xl lg:flex-row">
        <p className="text-center font-['Roboto'] text-2xl font-bold text-[#15599a] uppercase">
