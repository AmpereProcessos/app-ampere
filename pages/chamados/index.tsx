			...
			<div className="flex w-full flex-wrap items-center justify-around gap-2">
				...
				<Link href="/chamados/chamadosPosVenda" className="h-fit w-full md:h-[280px] md:w-[600px]">
					<Button variant={"outline"} size={"fit"} className="bg-card border-primary/30 flex h-full w-full flex-col gap-2 rounded-lg border p-6">
						...
						<h1 className="text-center text-lg font-black text-wrap text-[#15599a] uppercase md:text-2xl dark:text-[#fead41]">Chamados de Pós-Venda</h1>
						<p className="text-muted-foreground text-center text-sm tracking-tight text-wrap">
				...
				<Link href="/chamados/chamadosProjetos" className="h-fit w-full md:h-[280px] md:w-[600px]">
					<Button variant={"outline"} size={"fit"} className="bg-card border-primary/30 flex h-full w-full flex-col gap-2 rounded-lg border p-6">
						...
						<h1 className="text-center text-lg font-black text-wrap text-[#15599a] uppercase md:text-2xl dark:text-[#fead41]">Chamados de Engenharia</h1>
						<p className="text-muted-foreground text-center text-sm tracking-tight text-wrap">
