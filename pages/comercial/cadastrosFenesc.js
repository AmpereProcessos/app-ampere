			...
			<div className="mt-4 flex grow flex-wrap justify-around gap-3">
				{filteredRegisters ? (
					filteredRegisters.map((register) => (
						<div key={register._id} className="flex h-fit w-full flex-col gap-1 rounded-md border border-gray-300 p-3 shadow-sm lg:h-[290px] lg:w-[450px]">
							<div className="flex w-full items-center justify-between">
							...
							<div className="flex w-full flex-col">
								<div className="flex items-center gap-2">
									...
									<h1 className="text-xs font-medium text-gray-700">{register.dataRegistro ? dayjs(register.dataRegistro).format("DD/MM/YY HH:mm") : null}</h1>
								</div>
								<div className="flex items-center justify-center gap-3">
