...
function Configuracoes() {
  ...
  const [newApportionmentModalIsOpen, setNewApportionmentModalIsOpen] =
    useState(false);
  ...
  return (
    <div className="p-6 grow flex flex-col gap-2">
      ...
      <div className="w-full flex py-2 items-start gap-2">
        <div className="w-[50%] max-h-[500px] h-[500px]  flex flex-col rounded border border-gray-200 shadow-lg">
          <div className="flex items-center w-full justify-between px-2">
            <h1 className="pb-1 border-b border-gray-200 font-raleway font-black text-center p-3">
              CENTROS DE CUSTO
            </h1>
      ...
      {newApportionmentModalIsOpen ? (
        <NewApportionment
          closeModal={() => setNewApportionmentModalIsOpen(false)}
        />
      ) : null}
    </div>
  );
