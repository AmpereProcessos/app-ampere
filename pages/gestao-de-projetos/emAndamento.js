				...
				<ol className="self-center border-l-2 border-[#15599a]">
					<li>
						...
						<div className="ml-6 mb-6 flex flex-col gap-3 pb-6">
							<p className="text-sm text-blue-600 transition duration-300 ease-in-out focus:text-blue-800 hover:text-blue-700">{data.assContrato.length} projetos nesse estágio</p>
							<button
								onClick={() =>
									setProjects({
										estagio: "ASSINATURA DO CONTRATO",
					...
					<li>
						...
						<div className="ml-6 mb-6 flex flex-col gap-3 pb-6">
							<p className="text-sm text-blue-600 transition duration-300 ease-in-out focus:text-blue-800 hover:text-blue-700">{data.compraDoKit.length} projetos nesse estágio</p>
							<button
								onClick={() =>
									setProjects({
					...
					<li>
						...
						<div className="ml-6 mb-6 flex flex-col gap-3 pb-6">
							<p className="text-sm text-blue-600 transition duration-300 ease-in-out focus:text-blue-800 hover:text-blue-700">{data.entregaDoKit.length} projetos nesse estágio</p>
							<button
								onClick={() =>
									setProjects({
					...
					<li>
						...
						<div className="ml-6 mb-6 flex flex-col gap-3 pb-6">
							<p className="text-sm text-blue-600 transition duration-300 ease-in-out focus:text-blue-800 hover:text-blue-700">{data.assDocumentacoes.length} projetos nesse estágio</p>
							<button
								onClick={() =>
									setProjects({
					...
					<li>
						...
						<div className="ml-6 mb-6 flex flex-col gap-3 pb-6">
							<p className="text-sm text-blue-600 transition duration-300 ease-in-out focus:text-blue-800 hover:text-blue-700">{data.libConc.length} projetos nesse estágio</p>
							<button
								onClick={() =>
									setProjects({
					...
					<li>
						...
						<div className="ml-6 mb-6 flex flex-col gap-3 pb-6">
							<p className="text-sm text-blue-600 transition duration-300 ease-in-out focus:text-blue-800 hover:text-blue-700">{data.agendamentoObra.length} projetos nesse estágio</p>
							<button
								onClick={() =>
									setProjects({
					...
					<li>
						...
						<div className="ml-6 mb-6 flex flex-col gap-3 pb-6">
							<p className="text-sm text-blue-600 transition duration-300 ease-in-out focus:text-blue-800 hover:text-blue-700">{data.terminoObra.length} projetos nesse estágio</p>
							<button
								onClick={() =>
									setProjects({
					...
					<li>
						...
						<div className="ml-6 mb-6 flex flex-col gap-3 pb-6">
							<p className="text-sm text-blue-600 transition duration-300 ease-in-out focus:text-blue-800 hover:text-blue-700">{data.ligamentoUsina.length} projetos nesse estágio</p>
							<button
								onClick={() =>
									setProjects({
					...
					<li>
						...
						<div className="ml-6 mb-6 flex flex-col gap-3 pb-6">
							<p className="text-sm text-blue-600 transition duration-300 ease-in-out focus:text-blue-800 hover:text-blue-700">{data.entregaTecnica.length} projetos nesse estágio</p>
							<button
								onClick={() =>
									setProjects({
				...
				<div className="top-0 left-0 mb-2 flex h-[450px] w-full flex-col rounded-sm border border-gray-300 bg-[#fff] p-3 shadow-lg lg:sticky lg:top-[10%] lg:left-[60%] lg:mb-0 lg:h-[600px] lg:w-[500px]">
					...
					<div className="overscroll-y flex max-h-[520px] grow flex-col overflow-y-auto scrollbar-thin scrollbar-track-gray-100 scrollbar-thumb-gray-300">
						{selectedProjects.projetos?.length > 0 ? (
							...
							<p className="flex h-full items-center justify-center text-center text-sm italic text-gray-500">Nenhum projeto se encontra nesse estágio...</p>
						)}
					</div>
				</div>
			</div>
