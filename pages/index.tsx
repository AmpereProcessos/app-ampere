...
import { Check, CirclePlus, Clock, Play, Truck, Zap, TrendingDown, TrendingUp, Star, BadgeDollarSign } from 'lucide-react'
import { Tooltip, TooltipContent, TooltipTrigger } from '@/components/ui/tooltip'
import { Area, CartesianGrid, ComposedChart, Label, PolarGrid, PolarRadiusAxis, XAxis, YAxis } from 'recharts'
  ...
  return (
    <div className="bg-card border-primary/20 flex w-full flex-col gap-3 rounded-xl border px-3 py-4 shadow-xs">
      <div className="flex items-center justify-between">
        <h1 className="text-xs font-medium tracking-tight uppercase">{METRIC_LABELS[queryParams.metric].title}</h1>
