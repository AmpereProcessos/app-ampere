...
function GestaoDeObras() {
  ...
  function getStats() {
    axios.get('/api/gestao-obras/estatisticas').then((res) => setStats(res.data))
  }
      ...
      <div className="flex flex-col">
        ...
        <div className="grid grid-cols-1 grid-rows-6  gap-3 lg:grid-cols-6 lg:grid-rows-1">
          ...
          <div className="flex h-[250px] flex-col border border-gray-200 bg-[#fff] p-4 shadow-xl">
            ...
            <p className="flex grow items-center justify-center text-center text-2xl font-bold text-[#fead61]">{stats.obras && stats.obras.total}</p>
