    ...
    <div className="flex w-full grow flex-col p-6">
      <div className="flex flex-col">
        ...
        <div className="mt-2 flex w-full flex-col items-center justify-around gap-2 lg:flex-row">
          <div className="bg-background border-border flex min-h-[110px] w-full flex-col rounded-xl border p-6 shadow-xs lg:w-1/3">
            ...
            <div className="mt-2 flex w-full flex-col">
              <div className="text-2xl font-bold text-[#15599a]">
                {stats?.periodo?.iniciados || 0}
              </div>
              <div className="flex items-center gap-1">
                <FaHourglassStart />
                <p className="text-foreground text-xs font-medium uppercase">
                  {formatDecimalPlaces((stats?.periodo.tempoMedioPlanejamento || 0) / 24)} dias em
                  média de planejamento
                </p>
              </div>
            </div>
          </div>
          <div className="bg-background border-border flex min-h-[110px] w-full flex-col rounded-xl border p-6 shadow-xs lg:w-1/3">
            ...
            <div className="mt-2 flex w-full flex-col">
              <div className="text-2xl font-bold text-[#15599a]">
                {stats?.periodo?.executados || 0}
              </div>
              <div className="flex items-center gap-1">
                <FaHourglassStart />
                <p className="text-foreground text-xs font-medium uppercase">
                  {formatDecimalPlaces((stats?.periodo.tempoMedioExecucao || 0) / 24)} dias em média
                  de execução
                </p>
              </div>
            </div>
          ...
          <div className="bg-background border-border flex min-h-[110px] w-full flex-col rounded-xl border p-6 shadow-xs lg:w-1/3">
            ...
            <div className="mt-2 flex w-full flex-col">
              <div className="text-2xl font-bold text-[#15599a]">
                {stats?.periodo?.entregasEfetivadas || 0}
              </div>
              <div className="flex items-center gap-1">
                <BsCalendarEvent />
                <p className="text-foreground text-xs font-medium uppercase">
        ...
        <div className="mt-2 flex w-full flex-col items-center justify-around gap-2 lg:flex-row">
          <div className="bg-background border-border flex min-h-[110px] w-full flex-col rounded-xl border p-6 shadow-xs lg:w-1/3">
            ...
            <div className="mt-2 flex w-full flex-col">
              <div className="text-2xl font-bold text-[#15599a]">
                {stats?.adequacoesPadrao?.total || 0}
              </div>
              <div className="flex items-center gap-1">
                <FaPiggyBank />
                <p className="text-foreground text-xs font-medium uppercase">
                  {stats?.adequacoesPadrao.pagos} pagos
                </p>
              </div>
            </div>
          </div>
          <div className="bg-background border-border flex min-h-[110px] w-full flex-col rounded-xl border p-6 shadow-xs lg:w-1/3">
            ...
            <div className="mt-2 flex w-full flex-col">
              <div className="text-2xl font-bold text-[#15599a]">
                {stats?.adequacoesEstrutura?.total || 0}
              </div>
              <div className="flex items-center gap-1">
                <FaPiggyBank />
                <p className="text-foreground text-xs font-medium uppercase">
                  {stats?.adequacoesEstrutura.pagos} pagos
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="mt-5 flex w-full flex-wrap justify-center gap-4">
        <Link href="/obras/controle-padroes">
          <div className="border-border dark:hover:bg-primary/10 flex w-full cursor-pointer flex-col gap-2 rounded-md border p-3 shadow-xs duration-300 ease-in-out hover:border-blue-300 hover:bg-blue-100 lg:w-[500px]">
            <h1 className="text-center leading-none font-bold tracking-tight">
              CONTROLE DE PADRÕES
            </h1>
            <div className="flex w-full items-center justify-center p-2">
              <MdElectricMeter style={{ color: "#15599a", fontSize: "45px" }} />
            </div>
            <p className="text-foreground text-center font-light">
              Área de gestão e controle de adequações de padrões pendentes.
            </p>
          </div>
        </Link>
        <Link href="/obras/controle-estruturas">
          <div className="border-border dark:hover:bg-primary/10 flex w-full cursor-pointer flex-col gap-2 rounded-md border p-3 shadow-xs duration-300 ease-in-out hover:border-blue-300 hover:bg-blue-100 lg:w-[500px]">
            ...
            <p className="text-foreground text-center font-light">
              Área de gestão e controle de adequações de estruturas pendentes.
            </p>
          </div>
        </Link>
        <Link href="/obras/conferenciaMaterial">
          <div className="border-border dark:hover:bg-primary/10 flex w-full cursor-pointer flex-col gap-2 rounded-md border p-3 shadow-xs duration-300 ease-in-out hover:border-blue-300 hover:bg-blue-100 lg:w-[500px]">
            <h1 className="text-center leading-none font-bold tracking-tight">
              ENTREGAS PARA CONFERÊNCIA
            </h1>
            <div className="flex w-full items-center justify-center p-2">
              <FaListCheck style={{ color: "#15599a", fontSize: "45px" }} />
            </div>
            <p className="text-foreground text-center font-light">
              Área de controle e conferência de materiais.
            </p>
          </div>
        </Link>
      </div>
