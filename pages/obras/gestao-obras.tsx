		...
		<div className="flex w-full grow flex-col p-6">
			<div className="flex flex-col">
				...
				<div className="mt-2 flex w-full flex-col items-center justify-around gap-2 lg:flex-row">
					<div className="flex min-h-[110px] w-full flex-col rounded-xl border border-gray-300 bg-[#fff] p-6 shadow-sm lg:w-1/3">
						...
						<div className="mt-2 flex w-full flex-col">
							...
							<div className="flex items-center gap-1">
								<FaHourglassStart />
								<p className="text-xs font-medium uppercase text-gray-800">{formatDecimalPlaces((stats?.periodo.tempoMedioPlanejamento || 0) / 24)} dias em média de planejamento</p>
							</div>
						</div>
					</div>
					<div className="flex min-h-[110px] w-full flex-col rounded-xl border border-gray-300 bg-[#fff] p-6 shadow-sm lg:w-1/3">
						...
						<div className="mt-2 flex w-full flex-col">
							...
							<div className="flex items-center gap-1">
								<FaHourglassStart />
								<p className="text-xs font-medium uppercase text-gray-800">{formatDecimalPlaces((stats?.periodo.tempoMedioExecucao || 0) / 24)} dias em média de execução</p>
							</div>
						</div>
					</div>
					<div className="flex min-h-[110px] w-full flex-col rounded-xl border border-gray-300 bg-[#fff] p-6 shadow-sm lg:w-1/3">
						...
						<div className="mt-2 flex w-full flex-col">
							...
							<div className="flex items-center gap-1">
								<BsCalendarEvent />
								<p className="text-xs font-medium uppercase text-gray-800">{formatDecimalPlaces(stats?.periodo.entregasPrevistas || 0)} previstas em 30 dias</p>
							</div>
						</div>
					</div>
				</div>
