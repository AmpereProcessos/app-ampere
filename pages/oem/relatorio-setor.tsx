              ...
              <AnimatePresence>
                {scenarios.first.showClients ? (
                  <motion.div
                    initial={{ scale: 0.8, opacity: 0.6 }}
                    animate={{ scale: 1, opacity: 1 }}
                    className="overscroll-y flex h-fit max-h-[400px] w-full flex-col gap-4 self-center overflow-y-auto border border-gray-200 p-2 scrollbar-thin scrollbar-track-gray-100 scrollbar-thumb-gray-300 lg:w-[50%]"
                  >
