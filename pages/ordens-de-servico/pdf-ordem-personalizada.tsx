				...
				<div className="flex w-full flex-col p-2">
					...
					<div className="mt-2 flex w-full flex-col items-start gap-2 lg:flex-row">
						<div className="h-full w-full lg:w-[50%]">
							<TakeMaterialsBlock osInfo={infoHolder} setOsInfo={setInfoHolder} useMissingMaterialInformation={() => toast.error("Não disponível.")} />
						</div>
						<div className="h-full w-full lg:w-[50%]">
				...
				<div className="h-[29.7cm] w-[21cm] p-4">
					...
					<div className="mt-8 px-4">
						<p className="font-raleway text-center">
							...
							fotovoltaico de {((infoHolder.equipamentos.modulos.qtde || 0) * (Number(infoHolder.equipamentos.modulos.potencia) || 0)) / 1000} kWp instalado
							na{" "}
							<strong>
