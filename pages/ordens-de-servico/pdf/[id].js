...

{
	/**
        <div className="flex flex-col p-6 grow bg-background">
          ...
          <div className="flex flex-col justify-center flex-wrap p-3 border border-primary/20 shadow-lg">
          ...
          <div className="flex flex-col p-3 border border-primary/20 mt-2 shadow-lg">
            <h1 className="text-center font-bold font-raleway text-[#15599a]">
          ...
          <div className="flex flex-wrap justify-center gap-x-2 p-3 border border-primary/20 mt-2 shadow-lg">
            <div className="flex flex-col w-[450px] self-center mt-2 items-center">
              ...
              <textarea
                ...
                className="w-full text-center h-[150px] bg-gray-200 resize-none p-2 outline-hidden border border-primary/80"
                onChange={(e) =>
                  setosInfo({
                    ...osInfo,
                    obra: {
