	...
	return (
		<div className="grow p-6">
									...
									<div className="flex items-center justify-center gap-x-2">
										<div className="w-full lg:w-[250px]">
											<DateInput
												...
												handleChange={(value) => setFilters((prev) => ({ ...prev, date: { ...prev.date, after: formatDateInputChange(value, "string") as string } }))}
											/>
										</div>
										<div className="w-full lg:w-[250px]">
											<DateInput
												...
												handleChange={(value) => setFilters((prev) => ({ ...prev, date: { ...prev.date, before: formatDateInputChange(value, "string") as string } }))}
											/>
										</div>
									</div>
									<div className="w-full lg:w-[350px]">
			...
			<div className="mt-4 flex flex-wrap justify-around gap-3 overflow-y-auto overscroll-y-auto">
				...
				{isSuccess ? projects.map((project) => <PosVendaCard session={session} key={project._id} projectId={project._id} project={project} mode={mode} />) : null}
			</div>
		</div>
	);
}
