		...
		<div className="h-[29.7cm] w-[21cm] font-[Inter]">
			<div className="bg-background relative flex h-[297mm] w-[210mm] flex-col overflow-hidden">
				...
				<div className="px-2 py-2 text-center text-xs font-medium">
					...
					<strong className="text-[#fead61]"> com a missão de ser a melhor empresa de soluções em energia do Brasil</strong>, oferecendo soluções completas
					e com qualidade para os nossos clientes, levando economia e qualidade, com praticidade e facilidade. A Ampère conta com{" "}
					<strong className="text-[#fead61]">mais de 1500 sistemas fotovoltaicos comercializados na região</strong>, sendo uma das maiores integradoras de
					sistemas fotovoltaicos de Minas Gerais.
				</div>
