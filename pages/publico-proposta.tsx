...
function ProposePage() {
  const info = {
    ...
    servicos: [
      {
        titulo:
          "FORNECIMENTO DE MATERIAIS, EXECUÇÃO DE MALHA DE ATERRAMENTO E INSTALAÇÃO DE CABINE",
        descricao:
      ...
      },
      {
        ...
        descricao:
          "Instalação de poste equipado, instalação de eletrodutos,  lançamento de condutores e instalação de muflas.",
        itens: [
      ...
      },
      {
        ...
        descricao:
          "Instalação de alambrado em mourões de concreto e tela fornecidos pela contratada, incluindo aterramento e portão de entrada.",
        itens: [
    ...
    responsabilidades: [
      {
        descricao: "Fornecer liberação da área para execução dos serviços.",
        responsavel: "CONTRATANTE",
      },
      {
        descricao: "Fornecer documentação necessária para aprovação execução dos serviços.",
        responsavel: "CONTRATANTE",
      },
      {
        descricao: "Fornecer materiais que não constam na lista do ANEXO I.",
        responsavel: "CONTRATANTE",
      },
      {
        descricao:
          "Fornecer dois ajudantes práticos da área civil que serão instruídos e acompanhados por nossos técnicos na abertura de valas.",
        responsavel: "CONTRATANTE",
      },
    ],
  ...
  function groupResponsabilities(responsabilities: Propose["responsabilidades"]) {
    const grouped = responsabilities.reduce(
      (
        acc: {
          CONTRATANTE: Propose["responsabilidades"];
          CONTRATADA: Propose["responsabilidades"];
        },
        current,
      ) => {
    ...
    <div className="h-[29.7cm] w-[21cm] font-[Inter]">
      <div className="bg-background relative flex h-[297mm] w-[210mm] flex-col overflow-hidden">
        <div className="flex h-fit w-full items-center justify-between rounded-br-md rounded-bl-md bg-[#15599a] p-4">
          <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="text-xs font-light text-white">
                {info.localizacao.endereco}, Nº {info.localizacao.numeroOuIdentificador},{" "}
                {info.localizacao.bairro}{" "}
              </p>
            </div>
          </div>
        ...
        <div className="px-2 py-2 text-center text-xs font-medium">
          A <strong className="text-[#fead61]">Ampère Energias</strong> é uma empresa que nasceu no
          Triangulo Mineiro,
          <strong className="text-[#fead61]">
            {" "}
            com a missão de ser a melhor empresa de soluções em energia do Brasil
          </strong>
          , oferecendo soluções completas e com qualidade para os nossos clientes, levando economia
          e qualidade, com praticidade e facilidade. A Ampère conta com{" "}
          <strong className="text-[#fead61]">
            mais de 1500 sistemas fotovoltaicos comercializados na região
          </strong>
          , sendo uma das maiores integradoras de sistemas fotovoltaicos de Minas Gerais.
        </div>
        <div className="flex w-full flex-col gap-1">
          ...
          {info.servicos.map((service, index) => (
            <div className="border-primary/60 flex w-full flex-col border-b p-2">
              <div className="flex w-full items-center gap-2">
                ...
                <h1 className="text-[0.7rem] font-black tracking-tight text-[#15599a]">
                  {service.titulo}
                </h1>
              </div>
              <div className="text-foreground mt-2 flex w-full items-center justify-center text-center text-[0.6rem] font-medium uppercase">
                {service.descricao}
              </div>
              <h1 className="text-foreground mt-2 mb-1 w-full text-xs leading-none font-medium tracking-tight">
                COMPOSIÇÃO
              </h1>
          ...
          <div className="flex flex-col px-2">
            <div className="mt-2 flex items-center gap-2">
              <BsSuitDiamondFill size={10} />
              <h1 className="text-foreground text-[0.6rem] leading-none tracking-tight">
                EXECUTAR OS SERVIÇOS PROPOSTOS CONFORME PROJETO APROVADO
              </h1>
            </div>
          </div>
        </div>
