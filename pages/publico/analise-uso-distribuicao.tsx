...
export default function EnergyDistributionDashboard() {
  const [installationRecords, setInstallationRecords] =
    useState<TDistributionInstallationRecordGroupedByPeriod>({});
  ...
  const handleSubmit = async () => {
    ...
    if (isXLSX) {
      ...
      const groupedByPeriod = installationRecords.reduce(
        (acc: TDistributionInstallationRecordGroupedByPeriod, curr) => {
          ...
          const energyBillValue =
            (consumptionValue - compensatedEnergyValue) * newEntry.energyTariff +
            PUBLIC_ILUMINATION_VALUE +
            ENERGY_INFRA_VALUE;
          acc[period].push({
  ...
  const handleSaveGeneration = () => {
    ...
    updatedRecords[editingRecord.period][editingRecord.index].geracaoValor =
      editingValues.geracaoValor;
    updatedRecords[editingRecord.period][editingRecord.index].valorFatura =
      editingValues.valorFatura;
        ...
        <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
          <div className="space-y-2">
            ...
            <p className="text-lg text-gray-400">
              Análise de energia e distribuição por instalação
            </p>
          </div>
          ...
          <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
            <DialogTrigger asChild>
              <Button
                size="lg"
                className="bg-background hover:bg-primary/20 border-2 border-white px-8 py-3 font-semibold text-black"
              >
            ...
            <DialogContent className="bg-background sm:max-w-md">
              <DialogHeader>
                ...
                <DialogDescription className="text-foreground">
                  Adicione uma nova análise de distribuição de energia
                </DialogDescription>
              </DialogHeader>
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setNewEntry((prev) => ({ ...prev, installationTitle: e.target.value }))
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setNewEntry((prev) => ({
                        ...prev,
                        energyTariff: Number.parseFloat(e.target.value) || 0,
                      }))
                    }
                    className="border-border"
                  />
                ...
                <div className="space-y-2">
                  ...
                  <div className="border-border rounded-lg border-2 border-dashed p-6 text-center transition-colors hover:border-gray-400">
                    ...
                    <div className="text-foreground text-sm">
                      {newEntry.distributionFile ? (
                        ...
                        <>
                          <span className="font-medium">Clique para enviar</span> ou arraste o
                          arquivo
                        </>
                      )}
                    </div>
                    ...
                    <Button
                      ...
                      variant="outline"
                      size="sm"
                      className="border-border mt-2 text-black"
                ...
                <Button
                  ...
                  className="hover:bg-primary/80 w-full bg-black text-white"
                >
            ...
            {selectedPeriod && installationRecords[selectedPeriod] && (
              <div className="space-y-8">
                ...
                <div className="flex w-full flex-col items-center gap-2 lg:flex-row">
                  <Card className="bg-background border-border w-full shadow-xl lg:w-1/3">
                    ...
                    <CardContent>
                      <div className="text-3xl font-bold text-black">
                        {formatDecimalPlaces(periodStats.totalGeneration, 2)}
                      </div>
                      <p className="text-foreground mt-1 text-xs">kWh gerados no período</p>
                    </CardContent>
                  </Card>
                  <Card className="bg-background border-border w-full shadow-xl lg:w-1/3">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    ...
                    <CardContent>
                      <div className="text-3xl font-bold text-black">
                        {formatDecimalPlaces(periodStats.totalInjection, 2)}
                      </div>
                      <p className="text-foreground mt-1 text-xs">kWh injetados no período</p>
                    </CardContent>
                  </Card>
                  <Card className="bg-background border-border w-full shadow-xl lg:w-1/3">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    ...
                    <CardContent>
                      <div className="text-3xl font-bold text-black">
                        {formatDecimalPlaces(periodStats.totalTransferred, 2)}
                      </div>
                      <p className="text-foreground mt-1 text-xs">kWh transferidos no período</p>
                    </CardContent>
                  </Card>
                </div>
                ...
                <div className="flex w-full flex-col items-center gap-2 lg:flex-row">
                  <Card className="bg-background border-border w-full shadow-xl lg:w-1/3">
                    ...
                    <CardContent>
                      <div className="text-3xl font-bold text-black">
                        {formatDecimalPlaces(
                          periodStats.totalConsumptionFromGrid +
                            periodStats.totalConsumptionFromSelfGeneration,
                          2,
                        )}
                      </div>
                      <p className="text-foreground mt-1 text-xs">kWh consumidos no período</p>
                    </CardContent>
                  </Card>
                  <Card className="bg-background border-border w-full shadow-xl lg:w-1/3">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    ...
                    <CardContent>
                      <div className="text-3xl font-bold text-black">
                        {formatDecimalPlaces(periodStats.totalConsumptionFromSelfGeneration, 2)}
                      </div>
                      <p className="text-foreground mt-1 text-xs">
                        kWh consumidos pela geração no período
                      </p>
                    </CardContent>
                  </Card>
                  <Card className="bg-background border-border w-full shadow-xl lg:w-1/3">
                    ...
                    <CardContent>
                      <div className="text-3xl font-bold text-black">
                        {formatDecimalPlaces(
                          (periodStats.totalConsumptionFromSelfGeneration * 100) /
                            periodStats.totalGeneration,
                          2,
                        )}
                      </div>
                      <p className="text-foreground mt-1 text-xs">%</p>
                    </CardContent>
                  </Card>
                </div>
                <h1 className="text-2xl font-semibold text-white">Análise do Econômica</h1>
                <div className="flex w-full flex-col items-center gap-2 lg:flex-row">
                  <Card className="bg-background border-border w-full shadow-xl lg:w-1/2">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                      <CardTitle className="text-foreground text-sm font-semibold">
                        Total pago
                      </CardTitle>
                    ...
                    <CardContent>
                      <div className="text-3xl font-bold text-black">
                        {formatDecimalPlaces(periodStats.totalEnergyBillPaid, 2)}
                      </div>
                      <p className="text-foreground mt-1 text-xs">R$</p>
                    </CardContent>
                  </Card>
                  <Card className="bg-background border-border w-full shadow-xl lg:w-1/2">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    ...
                    <CardContent>
                      <div className="text-3xl font-bold text-black">
                        {formatDecimalPlaces(periodStats.totalEnergyBillSaved, 2)}
                      </div>
                      <p className="text-foreground mt-1 text-xs">R$</p>
                    </CardContent>
                  </Card>
                ...
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                          <PieChart>
                            <Pie
                              ...
                              dataKey="value"
                              label={({ name, value }) =>
                                `${name}: ${formatDecimalPlaces(value, 2)}kWh`
                              }
                              labelLine={false}
                            >
                              {getPieData(installationRecords[selectedPeriod]).map(
                                (entry, index) => (
                  ...
                  <Card className="bg-background border-border shadow-xl">
                    <CardHeader className="border-border border-b">
                      ...
                      <CardDescription className="text-foreground">
                        Geração vs Consumo vs Compensação
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="pt-6">
                      <div className="h-80">
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                  {installationRecords[selectedPeriod].map((record, index) => (
                    <Card
                      ...
                      className="bg-background group border-border relative overflow-hidden shadow-xl transition-all duration-300 hover:shadow-2xl"
                    >
                      <div
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-2">
                            <Button
                              size="fit"
                              variant="ghost"
                              onClick={() => handleEditGeneration(selectedPeriod, index, record)}
                              className="p-2"
                            >
                      ...
                      <CardContent className="space-y-4 pl-6">
                        <div className="border-border flex items-center justify-between border-b py-2">
                          <span className="text-foreground text-sm font-medium">Geração:</span>
                          <span className="text-lg font-bold text-black">
                            {record.geracaoValor
                              ? `${formatDecimalPlaces(record.geracaoValor, 2)} kWh`
                              : "N/A"}
                          </span>
                        </div>
                        <div className="border-border flex items-center justify-between border-b py-2">
                          <span className="text-foreground text-sm font-medium">Injetado:</span>
                          <span className="text-lg font-bold text-black">
                            {record.injecaoValor
                              ? `${formatDecimalPlaces(record.injecaoValor, 2)} kWh`
                              : "N/A"}
                          </span>
                        </div>
                        <div className="border-border flex items-center justify-between border-b py-2">
                          <span className="text-foreground text-sm font-medium">Consumo:</span>
                          <span className="text-lg font-bold text-black">
                            {record.consumoValor
                              ? `${formatDecimalPlaces(record.consumoValor, 2)} kWh`
                              : "N/A"}
                          </span>
                        </div>
                        <div className="border-border flex items-center justify-between border-b py-2">
                          <span className="text-foreground text-sm font-medium">Compensado:</span>
                          <span className="text-lg font-bold text-black">
                            {record.compensacaoValor
                              ? `${formatDecimalPlaces(record.compensacaoValor, 2)} kWh`
                              : "N/A"}
                          </span>
                        </div>
                        <div className="border-border flex items-center justify-between border-b py-2">
                          <span className="text-foreground text-sm font-medium">Recebido:</span>
                          <span className="text-lg font-bold text-black">
                            {record.recebimentoValor
                              ? `${formatDecimalPlaces(record.recebimentoValor, 2)} kWh`
                              : "N/A"}
                          </span>
                        </div>
                        <div className="border-border flex items-center justify-between border-b py-2">
                          <span className="text-foreground text-sm font-medium">Transferido:</span>
                          <span className="text-lg font-bold text-black">
                            {record.transferenciaValor
                              ? `${formatDecimalPlaces(record.transferenciaValor, 2)} kWh`
                              : "N/A"}
                          </span>
                        </div>
                        <div className="border-border border-t pt-3">
                          <div className="flex items-center justify-between">
                            <span className="text-foreground text-sm font-medium">Tarifa:</span>
                            <span className="text-lg font-bold text-black">
                              {record.tarifaEnergia
                                ? `${formatToMoney(record.tarifaEnergia)}/kWh`
                                : "N/A"}
                            </span>
                          </div>
                        </div>
                        <div className="border-border border-t pt-3">
                          <div className="flex items-center justify-between">
                            ...
                            <span className="text-lg font-bold text-black">
                              {record.valorFatura ? `${formatToMoney(record.valorFatura)}` : "N/A"}
                            </span>
                          </div>
                        </div>
                      </CardContent>
        ...
        <Dialog open={editModalOpen} onOpenChange={setEditModalOpen}>
          <DialogContent className="bg-background sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription className="text-foreground">
                Defina o valor de geração para {editingRecord?.record.identificador}
              </DialogDescription>
            </DialogHeader>
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setEditingValues((prev) => ({
                      ...prev,
                      geracaoValor: Number.parseFloat(e.target.value) || 0,
                    }))
                  }
                  className="border-border"
                />
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setEditingValues((prev) => ({
                      ...prev,
                      valorFatura: Number.parseFloat(e.target.value) || 0,
                    }))
                  }
                  className="border-border"
                />
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  variant="outline"
                  className="border-border flex-1 text-black"
                >
                  Cancelar
                </Button>
                <Button
                  onClick={handleSaveGeneration}
                  className="hover:bg-primary/80 flex-1 bg-black text-white"
                >
                  Salvar
                </Button>
              </div>
