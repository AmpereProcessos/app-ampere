...
import { fileTypes, formatCPFCpnj, formatToPhone, vendedores } from '../../utils/constants'
...
function CadastroFenesc() {
  ...
  async function addRegister() {
    ...
    if (validateFields()) {
      ...
      try {
        var imageRef = ref(storage, `fenesc/${registerInfo.codigoSVB}/propostaComercial${(Math.random() * 10000).toFixed(0)}`)
        ...
        <div className="w-[90%] h-[100%] bg-[#fff] rounded-lg flex flex-col border border-gray-300 shadow-lg p-2 items-center">
          ...
          <div className="grow w-full flex flex-col items-center">
            ...
            <SelectFoatingInput
              ...
              handleChange={(value) => setRegisterInfo((prev) => ({ ...prev, nomeVendedor: value }))}
            />
            <TextFloatingInput
              ...
              handleChange={(value) => setRegisterInfo((prev) => ({ ...prev, emailVendedor: value }))}
            />
            <NumberFloatingInput
              label={'CÓDIGO SVB'}
              editable={true}
              width={'50%'}
              value={registerInfo.codigoSVB ? registerInfo.codigoSVB.toString() : null}
              handleChange={(value) =>
            ...
            <NumberFloatingInput
              ...
              editable={true}
              width={'50%'}
              value={registerInfo.valorProjeto ? registerInfo.valorProjeto : null}
              handleChange={(value) => {
                setRegisterInfo((prev) => ({
                  ...prev,
            ...
            <NumberFloatingInput
              ...
              editable={true}
              width={'50%'}
              value={registerInfo.valorFinanciado ? registerInfo.valorFinanciado.toString() : null}
              handleChange={(value) =>
                setRegisterInfo((prev) => ({
                  ...prev,
            ...
            <NumberFloatingInput
              ...
              editable={true}
              width={'50%'}
              value={registerInfo.qtdeParcelas ? registerInfo.qtdeParcelas.toString() : null}
              handleChange={(value) =>
                setRegisterInfo((prev) => ({
                  ...prev,
            ...
            <NumberFloatingInput
              ...
              editable={true}
              width={'50%'}
              value={registerInfo.carenciaDesejada ? registerInfo.carenciaDesejada.toString() : null}
              handleChange={(value) =>
                setRegisterInfo((prev) => ({
                  ...prev,
            ...
            <div className="w-fit flex flex-col items-center">
              ...
              <div className="relative border-dotted h-fit p-2 rounded-lg border-2 border-blue-700 bg-gray-100 flex justify-center items-center mt-2">
                ...
                <input onChange={(e) => setImage(e.target.files[0])} className="h-full w-full opacity-0" type="file" accept=".png, .jpeg, .pdf" />
              </div>
            </div>
          </div>
