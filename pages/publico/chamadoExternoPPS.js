  ...
  if (insertStatus == "success")
    return (
      <div className="flex h-full w-full grow flex-col items-center justify-center gap-4">
        ...
        <h1 className="text-foreground text-lg font-medium italic">
          Solicitação criada com sucesso !
        </h1>
        <button
          onClick={() => setInsertStatus(null)}
          className="font-raleway text-sm font-bold tracking-tight text-blue-500 hover:text-cyan-500"
        >
          ABRIR NOVO CHAMADO
        </button>
      </div>
      ...
      <div className="flex w-full grow flex-col">
        {/* <div className="mt-4 flex items-center justify-center gap-4">
              <div className="flex items-center gap-2">
                ...
                <p className="text-xs font-medium text-foreground">{session.user.nome}</p>
              </div>
        ...
        <div className="mt-4 w-full self-center lg:w-[50%]">
          <SelectInput
            ...
            options={allActiveSellers.map((seller) => ({
              id: seller.id,
              label: seller.label,
              value: seller.value,
            }))}
            handleChange={(value) =>
              setInfoHolder((prev) => ({
                ...prev,
                requerente: { ...prev.requerente, apelido: value },
              }))
            }
            ...
            onReset={() =>
              setInfoHolder((prev) => ({
                ...prev,
                requerente: { ...prev.requerente, apelido: null },
              }))
            }
            width="100%"
          />
        ...
        <h1 className="bg-primary/80 mt-4 w-full p-2 text-center font-bold text-white">
          TIPO DE SOLICITAÇÃO
        </h1>
        <SelectInput
          ...
          options={ppsTiposSolicitacao.map((type, index) => ({
            id: index + 1,
            label: type.label,
            value: type.value,
          }))}
            ...
            <div className="mt-2 flex flex-col items-center gap-1 px-2">
              {infoHolder.projeto.id ? (
                <div className="flex flex-col items-center gap-1">
                  <p className="font-Raleway w-full text-center font-bold text-[#fead41]">
                    #{infoHolder.projeto.codigo}
                  </p>
                  <h1 className="font-Raleway w-full text-center text-xl leading-none font-bold tracking-tight">
                    {infoHolder.projeto.nome}
                  </h1>
                </div>
              ) : (
                <>
                  <p className="text-foreground w-full text-center text-sm italic lg:w-[60%]">
                    Lembrando que o código em questão é o código identificador de projeto no CRM,
                    sendo esse o número que acompanha o padrão:
                  </p>
                  <h1 className="text-foreground mb-2 text-sm">
                    <strong>CRM</strong>-<strong className="text-[#fead41]">(NÚMERO AQUI)</strong>
                  </h1>
                  <div className="flex items-end gap-2">
                    <NumberInput
                      label={"CÓDIGO IDENTIFICADOR DO PROJETO"}
                      labelClassName="text-center text-foreground font-bold font-raleway text-sm lg:text-base"
                      value={infoHolder.projeto.codigo}
                      handleChange={(value) =>
                        setInfoHolder((prev) => ({
                          ...prev,
                          projeto: { ...prev.projeto, codigo: value },
                        }))
                      }
        ...
        <div className="mt-1 flex w-full flex-col items-center gap-2 px-2 lg:flex-row">
          <div className="w-full lg:w-[50%]">
            <TextInput
              ...
              handleChange={(value) =>
                setInfoHolder((prev) => ({ ...prev, cliente: { ...prev.cliente, nome: value } }))
              }
              width="100%"
            />
          </div>
          <div className="w-full lg:w-[50%]">
            <TextInput
              ...
              handleChange={(value) =>
                setInfoHolder((prev) => ({
                  ...prev,
                  cliente: { ...prev.cliente, cpfCnpj: formatCPFCpnj(value) },
                }))
              }
              width="100%"
            />
        ...
        <div className="mt-1 flex w-full flex-col items-center gap-2 px-2 lg:flex-row">
          <div className="w-full lg:w-[50%]">
            <TextInput
              ...
              handleChange={(value) =>
                setInfoHolder((prev) => ({
                  ...prev,
                  cliente: { ...prev.cliente, telefone: formatToPhone(value) },
                }))
              }
              width="100%"
            />
          ...
          <div className="w-full lg:w-[50%]">
            <TextInput
              ...
              handleChange={(value) =>
                setInfoHolder((prev) => ({ ...prev, cliente: { ...prev.cliente, email: value } }))
              }
              width="100%"
            />
          </div>
        ...
        <div className="mt-1 flex w-full flex-col items-center gap-2 px-2 lg:flex-row">
          <div className="w-full lg:w-[50%]">
            <TextInput
              ...
              handleChange={(value) =>
                setInfoHolder((prev) => ({ ...prev, cliente: { ...prev.cliente, bairro: value } }))
              }
              width="100%"
            />
          </div>
          <div className="w-full lg:w-[50%]">
            <TextInput
              ...
              handleChange={(value) =>
                setInfoHolder((prev) => ({
                  ...prev,
                  cliente: { ...prev.cliente, endereco: value },
                }))
              }
              width="100%"
            />
          ...
          <div className="w-full lg:w-[50%]">
            <TextInput
              ...
              handleChange={(value) =>
                setInfoHolder((prev) => ({
                  ...prev,
                  cliente: { ...prev.cliente, numeroOuIdentificador: value },
                }))
              }
              width="100%"
            />
          ...
          <div className="w-full lg:w-[50%]">
            <DateInput
              ...
              handleChange={(value) =>
                setInfoHolder((prev) => ({
                  ...prev,
                  cliente: { ...prev.cliente, dataNascimento: value },
                }))
              }
              width="100%"
            />
          ...
          <div className="mt-1 flex w-full flex-col items-center gap-2 px-2 lg:flex-row">
            <div className="w-full lg:w-[50%]">
              <NumberInput
                ...
                handleChange={(value) =>
                  setInfoHolder((prev) => ({ ...prev, cliente: { ...prev.cliente, renda: value } }))
                }
                width="100%"
              />
            </div>
            <div className="w-full lg:w-[50%]">
              <TextInput
                ...
                handleChange={(value) =>
                  setInfoHolder((prev) => ({
                    ...prev,
                    cliente: { ...prev.cliente, profissao: value },
                  }))
                }
                width="100%"
              />
          ...
          <div className="mt-1 flex w-full flex-col items-center gap-2 px-2 lg:flex-row">
            <div className="w-full lg:w-1/3">
              <NumberInput
                ...
                handleChange={(value) =>
                  setInfoHolder((prev) => ({
                    ...prev,
                    premissas: { ...prev.premissas, geracao: value },
                  }))
                }
                width="100%"
              />
            ...
            <div className="w-full lg:w-1/3">
              <SelectInput
                ...
                options={tiposEstruturaCRM.map((type, index) => ({
                  id: index + 1,
                  label: type.label,
                  value: type.value,
                }))}
                ...
                onReset={() =>
                  setInfoHolder((prev) => ({
                    ...prev,
                    premissas: { ...prev.premissas, tipoEstrutura: null },
                  }))
                }
                width="100%"
              />
            ...
            <div className="w-full lg:w-1/3">
              <SelectInput
                ...
                handleChange={(value) =>
                  setInfoHolder((prev) => ({
                    ...prev,
                    premissas: { ...prev.premissas, topologia: value },
                  }))
                }
                selectedItemLabel="NÃO DEFINIDO"
                onReset={() =>
                  setInfoHolder((prev) => ({
                    ...prev,
                    premissas: { ...prev.premissas, topologia: null },
                  }))
                }
                width="100%"
              />
            ...
            <div className="w-full lg:w-[50%]">
              <NumberInput
                ...
                handleChange={(value) =>
                  setInfoHolder((prev) => ({
                    ...prev,
                    premissas: { ...prev.premissas, valorFinanciamento: value },
                  }))
                }
                width="100%"
              />
        ...
        {infoHolder.tipoSolicitacao == "PROPOSTA COMERCIAL (OFF GRID)" ? (
          <div className="mt-2 flex w-full items-center justify-center px-2">
            <ChargeMenu
              charges={infoHolder.premissas.cargas}
              addCharge={addCharge}
        ...
        {infoHolder.tipoSolicitacao == "ANÁLISE DE CRÉDITO" ? (
          <AttachFile
            files={files}
            setFiles={setFiles}
            clientIdentifier={infoHolder.cliente.cpfCnpj || ""}
          />
        ) : null}
      </div>
