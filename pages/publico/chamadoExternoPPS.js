...
import { formatCPFCpnj, formatToPhone, ppsTiposSolicitacao, tiposDeEstruturas, tiposEstruturaCRM, vendedores } from '../../utils/constants'
...
function ChamadoExternoPPS() {
  ...
  async function handleCallCreation() {
    ...
    try {
      const response = await createCall({ info: infoHolder })
      toast.dismiss(loadingToastId)
              ...
              {infoHolder.projeto.id ? (
                ...
                <>
                  <p className="w-full lg:w-[60%] text-center italic text-gray-500 text-sm">
                    Lembro que o código em questão é o código identificador de projeto no CRM, sendo esse o número que acompanha o padrão:
                  </p>
                  ...
                  <div className="flex items-end gap-2">
                    <NumberInput
                      ...
                      labelClassName="text-center text-gray-500 font-bold font-raleway"
        ...
        <div className="mt-1 flex w-full flex-col items-center gap-2 lg:flex-row px-2">
          <div className="w-full lg:w-[50%]">
            <SelectInput
              label={'ESTADO'}
              selectedItemLabel="NÃO DEFINIDO"
              value={infoHolder.cliente.uf ? Object.keys(estadosECidades).indexOf(infoHolder.cliente.uf) + 1 : null}
          ...
          <div className="w-full lg:w-[50%]">
            <SelectInput
              selectedItemLabel={'NÃO DEFINIDO'}
              label="CIDADE"
              value={infoHolder.cliente.cidade ? Object.keys(estadosECidades).indexOf(infoHolder.cliente.cidade) + 1 : null}
              options={
