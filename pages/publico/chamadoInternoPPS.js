	...
	return (
		<section className="min-h-[100vh] flex items-center justify-center bg-[#15599a]">
			<div className="flex flex-col bg-[#fff] p-4 rounded">
				...
				<div className="flex items-center flex-col lg:flex-row gap-x-2 border border-gray-300 p-2 mt-4">
          ...
          >
            ...
            <option value={"SETOR PROJETOS"}>SETOR PROJETOS</option>
				...
				<div className={`flex flex-col lg:flex-row gap-x-2 border ${errorsMessage.errorSvbCode ? "border-red-400" : "border-gray-300"} p-2 mt-4`}>
					<span className="text-center font-bold">CÓDIGO SVB:</span>
					<input value={svbCode} onChange={(e) => setSvbCode(e.target.value)} className="outline-none text-sm text-center grow placeholder:italic" type="number" />
				</div>
				<div className="flex flex-col  gap-x-2 border border-gray-300 p-2 mt-4">
					...
					<select value={solicitationType} onChange={(e) => setSolicitationType(e.target.value)} className="text-xs outline-none mt-2 lg:mt-0 text-center">
				...
				<div className={`flex flex-col gap-x-2 border  ${errorsMessage.errorDesc ? "border-red-400" : "border-gray-300"}  p-2 mt-4`}>
				...
				<div className="text-center">
					<button onClick={handleOpenCall} className="mt-2 bg-[#15599a] hover:bg-[#fead61] hover:text-[#15599a] text-white font-bold uppercase w-fit p-2 rounded">
						Enviar chamado
					</button>
				</div>
			</div>
