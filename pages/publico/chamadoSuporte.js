	...
	return (
		<section className="min-h-[100vh] flex items-center justify-center bg-[#15599a]">
			<div className="flex flex-col bg-[#fff] p-4 rounded">
				...
				<div className={`flex flex-col lg:flex-row gap-x-2 border ${errorsMessage.clientNameMessage ? "border-red-400" : "border-gray-300"}  p-2 mt-4`}>
				...
				<div className={`flex flex-col lg:flex-row gap-x-2 border ${errorsMessage.cpfCnpjMessage ? "border-red-400" : "border-gray-300"} p-2 mt-4`}>
				...
				<div className={`flex flex-col gap-x-2 ${errorsMessage.problemDescMessage ? "border border-red-400" : "border border-gray-300"}  p-2 mt-4`}>
