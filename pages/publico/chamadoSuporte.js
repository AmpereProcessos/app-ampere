  ...
  return (
    <section className="min-h-[100vh] flex items-center justify-center bg-[#15599a]">
      <div className="flex flex-col bg-[#fff] p-4 rounded">
        ...
        <div
          className={`flex flex-col lg:flex-row gap-x-2 border ${
            errorsMessage.cpfCnpjMessage ? "border-red-400" : "border-gray-200"
          } p-2 mt-4`}
        >
        ...
        <div className="flex flex-col lg:flex-row gap-x-2 border border-gray-200 p-2 mt-4">
          ...
          >
            ...
            <option value={"DÚVIDA COM APLICATIVO"}>
              DÚVIDA COM APLICATIVO
            </option>
            <option value={"DÚVIDA COM CONTA DE ENERGIA"}>
              DÚVIDA COM CONTA DE ENERGIA
            </option>
            <option value={"PROBLEMA COM PLACA"}>PROBLEMA COM PLACA</option>
            <option value={"PROBLEMA COM INVERSOR/MICRO"}>
              PROBLEMA COM INVERSOR/MICRO
            </option>
