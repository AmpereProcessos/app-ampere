	...
	return (
		<section className="flex min-h-screen items-center justify-center bg-[#15599a]">
			<div className="bg-background flex flex-col rounded p-4">
				...
				<div className={`flex flex-col gap-x-2 border lg:flex-row ${errorsMessage.clientNameMessage ? "border-red-400" : "border-primary/20"} mt-4 p-2`}>
				...
				<div className="border-primary/20 mt-4 flex flex-col gap-x-2 border p-2 lg:flex-row">
					...
					<select value={clientCity} onChange={(e) => setClientCity(e.target.value)} className="mt-2 grow text-center text-xs outline-hidden lg:mt-0">
						{cities.map((city) => (
				...
				<div className={`flex flex-col gap-x-2 border lg:flex-row ${errorsMessage.cpfCnpjMessage ? "border-red-400" : "border-primary/20"} mt-4 p-2`}>
				...
				<div className="border-primary/20 mt-4 flex flex-col gap-x-2 border p-2 lg:flex-row">
					...
					<select value={problemType} onChange={(e) => setProblemType(e.target.value)} className="mt-2 text-center text-xs outline-hidden lg:mt-0">
				...
				<div className={`flex flex-col gap-x-2 ${errorsMessage.problemDescMessage ? "border border-red-400" : "border-primary/20 border"} mt-4 p-2`}>
