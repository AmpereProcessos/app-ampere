		...
		<section className="min-h-[100vh] flex items-center justify-center bg-[#15599a]">
			<div className="flex flex-col bg-[#fff] p-4 rounded">
				...
				<div className="flex flex-col lg:flex-row gap-x-2 border border-gray-300 p-2 mt-4">
					...
					<select value={responsavel} onChange={(e) => setResponsavel(e.target.value)} className="text-xs grow outline-none mt-2 lg:mt-0 text-center">
				...
				<div className="flex flex-col  gap-x-2 border border-gray-300 p-2 mt-4">
					...
					<select value={tipoDoChamado} onChange={(e) => setTipoDoChamado(e.target.value)} className="text-xs outline-none mt-2 lg:mt-0 text-center">
