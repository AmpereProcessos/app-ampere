    ...
    <div className="p-6 grow flex flex-col bg-[#15599a] items-center">
      <div className="w-[90%] h-[100%] bg-[#fff] rounded-lg flex flex-col border border-gray-300 shadow-lg p-2 items-center">
        ...
        <div className="flex w-full flex-col">
          ...
          <div className="w-full grid grid-cols-3 border-b border-gray-200">
            <div className="text-gray-600 font-medium col-span-1 p-1 text-center border-l border-gray-200">JANEIRO</div>
          ...
          <div className="w-full grid grid-cols-3 border-b border-gray-200">
            <div className="text-gray-600 font-medium col-span-1 p-1 text-center border-l border-gray-200">FEVEREIRO</div>
            <div className="text-gray-600 font-medium col-span-1 p-1 text-center border-x border-gray-200">
          ...
          <div className="w-full grid grid-cols-3 border-b border-gray-200">
            <div className="text-gray-600 font-medium col-span-1 p-1 text-center border-l border-gray-200">MARÇO</div>
            <div className="text-gray-600 font-medium col-span-1 p-1 text-center border-x border-gray-200">
          ...
          <div className="w-full grid grid-cols-3 border-b border-gray-200">
            <div className="text-gray-600 font-medium col-span-1 p-1 text-center border-l border-gray-200">ABRIL</div>
            <div className="text-gray-600 font-medium col-span-1 p-1 text-center border-x border-gray-200">
          ...
          <div className="w-full grid grid-cols-3 border-b border-gray-200">
            <div className="text-gray-600 font-medium col-span-1 p-1 text-center border-l border-gray-200">MAIO</div>
            <div className="text-gray-600 font-medium col-span-1 p-1 text-center border-x border-gray-200">
          ...
          <div className="w-full grid grid-cols-3 border-b border-gray-200">
            <div className="text-gray-600 font-medium col-span-1 p-1 text-center border-l border-gray-200">JUNHO</div>
            <div className="text-gray-600 font-medium col-span-1 p-1 text-center border-x border-gray-200">
          ...
          <div className="w-full grid grid-cols-3 border-b border-gray-200">
            <div className="text-gray-600 font-medium col-span-1 p-1 text-center border-l border-gray-200">JULHO</div>
            <div className="text-gray-600 font-medium col-span-1 p-1 text-center border-x border-gray-200">
          ...
          <div className="w-full grid grid-cols-3 border-b border-gray-200">
            <div className="text-gray-600 font-medium col-span-1 p-1 text-center border-l border-gray-200">AGOSTO</div>
            <div className="text-gray-600 font-medium col-span-1 p-1 text-center border-x border-gray-200">
          ...
          <div className="w-full grid grid-cols-3 border-b border-gray-200">
            <div className="text-gray-600 font-medium col-span-1 p-1 text-center border-l border-gray-200">SETEMBRO</div>
            <div className="text-gray-600 font-medium col-span-1 p-1 text-center border-x border-gray-200">
          ...
          <div className="w-full grid grid-cols-3 border-b border-gray-200">
            <div className="text-gray-600 font-medium col-span-1 p-1 text-center border-l border-gray-200">OUTUBRO</div>
            <div className="text-gray-600 font-medium col-span-1 p-1 text-center border-x border-gray-200">
          ...
          <div className="w-full grid grid-cols-3 border-b border-gray-200">
            <div className="text-gray-600 font-medium col-span-1 p-1 text-center border-l border-gray-200">NOVEMBRO</div>
            <div className="text-gray-600 font-medium col-span-1 p-1 text-center border-x border-gray-200">
          ...
          <div className="w-full grid grid-cols-3 border-b border-gray-200">
            <div className="text-gray-600 font-medium col-span-1 p-1 text-center border-l border-gray-200">DEZEMBRO</div>
            <div className="text-gray-600 font-medium col-span-1 p-1 text-center border-x border-gray-200">
          ...
          <div className="w-full grid grid-cols-3 border-b border-gray-200">
            <div className="text-gray-600 font-medium col-span-1 p-1 text-center border-l border-gray-200">MÉDIA</div>
            <div className="text-gray-600 font-medium col-span-1 p-1 text-center border-x border-gray-200">
