	...
	function simulate() {
		...
		for (let i = 0; i <= meses; i++) {
			...
			var saldoParaAdicionarDireitoAdquirido =
				injetadoMesComparacao + disponibilidadePorTipoDeLigacao[info.tipoDeLigacao] - usoConcessionariaMesComparacao;
			...
			saldoCumuladoDireitoAdquirido =
				saldoCumuladoDireitoAdquirido + saldoParaAdicionarDireitoAdquirido > 0 ? saldoCumuladoDireitoAdquirido + saldoParaAdicionarDireitoAdquirido : 0;
			...
			var outrosCustos =
				compensacao >= usoConcessionariaMesComparacao ? fioB : fioB + (usoConcessionariaMesComparacao - compensacao) * progressaoKWH[anoComparacao];
			...
			var valorFaturaDireitoAdquirido =
				saldoParaAdicionarDireitoAdquirido > 0
					...
					: saldoParaAdicionarDireitoAdquirido + saldoPassadoDireitoAdquirido >= 0
						? custoDisponibilidade + info.iluminacaoPublica
						: Math.abs(saldoParaAdicionarDireitoAdquirido + saldoPassadoDireitoAdquirido) * progressaoKWH[anoComparacao] +
			...
			var economiaDireitoAdquirido =
				consumo[mesComparacao - 1].valor * progressaoKWH[anoComparacao] + info.iluminacaoPublica - valorFaturaDireitoAdquirido;
			...
			<div className="flex grow flex-col p-6">
				<div className="mb-3 flex w-full items-center justify-center gap-2">
					...
					<button
						...
						className="border-primary/80 text-primary/80 hover:bg-primary/80 rounded border p-2 duration-300 ease-in-out hover:scale-110 hover:text-white"
					>
						<MdRestartAlt />
					</button>
				</div>
				...
				<div className="grid w-full grid-cols-6 lg:grid-cols-8">
					...
					<div className="text-xxs flex items-center justify-center bg-black p-1 text-center font-bold text-white lg:text-base">POUPANÇA</div>
				</div>
				{data?.map((obj, index) => (
					<div key={index} className="border-primary/20 grid w-full grid-cols-6 border-x border-b lg:grid-cols-8">
						<h1 className="text-xxs text-primary/80 border-primary/20 border-r p-1 text-center lg:text-sm">{obj["TAG"]}</h1>
						<h1 className="text-xxs text-primary/80 border-primary/20 hidden border-r p-1 text-center lg:block lg:text-sm">
							{obj["SALDO ACUMULADO (DIREITO ADQUIRIDO)"].toFixed(2)}
						</h1>
						<h1 className="text-xxs text-primary/80 border-primary/20 hidden border-r p-1 text-center lg:block lg:text-sm">
							{obj["SALDO ACUMULADO (NOVA LEI)"].toFixed(2)}
						</h1>
						<h1 className="text-xxs text-primary/80 border-primary/20 border-r p-1 text-center lg:text-sm">
							{obj["VALOR FATURA (DIREITO ADQUIRIDO)"].toFixed(2)}
						</h1>
						<h1 className="text-xxs text-primary/80 border-primary/20 border-r p-1 text-center lg:text-sm">{obj["VALOR FATURA (NOVA LEI)"].toFixed(2)}</h1>
						<h1
							className={`text-xxs text-center lg:text-sm ${obj["PAYBACK (DIREITO ADQUIRIDO)"] > 0 ? "text-green-500" : "text-red-500"} border-primary/20 border-r p-1`}
						>
							{obj["PAYBACK (DIREITO ADQUIRIDO)"].toFixed(2)}
						</h1>
						<h1 className={`text-xxs text-center lg:text-sm ${obj["PAYBACK (NOVA LEI)"] > 0 ? "text-green-500" : "text-red-500"} p-1`}>
							{obj["PAYBACK (NOVA LEI)"].toFixed(2)}
						</h1>
						<h1 className="text-xxs text-primary/80 border-primary/20 border-r p-1 text-center lg:text-sm">{obj["INVESTIMENTO POUPANÇA"].toFixed(2)}</h1>
					</div>
				))}
			</div>
		);
		...
		return (
			<div className="flex grow flex-col items-center justify-center p-6 lg:flex-row">
				...
				<div className="flex w-full flex-col lg:w-[40%]">
					<h1 className="text-center font-['Roboto'] text-xl font-bold text-[#15599a]">SIMULAÇÃO DE FATURAS E PAYBACK</h1>
					<div className="flex w-full flex-col gap-2 px-12 py-2">
						<div className="grid w-full grid-cols-1 grid-rows-2 gap-2 lg:grid-cols-2 lg:grid-rows-1">
							<div className="flex w-full flex-col gap-2">
								<label className="text-md text-primary/60 text-start italic">Quantidade de Módulos</label>
								<input
							...
							<div className="flex w-full flex-col gap-2">
								<label className="text-md text-primary/60 text-start italic">Potência dos Módulos</label>
								<input
						...
						<div className="grid w-full grid-cols-1 grid-rows-2 gap-2 lg:grid-cols-2 lg:grid-rows-1">
							<div className="flex w-full flex-col gap-2">
								<label className="text-md text-primary/60 text-start italic">Tipo de ligação</label>
								<select
							...
							<div className="flex w-full flex-col gap-2">
								<label className="text-md text-primary/60 text-start italic">Cidade</label>
								<select
									value={info.cidade}
						...
						<div className="grid w-full grid-cols-1 grid-rows-2 gap-2 lg:grid-cols-2 lg:grid-rows-1">
							<div className="flex w-full flex-col gap-2">
								<label className="text-md text-primary/60 text-start italic">Ano de início</label>
								<select
							...
							<div className="flex w-full flex-col gap-2">
								<label className="text-md text-primary/60 text-start italic">Mês de início</label>
								<select
						...
						<div className="grid w-full grid-cols-1 grid-rows-2 gap-2 lg:grid-cols-2 lg:grid-rows-1">
							<div className="flex w-full flex-col gap-2">
								<label className="text-md text-primary/60 text-start italic">Valor do kWh</label>
								<input
									value={info.valorkWh}
							...
							<div className="flex w-full flex-col gap-2">
								<label className="text-md text-primary/60 text-start italic">Valor do Fio B</label>
								<input
						...
						<div className="grid w-full grid-cols-1 grid-rows-2 gap-2 lg:grid-cols-2 lg:grid-rows-1">
							<div className="flex w-full flex-col gap-2">
								<label className="text-md text-primary/60 text-start italic">Iluminação pública</label>
								<input
							...
							<div className="flex w-full flex-col gap-2">
								<label className="text-md text-primary/60 text-start italic">Simultaneidade</label>
								<input
						...
						<div className="grid w-full grid-cols-1 grid-rows-2 gap-2 lg:grid-cols-2 lg:grid-rows-1">
							<div className="flex w-full flex-col gap-2">
								<label className="text-md text-primary/60 text-start italic">Consumo médio (kWh)</label>
								<input
							...
							<div className="flex w-full flex-col gap-2">
								<label className="text-md text-primary/60 text-start italic">Valor investido (R$)</label>
								<input
						...
						<div className="flex w-full items-center justify-center">
							<div className="flex w-full flex-col gap-2">
								<label className="text-md text-primary/60 text-start italic">Rendimento mensal da Poupança (%)</label>
								<input
