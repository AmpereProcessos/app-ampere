    ...
    <div className="w-[21cm] h-[29.7cm] p-4">
      ...
      <div className="mt-8 px-4">
        <p className="text-center font-raleway">
          Eu, _____________________________________________________, inscrito
          sob o número de CPF/CNPJ{" "}
          <strong>___________________________________</strong>, declaro que a
          ...
          sistema fotovoltaico de ______ kWp instalado na{" "}
          <strong>
            _______________________, Nº ______, ______________________
          </strong>{" "}
          , no município de <strong>_____________</strong>.
        </p>
