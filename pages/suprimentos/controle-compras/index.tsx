...
function PurchasesControl({ initialMode, kanbanListExpandedModeOptions }: PurchasesControlProps) {
	...
	if (mode === "kanban")
		return <PurchaseControlsKanbanModePage initialKanbanListExpandedModeOptions={kanbanListExpandedModeOptions} session={session} handleSetMode={handleSetMode} />;

	if (mode === "card") return <PurchaseControlsCardModePage session={session} handleSetMode={handleSetMode} />;
	return <PurchaseControlsGroupedModePage initialListExpandedModeOptions={kanbanListExpandedModeOptions} session={session} handleSetMode={handleSetMode} />;
}
