    ...
    <div className="flex w-full items-center justify-center">
      <div className="flex h-[29.7cm] w-[21cm] flex-col">
        <div className="flex items-center justify-center gap-4 border border-black bg-black p-3">
          ...
          <h1 className="text-center text-xl leading-none font-black tracking-tight text-white">
        ...
        <div className="flex w-full flex-col gap-2 border-x border-black py-2">
          ...
          {purchaseControl.projetoDados ? (
            <div className="flex flex-col items-center gap-1">
              <p className="text-foreground text-[0.7rem] font-medium">INFORMAÇÕES DE PROJETO</p>
              ...
              <p className="text-foreground text-[0.7rem] font-medium">INFORMAÇÕES DE PAGAMENTO</p>
              <div className="flex flex-wrap items-center justify-center gap-4 px-2">
                <div className="flex items-center gap-1">
                  <FaUserAlt />
                  <p className="text-xs leading-none font-medium tracking-tight">
                    {purchaseControl.projetoDados?.pagamento.pagador.nome}
                  </p>
                </div>
                <div className="flex items-center gap-1">
                  <FaPhone />
                  <p className="text-xs leading-none font-medium tracking-tight">
                    {purchaseControl.projetoDados.pagamento.pagador.telefone}
                  </p>
                </div>
                <div className="flex items-center gap-1">
                  <BsPersonVcard />
                  <p className="text-xs leading-none font-medium tracking-tight">
                    {purchaseControl.projetoDados?.pagamento.pagador.cpfCnpj}
                  </p>
                </div>
                <div className="flex items-center gap-1">
                  <MdOutlinePayment />
          ...
          <div className="flex flex-col items-center gap-1">
            <p className="text-foreground text-[0.7rem] font-medium">LOCALIZAÇÃO</p>
            <div className="flex w-full items-center justify-center">
              <div className="flex items-center gap-1">
                <FaLocationDot />
          ...
          <div className="flex flex-col items-center gap-1">
            <p className="text-foreground text-[0.7rem] font-medium">ANOTAÇÕES</p>
          ...
          {purchaseControl.composicao.map((item, index) => (
            ...
            >
              <div className="flex w-[40%] flex-col">
                <h1 className="w-full text-start text-xs font-medium text-black">
                  {item.descricao}
                </h1>
                <div className="flex w-full items-center gap-1">
                  <MdDashboard />
                  <h1 className="text-foreground text-[0.65rem] tracking-tight">
                    {item.categoria || "CÓDIGO NÃO DEFINIDO"}
                  </h1>
                </div>
              </div>
              <h1 className="w-[30%] text-center text-xs font-medium text-black">{item.unidade}</h1>
              <h1 className="w-[30%] text-center text-xs font-medium text-black">
                {formatDecimalPlaces(item.qtde)}
              </h1>
            </div>
          ))}
        </div>
