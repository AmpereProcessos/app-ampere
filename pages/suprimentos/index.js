						...
						>
							...
							<div className="flex flex-col p-2">
								...
								<div className="mt-1 grid grid-cols-3 items-center">
									...
									<div className="flex flex-col items-center">
										...
										{dayjs(new Date()).isBefore(dayjs(dayjs(project.compra.previsaoEntrega).add(22, "hour"))) ? (
											<p className={`text-xs ${dayjs(project.compra.previsaoEntrega).diff(new Date(), "day") < 7 ? "font-bold text-red-500" : "font-bold text-green-500"} text-center`}>
								...
								<div className="flex flex-col items-center pt-1">
									...
									<p className="text-center text-xs uppercase text-gray-600">{project.faturamento?.previsaoFaturamento ? project.faturamento?.previsaoFaturamento : "-"}</p>
								</div>
								...
								{project.compra.dataPagamento == undefined && project.compra.dataMaxPagamento != null && dayjs(new Date(project.compra.dataMaxPagamento)).isValid() ? (
									dayjs(project.compra.dataMaxPagamento).isAfter(dayjs()) ? (
										<p className={`text-center text-sm ${dayjs(project.compra.dataMaxPagamento).diff(new Date(), "days") < 2 ? "text-red-500" : "text-gray-600"} italic`}>
