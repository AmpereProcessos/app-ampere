				...
				<div className="flex flex-col border-b border-gray-300 pb-2">
					...
					<div className="flex w-full items-center justify-center gap-2">
						<button
							...
							className={`flex h-[36px] items-center gap-2 rounded p-2 font-bold text-white shadow-md ${filters.overdue ? "bg-red-500" : "bg-[#15599a]"}`}
						>
							{filters.overdue ? (
								<>
						...
						<button onClick={filterProjects} className="flex h-[36px] items-center gap-x-2 rounded bg-[#fead61] px-2 font-bold hover:bg-[#15599a] hover:text-white">
							<p>Filtrar</p>
							<AiOutlineSearch />
						</button>
					</div>
