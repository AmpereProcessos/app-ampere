	...
	if (status == "authenticated") {
		return (
			<div className="flex grow flex-col bg-[#fff] p-6">
				...
				{modalIsOpen && <ModalSolicitacaoVendas editable={modalSolicitacao.aprovacao == false} info={modalSolicitacao} setModalIsOpen={setModalIsOpen} handleUpdates={handleUpdates} />}
			</div>
		);
	}
}
