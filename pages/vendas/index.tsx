...
import { accessGrantingStatus, ServiceOrderStatus, HomologationControlStatus, inspectionStatus } from '@/utils/select-options'
  ...
  return (
    <div className="grow p-6">
      ...
      {modalProject.isOpen && modalProject.id && (
        <ModalDatabase session={session} projectId={modalProject.id} closeModal={() => setModalProject({ isOpen: false, id: null })} />
      )}
    </div>
  )
}
