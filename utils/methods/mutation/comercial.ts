...
export async function generateContractRevenue({
  ...
  const paymentFractionnements = ContractRequestPaymentOptions.find(
    (c) => c.value === data.pagamento.metodo,
  )?.fractionnements;
