...
export const InsertFileReferenceSchema = z.object({
  idOportunidade: z
    ...
    .nullable(),
  idCliente: z
    .string({ invalid_type_error: "Tipo não válido para a referência de cliente." })
    .optional()
    .nullable(),
  idProjeto: z
    .string({ invalid_type_error: "Tipo não válido para a referência de projeto." })
    .optional()
    .nullable(),
  idCompra: z
    .string({ invalid_type_error: "Tipo não válido para a referência de compra." })
    .optional()
    .nullable(),
  idTransporte: z
    .string({ invalid_type_error: "Tipo não válido para a referência de transporte." })
    .optional()
    .nullable(),
  idReceita: z
    .string({ invalid_type_error: "Tipo não válido para a referência de receita." })
    .optional()
    .nullable(),
  idDespesa: z
    .string({ invalid_type_error: "Tipo não válido para a referência de despesa." })
    .optional()
    .nullable(),
  idOrdemServico: z
    .string({ invalid_type_error: "Tipo não válido para a referência da ordem de serviço." })
    .optional()
    .nullable(),
  idParceiro: z
    .string({
  ...
  idHomologacao: z
    ...
    .nullable(),
  idChamado: z
    .string({ invalid_type_error: "Tipo não válido para a referência de chamado." })
    .optional()
    .nullable(),
  titulo: z
    .string({
  ...
  dataExclusao: z
    ...
    .nullable(),
  autorIdExclusao: z
    .string({ invalid_type_error: "Tipo não válido para o autor da exclusão." })
    .optional()
    .nullable(),
...
export const FileReferencesQueryParamsSchema = z.object({
  clientId: z
    ...
    .nullable(),
  opportunityId: z
    .string({ invalid_type_error: "Tipo inválido para referência de oportunidade." })
    .optional()
    .nullable(),
  analysisId: z
    .string({ invalid_type_error: "Tipo inválido para referência de análise técnica." })
    .optional()
    .nullable(),
  homologationId: z
    .string({ invalid_type_error: "Tipo inválido para referência de homologação." })
    .optional()
    .nullable(),
  projectId: z
  ...
  purchaseId: z
    ...
    .nullable(),
  transportId: z
    .string({ invalid_type_error: "Tipo inválido para referência de transporte." })
    .optional()
    .nullable(),
  revenueId: z
    ...
    .nullable(),
  serviceOrderId: z
    .string({ invalid_type_error: "Tipo inválido para referência de ordem de serviço." })
    .optional()
    .nullable(),
  callId: z
    .string({ invalid_type_error: "Tipo inválido para referência de chamado." })
    .optional()
    .nullable(),
});
