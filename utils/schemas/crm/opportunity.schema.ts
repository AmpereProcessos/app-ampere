import z from "zod";
import { ClientDTOSchema, InsertClientSchema, type TClientDTO } from "./client.schema";
...
export const GeneralOpportunitySchema = z.object({
	...
	cliente: z.object({
		...
		cpfCnpj: z.string({ required_error: "CPF ou CNPJ do cliente não informado.", invalid_type_error: "Tipo não válido para CPF ou CNPJ do cliente." }).optional().nullable(),
...
export const PersonalizedOpportunityQuerySchema = z.object({
	...
	projectTypes: z.array(z.string({ required_error: "Tipos de projeto não informados ou inválidos.", invalid_type_error: "Tipos de projeto inválidos." })).nullable(),
