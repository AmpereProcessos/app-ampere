...
export const PlanDescriptiveItemSchema = z.object(
  {
    descricao: z.string({
      required_error: 'Item do descritivo não informado.',
      invalid_type_error: 'Tipo não válido para o item do descritivo do plano.',
    }),
  },
  {
...
const GeneralSignaturePlanSchema = z.object({
  ativo: z.boolean({
    required_error: 'Status de ativação do plano não informado.',
