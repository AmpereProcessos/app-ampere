...
const GeneralUserSchema = z.object({
	...
	codigoIndicacaoConecta: z.string().optional().nullable(),
	ativo: z.boolean(),
...
export const InsertUserSchema = z.object({
	...
	ativo: z.boolean(),
	codigoIndicacaoConecta: z.string({ invalid_type_error: "Tipo não válido para o código de indicação do Conecta." }).optional().nullable(),
	dataInsercao: z.string().datetime().optional().nullable(),
	dataAlteracao: z.string().datetime().optional().nullable(),
});
