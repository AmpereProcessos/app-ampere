...
export const ResourceItemSchema = z.object({
	...
	quantidade: z.number({ required_error: "Quantidade do material não informada.", invalid_type_error: "Tipo não válido para a quantidade do material." }),
	quantidadePrevista: z.number({ required_error: "Quantidade prevista do material não informada.", invalid_type_error: "Tipo não válido para a quantidade prevista do material." }),
	...
	precoUnitario: z.number({ required_error: "Preço unitário do material não informado.", invalid_type_error: "Tipo não válido para o preço unitário do material." }),
	movimentacoes: z.array(
		z.object({
			titulo: z.string({ required_error: "Título da movimentação não informado.", invalid_type_error: "Tipo não válido para o título da movimentação." }),
			quantidade: z.number({ required_error: "Quantidade da movimentação não informada.", invalid_type_error: "Tipo não válido para a quantidade da movimentação." }),
			precoUnitario: z.number({ required_error: "Preço unitário da movimentação não informado.", invalid_type_error: "Tipo não válido para o preço unitário da movimentação." }),
