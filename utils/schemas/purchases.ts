...
export const GeneralPurchaseControlSchema = z.object({
	...
	totalPrevisto: z.number({ required_error: "Total da compra não informado.", invalid_type_error: "Tipo não válido para o valor total da compra." }).optional().nullable(),
	liberacao: z.object({
...
export type TPurchaseControlSimplified = Pick<
	TPurchaseControl,
	"status" | "registrosStatus" | "etiquetas" | "titulo" | "projeto" | "liberacao" | "dataPedido" | "fornecedor" | "autor" | "dataInsercao" | "dataEfetivacao"
> & {
	liberacao: {
	...
	period: z.object(
		{
			...
			before: z
				...
				.optional()
				.nullable(),
			type: z.enum(["dataInsercao", "liberacao.data", "dataPedido", "entrega.dataPrevisao", "entrega.dataEfetivacao", "dataEfetivacao"]).optional().nullable(),
		},
