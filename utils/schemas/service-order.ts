...
const ServiceOrderCategories = z.enum([
  "MONTAGEM",
...
export const ServiceOrderSchema = z.object({
  ...
  favorecido: z.object({
    nome: z.string({
      required_error: "Nome do favorecido não informado.",
      invalid_type_error: "Tipo não válido para o nome do favorecido.",
    }),
    contato: z.string({
  ...
  idAnaliseTecnica: z
    .string({ invalid_type_error: "Tipo não válido para o ID da análise técnica." })
    .optional()
    .nullable(),
  projeto: z.object({
    id: z
      .string({ invalid_type_error: "Tipo não válido para o ID do projeto." })
      .optional()
      .nullable(),
    identificador: z.union([z.string(), z.number()]).optional().nullable(),
    nome: z
      .string({ invalid_type_error: "Tipo não válido para o nome do projeto." })
      .optional()
      .nullable(),
    tipo: z
      .string({ invalid_type_error: "Tipo não válido para o tipo do projeto." })
      .optional()
      .nullable(),
    // Important tracking fields
    vendedorNome: z
      .string({ invalid_type_error: "Tipo não válido para o nome do vendedor." })
      .optional()
      .nullable(),
    contratoDataAssinatura: z
      .string({ invalid_type_error: "Tipo não válido para a data de assinatura do contrato." })
      .optional()
      .nullable(),
    compraDataPagamento: z
      .string({ invalid_type_error: "Tipo não válido para a data de pagamento da compra." })
      .optional()
      .nullable(),
    compraEntregaDataPrevisao: z
      .string({
        invalid_type_error: "Tipo não válido para a data de previsão de entrega da compra.",
      })
      .optional()
      .nullable(),
    compraEntregaDataEfetivacao: z
      .string({
        invalid_type_error: "Tipo não válido para a data de efetivação de entrega da compra.",
      })
      .optional()
      .nullable(),
    homologacaoAcessoDataResposta: z
      .string({
        invalid_type_error: "Tipo não válido para a data de resposta da homologação de acesso.",
      })
      .optional()
      .nullable(),
  ...
  localizacao: z.object({
    ...
    numeroOuIdentificador: z
      .string({ required_error: "Número ou identificador não foi informado." })
      .optional()
      .nullable(),
    latitude: z
      .string({ invalid_type_error: "Tipo não válido para a latitude." })
      .optional()
      .nullable(),
    longitude: z
      .string({ invalid_type_error: "Tipo não válido para a longitude." })
      .optional()
      .nullable(),
    complemento: z
      .string({ invalid_type_error: "Tipo não válido para o complemento." })
      .optional()
      .nullable(),
  }),
  ...
  responsaveis: z.array(
    z.object({
      ...
      email: z
        ...
        .nullable(),
      dataValidacao: z
        .string({ invalid_type_error: "Tipo não válido para a data de validação do responsável." })
        .optional()
        .nullable(),
    }),
  ),
  ...
  anotacoes: z
    .string({ invalid_type_error: "Tipo não válido para as anotações." })
    .optional()
    .nullable(),
  detalhes: z.object({
    amperagemPadrao: z
      .string({ invalid_type_error: "Tipo não válido para a amperagem padrão." })
      .optional()
      .nullable(),
    configuracaoMonitoramento: z
      .boolean({ invalid_type_error: "Tipo não válido para a configuração de monitoramento." })
      .optional()
      .nullable(),
    ...
    senhaWifi: z
      .string({ invalid_type_error: "Tipo não válido para a senha Wi-Fi." })
      .optional()
      .nullable(),
    tipoEstrutura: z
      .string({ invalid_type_error: "Tipo não válido para o tipo de estrutura." })
      .optional()
      .nullable(),
    tipoPadrao: z
      .string({ invalid_type_error: "Tipo não válido para o tipo padrão." })
      .optional()
      .nullable(),
    tipoSaidaPadrao: z
      ...
      .nullable(),
    tipoTelha: z
      .string({ invalid_type_error: "Tipo não válido para o tipo de telha." })
      .optional()
      .nullable(),
    topologia: z
      .string({ invalid_type_error: "Tipo não válido para a topologia." })
      .optional()
      .nullable(), // corrigir para duas opções
  }),
  autor: AuthorSchema,
  cobranca: z.object({
    pagador: z
      .string({ invalid_type_error: "Tipo não válido para o pagador." })
      .optional()
      .nullable(),
  ...
  pagamento: z.object({
    recebedor: z
      .string({ invalid_type_error: "Tipo não válido para o recebedor." })
      .optional()
      .nullable(),
  ...
  observacoes: z.array(
    z.object({
      topico: z.string({
        required_error: "Tópico da observação não informado.",
        invalid_type_error: "Tipo não válido para o tópico da observação.",
      }),
      descricao: z.string({
  ...
  agendamento: z
    .object({
      inicio: z
        .string({ invalid_type_error: "Data inválida para o início do agendamento." })
        .nullable()
        .optional(),
      fim: z
        .string({ invalid_type_error: "Data inválida para o fim do agendamento." })
        .nullable()
        .optional(),
    })
    .optional()
  ...
  periodo: z.object({
    inicio: z
      .string({ invalid_type_error: "Tipo não válido para o início do período de execução." })
      .optional()
      .nullable(),
    fim: z
      .string({ invalid_type_error: "Tipo não válido para o fim do período de execução." })
      .optional()
      .nullable(),
    historico: z
      .array(
  ...
  calendarioId: z
    .string({ invalid_type_error: "Tipo não válido para o ID do calendário." })
    .optional()
    .nullable(),
  googleCalendarId: z
    .string({ invalid_type_error: "Tipo não válido para o ID do calendário no Google." })
    .optional()
    .nullable(),
  googleCalendarEventId: z
    .string({ invalid_type_error: "Tipo não válido para o ID do evento no Google." })
    .optional()
    .nullable(),
  // Field I will generally use for tracking the expected delivery date of the project (if applicable) purchase
  dataPrevisaoLiberacao: z
    .string({ invalid_type_error: "Tipo não válido para a data previsão de liberação." })
    .optional()
    .nullable(),
  // Field I will generally use for tracking the efective delivery date of the project (if applicable) purchase
  dataLiberacao: z
    .string({ invalid_type_error: "Tipo não válido para a data de liberação." })
    .optional()
    .nullable(),
  dataEfetivacao: z
...
export const PersonalizedFiltersSchema = z.object({
  ...
  tags: z.array(
    z.string({
      required_error: "Tag de filtro não informada.",
      invalid_type_error: "Tipo não válido para tag de filtro.",
    }),
    {
  ...
  category: z.array(
    z.string({
      required_error: "Categoria de filtro não informada.",
      invalid_type_error: "Tipo não válido para categoria de filtro.",
    }),
    {
  ...
  urgency: z.array(
    z.string({
      required_error: "Urgência de filtro não informada.",
      invalid_type_error: "Tipo não válido para urgência de filtro.",
    }),
    {
  ...
  authors: z.array(
    z.string({
      ...
      invalid_type_error: "Tipo não válido para Autor de filtro.",
    }),
    {
  ...
  topologies: z.array(
    z.string({
      required_error: "Topologia de filtro não informada.",
      invalid_type_error: "Tipo não válido para topologia de filtro.",
    }),
  ),
  roofTypes: z.array(
    z.string({
      required_error: "Tipo de telha de filtro não informada.",
      invalid_type_error: "Tipo não válido para tipo de telha de filtro.",
    }),
  ),
  period: z.object({
    after: z
...
export type TServiceOrderWithProjectDTO = TServiceOrderDTO & {
  projetoDados: TServiceOrderProjectDTO | null;
};
