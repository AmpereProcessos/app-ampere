...
export const ServiceOrderSchema = z.object({
  ...
  responsaveis: z.array(
    z.object({
      ...
      nome: z.string({ invalid_type_error: 'Tipo não válido para o nome do responsável.' }),
      avatar_url: z.string({ invalid_type_error: 'Tipo não válido para o avatar do responsável.' }).optional().nullable(),
      telefone: z.string({ invalid_type_error: 'Tipo não válido para o telefone do responsável.' }).optional().nullable(),
      email: z.string({ invalid_type_error: 'Tipo não válido para o email do responsável.' }).optional().nullable(),
      dataValidacao: z.string({ invalid_type_error: 'Tipo não válido para a data de validação do responsável.' }).optional().nullable(),
    })
  ),
