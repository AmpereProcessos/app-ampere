...
export const GeneralTechnicalAnalysisSchema = z.object({
	...
	complexidade: z
		...
		.optional()
		.nullable(),
	// [APPLICANT INPUT] an url link for a Google Drive folder, or any other cloud stored resource
	...
	// [ANALISTS INPUT] a list of pendencies for the conclution of the analysis
	pendencias: z.array(
		z.object({
	...
	// [ANALISTS INPUT] a text field for comments for the analysis
	anotacoes: z.string({
	...
	// [APPLICANT INPUT] the type of solicitation for the analysis
	...
	analista: z
		...
		.optional()
		.nullable(),
	// [APPLICANT INPUT] the requester/application of the analysis
	requerente: z.object({
	...
	// [APPLICANT INPUT] the opportunity/project of the analysis from CRM
	...
	projeto: z
		...
		.optional()
		.nullable(),
	// [APPLICANT INPUT] the location of the place of the analysis
	...
	// [APPLICANT INPUT] a list of existing equipments for the analysis
	equipamentosAnteriores: z.array(EquipmentSchema),
	// [APPLICANT INPUT] a list of the new equipments for the analysis
	equipamentos: z.array(EquipmentSchema),
	// [APPLICANT INPUT] a list of applicable power distribution poles to be analized
	padrao: z.array(
		z.object({
			alteracao: z.boolean({
	...
	// [APPLICANT INPUT] data from the energy transformer of the analysis
	...
	// [ANALISTS INPUT] data to be provided for field executors or engineers of the service in question
	execucao: z.object({
		observacoes: z
	...
	// [ANALISTS INPUT] a list of topics and descriptions for the analysis
	descritivo: z.array(
		z.object({
	...
	// [ANALISTS INPUT] a list of additional services to be provided for the analysis
	...
	// [ANALISTS OR APPLICANT INPUT] data about the analysis
	detalhes: z.object({
		// [ANALISTS OR APPLICANT INPUT] the concessionaire of energy of the analysis
		concessionaria: z.string(),
		// [ANALISTS OR APPLICANT INPUT] the topology of system being analyzed
		topologia: z
			.union([z.literal("MICRO-INVERSOR"), z.literal("INVERSOR")], { invalid_type_error: "Tipo não válido para a topologia." })
			.optional()
			.nullable(),
		// [ANALISTS OR APPLICANT INPUT] the material of the structure of the system being analyzed
		materialEstrutura: z
			.union([z.literal("MADEIRA"), z.literal("FERRO")], { invalid_type_error: "Tipo não válido para o material da estrutura." })
			.optional()
			.nullable(),
		// [ANALISTS OR APPLICANT INPUT] the type of structure of the system being analyzed
		tipoEstrutura: z
			.string({
			...
			.optional()
			.nullable(),
		// [ANALISTS OR APPLICANT INPUT] the type of roof of the system being analyzed
		tipoTelha: z
			.string({
			...
			.optional()
			.nullable(),
		// [ANALISTS OR APPLICANT INPUT] the type of fastening of the inverters of the system being analyzed
		fixacaoInversores: z
			.string({
			...
			.optional()
			.nullable(),
		// [ANALISTS INPUT] the status of the existence of drone images
		...
		// [ANALISTS INPUT] the status of the existence of images of the facade
		...
		// [ANALISTS INPUT] the status of the existence of images of the satellite
		...
		// [ANALISTSINPUT] the status of the existence of measurements from the place of the analysis
		medicoes: z.boolean({
		...
		// [ANALISTS OR APPLICANT INPUT] the orientation of installation of the system being analyzed
		orientacao: z.string({
			required_error: "Orientação do sistema não informada.",
			invalid_type_error: "Tipo não válido para a orientação do sistema.",
		}),
		// [APPLICANT INPUT] the existence of additional tiles in case of need
		telhasReservas: z
	...
	// [ANALISTS OR APPLICANT INPUT] the distances from the system to the internet connection point and the power distribution pole
	distancias: z.object({
	...
	// [ANALISTS INPUT] a list of costs necessary for the execution of the project
	custos: z.array(
		z.object({
			categoria: z
	...
	// [ANALISTS INPUT] the allocation of modules derived from availability, shadow and other factors for the analysis
	...
	// [ANALISTS INPUT] the drawing (CAD) of the system being analyzed
	desenho: z.object({
	...
	// [ANALISTS INPUT] a list of supplies necessary for the execution of the project
	suprimentos: z
		.object({
			// [ANALISTS INPUT] the observations about the supplies
			observacoes: z.string({
		...
		.optional()
		.nullable(),
	// [ANALISTS INPUT] the conclusion of the analysis
	conclusao: z.object({
