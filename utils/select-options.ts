...
export const PurchaseControlStatus = [
  ...
  { id: 6, label: 'AGUARDANDO FATURAMENTO', value: 'AGUARDANDO FATURAMENTO' },
  { id: 7, label: 'AGUARDANDO DESPACHE', value: 'AGUARDANDO DESPACHE' },
  { id: 8, label: 'AGUARDANDO ENTREGA', value: 'AGUARDANDO ENTREGA' },
  { id: 9, label: 'PENDÊNCIAS', value: 'PENDÊNCIAS' },
  { id: 10, label: 'CONCLUÍDA', value: 'CONCLUÍDA' },
]
