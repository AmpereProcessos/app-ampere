...
export type TComissionableItemsEnum =
  | "SISTEMA"
  | "PADRÃO"
...
export const VinculationCompanies = [
  {
    id: 1,
    label: "AMPERE ENGENHARIA E CONSULTORIA ELETRICA LTDA",
    value: "AMPERE ENGENHARIA E CONSULTORIA ELETRICA LTDA",
  },
...
export const ProductItemCategories = [
  ...
  { id: 2, label: "INVERSOR", value: "INVERSOR", icon: TbTopologyFull as React.ComponentType },
  {
    ...
    label: "INSUMO",
    value: "INSUMO",
    icon: MdOutlineSettingsInputComponent as React.ComponentType,
  },
...
export const paymentMethods = [
  ...
  {
    id: 2,
    label: "À VISTA (DINHEIRO)",
    value: "À VISTA (DINHEIRO)",
    apportionment: false,
    modality: null,
  },
  ...
  {
    id: 6,
    label: "PARCELADO (CRÉDITO)",
    value: "PARCELADO (CRÉDITO)",
    apportionment: true,
    modality: "SIMPLES",
  },
  {
...
export const PurchaseControlStatus = [
  ...
  { id: 3, label: "EM COTAÇÃO", value: "EM COTAÇÃO", deadlineDays: 2 },
  { id: 4, label: "AGUARDANDO APROVAÇÃO", value: "AGUARDANDO APROVAÇÃO", deadlineDays: null },
  { id: 5, label: "AGUARDANDO COMPRA", value: "AGUARDANDO COMPRA", deadlineDays: 2 },
  { id: 6, label: "AGUARDANDO NOTA FUTURA", value: "AGUARDANDO NOTA FUTURA", deadlineDays: 2 },
  { id: 7, label: "AGUARDANDO PAGAMENTO", value: "AGUARDANDO PAGAMENTO", deadlineDays: 3 },
  { id: 9, label: "AGUARDANDO SEPARAÇÃO", value: "AGUARDANDO SEPARAÇÃO", deadlineDays: 7 },
  { id: 10, label: "AGUARDANDO DESPACHE", value: "AGUARDANDO DESPACHE", deadlineDays: 7 },
  { id: 11, label: "AGUARDANDO ENTREGA", value: "AGUARDANDO ENTREGA", deadlineDays: 7 },
  { id: 12, label: "PENDÊNCIAS", value: "PENDÊNCIAS", deadlineDays: null },
  { id: 13, label: "CONCLUÍDA", value: "CONCLUÍDA", deadlineDays: null },
];
...
export const PurchaseDeliveryStatus: {
  id: number;
  label: string;
  value: TPurchaseControl["entrega"]["status"];
}[] = [
  { id: 1, label: "AGUARDANDO COMPRA", value: "AGUARDANDO COMPRA" },
...
export const FileReferenceCategories = [
  ...
  {
    id: 10,
    label: "CONTRATOS COM TERCEIROS - PRESTAÇÃO DE SERVIÇOS",
    value: "CONTRATOS COM TERCEIROS - PRESTAÇÃO DE SERVIÇOS",
    restrict: true,
  },
  { id: 11, label: "OUTROS", value: "OUTROS", restrict: false },
];
